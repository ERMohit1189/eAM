<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="GenerateTimeTable.aspx.cs" Inherits="admin_GenerateTimeTable" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <asp:UpdatePanel ID="upMain" runat="server">
        <ContentTemplate>
                            ...
                            <div class="panel-body ">
                                ...
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-3-p6 mgbt-xs-15" style="padding-top:26px;">
                                        <asp:LinkButton ID="btnGenerate" runat="server" OnClick="btnGenerate_Click" CssClass="button form-control-blue">Generate Time Table</asp:LinkButton>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div id="gdv" runat="server" class="text-center" style="width: 100%;">
                                                                    ...
                                                                    <asp:GridView ID="GridViewTT" runat="server" class="table table-striped table-hover no-head-border table-bordered" AutoGenerateColumns="false">
                                                                        <Columns>
            ...
            <script>
                function lineBreak() {
                    var trlength = $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_GridViewTT  tbody  tr").length;
                    for (var i = 1; i < trlength; i++) {
                        var tdlength = $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_GridViewTT  tbody  tr:eq(" + i + ") td").length;
                        for (var j = 1; j < tdlength; j++) {
                            var data = $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_GridViewTT  tbody  tr:eq(" + i + ") td:eq(" + j + ")").html();
                            var result = data.replace("#", "<br>");
                            $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_GridViewTT  tbody  tr:eq(" + i + ") td:eq(" + j + ")").html(result);
                        }
                    }
                }
            </script>
