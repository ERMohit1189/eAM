<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="AutomaticTimeTable.aspx.cs" Inherits="AutomaticTimeTable" %>
                            ...
                            <div class="panel-body ">
                                ...
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtDate" CssClass="form-control-blue validatetxt datepicker-normal" runat="server" AutoPostBack="true" OnTextChanged="txtDate_TextChanged"></asp:TextBox>
