<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="PaperMaster.aspx.cs" Inherits="PaperMaster" %>
                            ...
                            <div class="panel-body ">
                                ...
                                <div class="col-sm-12  no-padding" id="tblInsert" runat="server">
                                    ...
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox CssClass="form-control-blue validatetxt" ID="txtPaper" runat="server" onkeyup="CopyTextBox(this,'#ContentPlaceHolder1_ContentPlaceHolderMainBox_txtPeperCode');"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Paper Code&nbsp;<span class="vd_red">*</span></label>
                                        <div class="">
                                            <asp:TextBox CssClass="form-control-blue validatetxt" ID="txtPeperCode" runat="server"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <table class="tab-popup">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtEditPaper" CssClass="textbox validatetxt1" runat="server" onkeyup="CopyTextBox(this,'#ContentPlaceHolder1_ContentPlaceHolderMainBox_txtEditPeperCode');"></asp:TextBox>
                            </td>
                            </tr>
                        <tr>
                            <td><asp:Label ID="Label1" runat="server" Text="Paper Code *"></asp:Label></td>
                            <td><asp:TextBox ID="txtEditPeperCode" CssClass="textbox validatetxt1" runat="server"></asp:TextBox></td>
                        </tr>
                       <tr>
                            <td></td>
                            <td>
