<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="AcademicSessionAssesment.aspx.cs" Inherits="AcademicSessionAssesment" %>
                                                    ...
                                                    <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Assessment">
                                                                <ItemTemplate>
                                                                    <asp:TextBox runat="server" ID="txtAssessment"></asp:TextBox>
                                                                </ItemTemplate>
