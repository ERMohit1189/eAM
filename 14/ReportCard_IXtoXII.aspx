<%@ Page Title="" Language="C#" MasterPageFile="~/14/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_IXtoXII.aspx.cs" Inherits="ReportCard_IXtoXII" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        <div class="col-sm-12 ">
                            ...
                            <asp:Label runat="server" ID="lblBranchId" CssClass="hide"></asp:Label>
    ...
    <script>
        ...
        function LoadClass() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlClassG3.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>REPORT CARD FOR IX to XII</title>' + headContent + '</head>');
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ReportCard_IXtoXIIServer.aspx") %>',
                data: {
                    'SrNo': SrNo,
        ...
        function LoadReportCardForG() {
            ...
            var SessionName = $("[id*=lblSectionName]").html();
            var SectionId = $("[id*=lblSectionId]").html();
            var BranchId = $("[id*=lblBranchId]").html();
