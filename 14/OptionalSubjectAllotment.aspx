<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="OptionalSubjectAllotment.aspx.cs" Inherits="OptionalSubjectAllotment" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="col-sm-12  half-width-50  btn-a-devices-1-p4-p2 mgbt-xs-15">
                                                <asp:LinkButton ID="btnSubmit" runat="server" Visible="false" OnClientClick="ValidateDropdown('.validatedrp');return validationReturn();" CssClass="button form-control-blue" OnClick="btnSubmit_Click">Submit</asp:LinkButton>
                                            </div>
                                            <div class="col-sm-12  half-width-50 mgbt-xs-15">
