...
public partial class ClassTeacherAllotment : System.Web.UI.Page
{
    ...
    public void DisplayRecord()
    {
        ...
        sql = "select sctm.Id,sctm.EmpId,sctm.Ecode,sctm.EmpName,' ('+scm.SectionName+')' SectionNames,cm.ClassName,case when bm.IsDisplay=1 then bm.BranchName else '' end BranchName, sctm.Medium, cm.CidOrder from ICSEClassTeacherAllotment sctm ";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        sql = "Select ECode from ICSEClassTeacherAllotment where ";
        sql = sql + " Classid=" + drpclass.SelectedValue + " and BranchId=" + drpBranch.SelectedValue + " and SectionId=" + drpSection.SelectedValue + " ";
        ...
        {
            sql = "Select ECode from ICSEClassTeacherAllotment ";
            sql = sql + " wher Classid=" + drpclass.SelectedValue + " and BranchId=" + drpBranch.SelectedValue + " and SectionId=" + drpSection.SelectedValue + " ";
            sql = sql + " and Medium='" + drpmedium.SelectedItem.ToString() + "' and SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"] + "";
            if (oo.Duplicate(sql))
            {
                ...
                divDuplicate.InnerHtml = "<b>" + oo.ReturnTag(pp, "Name") + "</b> is already class teacher for the class <b>" + drpclass.SelectedItem.ToString() + " " + oo.ReturnTag(ss, "BranchName") + " (" + drpSection.SelectedItem.ToString() + ")</b>";
            }
            else
            {
                ...
                cmd = new SqlCommand();
                cmd.CommandText = "ICSEClassTeacherAllotmentProc";
                cmd.Connection = con;
    ...
    {
        sql = "Delete From ICSEClassTeacherAllotment where SessionName='" + Session["SessionName"].ToString() + "'";
