<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="SubjectTeacherAllotment.aspx.cs" Inherits="SubjectTeacherAllotment" %>
                                            ...
                                            <div class="col-sm-12   no-padding" runat="server" id="div1">
                                                ...
                                                <div class="col-sm-12   no-padding ">
                                                    ...
                                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        ...
                                                        <div class="">
                                                            <asp:DropDownList ID="drpSubjectPaper" runat="server" CssClass="form-control-blue validatedrp" AutoPostBack="True" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Class">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblSection" runat="server" Text='<%# Bind("SectionNames") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Subject">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSubjectGroup" runat="server" Text='<%# Bind("SubjectName") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Paper">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSubjectName" runat="server" Text='<%# Bind("PaperName") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                            </asp:TemplateField>
