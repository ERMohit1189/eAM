<%@ Page Title="" Language="C#" MasterPageFile="~/14/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_NurtoPrep.aspx.cs" Inherits="ReportCard_NurtoPrep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 ">
                            ...
                            <div id="Div1" class="col-sm-12  no-padding" runat="server">
                                ...
                                <div class="col-sm-2  half-width-50 mgbt-xs-15 hide" id="div3" runat="server">
                                    <label class="control-label">Promoted Class &nbsp;<span class="vd_red">*</span></label>
                                    <div class="">
                                ...
                                <div class="col-sm-2  half-width-50 mgbt-xs-15 hide" id="div4" runat="server">
                                    <label class="control-label">School Re-opens On &nbsp;<span class="vd_red">*</span></label>
                                    <div class="">
                                        <asp:TextBox ID="txtSchoolReopenon" runat="server" CssClass="form-control-blue datepicker-normal" ReadOnly="true" placeholder="Date"></asp:TextBox>
                                        <div class="text-box-msg">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2  half-width-50 mgbt-xs-15">
                                    ...
                                    <div class="">
                                        <asp:TextBox ID="txtDate" runat="server" CssClass="form-control-blue datepicker-normal" ReadOnly="true"></asp:TextBox>
                                        <div class="text-box-msg">
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            if ($("[id*=drpEval]").val() == "Term1") {
                $("[id*=div3]").addClass("hide");
                $("[id*=div4]").addClass("hide");
                $("[id*=txtPromotedtoclass]").removeClass("validatetxt");
                $("[id*=txtSchoolReopenon]").removeClass("validatetxt");
            }
            if ($("[id*=drpEval]").val() == "Term2") {
                $("[id*=div3]").removeClass("hide");
                $("[id*=div4]").removeClass("hide");

                $("[id*=txtPromotedtoclass]").addClass("validatetxt");
                $("[id*=txtSchoolReopenon]").addClass("validatetxt");
            }
            $("[id*=drpEval]").change(function () {
                if ($("[id*=drpEval]").val() == "Term1") {
                    $("[id*=div3]").addClass("hide");
                    $("[id*=div4]").addClass("hide");
                    $("[id*=txtPromotedtoclass]").removeClass("validatetxt");
        ...
        function LoadClass() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlClassG1.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadData() {
            ...
            if ($("[id*=drpEval]").val() == 'Term2') {
                ...
                if ($("[id*=txtPromotedtoclass]").val() == "") {
                    $("[id*=txtPromotedtoclass]").addClass("borders");
                    return;
                }
                else {
                    $("[id*=txtPromotedtoclass]").removeClass("borders");
                }

                if ($("[id*=txtSchoolReopenon]").val() == "") {
                    $("[id*=txtSchoolReopenon]").addClass("borders");
                    return;
                }
                else {
                    $("[id*=txtSchoolReopenon]").removeClass("borders");
                }
            }
            ...
            var Promotedtoclass = $("[id*=txtPromotedtoclass]").val();
            var SchoolReopenon = $("[id*=txtSchoolReopenon]").val();
            var curDate = $("[id*=txtDate]").val();
            
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ReportCard_NurtoPrepServer.aspx") %>',
                data: {
                    'SrNo': SrNo,
