...
public partial class RemarkNurToPrep : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlRemarkHead.Items.Insert(0, "<--Select-->");
            loadmedium();
    ...
    public void RemarkHead()
    {
        sql = "Select RemarkHead, Id from ICSERemarkHeadsNurToPrep";
        sql = sql + " Where SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
        oo.FillDropDown_withValue(sql, ddlRemarkHead, "RemarkHead", "id");
        ddlRemarkHead.Items.Insert(0, "<--Select-->");
    }
    ...
    protected void ddlRemarkHead_SelectedIndexChanged(object sender, EventArgs e)
    {
        Grd.DataSource = null;
        Grd.DataBind();
    ...
    public void displayEmpInfo()
    {
        ...
        if (Grd.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < Grd.Rows.Count; i++)
            {
                ...
                string qq2 = "select Remark from ICSERemarkNurToPrep where Srno='" + lblSrNo.Text + "' and Term='" + ddlTerm.Text + "' ";
                qq2 = qq2 + " and BranchCode=" + Session["BranchCode"] + " and SessionName='" + Session["SessionName"] + "' and RemarkHeadId=" + ddlRemarkHead.SelectedValue + "";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < Grd.Rows.Count; i++)
        {
            ...
            {
                cmd = new SqlCommand();
                cmd.CommandText = "ICSERemarkNurToPrepProc";
                cmd.Connection = con;
                ...
                cmd.Parameters.AddWithValue("@RemarkHeadId", ddlRemarkHead.SelectedValue);
