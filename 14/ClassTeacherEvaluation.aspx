<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ClassTeacherEvaluation.aspx.cs" Inherits="ClassTeacherEvaluation" %>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="col-sm-12   mgbt-xs-15">
                                                ...
                                                <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                                    ...
                                                    <div class="">
                                                        <asp:DropDownList ID="ddlEvaluationHead" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlEvaluationHead_SelectedIndexChanged"
                                                            CssClass="form-control-blue validatedrp">
                                                        </asp:DropDownList>
                                                        <div class="text-box-msg">
                                                        </div>
                                                    ...
                                                    <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Evaluation">
                                                                <ItemTemplate>
                                                                    <asp:TextBox runat="server" ID="txtEvaluation" onblur="checkGrades(this);"></asp:TextBox>
                                                                </ItemTemplate>
