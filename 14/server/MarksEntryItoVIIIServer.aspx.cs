...
public partial class MarksEntryItoVIIIServer : System.Web.UI.Page
{
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        string MaxTest1 = "", MaxTest2 = "", MaxTest3 = "", MaxHY = "", MaxTest4 = "", MaxTest5 = "", MaxTest6 = "", MaxAE = "";
                        string sql1 = "select MaxTest1, MaxTest2, MaxTest3, MaxHY, MaxTest4, MaxTest5, MaxTest6, MaxAE from ICSEMaxMarkEntryItoVIII where BranchCode=" + BranchCode.ToString() + "  and SessionName='" + SessionName.ToString() + "' ";
                        ...
                        if (Term.ToLower() == "term1")
                        {
                            ...
                            Response.Write("<th class='p-tot-tit p-pad-n " + DisableTest1 + "' scope='col'style='width: 10% !important;'><span> MONTHLY TEST1 </span><br><input name='' type='text' value='" + MaxTest1.ToString() + "' id='MaxTest1' class='form-control-blue validatetxt text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n " + DisableTest2 + "' scope='col'style='width: 10% !important;'><span> MONTHLY TEST2 </span><br><input name='' type='text' value='" + MaxTest2.ToString() + "' id='MaxTest2' class='form-control-blue validatetxt text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n " + DisableTest3 + "' scope='col'style='width: 10% !important;'><span> MONTHLY TEST3 </span><br><input name='' type='text' value='" + MaxTest3.ToString() + "' id='MaxTest3' class='form-control-blue validatetxt text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n " + monthlyTest1 + "' scope='col' style='width: 10% !important;'>MONTHLY TEST<br>(Max Marks 20)</th>");
                            Response.Write("<th class='p-tot-tit p-pad-n' scope='col'style='width: 10% !important;'><span> HALF YEARLY EXAM</span><br><input name='' type='text' value='" + MaxHY.ToString() + "' id='MaxHY' class='form-control-blue validatetxt text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n' scope='col' style='width: 10% !important;'>AGGREGATE<br>(Max Marks 100)</th>");
                            ...
                            if (monthlyTest1 != "hide")
                            {
                                ...
                                if (MaxTest3.ToString().Trim().ToUpper() == "NP" || MaxTest3.ToString().Trim().ToUpper() == "NAD" || MaxTest3.ToString().Trim().ToUpper() == "ML" || MaxTest3.ToString().Trim().ToUpper() == "" || DisableTest3 == "hide") { }
                        ...
                        if (Term.ToLower() == "term2")
                        {
                            ...
                            Response.Write("<th class='p-tot-tit p-pad-n' scope='col'><span> ANNUAL EXAM</span><br><input name='' type='text' value='" + MaxAE.ToString() + "' id='MaxAE' class='form-control-blue text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n' scope='col'>AGGREGATE<br>(Max Marks 100)</th>");
                        ...
                        {
                            string sql2 = "select Test1, Test2, Test3, BestOfT1T2T3, HY, AggreGateHY, Test4, Test5, Test6, BestOfT4T5T6, AE, AggreGateAE from ICSEMarkEntryItoVIII where BranchCode=" + BranchCode.ToString() + "  and SessionName='" + SessionName.ToString() + "' ";
                            ...
                            string HY = "", Test1 = "", Test2 = "", Test3 = "", AE = "", Test4 = "", Test5 = "", Test6 = "";
                            double HYM = 0, Test1M = 0, Test2M = 0, Test3M = 0, AEM = 0, Test4M = 0, Test5M = 0, Test6M = 0;
                            ...
                            if (Term.ToLower() == "term1")
                            {
                                ...
                                if (dt2.Rows.Count > 0)
                                {
                                    ...
                                    aggregateHY = Math.Round(MonthlyTestAY + HYM);
                                }
                            ...
                            if (Term.ToLower() == "term2")
                            {
                                ...
                                if (dt2.Rows.Count > 0)
                                {
                                    ...
                                    aggregateAE = Math.Round(MonthlyTestAE + AEM);
                                }
