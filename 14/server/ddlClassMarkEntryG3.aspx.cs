...
public partial class ddlClassMarkEntryG3 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            _sql = _sql + " and id in(select classid from ICSEClassGroupMaster where GroupName='G3' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + ")  Order by CIDOrder";
        ...
        {
            _sql = "Select Distinct ClassName,cm.Id,CIDOrder from ICSESubjectTeacherAllotment ctm";
            ...
            _sql = _sql + " and cm.id in(select classid from ICSEClassGroupMaster where GroupName='G3' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + ")";
