<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ConductAndRemarkEntryIXtoXII.aspx.cs" Inherits="ConductAndRemarkEntryIXtoXII" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                                             ...
                                             <div class="col-sm-12   mgbt-xs-15">
                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                 ...
                                                 <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        ...
                                                        <div class="">
                                                            <asp:DropDownList ID="ddlRemarkType" runat="server" 
                                                                CssClass="form-control-blue validatedrp" >
                                                                <asp:ListItem Value=""><-Select--></asp:ListItem>
                                                                <asp:ListItem Value="SUPW">SUPW (Grade)</asp:ListItem>
                                                    ...
                                                    <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Student's Name">
                                                                ...
                                                                <HeaderStyle HorizontalAlign="Left" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" Width="240px" />
    ...
    <script>
        function checkGrades(tis) {
            if ($('#ContentPlaceHolder1_ContentPlaceHolderMainBox_ddlRemarkType').val() == "SUPW") {
                $(tis).val(tis.value.toUpperCase());
                var tisVal = $(tis).val();
                if (tisVal == "A+" || tisVal == "A" || tisVal == "B+" || tisVal == "B" || tisVal == "C" || tisVal == "D" || tisVal == "") {
                    $(tis).val(tisVal);
                }
                else {
                    $(tis).val('');
                    alert('Please enter only A+,A,B+,B,C or D');
                }
            }
        }
    </script>
