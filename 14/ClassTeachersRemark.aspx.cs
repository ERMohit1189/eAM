...
public partial class ClassTeachersRemark : System.Web.UI.Page
{
    ...
    public void displayEmpInfo()
    {
        ...
        for (int i = 0; i < Grd.Rows.Count; i++)
        {
            ...
            string qq2 = "select Remark from ICSEClassTeacherRemarks where Srno='" + lblSrNo.Text + "' and Term='" + ddlTerm.Text + "'";
        ...
        for (int i = 0; i < Grd.Rows.Count; i++)
        {
            ...
            if (txtRemark.Text.Trim() != "")
            {
                try
                {
                    ...
                    cmd = new SqlCommand();
                    cmd.CommandText = "ICSEClassTeacherRemarksProc";
                    cmd.Connection = con;
