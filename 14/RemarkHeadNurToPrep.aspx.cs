...
public partial class RemarkHeadNurToPrep : System.Web.UI.Page
{
    ...
    public void loadclass()
    {
        ...
        sql = sql + " and id in(select classid from ICSEClassGroupMaster where GroupName='G1' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + ")  Order by CIDOrder";
    ...
    public void displayEmpInfo()
    {
        ...
        string ss = "select evh.id, evh.classid, evh.Branchid, cm.ClassName,  bm.BranchName, evh.RemarkHead, evh.Medium from ICSERemarkHeadsNurToPrep evh ";
        ...
        {
            Label RemarkHeadId = (Label)Grd.Rows[i].FindControl("Label36");
            ...
            sql = "select Medium from ICSERemarkNurToPrep where RemarkHeadId=" + RemarkHeadId.Text + " and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + "";
            if (oo.Duplicate(sql))
            {
    ...
    {
        string ss = "select evh.Medium from ICSERemarkHeadsNurToPrep evh ";
        ss = ss + " where evh.ClassId=" + drpclass.SelectedValue + " and  evh.BranchId=" + drpBranch.SelectedValue + " and evh.BranchCode=" + Session["BranchCode"] + " ";
        ss = ss + " and evh.medium='" + drpmedium.SelectedValue + "' and evh.SessionName='" + Session["SessionName"] + "' and evh.RemarkHead='" + txtRemarkHead.Text.Trim() + "'";
        if (oo.Duplicate(ss))
        {
        ...
        {
            cmd = new SqlCommand();
            cmd.CommandText = "ICSERemarkHeadsNurToPrepProc";
            cmd.Connection = con;
            ...
            cmd.Parameters.AddWithValue("@RemarkHead", txtRemarkHead.Text.Trim());
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        txtRemarkHead0.Text = lblEvaluationHead.Text;
    ...
    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        ...
        ss = ss + " and evh.medium='" + lblMediums.Text + "' and evh.SessionName='" + Session["SessionName"] + "' and evh.RemarkHead='" + txtRemarkHead0.Text.Trim() + "' and id<>"+ lblID.Text.Trim() + "";
        if (oo.Duplicate(ss))
        {
            Campus camp = new Campus(); camp.msgbox(this.Page, divMsg, "Duplicate entry!", "A");
            return;
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@RemarkHead", txtRemarkHead0.Text.Trim());
            cmd.Parameters.AddWithValue("@SessionName", Session["SessionName"].ToString());
            cmd.Parameters.AddWithValue("@BranchCode", Session["BranchCode"].ToString());
            cmd.Parameters.AddWithValue("@LoginName", Session["LoginName"].ToString());
