<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="RemarkHeadNurToPrep.aspx.cs" Inherits="RemarkHeadNurToPrep" %>
                                             ...
                                             <div class="col-sm-12   mgbt-xs-15">
                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                 ...
                                                 <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                     ...
                                                     <div class="">
                                                         <asp:TextBox ID="txtRemarkHead" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                                         <div class="text-box-msg">
                                                         </div>
                                                     </div>
                                                 </div>
                                                    ...
                                                    <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Medium">
                                                             ...
                                                             <asp:TemplateField HeaderText="Remark Head">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblEvaluationHead" runat="server" Text='<%# Eval("RemarkHead") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                            </asp:TemplateField>
             ...
             <div style="overflow: auto; width: 1px; height: 1px">
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        <tr>
                            <td>Remark Head <span class="vd_red">*</span></td>
                            <td>
                                ...
                                <asp:TextBox ID="txtRemarkHead0" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
