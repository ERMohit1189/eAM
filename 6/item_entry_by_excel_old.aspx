<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="item_entry_by_excel_old.aspx.cs" Inherits="admin_libraryItemEntryByExcel" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-1-p4-p2 mgbt-xs-15">
                                        ...
                                        &nbsp;
                                        <asp:LinkButton ID="lnkReset" runat="server" CssClass="button " OnClick="lnkReset_Click">Reset</asp:LinkButton>
                                        <div id="msgbox" runat="server" style="left: 240px"></div>
                                    </div>
                                    <div class="col-sm-4  half-width-50  btn-a-devices-2-p2 mgbt-xs-15">
                                        <asp:LinkButton ID="lnkDownloadExcel" runat="server" CssClass="button " OnClick="lnkDownloadExcel_Click">Download Excel</asp:LinkButton>
                                ...
                                <div class="col-md-12 ">
                                    <div class=" table-responsive  table-responsive2">
                                        <asp:GridView ID="gvUploadLibItem" runat="server"
                                            CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group"
                                            AutoGenerateColumns="false" OnRowDataBound="gvUploadLibItem_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="AccessionNo*">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="LibraryEntryDate*">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="NoOfItem*">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblNoOfItem" runat="server" Text='<%# Eval("F7") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="BiilDate">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="SubjectTopic*">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="ISBNISSN">
                                                    <ItemTemplate>
