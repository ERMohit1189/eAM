<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="supplier_category.aspx.cs"
    Inherits="supplier_category" %>
                    ...
                    <table class="tab-popup">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align:center;">
                                <asp:LinkButton ID="LinkButton4" OnClientClick="ValidateTextBox('.validatetxt1');return validationReturn();" runat="server" CausesValidation="False" OnClick="LinkButton4_Click" CssClass="button-y">Update</asp:LinkButton>
                                &nbsp;
