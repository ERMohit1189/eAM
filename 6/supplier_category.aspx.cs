...
public partial class supplier_category : System.Web.UI.Page
{
    ...
    {
        sql = "Select  ROW_NUMBER() OVER (ORDER BY id ASC) AS SrNo,id,CategoryCode, CategoryName,Remark from SupplierCategoryMaster ";
        sql = sql + " where BranchCode=" + Session["BranchCode"].ToString() + "";
        GridView1.DataSource = oo.GridFill(sql);
        GridView1.DataBind();
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            Label SupplierCategory = (Label)GridView1.Rows[i].FindControl("Label2");
            LinkButton LinkButton3 = (LinkButton)GridView1.Rows[i].FindControl("LinkButton3");
            sql = "SELECT SupplierCategory FROM SupplierInfoEntry where SupplierCategory='" + SupplierCategory.Text.Trim() + "' AND BranchCode=" + Session["BranchCode"] + "";
            if (oo.Duplicate(sql))
            {
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
         ...
         sql = "select CategoryName from SupplierCategoryMaster where CategoryName='" + TextBox1.Text.Trim() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
        ...
        else
        {
            ...
            try
            {
                sql = "select max(id)+1 as id   from SupplierCategoryMaster   ";
            ...
            cmd.CommandText = "SupplierCategoryMasterProc";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Connection = con;
            cmd.Parameters.AddWithValue("@CategoryCode", scode);
    ...
    protected void LinkButton4_Click(object sender, EventArgs e)
    {
        ...
        sql = "select CategoryName from SupplierCategoryMaster where CategoryName='" + TextBox3.Text.Trim() + "' and id<>"+ lblID.Text.Trim() + " and BranchCode=" + Session["BranchCode"].ToString() + "";
        ...
        SqlCommand cmd = new SqlCommand();
        cmd.CommandText = "SupplierCategoryMasterUpdateProc";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@id", lblID.Text);
        //cmd.Parameters.AddWithValue("@CategoryCode", '1');
    ...
    {
        sql = "Delete from SupplierCategoryMaster where id=" + lblvalue.Text.Trim();
