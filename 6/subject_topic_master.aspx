<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="subject_topic_master.aspx.cs" Inherits="subject_topic_master" %>
                    ...
                    <table class="tab-popup ">
                        ...
                        <tr>
                            ...
                            <td >
                                ...
                                <asp:TextBox ID="txtsubject0" runat="server" SkinID="TxtBoxDef" CssClass=" form-control-blue validatetxt1"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr class=" hide">
                            <td >Remark </td>
                            <td>
                                <asp:TextBox ID="txtremark0" runat="server" SkinID="txtmulti"
                                    TextMode="MultiLine" CssClass=" form-control-blue"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 5px; text-align: left">
                                <asp:LinkButton ID="LinkButton4" runat="server" OnClientClick="ValidateTextBox('.validatetxt1');return validationReturn();" CausesValidation="False"
                                    OnClick="LinkButton4_Click" CssClass="button-y">Update</asp:LinkButton>
                                &nbsp;
