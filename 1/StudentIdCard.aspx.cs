...
namespace _1
{
    public partial class StudentIdCard : Page
    {
        ...
        public void ShowDetails()
        {
            ...
            _sql = " select SrNo, Name,BloodGroup, CombineClassName, FatherContactNo, FatherName, Gender,MotherName, StLocalAddress+', '+StLocalCityName as Laddress, PhotoPath, case when isnull(PhotoPath, '')='' then '../img/user-pic/user-pic.jpg' else PhotoPath end PhotoPaths from AllStudentRecord_UDF('" + Session["SessionName"] + "', " + Session["BranchCode"] + ") ";
