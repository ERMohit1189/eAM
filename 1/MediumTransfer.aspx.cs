    ...
    public partial class AdminGroupTransfer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DropMedium.Items.Add(new ListItem("<--Select-->", "<--Select-->"));
        ...
        private void LoadMedium()
        {
            ...
            _sql = "Select Medium,Id from MediumMaster where ";
            _sql +=  " BranchCode=" + Session["BranchCode"] + "";

            _oo.FillDropDown_withValue(_sql, DropMedium, "Medium", "Id");
        }
        ...
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            ...
            _sql = "select Reason,convert(nvarchar,RecordDate,106) as TransferDate,Mediumold as OldMedium,Mediumnew as NewMedium";
            _sql +=  " from MediumTransferDetails Gtd";
            _sql +=  " where  SrNo='" + studentId + "' ";
            _sql +=  " and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + " order by Gtd.id";
        ...
        protected void Submit()
        {
            ...
            _sql = "Select Medium from StudentOfficialDetails where srno='" + studentId + "' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + "";

            if (_oo.ReturnTag(_sql, "Medium").Trim() == DropMedium.SelectedItem.Text.Trim())
            {
                Campus camp = new Campus(); camp.msgbox(Page, msgbox, "Same Medium can not be Transferred!", "A");
            }
            else
            {
                ...
                var Mediumold = _oo.ReturnTag(_sql, "Medium");
                ...
                cmd.CommandText = "Mediumtransferdetailsproc";
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                cmd.Parameters.AddWithValue("@Mediumold", Mediumold);
                cmd.Parameters.AddWithValue("@MediumNew", DropMedium.SelectedItem.Text.Trim());
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    _con.Close();
                    //oo.MessageBoxforUpdatePanel("Transferred successfully", LinkButton4);
