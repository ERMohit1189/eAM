<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="MonthwiseStudentReport.aspx.cs" Inherits="_1_MonthwiseStudentReport" %>
...
--%>
                                ...
                                <div runat="server" id="table4" class="col-sm-12   no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-2-p2 mgbt-xs-15">
                                        <asp:LinkButton ID="lnkSubmit" CssClass="button form-control-blue" runat="server" OnClick="lnkSubmit_Click" ValidationGroup="a">View</asp:LinkButton>
                                ...
                                <div class="col-sm-12  " runat="server" id="table2">
                                    ...
                                    <div class=" table-responsive  table-responsive2">
                                       <asp:Label ID="combineClass2" runat="server" CssClass="hide"></asp:Label>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Class">
                                                                <ItemTemplate>
                                                                     ...
                                                                     <asp:Label ID="lblClassIdStudent" runat="server" Text='<%# Bind("ClassId") %>' CssClass="hide"></asp:Label>
                                                                    <asp:Label ID="lblbranchIDStudent" runat="server" Text='<%# Bind("BranchId") %>' CssClass="hide"></asp:Label>
