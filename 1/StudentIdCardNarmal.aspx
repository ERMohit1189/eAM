<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="StudentIdCardNarmal.aspx.cs" Inherits="_1.StudentIdCardNarmal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    padding-left: 5px !important;
        ...
        .tablePortRat > tbody > tr > td, .table > tfoot > tr > td {
            padding: 0px;
            line-height: 1.5;
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                    ...
                                    <div class="col-sm-12  no-padding " style="border-bottom: 1px solid #ccc;" runat="server" id="divtp">
                                        <div class="col-sm-4 ">
                                            <asp:RadioButtonList ID="reportType" runat="server" class="form-control-blue vd_radio radio-success" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="reportType_SelectedIndexChanged">
                                                <asp:ListItem Value="0">Card View Print</asp:ListItem>
                                                <asp:ListItem Value="1" Selected="True">Normal View Print</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </div>
                                    </div>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlLayout" runat="server"
                                                        CssClass="form-control-blue" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="ddlLayout_SelectedIndexChanged">
                                ...
                                <div class="col-sm-6 half-width-50 mgbt-xs-15" runat="server" id="DisplayOrder" >
                                    ...
                                    <div class="col-sm-6 half-width-50 mgbt-xs-15" runat="server" id="hdFields" visible="false">
                                        <label class="control-label">Hide Fields</label>
                                        <div class="controls">
                                            <asp:CheckBoxList runat="server" ID="chkOptionalParameterList" CssClass="vd_checkbox checkbox-success" 
                                                RepeatDirection="Horizontal" RepeatLayout="flow">
                                                <asp:ListItem Value="Srno">S.R. No.</asp:ListItem>
                                                <asp:ListItem Value="FName">Father Name</asp:ListItem>
                                                <asp:ListItem Value="MName">Mother Name</asp:ListItem>
                                    ...
                                    <div class="table-responsive2 table-responsive" id="gdv" runat="server">
                                        <div class="portraits" id="abc" runat="server" cellpadding="0">
                                            ...
                                            <asp:Repeater runat="server" ID="rptICard">
                                                <ItemTemplate>
                                                    <div class="border-1" style="line-height: 16px !important; border-radius: 5px; float:left;margin-right:10px; margin-bottom:24px; width: 211px !important; height: 325px !important;">
                                                        <div class="col-md-12" style="margin-top:0px; padding: 0 4px;">
                                                        ...
                                                        <div class="col-md-12 col-sm-12  idtext" style="margin:0px; padding: 5px;">
                                                            <div class="col-md-12 col-sm-12  no-mgpd text-center">
                                                             <div class="text-left" style="width:100%; float:left; text-align:center;position:relative;">
                                                                ...
                                                                <span style="padding-top: 28px;padding-left: 5px;font-size: 12px;font-weight: 600; position:absolute;right:24px;top:0;"><asp:Label ID="lblBloodGroupValue1" runat="server" Text='<%# Eval("BloodGroup") %>'></asp:Label></span>
                                                             </div>
                                                                <div class="text-center" style="width:59%; float:right;display:none;">
                                                                     <asp:Image runat="server" ID="imgs" style="margin-top: 25px;" />
                                                                </div>
                                                            </div>
                                        ...
                                        <div id="Div1" runat="server" cellpadding="0">
                                            <style>
                                                #Label1 {
                                                    margin-left: -33px !important;
                                                }
                                                        ...
                                                        <div class="col-md-12" style="margin-top: 3px; padding: 0 2px;">
                                                         ...
                                                         <div class="col-md-12 col-sm-12  idtext" style="margin: 0; padding:2px 5px;">
                                                             <div class="no-mgpd text-left" style="width: 22%; float:left;    position: relative; vertical-align: top; text-align: center; padding: 0px !important; padding-top: 0px !important;">
                                                                        ...
                                                                        <p style="margin-top:0px;font-size: 12px;font-weight: 600;text-align:center;position: relative;display: flex;justify-content: center;width: 100%; display:none;"><asp:Label ID="lblBloodGroupValue" runat="server" Text='<%# Eval("BloodGroup") %>'></asp:Label></p>
                                                                        <div class="text-center" style="position:relative;padding-top: 13px;">
                                                                            <span style="position:absolute;top:-6px;left: 20px;max-width: 40px;">
                                                                              
                                                                                  <asp:Image ID="pricipleSignImage" runat="server" Visible="<%#chkOptionalParameterList.Items[4].Selected?false:true %>"
                                                                                   ImageUrl='<%# ResolveUrl(Eval("PrincpalSign").ToString()) %>' 
                                                                                   Width="100px" Height="50px" />

                                                                            </span>
                                                                            <p runat="server" id="principal" Visible="<%# chkOptionalParameterList.Items[3].Selected?false:true %>">Principal</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="no-mgpd idtext" style="line-height: 14px !important; float:right; width: 78%; padding-left:6px !important; vertical-align: top;">
                                                                        ...
                                                                        <table class="tablePortRat" style="width:100%;">
                                                                        <tr runat="server" id="srno" Visible="<%# chkOptionalParameterList.Items[0].Selected?false:true %>">
                                                                        
                                                                            <th style="width:86px;"><asp:Label ID="Label4" runat="server" Text="Sr No." Font-Bold="True"></asp:Label><span style="float: right;">:&nbsp;</span></th>
                                                                            <td style="white-space:nowrap;"><asp:Label ID="Label5" runat="server" Text='<%# Eval("SrNo")  %>'></asp:Label></td>
                                                                        </tr>
                                                                    <tr>
                                                                        ...
                                                                        <tr runat="server" id="fname" Visible="<%# chkOptionalParameterList.Items[1].Selected?false:true %>">
                                                                       <th style="white-space:nowrap; display:flex; align-items:center;justify-content: space-between;"> <asp:Label ID="Label18" runat="server" Font-Bold="True" Text="FATHER's NAME"> </asp:Label><span style="float: right;">:&nbsp;</span></th>
 
                                                                        <td style="white-space:nowrap;"><asp:Label ID="Label19" runat="server" Text='<%# Eval("FatherName")  %>'></asp:Label></td>
                                                                    </tr>
                                                                           
                                                                     <tr runat="server" id="mname" Visible="<%# chkOptionalParameterList.Items[2].Selected?false:true %>">
                                                                       <th style="white-space:nowrap; display:flex; align-items:center;justify-content: space-between;"><asp:Label ID="Label2" runat="server" Font-Bold="True" Text="MOTHER's NAME"> </asp:Label><span style="float: right;">:&nbsp;</span></th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><div style="padding-right:2px;"><asp:Label ID="Label1s" runat="server" Text='<%# Eval("Laddress")  %>'></asp:Label></div></td>
                                                                    </tr>
                                                                            <tr style="display:none">
                                                                                <td colspan="2" class="no-mgpd text-left">
                                                                                    <asp:Image runat="server" ID="imgs" />
                                                                                </td>
                                                                            </tr>
                                                                </table>
