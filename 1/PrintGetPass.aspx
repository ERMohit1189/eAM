<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="PrintGetPass.aspx.cs" Inherits="_1.AdminDuplicateGetPass" %>

<%@ Register Src="~/admin/usercontrol/gatepass.ascx" TagPrefix="uc1" TagName="gatepass" %>
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12  no-padding">
                                                                ...
                                                                <div class="table-pic-box3" style="margin-top: 6px;">
                                                                    <asp:Image ID="Image3" runat="server" AlternateText='<%# Eval("srno") %>'
                                                                        ImageUrl='<%# ResolveClientUrl(!string.Equals((string) Eval("StudentPhotopath"), "", StringComparison.Ordinal) ?
                                                                                                 Eval("StudentPhotopath").ToString():@"../img/user-pic/user-profile-demo.png") %>' />
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="table-pic-box3" style="margin-top: 6px;">
                                                                    <asp:Image ID="Image4" runat="server" AlternateText='<%# Eval("srno") %>'
                                                                        ImageUrl='<%# ResolveClientUrl(!string.Equals((string) Eval("GuardianPhotoPath"), "", StringComparison.Ordinal) ?
                                                                                                 Eval("GuardianPhotoPath").ToString():@"../img/user-pic/user-profile-demo.png") %>' />
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 no-mgpd">
                                                                <table class="table table-hover no-bm no-head-border print-table-text">
                            ...
                            <div class="col-md-2  mgbt-xs-15">
                                ...
                                <asp:LinkButton ID="lnkBack" runat="server" CssClass="btn-print-box" PostBackUrl="~/1/GatePass.aspx" Style="color: #CC0000"
                                    title="Go back to GatePass" data-placement="bottom"><i class="fa fa-reply"></i></asp:LinkButton>
                                &nbsp;
