<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="changeTypeOfAdmission.aspx.cs" Inherits="_1.changeTypeOfAdmission" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12  " runat="server" ID="grdshow" Visible="False">
                                    <div class="col-sm-12 table-responsive  table-responsive2">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Class">
                                                                <ItemTemplate>
                                                                    ...
                                                                    [<asp:Label ID="Label3" runat="server" Text='<%# Bind("TypeOFAdmision") %>'></asp:Label>]
                                    ...
                                    <div class="col-sm-3 col-xs-3 btn-a-devices-6-p6 ">
                                    <label class="label-control">Type of Admission </label>
                                    ...
                                    <div class="col-sm-3 col-xs-3 btn-a-devices-6-p6 " style="padding-top:26px;">
                                    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" title="Delete" CssClass="button form-control-blue">Submit</asp:LinkButton></td>
                                </div>
                                </div>
