<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="class_master.aspx.cs"
    Inherits="_1.AdminClassMaster" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-9">
                                       <label class="control-label">Lock Attendance Date in Teacher Portal</label>
                                       <div class="">
                                           <asp:DropDownList ID="ddlLockAttendance" runat="server" CssClass="form-control-blue">
                                        ...
                                        <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="#">
                                                    <ItemTemplate>
                                                           <asp:Label ID="lblDurationDays" runat="server" Text='<%# Bind("DurationDays") %>' Visible="false"></asp:Label>
                                                           <asp:Label ID="lblDurationMonth" runat="server" Text='<%# Bind("DurationMonth") %>' Visible="false"></asp:Label>
                                               ...
                                               <asp:BoundField Visible="false" DataField="ModeofEducation" HeaderText="Mode of Education" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                <asp:BoundField Visible="false" DataField="SemesterType" HeaderText="Semester Type" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                ...
                                                <asp:TemplateField HeaderText="Lock Attendance Date in Teacher Portal">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblLockAttendance" runat="server" Text='<%# Bind("IsAttendenceLock") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>  
                        ...
                        <div class="col-sm-12 ">
                            <table class="tab-popup">
                              ...
                              <tr>
                                ...
                                <tr>
                                   <td>Lock Attendance Date in Teacher Portal <span class="vd_red">*</span></td>
                                   <td>
                                      <asp:DropDownList ID="ddlLockAttendancePanel" runat="server" CssClass="form-control-blue">
                                          <asp:ListItem Value="1" Selected="True">Yes</asp:ListItem>
                                          <asp:ListItem Value="0">No</asp:ListItem>
                                      </asp:DropDownList>
                                   </td>
