<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="student_registration.aspx.cs" Inherits="_1.student_registration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMainhead" runat="Server">
    ...
    <script type="text/javascript">
        function copyTextValue() {
            var textBox1Value = document.getElementById('<%= txtMobile.ClientID %>').value;
            document.getElementById('<%= txtcontfa.ClientID %>').value = textBox1Value;
            document.getElementById('<%= txtcontactNo.ClientID %>').value = textBox1Value;

        }
        function copyTextValue1() {
            var textBox1Value = document.getElementById('<%= txtEmail.ClientID %>').value;
            document.getElementById('<%= txtemailfather.ClientID %>').value = textBox1Value;
            document.getElementById('<%= txtemailfamily.ClientID %>').value = textBox1Value;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <div class="vd_content-section clearfix">
        <div class="row">
            <script>
                //====
                //Sys.Application.add_load(checksFileSizeandFileTypeinupdatePanel(fileupload, size, filetype, imageClass, hiddenfield));
                                ...
                                <div class="col-sm-12" runat="server" id="divReceipForAddmission">
                                    ...
                                    <div class="col-sm-8 ">
                                        ...
                                        <div class="col-xs-6 text-right no-padding mgbt-xs-15">
                                            <asp:HyperLink ID="hprQuick" runat="server" NavigateUrl="~/1/StudentQuickRegistration.aspx" class="button form-control-blue"><i class="fa fa-user-plus"></i> Quick Registration</asp:HyperLink>
                                        </div>
                                    </div>
                                </div>
                            </ContentTemplate>
                            ...
                            <div class="tabs">
                                <ul class="nav nav-tabs nav-justified">
                                    <li id="liGeneralDetails" class="active"><a href="#home-tab" data-toggle="tab"><span class="menu-icon">
                                        <i class="glyphicon glyphicon-list-alt"></i></span>&nbsp; General Details <span class="menu-active"><i class="fa fa-caret-up"></i></span><span class="tabNo">1</span></a></li>
                                    <li id="liFamilyDetails"><a href="#posts-tab" data-toggle="tab" style="pointer-events: none">
                                        <span class="menu-icon"><i class="fa fa-users"></i></span>&nbsp; Family Details <span class="menu-active"><i class="fa fa-caret-up"></i></span><span class="tabNo">2</span></a></li>

                                    <li id="liOfficialDetails"><a href="#posts-tab2" data-toggle="tab" style="pointer-events: none"><span class="menu-icon">
                                        <i class=" icon-newspaper"></i></span>&nbsp; Official Details <span class="menu-active"><i class="fa fa-caret-up"></i></span><span class="tabNo">3</span></a></li>
                                    <li id="liDocuments" onclick="captureImage();"><a href="#list-tab2" data-toggle="tab" style="pointer-events: none"><span class="menu-icon">
                                        <i class="fa fa-file-archive-o"></i></span>&nbsp; Photo & Documents <span class="menu-active"><i class="fa fa-caret-up"></i></span><span class="tabNo">4</span></a></li>
                                    <li id="liPreviousEducation"><a href="#list-tab" data-toggle="tab" style="pointer-events: none"><span class="menu-icon">
                                        <i class="icon-graduation"></i></span>&nbsp; Previous Education Details <span class="menu-active"><i class="fa fa-caret-up"></i></span><span class="tabNo">5</span></a></li>
                                    <li id="otherdetails" style="display: none"><a href="#poststab3" data-toggle="tab" style="pointer-events: none"><span class="menu-icon">
                                        <i class="glyphicon glyphicon-list-alt"></i></span>&nbsp; Scholarship Details <span class="menu-active"><i class="fa fa-caret-up"></i></span><span class="tabNo">7</span></a></li>
                                    <%--<li id="helthdetails"><a href="#helthdetail" data-toggle="tab" style="pointer-events: none"><span class="menu-icon">
                                        <i class="glyphicon glyphicon-user"></i></span>&nbsp; Health Details <span class="menu-active"><i class="fa fa-caret-up"></i></span><span class="tabNo">6</span></a></li>--%>
                                </ul>
                                    ...
                                    <div class="tab-pane active " id="home-tab">
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <div class="col-sm-4  mgbt-xs-15">
                                                                        ...
                                                                        <div class="vd_input-wrapper controls ">
                                                                            ...
                                                                            <asp:TextBox ID="txtFirstNa" runat="server" CssClass="form-control-blue validatetxt validatetxtA"></asp:TextBox>
                                                                    ...
                                                                    <div class="col-sm-12  no-padding ">
                                                                            ...
                                                                            <div class="col-sm-4  mgbt-xs-15">
                                                                                ...
                                                                                <div class="vd_input-wrapper controls ">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtStudentDOB" placeholder="dd-MMM-yyyy"
                                                                                        runat="server" CssClass="form-control-blue dateblank datepicker-normal validatetxt validatetxtA" onblur="dateformatvalidate(this)" onchange="BeginRequestHandlerNorm();"></asp:TextBox>
                                                                            ...
                                                                            <div class="col-sm-4  mgbt-xs-15">
                                                                                ...
                                                                                <div class="vd_input-wrapper controls ">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtAgeOnDate" placeholder="Age on Date" onblur="dateformatvalidate(this)" onchange="BeginRequestHandlerNorm();"
                                                                                        runat="server" CssClass="form-control-blue currDate datepicker-normal  validatetxt validatetxtA"></asp:TextBox>
                                                                                    <div style="font-size: 10px; color: red;">Ex.: 01-Apr-2021</div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-sm-12  no-padding ">
                                                                            ...
                                                                            <div class="col-sm-12  no-padding" runat="server" id="divStudentEmailContact" visible="false">
                                                                                ...
                                                                                <div class="col-sm-4  no-padding ">
                                                                                    <div class="col-sm-12  ">
                                                                                        ...
                                                                                        <div class="vd_input-wrapper controls ">
                                                                                            ...
                                                                                            <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control-blue" onBlur="copyTextValue1();ValidateEmails(this);"></asp:TextBox>
                                                                                            <div class="text-box-msg">
                                                                                            </div>
                                                                                ...
                                                                                <div class="col-sm-4  no-padding ">
                                                                                    <div class="col-sm-12  ">
                                                                                        ...
                                                                                        <div class="vd_input-wrapper controls ">
                                                                                            ...
                                                                                            <asp:TextBox ID="txtMobile" placeholder="" runat="server" CssClass="form-control-blue" MaxLength="10" onBlur="copyTextValue();ChecktenDigitMobileNumber(this);"></asp:TextBox>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel61" runat="server">
                                                                <ContentTemplate>
                                                                    <div class="col-sm-12  no-padding">
                                                                        <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                                                            ...
                                                                            <div class="vd_input-wrapper controls ">
                                                                                ...
                                                                                <asp:TextBox ID="txtMotherTongue" runat="server" CssClass="form-control-blue validatetxt validatetxtA"></asp:TextBox>
                                                                                <div class="text-box-msg">
                                                                                </div>
                                                                        ...
                                                                        <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                                                            ...
                                                                            <div class="vd_input-wrapper controls ">
                                                                                ...
                                                                                <asp:TextBox ID="txtHomeTown" runat="server" CssClass="form-control-blue validatetxt validatetxtA"></asp:TextBox>
                                                                                <div class="text-box-msg">
                                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-12  half-width-50 half-width-100-tc mgbt-xs-15">
                                                                        <label class="control-label" runat="server" id="lblAadhaar2">Aadhaar No.</label>&nbsp;<span class="vd_red" id="txtAadharNored" runat="server">*</span>
                                                                        <div class="vd_input-wrapper controls ">
                                                                            <span class="menu-icon"><i class="fa  fa-tag"></i></span>
                                                                            <asp:TextBox ID="txtAadharNo" placeholder="" runat="server" CssClass="form-control-blue" MaxLength="12" AutoPostBack="true" OnTextChanged="txtAadharNo_TextChanged" onBlur="ChecktwellebDigitMobileNumber(this);"></asp:TextBox>
                                                                            <div class="text-box-msg">
                                                                            </div>
                                                                    ...
                                                                    <div class="col-sm-12  half-width-50 half-width-100-tc hide">
                                                                        <label class="control-label">
                                                                            Date of Issue of
                                                                            <label runat="server" id="lblAadhaar3">Aadhaar</label></label>
                                                                        <div class="vd_input-wrapper controls ">
                                                                            <span class="menu-icon"><i class="fa  fa-tag"></i></span>
                                            ...
                                            <div class="col-sm-6  full-width-100">
                                                <div class="panel widget">
                                                    <div class="panel-heading vd_bg-dark-blue">
                                                        ...
                                                        <div class="vd_panel-menu ">
                                                            <div data-action="minimize" title="Minimize" data-placement="bottom" class=" menu entypo-icon active">
                                                                <i class="icon-minus3"></i>
                                                            </div>
                                                    ...
                                                    <div class="panel-body padding-tlbr-15 form-main-box-border" style="display: none;">
                                                        <div class="row">
                                        ...
                                        <div class="tab-pane" id="posts-tab">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel67" runat="server">
                                                                    <ContentTemplate>
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel37" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:TextBox ID="txtfaNameee" runat="server" placeholder=""
                                                                                            ...
                                                                                            CssClass="form-control-blue validatetxt validatetxtB"></asp:TextBox>
                                                                                        <div class="text-box-msg">
                                                                                        </div>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel30" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:DropDownList ID="drpOccupationfa" runat="server"
                                                                                            AutoPostBack="True" CssClass="form-control-blue validatedrp validatedrpB">
                                                                                        </asp:DropDownList>
                                                                                        <div class="text-box-msg">
                                                                                        </div>
                                                                                    </ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                            ...
                                                                            <div class="">
                                                                                <asp:TextBox ID="txtfaadhaarcardno" placeholder="" runat="server" 
                                                                                    CssClass="form-control-blue " MaxLength="12"                                                                                    
                                                                                ...
                                                                                <div class="col-sm-12  no-padding mgbt-xs-15">
                                                                                    ...
                                                                                    <div class="vd_input-wrapper controls ">
                                                                                        ...
                                                                                        <asp:UpdatePanel ID="UpdatePanel36" runat="server">
                                                                                            <ContentTemplate>
                                                                                                <asp:TextBox ID="txtemailfather" runat="server" placeholder="" OnTextChanged="txtemailfather_TextChanged1" AutoPostBack="true"
                                                                                        ...
                                                                                        <asp:UpdatePanel ID="UpdatePanel35" runat="server">
                                                                                            <ContentTemplate>
                                                                                                <asp:TextBox ID="txtcontfa" runat="server" placeholder=""
                                                                                                    ...
                                                                                                    CssClass="form-control-blue validatetxt validatetxtB" MaxLength="10"></asp:TextBox>
                                                                                            </ContentTemplate>
                                                                                        </asp:UpdatePanel>
                                                                                    </div>
                                                                                </div>
                                                ...
                                                <div class="col-sm-6  full-width-100">
                                                    <div class="panel widget">
                                                        <div class="panel-heading vd_bg-dark-blue">
                                                            ...
                                                            <div class="vd_panel-menu ">
                                                                <div data-action="minimize" title="Minimize"
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel68" runat="server">
                                                                    <ContentTemplate>
                                                                        <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                            ...
                                                                            <div class="vd_input-wrapper controls ">
                                                                                <span class="menu-icon"><i class="fa fa-user"></i></span>
                                                                                <asp:TextBox ID="txtmotherNameeee" runat="server" CssClass="form-control-blue validatetxt validatetxtB" placeholder=""
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel31" runat="server" EnableViewState="true" UpdateMode="Conditional">
                                                                                    <ContentTemplate>
                                                                                        <asp:DropDownList ID="drpOccupationmoth"
                                                                                            ...
                                                                                            CssClass="form-control-blue validatedrp validatedrpB">
                                                                                        </asp:DropDownList>
                                                                                        <div class="text-box-msg">
                                                                                        </div>
                                                                                    </ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-12  no-padding">
                                                                            ...
                                                                            <div class="col-sm-12  half-width-50 ">
                                                                                <div class="col-sm-12  no-padding ">
                                                                                    <label class="control-label">
                                                                                        Mobile No.&nbsp;<span class="vd_red">*</span></span>
                                                                                    </label>
                                                                                    <div class="vd_input-wrapper controls ">
                                                                                        <span class="menu-icon"><i class="fa  fa-phone"></i></span>

                                                                                        <asp:TextBox ID="txtmothercontact" placeholder="" runat="server"
                                                                                            CssClass="form-control-blue validatetxt validatetxtB" MaxLength="10"
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:TextBox ID="txtPreaddress" placeholder="Please don't write State and City name here" runat="server"
                                                                                            TextMode="MultiLine" Rows="2" CssClass="form-control-blue validatetxt validatetxtB"></asp:TextBox>
                                                                                        <div class="text-box-msg">
                                                                                        </div>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                                    ...
                                                                    <asp:UpdatePanel ID="UpdatePanel65" runat="server">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <asp:CheckBox ID="chkCopy" runat="server" TextAlign="Right"
                                                                                ...
                                                                                AutoPostBack="true" CssClass="vd_checkbox checkbox-success"
                                                                ...
                                                                <div class="col-sm-4  half-width-50 mgbt-xs-15 hide">
                                                                    ...
                                                                    <div class="vd_input-wrapper controls ">
                                                                        ...
                                                                        <asp:UpdatePanel ID="UpdatePanel50" runat="server">
                                                                            <ContentTemplate>
                                                                                <asp:TextBox ID="txtPerMobileNo" placeholder="" runat="server" CssClass="form-control-blue" MaxLength="10" onBlur="ChecktenDigitMobileNumber(this);"></asp:TextBox>
                                                                                <div class="text-box-msg">
                                                                                </div>
                                                                            </ContentTemplate>
                                                                        </asp:UpdatePanel>
                                            ...
                                            <div class="row mgbt-xs-20">
                                                ...
                                                <div class="col-sm-6  full-width-100 hide">
                                                    <div class="panel widget">
                                                        <div class="panel-heading vd_bg-dark-blue">
                                                                ...
                                                                <asp:UpdatePanel ID="UpdatePanel73" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                                                            ...
                                                                            <div class="">
                                                                                <asp:DropDownList ID="DrpRelationship" runat="server" CssClass="form-control-blue validatedrp validatedrpB"
                                                                                    AutoPostBack="True"
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel34" runat="server">
                                                                                        <ContentTemplate>
                                                                                            <asp:TextBox ID="txtcontactNo" runat="server"
                                                                                                CssClass=" form-control-blue validatetxt validatetxtB" MaxLength="10" onBlur="ChecktenDigitMobileNumber(this);"></asp:TextBox>
                                                                                            <div class="text-box-msg"></div>
                                                                                        </ContentTemplate>
                                                                                    </asp:UpdatePanel>
                                                                                </div>
                                                                        ...
                                                                        <div class="col-md-4 " style="display: none">
                                                                            ...
                                                                            <div class="vd_input-wrapper controls ">
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel81" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:TextBox ID="txtG1MobileNo" placeholder="" runat="server" CssClass="form-control-blue" MaxLength="10" onBlur="ChecktenDigitMobileNumber(this);"></asp:TextBox>
                                                                        ...
                                                                        <div class="col-md-8 mgbt-xs-15">
                                                                            ...
                                                                            <div class="vd_input-wrapper controls ">
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanel41" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:TextBox ID="txtGuardiantwoEmail" placeholder="" runat="server" CssClass="form-control-blue" onBlur="ValidateEmails(this);"></asp:TextBox>
                                                                                    </ContentTemplate>
                                                                                </asp:UpdatePanel>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-4 ">
                                                                            ...
                                                                            <div class="vd_input-wrapper controls ">
                                                                                ...
                                                                                <asp:UpdatePanel ID="UpdatePanelG281" runat="server">
                                                                                    <ContentTemplate>
                                                                                        <asp:TextBox ID="txtG2MobileNo" placeholder="" runat="server" CssClass="form-control-blue" MaxLength="10" onBlur="ChecktenDigitMobileNumber(this);"></asp:TextBox>
                                        ...
                                        <div class="tab-pane" id="posts-tab2">
                                            <div class="row mgbt-xs-20">
                                                                            ...
                                                                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                                ...
                                                                                <div class="vd_input-wrapper controls ">
                                                                                    ...
                                                                                    <asp:TextBox ID="TextBox100" placeholder="" runat="server"
                                                                                        CssClass="form-control-blue datepicker-normal  validatetxt validatetxtC" onblur="dateformatvalidate(this)"></asp:TextBox>
                                                                                    <div style="font-size: 10px; color: red;">Ex.: 01-Apr-2021</div>
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel59" runat="server">
                                                                                        <ContentTemplate>
                                                                                            <asp:DropDownList ID="DropCourse" runat="server"
                                                                                                CausesValidation="True" CssClass="form-control-blue validatedrp validatedrpC"
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                                                                        <ContentTemplate>
                                                                                            <asp:DropDownList ID="DropAdmissionClass" runat="server" AutoPostBack="True"
                                                                                                CssClass="form-control-blue validatedrp validatedrpC"
                                                                                    ...
                                                                                    <asp:UpdatePanel ID="UpdatePanel58" runat="server">
                                                                                        <ContentTemplate>
                                                                                            <asp:DropDownList ID="drpSection" runat="server" CausesValidation="false"
                                                                                                CssClass="form-control-blue validatedrp validatedrpC" OnSelectedIndexChanged="drpSection_SelectedIndexChanged" AutoPostBack="true">
                                                                                            </asp:DropDownList>
                                                                                            <div class="text-box-msg"></div>
                                                                                        </ContentTemplate>
                                                                                    </asp:UpdatePanel>
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-12  no-padding">
                                                                            <div class="row" style="margin: 0;">
                                                                                ...
                                                                                <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="divSrNo" visible="false">
                                                                                    <label class="control-label">S.R. No.&nbsp;<span class="vd_red">*</span></label>
                                                                                    <div class="vd_input-wrapper controls ">
                                                                                        <span class="menu-icon hide"><i class="fa fa-hand-o-right"></i></span>

                                                                                        <asp:Label ID="lblSrString" placeholder="" runat="server" CssClass="form-control-blue"></asp:Label>
                                                                                        <asp:TextBox ID="txtSr" placeholder="" AutoPostBack="true" runat="server" Style="width: 60%; padding-left: 0;" OnTextChanged="txtSr_TextChanged"></asp:TextBox>
                                                                                        <div class="text-box-msg"></div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                            ...
                                                                            <div class="row" style="margin: 0;">
                                                                                ...
                                                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                                    ...
                                                                                    <div class="vd_input-wrapper controls ">
                                                                                        <span class="menu-icon"><i class="fa fa-hand-o-right"></i></span>
                                                                                        <asp:TextBox ID="txtUniversityBoardRollNo" placeholder="" runat="server"
                                                                                            CssClass="form-control-blue"></asp:TextBox>
                                                                                        <div class="text-box-msg"></div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                                    ...
                                                                                    <div class="vd_input-wrapper controls ">
                                                                                        <span class="menu-icon"><i class="fa fa-hand-o-right"></i></span>
                                                                                        <asp:TextBox ID="txtSchoolcollegeRollno" placeholder="" runat="server" CssClass="form-control-blue" onBlur="ChecktenDigitNumber(this);"></asp:TextBox>
                                                                                        <div class="text-box-msg"></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row" style="margin: 0;">
                                                                                ...
                                                                                <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="divAdmissiondoneat">
                                                                                    <label class="control-label">Admission done at </label>
                                                                                    <div class="vd_input-wrapper controls ">
                                                                                        <span class="menu-icon"><i class="fa  fa-tag"></i></span>
                                                                                        <asp:TextBox ID="txtAddDoneat" placeholder="Amount" runat="server" CssClass="form-control-blue"></asp:TextBox>
                                                                                        <div class="text-box-msg"></div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                ...
                                                <div class="col-sm-12  full-width-100 hide">
                                                    <div class="col-sm-6  full-width-100" style="padding-left: 0;">
                                                        <div class="panel widget">
                                                            <div class="panel-heading vd_bg-dark-blue">
                                                                <h3 class="panel-title"><span class="menu-icon"><i class="icon-vcard"></i></span>Student's Other Details </h3>
                                                                <div class="vd_panel-menu ">
                                                                                    ...
                                                                                    <div class="col-sm-12  no-padding ">
                                                                                        <fieldset>
                                                                                            ...
                                                                                            <div class=" col-sm-12  no-padding">
                                                                                                ...
                                                                                                <div class=" col-sm-12  no-padding">
                                                                                                    <a onclick="take_snapshot();return false;" id="sdsd1" class="pull-top btn-click" style="cursor: pointer;">
                                                                                        ...
                                                                                        <div class="stu-pic-box" style="width: 120px; height: 140px;">
                                                                                            <div class="stu-pic-box-main" style="width: 103px; height: 123px;">
                                                                                                <asp:Image ID="imgFather" runat="server" class="imgFather"
                                                                                                    ImageUrl="../img/user-pic/student-pic.png" alt="" Style="width: 103px; height: 123px;" />
                                                                                ...
                                                                                <div class="col-sm-8  mgbt-xs-15">
                                                                                    ...
                                                                                    <div class="vd_input-wrapper controls img-input-ped ">
                                                                                        <asp:FileUpload ID="FileUpload2" runat="server"
                                                                                            CssClass="form-control-blue "
                                                                                            onchange="checksFileSizeandFileTypeinupdatePanel(this, 100000, 'jpg|png|jpeg|gif|JPG|PNG|JPEG|GIF','imgMother',
                                                                                ...
                                                                                <div class="col-sm-4  mgbt-xs-15">
                                                                                    <div class="stu-pic-box" style="width: 120px; height: 140px;">
                                                                                        <div class="stu-pic-box-main" style="width: 103px; height: 123px;">
                                                                                            ...
                                                                                            <asp:Image ID="imgMother" ImageUrl="../img/user-pic/student-f-pic.png" runat="server" Class="imgMother" Style="width: 103px; height: 123px;" />
                                                                                ...
                                                                                <div class="col-sm-12 ">
                                                                                    <div class="group-pic-box" style="margin-top: 10px;">
                                                                                        <div class="group-pic-box-main">
                                                                                            ...
                                                                                            <asp:Image ID="imgGroupPhoto" runat="server" Class="imgGroupPhoto" ImageUrl="../img/user-pic/group-photo.jpg" />
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12 ">
                                            <div class="btn-center-box-130" runat="server" id="btnDiv">
                                                <button type="button" id="LinkGeneralDetails"
                                                    onclick="ValidateTextBox('.validatetxtA');ValidateDropdown('.validatedrpA');  Next('liFamilyDetails', 'LinkFamilyDetails', 'liGeneralDetails'); return validationReturn();"
                                                    class="btn vd_btn vd_bg-blue">
                                                    <i class="fa fa-arrow-right"></i>&nbsp; Next
                                                </button>

                                                <button type="button" id="LinkFamilyDetails"
                                                    onclick="ValidateTextBox('.validatetxtB');ValidateDropdown('.validatedrpB'); Next('liOfficialDetails', 'LinkOfficialDetails', 'liFamilyDetails'); return validationReturn();"
                                                    class="btn vd_btn vd_bg-blue hide">
                                                    <i class="fa fa-arrow-right"></i>&nbsp; Next
                                                </button>

                                                <button type="button" id="LinkOfficialDetails"
                                                    onclick="ValidateTextBox('.validatetxtC');ValidateDropdown('.validatedrpC'); Next('liDocuments', 'LinkButton14', 'liOfficialDetails'); return validationReturn();"
                                                    class="btn vd_btn vd_bg-blue hide">
                                                    <i class="fa fa-arrow-right"></i>&nbsp; Next
                                                </button>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel88" runat="server">
                                                    <ContentTemplate>
                                                        <asp:LinkButton ID="LinkButton14" OnClick="LinkButton14_Click"
                                                            OnClientClick="return Testing(); ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp'); Next('liGeneralDetails', 'LinkGeneralDetails', 'liDocuments'); return validationReturn();"
                                                            ValidationGroup="A" CssClass="btn vd_btn vd_bg-blue hide" runat="server">Submit</asp:LinkButton>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function Testing() {
                try {
                    ...
                    var ele = document.getElementById('<%=LinkButton14.ClientID%>');
        ...
        <script>
            ...
            function Next(TabId, BtnId, MainTabId) {
                var status = validationReturn();
                if (status == true) {
                    $("#LinkGeneralDetails").addClass("hide");
                    $("#LinkFamilyDetails").addClass("hide");
                    $("#LinkOfficialDetails").addClass("hide");
                    $("[id*=UpdatePanel88] [id*=LinkButton14]").addClass("hide");

                    $("#liGeneralDetails a").css('pointer-events', 'none');
                    $("#liFamilyDetails a").css('pointer-events', 'none');
                    $("#liOfficialDetails a").css('pointer-events', 'none');
                    $("#liDocuments a").css('pointer-events', 'none');
                    $("#liPreviousEducation a").css('pointer-events', 'none');
                    $("#otherdetails a").css('pointer-events', 'none');
                    $("#helthdetails a").css('pointer-events', 'none');

                    $("#" + TabId + " a").css('pointer-events', 'painted');
                    $("#" + TabId + " a").click();
                    $("#" + TabId + " a").focus();

                    if (MainTabId == "liOfficialDetails") {
                        $("#liGeneralDetails a").css('pointer-events', 'painted');
                        $("#liFamilyDetails a").css('pointer-events', 'painted');
                        $("#liOfficialDetails a").css('pointer-events', 'painted');
                        $("#liDocuments a").css('pointer-events', 'painted');
                        $("#liPreviousEducation a").css('pointer-events', 'painted');
                        $("#otherdetails a").css('pointer-events', 'painted');
                        $("#helthdetails a").css('pointer-events', 'painted');
                        $("[id*=UpdatePanel88] [id*=LinkButton14]").removeClass("hide");
                    }
                    else if (MainTabId == "liDocuments") {
                        $("#LinkFamilyDetails").addClass("hide");
                        $("#LinkOfficialDetails").addClass("hide");
                        $("[id*=UpdatePanel88] [id*=LinkButton14]").addClass("hide");
                        $("#LinkGeneralDetails").removeClass("hide");
                        $("#liGeneralDetails a").css('pointer-events', 'none');
                        $("#liFamilyDetails a").css('pointer-events', 'none');
                        $("#liOfficialDetails a").css('pointer-events', 'none');
                        $("#liDocuments a").css('pointer-events', 'none');
                        ...
                        $("#" + BtnId).removeClass("hide");
                    }
                }
                else {
                    if (MainTabId == "liDocuments") {
                        alert("Please check all sections to complete required information!");
                        return false;
                    }
                    else {
                        $("#" + MainTabId + " a").click();
            ...
            function captureImage() {
                ...
                Webcam.on('error', function (err) {
                    ...
                    if (err.name === 'OverconstrainedError' || err.name === 'ConstraintNotSatisfiedError') {
                        alert("Webcam cannot meet the requested resolution or settings. Try adjusting the settings or using a different camera.");
                    }
                });
            }
