<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="MediumTransfer.aspx.cs" Inherits="_1.AdminGroupTransfer" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            ...
                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                ...
                                <div class="">
                                    ...
                                    <div class="col-sm-12 ">
                                        <asp:Label ID="Label3" runat="server" style="color:red; font-weight:bold;">If Medium will be transfer, examination marks of particular student will be lost.</asp:Label><br />
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                            <ContentTemplate>
                                                <div class="col-sm-12  no-padding" id="Panel1" runat="server">
                                                                    ...
                                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover no-bm no-head-border table-bordered">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="From">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Label27" runat="server" Text='<%# Bind("OldMedium") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="To">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Label26" runat="server" Text='<%# Bind("NewMedium") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                            </asp:TemplateField>
                                                    ...
                                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        <label class="control-label">Select New Medium&nbsp;<span class="vd_red">*</span></label>
                                                        <div class="">
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="DropMedium" runat="server" CausesValidation="True" CssClass="form-control-blue">
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                            <div class="text-box-msg">
