...
namespace _1
{
    public partial class AdminClassMaster : System.Web.UI.Page
    {
        ...
        {
            _sql = "Select ROW_NUMBER() OVER (ORDER BY cm.Id ASC) AS SrNo, cm.Id,ClassName,RoomNo,Location,ClassCode,CIDOrder,ISNULL(CourseName,'N/A') as CourseName,ISNULL(cm.ModeofEducation,'N/A') as ModeofEducation,ISNULL(SemesterType,'N/A') as SemesterType,cm.DurationDays,cm.DurationMonth,IIF(cm.IsAttendenceLock=1,'Yes','No') IsAttendenceLock from ClassMaster cm";
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@IsAttendenceLock", ddlLockAttendance.SelectedValue);
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            _sql = "Select ROW_NUMBER() OVER (ORDER BY Id ASC) AS SrNo, Id,ClassName,RoomNo,Location,ClassCode,Remark,CIDOrder,Course,DurationDays,DurationMonth,IsAttendenceLock from ClassMaster";
            ...
            ddlLockAttendancePanel.SelectedValue = _oo.ReturnTag(_sql, "IsAttendenceLock");
            //loadPanelBranch();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.Parameters.AddWithValue("@IsAttendenceLock", ddlLockAttendancePanel.SelectedValue);
                cmd.Connection = _con;
                try
                {
                    _con.Open();
