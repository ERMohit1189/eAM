        ...
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    _sql = "select SG.Id, SC.SectionName,CM.ClassName,convert(nvarchar,So.DateOfAdmiission,106) as DateOfAdmiission ,SO.SectionId,Sf.FatherName,SF.MotherName,SG.FirstName,SG.MiddleName,SG.LastName,sg.StEnRCode as StEnRCode,sg.srno  as srno from StudentGenaralDetail SG ";
                    ...
                    _sql = _sql + "  where cm.ClassName='" + Class + "' and sm.SectionName='" + DrpSectionTransfer.SelectedItem + "'";
