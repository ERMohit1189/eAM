<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ClassTransfer.aspx.cs" Inherits="_1.AdminGroupTransfer" %>
                                ...
                                <div class="">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                            <ContentTemplate>
                                                <asp:LinkButton ID="LinkButton2" runat="server" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();" CssClass="button form-control-blue" OnClick="LinkButton2_Click">View</asp:LinkButton>
                                                <div id="msgbox" runat="server" style="left: 64px"></div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    <div class="col-sm-12 ">
                                        <asp:Label ID="Label3" runat="server" style="color:red; font-weight:bold;">If Class will be transfer, attendance & examination marks of particular student will be lost.</asp:Label><br />
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                            <ContentTemplate>
                                                <div class="col-sm-12  no-padding" id="Panel1" runat="server">
                                                                    ...
                                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover no-bm no-head-border table-bordered">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="From">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Label27" runat="server" Text='<%# Bind("OldClass") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                            </asp:TemplateField>
                                                                            <asp:TemplateField HeaderText="To">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Label26" runat="server" Text='<%# Bind("NewClass") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                            </asp:TemplateField>
                                                    ...
                                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        <label class="control-label">Select New Course&nbsp;<span class="vd_red">*</span></label>
                                                        <div class="">
                                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="drpCourse" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpCourse_SelectedIndexChanged" CausesValidation="True" CssClass="form-control-blue validatedrp">
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                            <div class="text-box-msg">
                                                    ...
                                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        <label class="control-label">Select New Class&nbsp;<span class="vd_red">*</span></label>
                                                        <div class="">
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="drpClass" OnSelectedIndexChanged="drpClass_SelectedIndexChanged" AutoPostBack="true" runat="server" CausesValidation="True" CssClass="form-control-blue validatedrp">
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                            <div class="text-box-msg">
                                                    ...
                                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        ...
                                                        <div class="">
                                                            <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="drpBranch" runat="server" CausesValidation="True" CssClass="form-control-blue validatedrp">
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                            <div class="text-box-msg">
                                                    ...
                                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        ...
                                                        <div class="">
                                                            <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="drpSection" runat="server" CausesValidation="True" CssClass="form-control-blue validatedrp">
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                            <div class="text-box-msg">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                            <ContentTemplate>
                                                                <asp:LinkButton ID="LinkButton4" runat="server" OnClick="LinkButton4_Click" 
                                                                    OnClientClick="ValidateTextBox('.validatetxt1');ValidateDropdown('.validatedrp');return validationReturn();"
                                                                     CssClass="button form-control-blue">Submit</asp:LinkButton>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
