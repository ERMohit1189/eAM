<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="EnquiryReference.aspx.cs"
    Inherits="_1.EnquiryReference" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Refrence Name &nbsp;<span class="vd_red">*</span></label>
                                        <div class="">
                                            <asp:TextBox ID="txtRefrenceName" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                    ...
                                    <div class="table-responsive  table-responsive2">
                                        <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Refrence Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="RefrenceName" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Delete">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="LinkButton3" runat="server" title="Delete" 
                                                            OnClick="LinkButton3_Click" CausesValidation="False" class="btn menu-icon vd_bd-yellow vd_yellow"> <i class="fa fa-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="40px" />
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="menu-action" Wrap="False" />
                                                </asp:TemplateField>
                        ...
                        <div class="col-sm-12 ">
                            <table class="tab-popup">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRefrenceNamePanel" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        ...
                                        <asp:Label ID="lblRefrenceName" runat="server" Visible="False"></asp:Label>
