<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="StudentDocsReportold.aspx.cs" Inherits="_1.AdminStudentDocsReportold" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Class&nbsp;<span class="vd_red hide">* </span></label>
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <%--<asp:DropDownList ID="drpClass" runat="server" CausesValidation="false" onchange="ValidateDropdown('.valiadte');" CssClass="form-control-blue valiadte"
                                                        OnSelectedIndexChanged="drpClass_SelectedIndexChanged" AutoPostBack="True">
                                                    </asp:DropDownList>--%>
                                                    <asp:DropDownList ID="drpClass" runat="server" CausesValidation="false" CssClass="form-control-blue valiadte"
                                                        OnSelectedIndexChanged="drpClass_SelectedIndexChanged" AutoPostBack="True">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Section&nbsp;<span class="vd_red hide">* </span></label>
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="drpSection" runat="server" CssClass="form-control-blue"></asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            <div class="text-box-msg">
                                            </div>
                                ...
                                <div class="col-sm-12  " id="divExport" runat="server" visible="false">
                                    <div class=" table-responsive  table-responsive2">
                                        <table runat="server" id="abc" style="width:100%;">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-text-center table-header-group"
