...
document.onreadystatechange = function () {
    ...
    today = dd + '-' + mm + '-' + yyyy;
    var dd1 = '22'; var mm1 = '06'; var yyyy1 = '2019'
    today2 = dd1 + '-' + mm1 + '-' + yyyy1;
    //if (today > today2) {
    //    //var links = document.getElementsByTagName('a');
        
    //    var links = $('div.col-sm-12 a');
    //    for (var i = 0; i < links.length; i++) {
    //        links[i].href = "";
    //    }
        
    //    var links3 = $('input[type=submit]');
    //    for (var i = 0; i < links3.length; i++) {
    //        links3[i].id = "";
    //    }
    //    var links4 = $('div.col-sm-6 a');
    //    for (var i = 0; i < links4.length; i++) {
    //        links4[i].href = "";
    //    }
    //    var links2 = $('input[type=button]');
    //    for (var i = 0; i < links2.length; i++) {
    //        links2[i].id = "";
    //    }
    //    var links5 = $('#ContentPlaceHolder1_ContentPlaceHolderMainBox_lnkSubmit');
