<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="PaperMaster.aspx.cs"
    Inherits="PaperMaster" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtPaperName" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Remark&nbsp;<span class="vd_red"></span></label>
                                        <div class="">
                                            <asp:TextBox ID="txtRemark" runat="server" Text="" CssClass="form-control-blue" TextMode="MultiLine" rows="1" cols="20"></asp:TextBox>
                                        </div>
                                    </div>
                                      <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn();" OnClick="LinkButton1_Click" ValidationGroup="a" CssClass="button form-control-blue">Submit</asp:LinkButton>
                        ...
                        <div class="col-sm-12 ">
                            <table class="tab-popup">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlClassPanel" runat="server" CssClass="form-control-blue validatedrp1" Enabled="false"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlSubjectPanel" runat="server" CssClass="form-control-blue" Enabled="false"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPaperNamePanel" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRemarkPanel" runat="server" Text="N/A" CssClass="form-control-blue"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
