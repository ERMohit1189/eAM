<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="DeAllotExam.aspx.cs"
    Inherits="DeAllotExam" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-12  half-width-50  btn-a-devices-3-p6 mgbt-xs-15 text-danger">
                                        Note:- In this page if you will check any checkbox and submit then checked students will be dealloted from particular test.
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive2 table-responsive">
                                        <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Test Valid From-TO" Visible="false">
                                                     <HeaderTemplate>
                                                         <asp:Label runat="server">Test Valid From-TO</asp:Label><br />
                                                        <asp:TextBox ID="ExamValidFromH" runat="server" CssClass="datepicker-normal"  OnTextChanged="ExamValidFromH_TextChanged" AutoPostBack="true" Width="45%"></asp:TextBox> -To- 
                                                        <asp:TextBox ID="ExamValidToH" runat="server" CssClass="datepicker-normal" Width="45%"  OnTextChanged="ExamValidToH_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="ExamValidFrom" runat="server" CssClass="datepicker-normal" Width="45%"></asp:TextBox> -To- 
                                                        <asp:TextBox ID="ExamValidTo" runat="server" CssClass="datepicker-normal" Width="45%"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white"  Width="140" />
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Test Duration From-TO" Visible="false">
                                                    <HeaderTemplate>
                                                        <asp:Label runat="server">Test Duration From-TO</asp:Label><br />
                                                        <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                                            <div class="">
                                                                <asp:DropDownList ID="ddlFromHourFromH" CssClass="form-control-blue col-sm-4 col-xs-4" runat="server" OnSelectedIndexChanged="ddlFromHourFromH_SelectedIndexChanged" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromMinuteFromH" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4"  OnSelectedIndexChanged="ddlFromMinuteFromH_SelectedIndexChanged" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromTypeFromH" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4"  OnSelectedIndexChanged="ddlFromTypeFromH_SelectedIndexChanged" AutoPostBack="true">
                                                        ...
                                                        <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                                            <div class="">
                                                                <asp:DropDownList ID="ddlFromHourTOH" CssClass="form-control-blue col-sm-4 col-xs-4" runat="server"  OnSelectedIndexChanged="ddlFromHourToH_SelectedIndexChanged" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromMinuteToH" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4"  OnSelectedIndexChanged="ddlFromMinuteToH_SelectedIndexChanged" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromTypeToH" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4"  OnSelectedIndexChanged="ddlFromTypeToH_SelectedIndexChanged" AutoPostBack="true">
                                                                    <asp:ListItem Text="AM" Value="AM"></asp:ListItem>
                                                                    <asp:ListItem Text="PM" Value="PM"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                                            <div class="">
                                                                <asp:DropDownList ID="ddlFromHourFrom" CssClass="form-control-blue col-sm-4 col-xs-4" runat="server">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromMinuteFrom" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromTypeFrom" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4">
                                                                    <asp:ListItem Text="AM" Value="AM"></asp:ListItem>
                                                                    <asp:ListItem Text="PM" Value="PM"></asp:ListItem>
                                                                </asp:DropDownList>
                                                                <div class="text-box-msg">
                                                        ...
                                                        <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                                            <div class="">
                                                                <asp:DropDownList ID="ddlFromHourTo" CssClass="form-control-blue col-sm-4 col-xs-4" runat="server">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromMinuteTo" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4">
                                                                </asp:DropDownList>
                                                                <asp:DropDownList ID="ddlFromTypeTo" runat="server" CssClass="form-control-blue col-sm-4 col-xs-4">
                                                                    <asp:ListItem Text="AM" Value="AM"></asp:ListItem>
                                                                    <asp:ListItem Text="PM" Value="PM"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                ...
                                                <asp:TemplateField HeaderText="Allot TO">
                                                    <HeaderTemplate>
                                                        <asp:Label runat="server">Allot To</asp:Label><br />
