<%@ Page Title="Assignment | eAM&#174;" Language="C#" MasterPageFile="stuRootManager.master" AutoEventWireup="true" 
CodeFile="Assignment.aspx.cs" Inherits="sp_Circular" %>
                                        ...
                                        <asp:GridView ID="grdDocList" runat="server" AutoGenerateColumns="false" CssClass="table table-striped no-bm table-hover no-head-border table-bordered pro-table">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Download">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDocPath" runat="server" Text='<%# Bind("DocPath") %>' CssClass="hide" ></asp:Label>
