<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="TermMaster.aspx.cs"
    Inherits="TermMaster" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtTermName" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                        </div>
                                    </div>
                                        ...
                                        <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Term Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label2ss" runat="server" Text='<%# Bind("TermName") %>'></asp:Label>
                                                    </ItemTemplate>
                        ...
                        <div class="col-sm-12 ">
                            <table class="tab-popup">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTermNamePanel" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                                    </td>
                                </tr>
