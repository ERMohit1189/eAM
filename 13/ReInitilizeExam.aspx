<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ReInitilizeExam.aspx.cs"
    Inherits="ReInitilizeExam" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-12  half-width-50  btn-a-devices-3-p6 mgbt-xs-15 text-danger">
                                        Note:- In this page if you will check any checkbox and submit then checked student's allotment will be reinitialize for particular test and also delete marks of that particular test.
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive2 table-responsive">
                                        <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Reinitialize">
                                                    <HeaderTemplate>
                                                        <asp:Label runat="server">DeAllot</asp:Label><br />
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="Attempted" runat="server" Visible="false">Attempted</asp:Label>
                                                    </ItemTemplate>
