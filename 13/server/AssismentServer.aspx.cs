...
public partial class AssismentServer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        _sql = _sql + " Questions, MaxMarks, Option1, Option2, Option3, Option4, Option5, Option6, RightOption, '' ChooseOption, 0 ObtaindMarks, '' AnswerStatus, '' UploadFiles, '' remark  from OT_AnswerMaster ";
        ...
        if (ds != null)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    Response.Write("<p><input type='text' class='validatetxt' style='width:100px;'  class='inputmarks' onblur='enterMarks(this); CheckDecimalNumber(this);' ExamID='" + ExamID + "' max='"+ ds.Tables[0].Rows[i]["MaxMarks"].ToString()+"' QuestionId ='" + ds.Tables[0].Rows[i]["id"].ToString() + "' Id ='txtMarks" + ds.Tables[0].Rows[i]["id"].ToString() + "' value='" + ds.Tables[0].Rows[i]["ObtaindMarks"].ToString() + "' placeholder='Enter Marks' " + (ds.Tables[0].Rows[i]["AnswerStatus"].ToString() != "" ? "disabled='disabled'" : "") + " />&nbsp;&nbsp;&nbsp;<input type='text' style='width:150px;' class='inputmarks' onblur='enterMarks(this)' ExamID='" + ExamID + "' max='" + ds.Tables[0].Rows[i]["MaxMarks"].ToString() + "' Id ='txtReMarks" + ds.Tables[0].Rows[i]["id"].ToString() + "' QuestionId ='" + ds.Tables[0].Rows[i]["id"].ToString() + "' value='" + ds.Tables[0].Rows[i]["remark"].ToString() + "' placeholder='Enter Remarks' " + (ds.Tables[0].Rows[i]["AnswerStatus"].ToString() != "" ? "disabled='disabled'" : "") + " /></p>");
                    Response.Write("</div>");
