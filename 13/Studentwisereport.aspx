<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Studentwisereport.aspx.cs"
    Inherits="Studentwisereport" %>
                                ...
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                     ...
                                     <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                        <asp:TextBox runat="server" ID="lblQuesType" class="control-label" Enabled="false"></asp:TextBox>
                                            </div>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-12  " id="gdv" runat="server">
                                                ...
                                                <div class=" table-responsive  table-responsive2 text-center" id="abc" runat="server">
                                                    ...
                                                    <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Max. Marks">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="Total" runat="server" Text='<%# Bind("MaxMarks") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="170" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Obtained Marks">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="RightAns" runat="server" Text='<%# Bind("ObtaindMarks") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="170" />
                                                    ...
                                                    <asp:GridView ID="Grd2" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                                        <AlternatingRowStyle CssClass="grid_alt_details_default" />
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="#">
                                                                <ItemTemplate>
                                                           ...
                                                           <asp:TemplateField HeaderText="No. Of Ques.">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="TotalQus" runat="server" Text='<%# Bind("TotalQus") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="170" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Incorrect">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="wrongAns" runat="server" Text='<%# Bind("wrongAns") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="170" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Correct">
                                                             ...
                                                             <asp:TemplateField HeaderText="Max. Marks">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="MaxMarks" runat="server" Text='<%# Bind("MaxMarks") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="170" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Obtained Marks">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="ObtaindMarks" runat="server" Text='<%# Bind("ObtaindMarks") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="170" />
