<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="AdditionalFeeReceipt_duplicate.aspx.cs" Inherits="AdditionalFeeReceipt_duplicate" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6 no-padding text-right menu-action">
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn-print-box" PostBackUrl="~/2/additionalFeesDeposit.aspx" Style="color: #CC0000"
                                title="Go back to ADDITIONAL FEE Deposit" data-placement="left"><i class="fa fa-reply"></i></asp:LinkButton>
                            &nbsp;
                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="btn-print-box"
                                title="Receipt Print" data-placement="left">
    ...
    <div style="margin: 0 auto; width: 900px; padding: 10px; font-size: 12px;" class="marg-bot-30">
        <div class="col-sm-12 no-padding print-row marg-bot-30" runat="server" id="xyz">
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl">
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="Label252" runat="server" Text="ADDITIONAL FEE "></asp:Label></h3>
                                    <h3 class="sub-adds-l text-center">
                                        <asp:Label ID="lblCancel" runat="server"></asp:Label>STUDENT'S COPY<br /><asp:Label ID="Label2" runat="server" Text="(DUPLICATE)"></asp:Label></h3>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="col-sm-12 ">
                    <table style="font-family: Courier New; width: 100%;">
                        ...
                        <tr>
                            <td class="text-left">
                                <asp:Label ID="Label4" runat="server" Text="Mode" Font-Bold="False" Font-Size="12px"></asp:Label>
                            </td>
                            <td class="text-left">: &nbsp;
                ...
                <div class="col-sm-12 ">
                    <table style="font-family: Courier New; width: 100%;" class="print-table-text">
                        <tr runat="server" id="trbounce">
                            <td class="text-left" style="width: 40%;">
                                <asp:Label ID="Label8" runat="server" Text="Bounce Charge" Font-Size="12px"></asp:Label>
                            </td>

                            <td class="text-right" style="width: 60%;">
                                <asp:Label ID="lblbounceCharge" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-left" style="width: 40%;">
                            ...
                            <td class="text-right" style="width: 60%;">
                                <asp:Label ID="lblTotalAmt" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </td>
                        </tr>
                     ...
                     <%--   <tr>
                              <td colspan="2" class="text-left" id="grdfeeDetailscancelleddiv" runat="server" visible="false" style="font-family: Courier New; font-size: 11px;padding: 5px 0 0 0;">
                                           
                                                Cancelled by
                                                                  <asp:Label ID="Label133" runat="server" Text=""></asp:Label>&nbsp;on 
                                                                  <asp:Label ID="Label155" runat="server" Text=""></asp:Label>
                                            </td>
                            <td colspan="2" align="right" style="font-family: Courier New; font-size: 11px; font-weight: bold;">
                        ...
                        <tr runat="server" id="Tr2">
                            <td class="text-center" colspan="4" style="font-family: Courier New; font-size: 11px; padding: 5px 0 0 0;">
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl">
                  ...
                  <%--  <table style="font-family: Courier New; width: 100%;">
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="Label6" runat="server" Text="ADDITIONAL FEE"></asp:Label></h3>
                                    <h3 class="sub-adds-l text-center">
                                        <asp:Label ID="Label22" runat="server"></asp:Label>SCHOOL'S COPY<br /><asp:Label ID="Label3" runat="server" Text="(DUPLICATE)"></asp:Label></h3>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="col-sm-12 ">
                    <table style="font-family: Courier New; width: 100%;" class="print-table-text">
                        <tr runat="server" id="trbounce0">
                            <td class="text-left" style="width: 40%;">
                                <asp:Label ID="Label16" runat="server" Text="Bounce Charge" Font-Size="12px"></asp:Label>
                            </td>

                            <td class="text-right" style="width: 60%;">
                                <asp:Label ID="lblbounceCharge0" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-left" style="width: 40%;">
                            ...
                            <td class="text-right" style="width: 60%;">
                                <asp:Label ID="lblTotalAmt0" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <%--<tr>
                             <td colspan="2" class="text-left" id="grdfeeDetailscancelleddiv1" runat="server" visible="false" style="font-family: Courier New; font-size: 11px;padding: 5px 0 0 0;">
                                           
                                                Cancelled by
                                                                  <asp:Label ID="Label28" runat="server" Text=""></asp:Label>&nbsp;on 
                                                                  <asp:Label ID="Label30" runat="server" Text=""></asp:Label>
                                            </td>
                            <td colspan="2" class="text-right" style="font-family: Courier New; font-size: 11px; font-weight: bold;">
                         ...
                         <tr>
                             <td class="text-left" style="font-family: Courier New; font-size: 11px;padding: 5px 0 0 0;width:50%">
                                 <div id="grdfeeDetailscancelleddiv1" runat="server" visible="false">
                                     Cancelled by
                                           <asp:Label ID="Label3" runat="server" Text=""></asp:Label>&nbsp;on 
