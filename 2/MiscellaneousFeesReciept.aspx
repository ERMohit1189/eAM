<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="MiscellaneousFeesReciept.aspx.cs" Inherits="admin_miscellaneousFeeReciept" %>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    ...
                                    <h3 class="sub-adds-l text-center">
                                        <asp:Label ID="lblCancel" runat="server"></asp:Label>STUDENT'S COPY<asp:Label ID="Label2" runat="server" Text="(Canceled)" Visible="false"></asp:Label></h3>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    ...
                                    <h3 class="sub-adds-l text-center">
                                        <asp:Label ID="Label22" runat="server"></asp:Label>SCHOOL'S COPY<asp:Label ID="Label3" runat="server" Text="(Canceled)" Visible="false"></asp:Label></h3>
                                </div>
                            </td>
                        </tr>
