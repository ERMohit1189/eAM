<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="UniformFeeDeposit.aspx.cs" Inherits="_2.UniformFeeDeposit" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12 " id="Tables" runat="server" visible="false">
                                    ...
                                    <div class="col-sm-12  no-padding">
                                        ...
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15" style="padding-left: 0;">
                                        ...
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15" id="divModeNo" runat="server" visible="false">
                                            <span><asp:Label ID="Label42" class="control-label" runat="server"></asp:Label>&nbsp;<span class="vd_red">*</span></span>
                                            <div class="">
                                    ...
                                    <div class="col-sm-3 col-xs-3 no-padding" runat="server" id="divSubmit" >
                                        <table class="table no-bm  show-payble-box">
                                            ...
                                            <tr class="hide">
                                             ...
                                             <tr runat="server" id="divBounce" visible="false">
                                                <th style="text-align: left; width:70%;">Total Due Amount</th>
                                                <td>
                                                    <asp:Label ID="BounceCharges" runat="server" style="padding-left: 5px;">0</asp:Label></td>
                                            </tr>
                                            <tr>
