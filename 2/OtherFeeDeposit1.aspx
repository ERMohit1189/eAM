...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12" id="Tables" runat="server" visible="false">
                                    ...
                                    <div class="col-sm-12 no-padding">
                                        <div class="col-sm-4 mgbt-xs-15 no-padding">
                                        ...
                                        <div class="col-sm-3 mgbt-xs-15" id="divModeDate" runat="server" visible="false" style="padding-left: 0;">
                                        ...
                                        <div class="col-sm-3 mgbt-xs-15" id="divModeNo" runat="server" visible="false">
                                        ...
                                        <div class="col-sm-3 mgbt-xs-15" id="divbankname" runat="server" visible="false">
                                        ...
                                        <div class="col-sm-3 mgbt-xs-15" id="divStatus" runat="server" visible="false">
                                        ...
                                        <div class="col-sm-3 mgbt-xs-15" id="divRemark" runat="server" visible="false">
                                    ...
                                    <div class="col-sm-12 no-padding">
                                        ...
                                        <div class="col-sm-6" runat="server" id="divSubmit">
    ...
    <br />
    <asp:Button ID="btnSubmit" CssClass="button form-control-blue" runat="server" OnClick="btnSubmit_Click" Text="Submit" UseSubmitBehavior="false" OnClientClick="this.disabled='true'; this.value='Please Wait...'" />
    <div id="msgbox2" runat="server" style="left: 60px;"></div>
    <br />
</div>
                                
                                        <div class="col-sm-12 no-padding text-center text-primary no-padding">
