...
namespace _2
{
    public partial class SpecialDiscount : System.Web.UI.Page
    {
        ...
        private void loadData(string id="")
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("SpecialDiscountProc", param);
            ...
            for (int i = 0; i < Grd.Rows.Count; i++)
            {
                ...
                for (int k = 0; k < chkFeeHead.Items.Count; k++)
                {
                    if (chkFeeHead.Items[k].Selected)
                    {
                        ...
                        if (txtValue4.Text != "")
                        {
                            insert(ddlClassMain.SelectedValue, drpFeeGroup.SelectedValue, drpGender.SelectedValue, txtCap4.Text, FromDate4.Text, ToDate4.Text, installmentId.Text, chkFeeHead.Items[k].Value, txtValue4.Text, drpMode4.SelectedValue);
        ...
        private void insert(string ClassId, string FeeGroup, string Gender, string Caption, string DateFrom, string DateTo, string InstallmentId, string FeeHeadId, string Discount, string DiscountMode)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "SpecialDiscountProc";
