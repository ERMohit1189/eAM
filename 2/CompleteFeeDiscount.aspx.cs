...
namespace _2
{
    public partial class CompleteFeeDiscount : System.Web.UI.Page
    {
        ...
        private void loadData(string id="")
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("CompleteFeeDiscountProc", param);
            ...
            for (int i = 0; i < Grd.Rows.Count; i++)
            {
                ...
                for (int k = 0; k < chkFeeHead.Items.Count; k++)
                {
                    if (chkFeeHead.Items[k].Selected)
                    {
                        ...
                        if (txtValue4.Text != "")
                        {
                            insert(ddlClassMain.SelectedValue, drpFeeGroup.SelectedValue, txtCap4.Text, FromDate4.Text, ToDate4.Text, installmentId.Text, chkFeeHead.Items[k].Value, txtValue4.Text, drpMode4.SelectedValue, txtHowMuch.Text);
        ...
        private void insert(string ClassId, string FeeGroup, string Caption, string DateFrom, string DateTo, string InstallmentId, string FeeDeadId, string Discount, string DiscountMode, string TransportDiscountPer)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "CompleteFeeDiscountProc";
            ...
            cmd.Parameters.AddWithValue("@FeeHeadId", FeeDeadId);
            cmd.Parameters.AddWithValue("@Discount", Discount);
            cmd.Parameters.AddWithValue("@DiscountMode", DiscountMode);
            cmd.Parameters.AddWithValue("@TransportDiscountPer", TransportDiscountPer);
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            ...
            Label TransportDiscount = (Label)lnk.NamingContainer.FindControl("lblTransportDiscount");
            ...
            txtTransportDiscount.Text = TransportDiscount.Text;

            Panel1_ModalPopupExtender.Show();
        }
        protected void lnkUpdate_Click(object sender, EventArgs e)
        {
            update(lblFlnkUpdate.Text.Trim(), FromDate4Panel.Text.Trim(), ToDate4Panel.Text.Trim(), txtValue4Panel.Text.Trim(), drpMode4Panel.SelectedValue, txtTransportDiscount.Text.Trim());
        }
        private void update(string Id, string DateFrom, string DateTo, string Discount, string DiscountMode, string TransportDiscountPer)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "CompleteFeeDiscountProc";
            cmd.CommandType = CommandType.StoredProcedure;
