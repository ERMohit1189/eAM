...
public partial class AdditionalFeeReceipt : Page
{
	...
	public void DisplayStudentCopy()
	{
		...
		sql += " convert(nvarchar, Other_fee_collection_1.FeeDepositeDate, 106) as RecieptDate, asr.ClassName, asr.SectionName, asr.Gender,CASE WHEN asr.IsDisplay = 1 THEN asr.BranchName ELSE '' END BranchName, MOP,Status ";
