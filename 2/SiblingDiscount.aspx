<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="SiblingDiscount.aspx.cs" Inherits="_2.SiblingDiscount" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12 " id="div1" runat="server">
                                    <fieldset>
                                        ...
                                        <label class="control-label">Sibling Category&nbsp;<span class="vd_red">*</span></label>
                                        <div class="">
                                            <asp:DropDownList ID="drpSiblingCategory" CssClass="form-control-blue" AutoPostBack="True" runat="server" OnTextChanged="drpSiblingCategory_OnTextChanged">
                                                <asp:ListItem Value="1SB">
                                                    One Sibling Discount
                                                </asp:ListItem>
                                                <asp:ListItem Value="2SB">
                                                    Two Sibling Discount
                                                </asp:ListItem>
                                                <asp:ListItem Value="3SB">
                                                    Three Sibling Discount
                                                </asp:ListItem>
                                                <asp:ListItem Value="4SB">
                                                    Four Sibling Discount
                                                </asp:ListItem>
                                                <asp:ListItem Value="5SB">
                                                    Five Sibling Discount
                                                </asp:ListItem>
                                            </asp:DropDownList>
                                        ...
                                        <div class="col-sm-3   mgbt-xs-15">
                                            <label class="control-label">Apply On&nbsp;<span class="vd_red">* </span></label>
                                            <div class="">
                                                <asp:DropDownList ID="drpSiblingType" runat="server" CssClass="form-control-blue" OnSelectedIndexChanged="drpSiblingType_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="col-sm-3   mgbt-xs-15" runat="server" id="ApplicableClass">
                                            <label class="control-label">Applicable Class&nbsp;<span class="vd_red">* </span></label>
                                            <div class="">
                                                <asp:DropDownList ID="drpApplyononesibling" runat="server" CssClass="form-control-blue">
                                                    <asp:ListItem Value="Lower">Lower</asp:ListItem>
                                                    <asp:ListItem Value="Higher">Higher</asp:ListItem>
                                                </asp:DropDownList>
                                                <div class="text-box-msg">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12   mgbt-xs-15" style="padding:0 !important;">
                                        <div class="col-sm-3 col-xs-3  mgbt-xs-15">
                                        ...
                                        <div class="col-sm-3 col-xs-3  mgbt-xs-15">
                                            ...
                                            <div class="">
                                                <asp:TextBox ID="txtCap4" runat="server" Text="One Sibling Discount" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                                <div class="text-box-msg">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12 " style="margin-top: 30px !important;">
                                     <div class="col-sm-4 col-xs-4">
                                        <label class="control-label">Sibling Category&nbsp;<span class="vd_red">*</span></label>
                                        <div class="">
                                            <asp:DropDownList ID="ddlSiblingCategory" CssClass="form-control-blue" runat="server">
                                                <asp:ListItem Value="1SB">
                                                    One Sibling Discount
                                                </asp:ListItem>
                                                <asp:ListItem Value="2SB">
                                    ...
                                    <div class=" table-responsive  table-responsive2">
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Apply On">
                                                    <ItemTemplate>
                                                        <asp:Label ID="SiblingType" runat="server" Text='<%# Bind("SiblingType") %>'></asp:Label>
                                                        <asp:Label ID="ApplyFor" runat="server" Text='<%# Bind("ApplyFor") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Fee Category">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("FeeGroupName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
