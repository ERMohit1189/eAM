<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="FeeReceiptAll.aspx.cs" Inherits="FeeReceiptAll" %>
                            ...
                            <asp:TemplateField>
                                ...
                                <FooterTemplate>
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: Courier New;">
                                            ...
                                            <td colspan="4">
                                                <table class="table no-head-border no-bm">
                                                    <tr>
                                                        ...
                                                        <td style="padding: 0 5px !important; width: 20%; text-align: right;">&nbsp;<asp:Label ID="Label18" runat="server" Text="Label" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <div class="col-lg-12 right-padd-0">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; padding: 0 5px !important;" class="text-right">&nbsp;<asp:Label ID="Label14" runat="server" Text="Label" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                        ...
                                        <tr>
                                            <td class="text-right" colspan="4" style="font-family: Courier New; font-size: 11px; padding: 5px 0 0 0;">Received by
                            ...
                            <asp:TemplateField>
                                ...
                                <FooterTemplate>
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: Courier New;">
                                            ...
                                            <td colspan="4">
                                                <table class="table no-head-border no-bm">
                                                    <tr>
                                                        ...
                                                        <td style="padding: 0 5px !important; width: 20%; text-align: right;">&nbsp;<asp:Label ID="Label18_2" runat="server" Text="Label" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <div class="col-lg-12 right-padd-0">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td class="text-right" style="width: 50%; padding: 0 5px !important;">&nbsp;<asp:Label ID="Label14_2" runat="server" Text="Label" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2">
                                        ...
                                        <tr>
                                            <td colspan="4" class="text-right" style="font-family: Courier New; font-size: 11px; padding: 5px 0 0 0;">Received by
