<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="CompleteFeeDiscount.aspx.cs" Inherits="_2.CompleteFeeDiscount" %>
                    ...
                    <div class="col-sm-12 ">
                        <div class="panel widget light-widget panel-bd-top ">
                            <div class="panel-body">
                                <div class="col-sm-12 " id="div1" runat="server">
                                    <fieldset>
                                        ...
                                        <div class="col-sm-4 col-xs-4  mgbt-xs-15">
                                            ...
                                            <div class="">
                                                <asp:TextBox ID="txtCap4" runat="server" Text="Complete Fee Discount" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-12  hide" id="div2" runat="server">
                                    <fieldset>
                                        <legend>Transport Fee Discounts
                                        </legend>
                                       
                                        <div class="col-sm-4   mgbt-xs-15" runat="server">
                                            <label class="control-label">How much in Percent&nbsp;<span class="vd_red">*</span></label>
                                            <div class="">
                                                <asp:TextBox ID="txtHowMuch" runat="server" CssClass="form-control-blue validatetxt" Text="0"
                                                    onkeyup="checkDecimalValue(this);" onchange="checkDecimalValue(this);"></asp:TextBox>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Installment(s)">
                                                 ...
                                                 <asp:TemplateField HeaderText="Transport" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblTransportDiscount" runat="server" Text='<%# Bind("TransportDiscountPer") %>'></asp:Label> %
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <div class="col-sm-12  no-padding ">
                                            <fieldset>
                                               ...
                                               <div class="col-sm-4   mgbt-xs-15">
                                                ...
                                                <div class="col-sm-4   mgbt-xs-15" id="divHowMuchPanel" runat="server" visible="false">
                                                    <label class="control-label">How much in Percent&nbsp;<span class="vd_red">*</span></label>
                                                    <div class="">
                                                        <asp:TextBox ID="txtTransportDiscount" runat="server" CssClass="form-control-blue validatetxt" Text="0"
                                                    onkeyup="checkDecimalValue(this);" onchange="checkDecimalValue(this);"></asp:TextBox>
