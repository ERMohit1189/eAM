<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="YearlyStudentReceiptGenerate_Duplicate.aspx.cs" Inherits="admin_YearlyStudentReceiptGenerate_Duplicate" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6 no-padding text-right menu-action">
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn-print-box" PostBackUrl="~/2/fee_deposit.aspx" Style="color: #CC0000"
                                title="Go back to Fee Deposit" data-toggle="tooltip" data-placement="left"><i class="fa fa-reply"></i></asp:LinkButton>
                            &nbsp;
                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="btn-print-box"
                                title="Receipt Print" data-toggle="tooltip" data-placement="left"><i class="icon-printer"></i></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    ...
                                    <h3 class="sub-adds-l text-center">STUDENT'S COPY (DUPLICATE)</h3>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    ...
                                    <h3 style="font-size: 13px; font-weight: 400;" class="sub-adds-l text-center">SCHOOL'S COPY (DUPLICATE)</h3>
                                </div>
                            </td>
                        </tr>
