<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="FeeReceiptGenerate.aspx.cs" Inherits="StudentReceiptGenerate" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6 no-padding text-right menu-action">
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn-print-box" PostBackUrl="~/2/fee_deposit.aspx" Style="color: #CC0000"
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left" style="width: 35%; padding: 5px 10px 0 0 !important;">:&nbsp;
                                           <asp:Label ID="Label7" runat="server" Font-Bold="True" Text='<%# Eval("RecieptSrNo") %>' Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                    </td>
                                    ...
                                    <td class="text-left" style="width: 30%; padding: 5px 10px 0 0 !important;">:&nbsp;
                                           <asp:Label ID="Label34" runat="server" Text='<%# Eval("FeeDepositeDate") %>' Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-left" style="padding: 5px 10px 0 0 !important;">:&nbsp;
                                          <asp:Label ID="Label8" runat="server" Text='<%# Eval("StdName") %>' Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-left" style="padding: 5px 10px 0 0 !important;">:&nbsp;
                                       <asp:Label ID="Label9" runat="server" Text='<%# Eval("Class") %>' Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left" style="padding: 5px 10px 0 0 !important;">:&nbsp;
                                       <asp:Label ID="Label29" runat="server" Text='<%# Eval("MOP") %>' Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                    </td>
                                    <td class="text-left" style="padding: 5px 10px 0 0 !important;">
                                    ...
                                    <td class="text-left" colspan="3" style="padding: 5px 10px 0 0 !important;">:&nbsp;
                                       <asp:Label ID="Label11" runat="server" Text='<%# Eval("Cancel") %>' Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <FooterTemplate>
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: Courier New;">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" class="text-right" style="font-family: Courier New; font-size: 11px;padding: 5px 0 0 0;">Generated by eAM&reg; | Received by
                                                ...
                                                <div class="col-lg-12 left-padd-0 right-bor-l">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%;" class="text-right">
                                                                <i class="fa fa-inr p-icon-size"></i>
                                                                <asp:Label ID="Label30_2" runat="server" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-left">
