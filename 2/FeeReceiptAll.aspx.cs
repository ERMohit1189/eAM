...
public partial class FeeReceiptAll : System.Web.UI.Page
{
    readonly SqlConnection con = new SqlConnection();
    readonly Campus oo = new Campus();
    private readonly DLL dll = new DLL();
    ...
    public void LaserPrint()
    {
        try
        {
            ...
            DataSet ds = dll.Sp_SelectRecord_usingExecuteDataset("FeeReceiptAll", param);
            ///
            if (ds != null)
            {
                string simbol = "";
