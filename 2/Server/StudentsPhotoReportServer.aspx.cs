        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    Response.Write("<tr>");
                    Response.Write("<th class='text-left'>#</th>");
                    Response.Write("<th class='text-center'>SrNo.</th>");
                    Response.Write("<th class='text-center'>Name</th>");
                    Response.Write("<th class='text-center'>Father</th>");
                    Response.Write("<th class='text-center'>Photo</th>");
                    Response.Write("<th class='text-center'>Father Photo</th>");
                    Response.Write("<th class='text-center'>Mother Photo</th>");
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        {
                            Response.Write("<tr>");
                            Response.Write("<td class='text-left'>" + (i + 1) + "</td>");
                            ...
                            Response.Write("<td class='text-center'>" + (ds.Tables[0].Rows[0]["PhotoPath"].ToString() == "" ? "<img src='../uploads/StudentPhoto/blank.jpg' style='width:60px;' />" : "<img class='zoom' src=" + ds.Tables[0].Rows[0]["PhotoPath"].ToString() + " style='width:60px;' />") +"</td>");// "<img class='zoom' src='../uploads/StudentPhoto/blank.jpg' style='width:40px;' />" : '<img class='zoom' src="+ ds.Tables[0].Rows[0]["PhotoPath"].ToString() + " style='width:40px;'/>'+)+"</td>");
                            Response.Write("<td class='text-center'>" + (ds.Tables[1].Rows[0]["FatherPhotoPath"].ToString() == "" ? "<img src='../uploads/StudentPhoto/blank.jpg' style='width:60px;' />" : "<img class='zoom' src=" + ds.Tables[1].Rows[0]["FatherPhotoPath"].ToString() + " style='width:60px;' />") +"</td>");// "<img class='zoom' src='../uploads/StudentPhoto/blank.jpg' style='width:40px;' />" : '<img class='zoom' src="+ ds.Tables[0].Rows[0]["PhotoPath"].ToString() + " style='width:40px;'/>'+)+"</td>");
                            Response.Write("<td class='text-center'>" + (ds.Tables[2].Rows[0]["MotherPhotoPath"].ToString() == "" ? "<img src='../uploads/StudentPhoto/blank.jpg' style='width:60px;' />" : "<img class='zoom' src=" + ds.Tables[2].Rows[0]["MotherPhotoPath"].ToString() + " style='width:60px;' />") +"</td>");// "<img class='zoom' src='../uploads/StudentPhoto/blank.jpg' style='width:40px;' />" : '<img class='zoom' src="+ ds.Tables[0].Rows[0]["PhotoPath"].ToString() + " style='width:40px;'/>'+)+"</td>");
                            Response.Write("<td class='text-center'>" + (ds.Tables[3].Rows[0]["GroupPhotoPath"].ToString() == "" ? "<img src='../uploads/StudentPhoto/blank.jpg' style='width:60px;' />" : "<img class='zoom' src=" + ds.Tables[3].Rows[0]["GroupPhotoPath"].ToString() + " style='width:60px;' />") +"</td>");// "<img class='zoom' src='../uploads/StudentPhoto/blank.jpg' style='width:40px;' />" : '<img class='zoom' src="+ ds.Tables[0].Rows[0]["PhotoPath"].ToString() + " style='width:40px;'/>'+)+"</td>");
                            Response.Write("</tr>");
