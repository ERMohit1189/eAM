...
public partial class PrintfeeCardServerWithDueMonth : Page
{
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        cmd.Parameters.AddWithValue("@templetId", "3");
                        cmd.Parameters.AddWithValue("@branchCode", BranchCode.Trim());
                        ...
                        try
                        {
                            if (dts.Tables[2].Rows.Count > 0)
                            {
                                ...
                                if (dts.Tables[2].Rows[0]["templetId"].ToString() == "3")
                                {
                                    ...
                                    {
                                        Response.Write("<tr><th style='text-align:center; font-size: 13px !important;padding: 5px 5px 5px 5px!important;'>#</th><th style='text-align:Left; font-size: 14px !important;padding: 10px 5px 10px 5px!important;'>Due Month</th><th style='text-align:Left; font-size: 14px !important;padding: 10px 5px 10px 5px!important;'>Installments</th><th style='text-align:right; font-size: 14px !important;padding: 10px 5px 10px 0px!important;'>Amount</th></tr>");
                                        int srno = 0;
                                    ...
                                    Response.Write("<tr><td style='text-align:right; font-size: 15px !important; padding: 5px !important;' colspan='3'><b>Total</b> </td><td style='text-align:right; font-size: 15px !important; padding: 5px !important;'><b>= " + GTotal.ToString("0.00") + "</b></td></tr>");
                                    ...
                                    Response.Write("<tr><th style='text-align:center; font-size: 12px !important; width: 4%;'>#</th><th style='text-align:center; font-size: 14px !important;padding:3px!important; width: 10%;'>Due<br/>Month</th><th style='text-align:left; font-size: 14px !important;padding:3px!important; width: 21%;'>Installments</th><th  style='text-align:center; font-size: 14px !important;padding: 5px!important; width: 15%;'>Amount<br/>Received</th><th  style='text-align:center; font-size: 14px !important;padding: 5px!important; width: 17%;'>Receipt No & Date </th><th  style='text-align:center; font-size: 14px !important;padding: 5px!important; width: 18%;'>Bal.</th><th  style='text-align:center; font-size: 14px !important;padding: 5px!important; width: 13%;'>Sign</th></tr>");
                                    Response.Write("</thead>");
                                    Response.Write("</tbody>");
                                    for (int m = 0; m < dts.Tables[1].Rows.Count; m++)
                                    {
                                        Response.Write("<tr><td style='text-align:center; font-size: 12px !important;'>" + (m + 1) + "</td><td style='text-align:left; font-size: 12px !important; padding:  7px 5px 7px 5px  !important;'>" + dts.Tables[1].Rows[m]["DueMonth"].ToString() +"</br>"+ dts.Tables[1].Rows[m]["DueYear"].ToString()+"</td><td style='text-align:left; font-size: 12px !important; padding:  7px 5px 7px 5px  !important;'>" + dts.Tables[1].Rows[m]["InstallmentName"].ToString() + "</td><td></td><td></td><td></td><td></td></tr>");
                                    }
                                    Response.Write("</tbody></table>");
                                    Response.Write("</div>");
                                    Response.Write("<div class='col-sm-6' style='border: 2px solid;padding-left:8px; padding-right:8px;height: 758px !important;'>");
