...
public partial class UpdateUniformFeeHeadServer : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            {
                Response.Write("<span class='label label-danger' style='font-size: 100% !important;'>Unfortunately an error occurred during Uniform Fee head entry. Please try again!</span>");
                try
                {
