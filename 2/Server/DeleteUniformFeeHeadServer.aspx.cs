...
public partial class DeleteUniformFeeHeadServer : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            try
            {
                ...
                transaction.Commit();
                Response.Write("<span class='label label-success' style='font-size: 100% !important;'>Uniform fee head deleted duccessfully.</span>");
            }
            catch (Exception ex)
            {
