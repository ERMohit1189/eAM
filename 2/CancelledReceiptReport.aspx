<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="CancelledReceiptReport.aspx.cs" Inherits="CancelledReceiptReport" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        <div class="col-sm-12  no-padding ">
                            ...
                            <div class="col-sm-4   mgbt-xs-15" id="divSession" runat="server">
                            ...
                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="DrpTables" runat="server" CssClass="form-control-blue">
                                                <asp:ListItem Value="">All</asp:ListItem>
                                                <asp:ListItem Value="1">Tuition Fee</asp:ListItem>
                                                <asp:ListItem Value="5">Other Fee</asp:ListItem>
                                                <asp:ListItem Value="6">TC Fee</asp:ListItem>
                                                <asp:ListItem Value="7">CC Fee</asp:ListItem>
                                                <asp:ListItem Value="8">Admission Form Fee</asp:ListItem>
                                                <asp:ListItem Value="9">Additional Fee</asp:ListItem>
                                                <asp:ListItem Value="10">Product Fee</asp:ListItem>
                                                <asp:ListItem Value="11">Library Fine</asp:ListItem>
                                            </asp:DropDownList>
                            ...
                            <div class="col-sm-4   ">
                                <label class="control-label">From Date of Generation</label>
                                <div class="">
                                    <asp:DropDownList ID="fromDDYears" runat="server" CssClass="form-control-blue col-sm-4">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="fromDDMonths" runat="server" CssClass="form-control-blue col-sm-4">
                                    </asp:DropDownList>
                            ...
                            <div class="col-sm-4   mgbt-xs-15">
                                <label class="control-label">To Date of Generation</label>
                                <div class="">
                                    <asp:DropDownList ID="toDDYears" runat="server" CssClass="form-control-blue col-sm-4">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="toDDMonths" runat="server" CssClass="form-control-blue col-sm-4">
                                    </asp:DropDownList>
                            ...
                            <div class="col-sm-1   mgbt-xs-15"><div id="msgbox" runat="server" style="left: 75px;"></div></div>
                        </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div id="gdv" runat="server" class="text-center" style="width: 100%;">
                                                                <div style="padding-bottom:5px"><asp:Label ID="heading" runat="server" Style="font-weight: 700; font-size: 14px;"></asp:Label></div>
                                                                ...
                                                                <asp:GridView ID="GrdDisplay" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group  ">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Mode">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Mode" runat="server"  Text='<%# Bind("MOP") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Generated by">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbgenerated" runat="server"  Text='<%# Bind("GeneratedBy","{0: dd-MMM-yyyy}") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"  />
                                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Date of Cancellation">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="receiptCancelDate" runat="server"  Text='<%# Bind("receiptCancelDate1","{0: dd-MMM-yyyy}") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"  />
                                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Cancelled by">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="FatherName" runat="server"  Text='<%# Bind("CanceledBy") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"  />
                                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                        </asp:TemplateField>
                                                                         <asp:TemplateField HeaderText="Contact No." Visible="false">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="FatherContactNo" runat="server"  Text='<%# Bind("FamilyContactNo") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"  />
                                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Module">
                                                                            ...
                                                                            <FooterTemplate>
                                                                                <asp:Label ID="Footss" runat="server" Style="font-weight: bold" Text="Total"></asp:Label>
                                                                            </FooterTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"  />
                                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                            <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Remark">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="remarklbl" runat="server"  Text='<%# Bind("remark") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"  />
                                                                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Amount">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="amount" runat="server"  Text='<%# Bind("PaidAmount") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
