<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="DcrDesc.aspx.cs" Inherits="DcrDesc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                <div class="col-sm-12 no-padding ">
                                    <div class="col-sm-3 mgbt-xs-15" id="divBranch" runat="server">
                                    ...
                                    <div class="col-sm-2" id="divSession" runat="server">
                                        ...
                                        <div class="">
                                            <asp:DropDownList runat="server" ID="DrpSessionName" CssClass="form-control-blue"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2 half-width-50 hide" style="margin-top: 14px;">
                                    ...
                                    <div class="col-sm-2  mgbt-xs-15" style="margin-top: 12px;">
                                        <div class="" style="margin-top: 15px;">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <asp:LinkButton ID="btnView" runat="server" CssClass="button form-control-blue" OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn(this);" OnClick="btnView_Click">View</asp:LinkButton>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                        <ContentTemplate>
                                            <div style="float: right; font-size: 19px;" id="Panel2" runat="server">
                                                ...
                                                <asp:LinkButton ID="ImageButton4" runat="server" OnClick="ImageButton4_Click" CssClass="icon-print-color hide"
                                                    title="Print" ><i class="fa fa-print "></i></asp:LinkButton>

                                                <span id="btnPrint" runat="server" class="icon-print-color" onclick="printDiv('Daily Collection (All heads)', 'tblData');" ><a><i class="fa fa-print "></i></a></span>
    ...
    <script>
        ...
        function getTotal() {
            ...
            var monthlyFee = 0, termFee = 0, examFee = 0, tutionFee = 0, miscFee = 0, libFee = 0, fineFee = 0, disc = 0, totalFee = 0, depositFee = 0;
            var ar = []; var temp = []; var val = 0;
            var columnNums = $('#tblData tbody tr:eq(1)').find('td').length;
            var firstro = 0;
            $('#tblData tbody tr').each(function () {
                var j = 0; val = 0;
                for (var i = 8; i < columnNums; i++) {
                    if (firstro == 0) { ar.push('0'); }
                    else {
                        val = (typeof ($(this).find('td:eq(' + i + ')').html()) == 'undefined' ? 0 : ($(this).find('td:eq(' + i + ')').html() == '' ? 0 : (isNaN($(this).find('td:eq(' + i + ')').html()) ? 0 : $(this).find('td:eq(' + i + ')').html())))
                        temp.push(parseInt(val) + parseInt(ar[j]));
                        j++;
                    }
                }
                firstro++;
            ...
            $('#tblData tr:last').find('td:eq(1)').removeAttr('colspan');
            $('#tblData tr:last').html('<td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td class="text-left">Total</td>');

            for (var i = 0; i < ar.length; i++) {
                $('#tblData tr:last').append('<td class="text-right"><b>' + ar[i].toFixed(2) + '</td>')
            }
        }
    ...
    <script src="../js/jquery.min.js"></script>
    <script src="../js/printadd.js"></script>
</asp:Content>
