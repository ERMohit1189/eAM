<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ArrearReport.aspx.cs" Inherits="ArrearReport" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding ">
                                 ...
                                 <div class="col-sm-4 ">
                                    ...
                                    <div class="col-sm-2 " id="divClass" runat="server" visible="false">
                                    ...
                                    <div class="col-sm-2 " id="divStream" runat="server" visible="false">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="" style="margin-top: 25px;">
                                            ...
                                            <asp:LinkButton ID="LinkButton2" runat="server" Visible="false" OnClick="LinkButton2_Click" OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn();" CssClass="button form-control-blue ">View</asp:LinkButton>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div id="gdv" runat="server" class="text-center" style="width: 100%;">
                                                                    ...
                                                                    <asp:GridView ID="ConsolidatedGrid" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group  ">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Arrear">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="Arrear" runat="server" Text='<%# Bind("Arrear") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <FooterTemplate>
                                                                                    <asp:Label ID="ClassArrear" runat="server"></asp:Label>
                                                                                </FooterTemplate>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Discount">
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <asp:Label ID="ClassDiscount" runat="server"></asp:Label>
                                                                                </FooterTemplate>
                                                                                <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                                                                <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                                                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Total">
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <asp:Label ID="ClassTotal" runat="server"></asp:Label>
                                                                                </FooterTemplate>
                                                                                <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                                                                <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                                                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Paid">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="PaidAmount" runat="server" Text='<%# Bind("PaidAmount") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                                <FooterTemplate>
                                                                                    <asp:Label ID="ClassPaidAmount" runat="server"></asp:Label>
                                                                                </FooterTemplate>
                                                                                <HeaderStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                                                                <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                                                                <ItemStyle HorizontalAlign="Right" VerticalAlign="Middle" />
                                                                    ...
                                                                    <asp:GridView ID="ClasswiseGrid" runat="server" Visible="false" AutoGenerateColumns="False" ShowFooter="True" CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group  ">
                                                                        <AlternatingRowStyle CssClass="alt" />
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="#">
                                                                                <ItemTemplate>
