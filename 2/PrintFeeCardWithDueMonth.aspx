<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="PrintFeeCardWithDueMonth.aspx.cs" Inherits="PrintFeeCardWithDueMonth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/PrintfeeCardServerWithDueMonth.aspx") %>',
                data: {
                    'session': session,
                    'SrNo': SrNo,
                    'Section': Section,
