<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="FeeReceiptAllDuplicate.aspx.cs" Inherits="FeeReceiptAllDuplicate" %>
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl">
                <div class="col-sm-12 ">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                         <%--   <td style="width: 75%" class="print-font-set" id="Td1" runat="server"></td>--%>
                                            ...
                                            <td colspan="4">
                                                <table class="table no-head-border no-bm">
                                                    <tr>
                                                        ...
                                                        <td  style="padding: 0 5px !important; width: 20%; text-align: right;">
                                                            &nbsp;<asp:Label ID="Label18_2" runat="server" Text="Label" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label><br />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="text-left" style="font-family: Courier New; font-size: 11px;padding: 5px 0 0 0;width:50%">
                                                <div id="grdfeeDetailscancelleddiv1" runat="server" visible="false">
                                                    Cancelled by
                                                          <asp:Label ID="Label13" runat="server" Text=""></asp:Label>&nbsp;on 
