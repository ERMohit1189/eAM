<%@ Page Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="admtemplate3.aspx.cs" Inherits="_2_admtemplate3" %>
...
.vd_content-section .mgbt-xs-5 {
    margin-bottom: 0px !important;
}
.print-controls button:hover {
  background-color: #45a049;
}
.checkbox input#ContentPlaceHolder1_ContentPlaceHolderMainBox_chkFemale{margin-left:0;}
    </style>
    <div id="loader" runat="server"></div>
    <div class="vd_content-section clearfix" style="width:960px;margin:auto;padding-left:0px !important;">
    ...
    <div class="col-sm-10">
        ...
        <div class="admission-form">
            <div style="max-width:760px;padding:10px;background-color: var(--form-bg-color);border:2px solid var(--form-border-color);border-radius:10px;">
          <div class="header">
           <%-- <div class="logo">
       ...
       <div class="" id="header" runat="server" style="width: 100%;"></div>
          ...
          <div class="form-title">
            ...
            <div class="serial-number">S. No. <span class="sl-no"><asp:Label ID="lblSrno" runat="server" Style="text-transform: uppercase"></asp:Label></span></div>
          </div>
          ...
          <div class="student-details">
            ...
            <div class="field-row">
              ...
              <div class="box-row">
                  ...
                  <div class="box"></div>
                  <div class="box"></div>--%>
                  <asp:PlaceHolder ID="phFirstName" runat="server"></asp:PlaceHolder>
                </div>
            ...
            <div class="field-row">
              ...
              <div class="field-input small-input" style="max-width:120px !important;"><asp:Label ID="lblClass" runat="server" Style="text-transform: uppercase; height: 20px; padding: 5px 5px;"></asp:Label></div>
              <div class="field-label gender-label" style="text-align:right; padding-right:4px;flex: 0 0 34px !important;">GENDER</div>
              <div class="field-label gender-label" style="text-align:right; padding-right:4px;flex: 0 0 34px !important;">M</div>
                <div class="checkbox1"><asp:CheckBox ID="chkMale" runat="server"  /></div>
              <div class="field-label gender-label" style="text-align:right; padding-right:4px;flex: 0 0 34px !important;">F</div>
              <div class="checkbox1"><asp:CheckBox ID="chkFemale" runat="server" /></div>
            </div>
            ...
            <div class="field-row">
              ...
              <div class="field-input dob-boxes" id="dobInBirrd" runat="server"></div>
    ...
    &nbsp;
                <asp:LinkButton ID="lnkPrint" runat="server" OnClientClick="window.print()" CssClass="btn-print-box"
