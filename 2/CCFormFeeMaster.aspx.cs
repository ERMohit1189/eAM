...
public partial class CCFormFeeMaster : Page
{
    ...
    {
        _sql = "Select affm.Id,cm.ClassName,Amount,ISNULL(BranchName,'Other') Branch from CCFormFeeMaster affm inner join ClassMaster cm on cm.Id=affm.Classid left join BranchMaster bm on bm.Id=affm.BranchId and bm.SessionName=affm.SessionName where cm.SessionName='" + Session["SessionName"] + "' and affm.SessionName='" + Session["SessionName"] + "' and cm.BranchCode=" + Session["BranchCode"] + "  and affm.BranchCode=" + Session["BranchCode"] + "";
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            _sql = "Select *from CCFormFeeMaster where ClassId='" + drpClass.SelectedValue + "' and BranchId='" + drpBranch.SelectedValue + "' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + "";
    ...
    {
        _cmd = new SqlCommand();
        _cmd.CommandText = "CCFormFeeMasterProc";
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        lblId.Text = lnk.Text;
        _sql = "Select Id,ClassId,Amount from CCFormFeeMaster where Id='" + lblId.Text + "' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + "";
    ...
    {
        _sql = "Delete From CCFormFeeMaster where Id='" + lblvalue.Text + "'";
