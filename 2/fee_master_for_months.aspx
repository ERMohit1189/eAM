<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="fee_master_for_months.aspx.cs" Inherits="admin_FeesAllotmentForClasst" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12 no-padding ">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList runat="server" ID="DrpNewOld" AutoPostBack="True"
                                                        OnSelectedIndexChanged="DrpNewOld_SelectedIndexChanged" CssClass="form-control-blue drpUpdate">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="drpFeeGroup" runat="server" AutoPostBack="True"
                                                        OnSelectedIndexChanged="DropDownList4_SelectedIndexChanged" CssClass="form-control-blue drpUpdate">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            <div class="text-box-msg">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15" style="display:none">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="drpMod" runat="server" CssClass="form-control-blue drpUpdate" 
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="drpInstallment" runat="server" AutoPostBack="True"
                                                        OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" CssClass="form-control-blue drpUpdate">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            <div class="text-box-msg">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="drpBranch" runat="server" CssClass="form-control-blue drpUpdate" AutoPostBack="True"
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpMedium" runat="server" CssClass="form-control-blue drpUpdate" AutoPostBack="True"
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="drpFeeHead" runat="server" AutoPostBack="True"
                                                        OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged" CssClass="form-control-blue drpUpdate">
                                                    </asp:DropDownList>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtAmt" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>

                                            <div class="text-box-msg">
                                              
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                    ControlToValidate="txtAmt" ErrorMessage="Only numeric value."
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-3-p6 mgbt-xs-15">
                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="ValidateDropdown('.drpUpdate');ValidateTextBox('.validatetxt');validationReturn();" OnClick="LinkButton1_Click" ValidationGroup="a" CssClass="button form-control-blue">Submit</asp:LinkButton>
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Mode">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("MOD") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Fee Head">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("FeeType") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Fee Amount">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("FeePayment") %>'></asp:Label>
                                                            </ItemTemplate>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="drpMonthPanel" runat="server"
                                    OnSelectedIndexChanged="drpMonthPanel_SelectedIndexChanged"
                                    Visible="False" CssClass="textbox" Width="220px">
                                </asp:DropDownList>
                                <asp:Label ID="Label7" runat="server" CssClass="textbox"></asp:Label>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                       </td>
                </tr>--%>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="drpClassPanel" runat="server" CssClass="textbox" Width="220px">
                                </asp:DropDownList>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                        ...
                        <%--  <tr>
                    <td align="right">Fee Head :</td>
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="drpSelectFeeTypePanel" runat="server" OnSelectedIndexChanged="drpSelectFeeTypePanel_SelectedIndexChanged" CssClass="textbox"
                                    Width="220px">
                                </asp:DropDownList>
                                <asp:Label ID="lblFeeHeadPanel" runat="server" Visible="False"></asp:Label>
                                <asp:Label ID="lblMediumPanel" runat="server" Visible="False"></asp:Label>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>--%>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>
                                <asp:TextBox ID="txtRemarkPanel" runat="server" TextMode="MultiLine" CssClass="textbox" Height="50px" Width="200px"></asp:TextBox>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>--%>
