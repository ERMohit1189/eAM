<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="AdditionalFeeReceipt.aspx.cs" Inherits="AdditionalFeeReceipt" %>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    ...
                                    <h3 class="sub-adds-l text-center">
                                        <asp:Label ID="lblCancel" runat="server"></asp:Label>STUDENT'S COPY<br /><asp:Label ID="Label2" runat="server" Text="(ORIGINAL)"></asp:Label></h3>
                                </div>
                            </td>
                        </tr>
                ...
                <div class="col-sm-12 ">
                    <table style="font-family: Courier New; width: 100%;" class="print-table-text">
                       ...
                       <%-- <tr>
                        ...
                        <tr>
                            <td colspan="4" class="text-right" style="font-family: Courier New; font-size: 11px;padding: 5px 0 0 0;width:50%">
                                Received by
                        ...
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    ...
                                    <h3 class="sub-adds-l text-center">
                                        <asp:Label ID="Label22" runat="server"></asp:Label>SCHOOL'S COPY<br /><asp:Label ID="Label3" runat="server"  Text="(ORIGINAL)"></asp:Label></h3>
                                </div>
                            </td>
                        </tr>
