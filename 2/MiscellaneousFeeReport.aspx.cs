...
public partial class MiscellaneousFeeReport : Page
{
    ...
    {
        oo.ExportTolandscapeWord(Response, "MiscellaneousFeeReport", gdv1);
    }
    protected void ImageButton2_Click(object sender, EventArgs e)
    {
        oo.ExportDivToExcelWithFormatting(Response, "MiscellaneousFeeReport.xls", gdv1, Server.MapPath("~/Admin/css/style.css"));
    }
    protected void ImageButton3_Click(object sender, EventArgs e)
    {
        oo.ExporttolandscapePdf(Response, "MiscellaneousFeeReport", abc);
    }
    ...
    protected void loadData()
    {
        ...
        {
            heading.Text = "Miscellaneous Fee Report From " + fromdate + " to " + todate + "";
            ...
            param.Add(new SqlParameter("@action", "MiscellaneousFee"));
            DataTable dt;
            DataSet ds;
