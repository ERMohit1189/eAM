<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="MiscellaneousFeeReport.aspx.cs" Inherits="MiscellaneousFeeReport" %>
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12  no-padding ">
                            ...
                            <div class="col-sm-3   mgbt-xs-15">
                             ...
                             <div class="col-sm-2   mgbt-xs-15" id="divClass" runat="server">
                                                                ...
                                                                <asp:GridView ID="GrdDisplay" runat="server" AutoGenerateColumns="False" ShowFooter="True" CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group  ">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Installments">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Installments" runat="server"  Text='<%# Bind("Month_Name") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
