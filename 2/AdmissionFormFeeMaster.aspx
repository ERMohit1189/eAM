<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="AdmissionFormFeeMaster.aspx.cs" Inherits="_2.AdminAdmissionFormFeeMaster" %>
                            ...
                            <div class="panel-body ">
                                ...
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15 hide">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtConcession" runat="server" CssClass="form-control-blue"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" class="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Type of Admission">
                                                    <ItemTemplate>
                                                        <asp:Label ID="AdminssionType" runat="server" Text='<%# Bind("AdminssionType") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Exemption" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("Concession") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtFeehead0" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr class="hide">
                            ...
                            <td>
                                <asp:TextBox ID="txtConcession0" runat="server" CssClass="form-control-blue"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:LinkButton ID="lnkUpdate" runat="server" OnClientClick="ValidateTextBox('.validatetxt1');return validationReturn();" CssClass="button-y" OnClick="lnkUpdate_Click">Update</asp:LinkButton>
                                &nbsp;&nbsp;
