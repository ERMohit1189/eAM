<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="TCCounterSignHindi.aspx.cs" Inherits="_2_TCCounterSignHindi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
          ...
          <style>
            ...
            .certificate-table {
              ...
              .class-label {
                ...
                white-space: nowrap;
                font-size:10px;border-left: 1px solid #000 !important;
              }
                ...
                <div id="PrintDiv" runat="server">
                        ...
                        <td colSpan='3' class="header">
                         ...
                         <%--   <img src="/Uploads/CollegeLogo/logo_1.jpg" alt="School Logo" class="school-logo" />--%>
                          ...
                          <div class="school-title">
                            ...
                            <p class="form-subtitle">SCHOLAR'S REGISTER & TRANSFER CERTIFICATE FORM (स्कॉलर रजिस्टर तथा टी. सी. फॉर्म)</p>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td class="form-row">
                          <span class="heading">Admission No. / प्रवेश फाइल सं०</span>
                          <span class="value"><asp:Label ID="Label31" runat="server" Text=""></asp:Label></span>
                        </td>
                        <td class="form-row" style="width:400px;">
                         <%-- <span class="label">Withdrawal File No.</span>
                          <span class="value">01</span>--%>
                             <span class="heading">Transfer Certificate No. / विथड्राल फाइल सं.</span>
                          <span class="heading"><asp:Label ID="Label30" runat="server" Text=""></asp:Label></span>
                        </td>
                        <td class="form-row" style="width:300px;">
                         
                          <span class="heading">Register No. / फाइल सं.</span>
                          <span class="value"><asp:Label ID="Label32" runat="server"></asp:Label></span>
                        </td>
                      </tr>
                     <tr>
                        <td class="form-row" style="width:360px;text-align:center;">
                            <span class="heading">छात्र का नाम तथा धर्म<br />Name of the Scholar with caste, If Hindu otherwise religion</span>
                        </td>
                        ...
                        <td class="data-cell" style="text-align:center;">
                            <span class="heading">अन्तिम संस्थान जहाँ कि विद्यार्थी ने इसके पहले शिक्षा पाई हो <br /> The Last Institution attended by the Scholar </span>
                        </td>
                    </tr>
                      <tr>
                      ...
                      <tr>
                            <td class="data-cell">
                              <span style="color:#000;"> जन्मतिथि (अंको व शब्दों में) / Date of Birth in Figures & Word</span>
                            </td>
                        ...
                        <tr>
                            <td class="data-cell">
                                <div style="display:flex;">
                                     <div class="pen-label">यूडीआईएसई पेन / UDISE PEN</div>
                                     <div class="pen-boxes" style="text-align:center;">
                                         <asp:Literal ID="litPenBoxes" runat="server" Text="" />
                                     </div>
                                </div>
                            ...
                            <td colSpan="2" class="data-cell" >
                                <div style="display:flex;">
                                     <div class="pen-label">अपार आईडी / APAAR ID</div>
                                     <div class="pen-boxes" style="text-align:center;">
                  ...
                  <table class="records-table">
                    <thead>
                      <tr>
                          <th rowSpan="2"></th>
                            <th rowSpan="2">कक्षा <br /> Class</th>
                            <th rowSpan="2">प्रवेश तिथि <br />Date of Admission</th>
                            <th rowSpan="2">उत्तीर्ण तिथि<br />Date of Promotion</th>
                            <th rowSpan="2">त्याग तिथि<br />Date of Removal</th>
                            <th rowSpan="2">अलग होने का कारण<br />Cause of Removal</th>
                            <th rowSpan="2">वर्ष<br />Year</th>
                            <th rowSpan="2">चरित्र<br />Conduct</th>
                            <th rowSpan="2">कार्य<br />Work</th>  
    ...
    <ItemTemplate>
        <tr>
            ...
            <td style="white-space:nowrap;"><%# Eval("ClassList[0].DateOfAdmission") %></td>
            <td><%# Eval("ClassList[0].DateOfPromotion") %></td>
            <td><%# Eval("ClassList[0].DateOfRemoval") %></td>
            <td><%# Eval("ClassList[0].CauseOfRemoval") %></td>
            <td style="white-space:nowrap;"><%# Eval("ClassList[0].AcademicYear") %></td>
        ...
        <asp:Repeater ID="rptInnerRows" runat="server"
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%# Eval("Work") %></td>
                     <td class="no-print">
                         <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# String.Format("{0}", Eval("ID")) %>' />
                      <asp:LinkButton ID="LinkButton1" runat="server" title="Edit" CommandArgument='<%# Eval("ID") %>' OnClick="LinkButton2_Click" CausesValidation="False" class="btn menu-icon vd_bd-yellow vd_yellow"> <i class="fa fa-pencil"></i></asp:LinkButton>
              </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
                 ...
                 <div class="certifications" style="padding-top:10px;">
                   <div class="certification">
                     <div class="certification-number">1.</div>
                     <div class="certification-text">
                       यह प्रमाणित किया जाता है कि छात्रों से संबंधित विवरणों की प्रविष्टियाँ प्रवेश प्रपत्र से भली-भांति जांची गई हैं और वे पूर्ण हैं।<br /> 
                   ...
                   <div class="certification">
                     ...
                     <div class="certification-text">
                          यह प्रमाणित किया जाता है कि उपर्युक्त छात्र लेखा पत्रक शिक्षा विभाग के नियमानुसार त्याग तिथि तक यथोचित लिखा गया है।<br />
                        Certified that the above Student's Register has been posted up to date of the student's leaving as required by the Departmental rules.
                     </div>                     
                   </div>
                    <p style="padding:4px 6px;">टिप्पणी: यदि छात्र कक्षा में प्रथम पाँच छात्रों में योग्यतानुसार हो तो कार्य कोष्ठ में विवरण देना चाहिए। कक्षा IX से XII के बीच अगर विद्यार्थी संस्था छोड़ता है तो उसकी उपस्थिति भी इस आदेश पर अंकित कर देना चाहिए।</p>
                 </div>
                  ...
                  <div class="footer" style="padding-top:40px;">
                    ...
                    <div class="head-of-institution">
                      <span>प्रधानाचार्य / Head of Institution <asp:Label ID="lblHead1" runat="server"></asp:Label></span>
                    </div>
                  </div>

                  <div class="attendance-section">
                    <h2 class="attendance-title">उपस्थिति का विवरण / STATEMENT OF ATTENDANCE </h2>
                    <table class="attendance-table">
                      <thead>
                        <tr>
                          ...
                          <th>दिए गए व्याख्यानों की संख्या<br />No. of meetings held</th>
                          <th>उपस्थित व्याख्यानों की संख्या<br />No. of meetings attended</th>
                            <th class="no-print">Action</th>
                        </tr>
                      </thead>
                      <tbody>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td style="padding:13px 4px !important;"><%# Eval("AcademicYear") %></td>
                  ...
                  <div class="remarks-section">
                    <h3 class="remarks-title">छात्र की अन्य गतिविधियों के संबंध में टिप्पणियाँ<br />REMARKS REGARDING OTHER ACTIVITIES OF THE STUDENT

                        <asp:LinkButton ID="LinkButton4" runat="server" title="Edit" OnClick="LinkButton2_Click1"  CausesValidation="False" class="btn menu-icon vd_bd-yellow vd_yellow no-print"> <i class="fa fa-pencil"></i></asp:LinkButton>
                    </h3>
                  ...
                  <div class="receipt-section">
                    <div class="date-section" style="padding-top:30px;">
                      ...
                      <p class="signature-line">प्रधानाचार्य / Head of Institution</p>
                    </div>
                    <p class="receipt-text">छात्र पत्रावली की प्रतिलिपि प्राप्त हुई / Received a copy of scholar's Register</p>
                    <div class="date-section">
                      <p>Date: - <asp:Label ID="Label16" runat="server" Text=""></asp:Label></p>
                      <p class="signature-line">प्राप्तकर्ता का हस्ताक्षर<br />Sig. of Recipient</p>
                    </div>
                  </div>
