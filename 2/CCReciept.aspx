<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="CCReciept.aspx.cs" Inherits="_2.AdminCCReciept" %>
                    ...
                    <table style="font-family: Courier New; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <asp:Label ID="Label18" runat="server" Font-Names="Courier New" Font-Size="12px">Character Certificate Fees </asp:Label>
                            </td>
                            <td class="text-right">
                ...
                <div class="col-sm-12 ">
                    <table style="font-family: Courier New; width: 100%;">
                        ...
                        <tr runat="server" id="divConcession" visible="false">
                            ...
                            <td class="text-right" style="width: 60%;">-<asp:Label ID="lblConcessionAmount" runat="server" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-left">
                    ...
                    <table style="font-family: Courier New; width: 100%;">
                        ...
                        <tr>
                            <td>
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="Label2" runat="server" Text="FEE RECEIPT"></asp:Label>
                ...
                <div class="col-sm-12 ">
                    <table style="font-family: Courier New; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <asp:Label ID="lblAdmissionFees0" runat="server" Font-Names="Courier New" Font-Size="12px">Character Certificate Fees</asp:Label>
                            </td>
                            <td class="text-right">
                ...
                <div class="col-sm-12 ">
                    <table style="font-family: Courier New; width: 100%;">
                        ...
                        <tr runat="server" id="divConcession0" visible="false">
                            ...
                            <td class="text-right" style="width: 60%;">-<asp:Label ID="lblConcessionAmount0" runat="server" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-left">
                        ...
                        <tr>
                            <td class="text-left"  
                                style="font-family: Courier New; font-size: 11px; padding: 5px 0 0 0;">
                            ...
                            <td class="text-right" style="font-family: Courier New; font-size: 11px; font-weight: bold;">
                                <%--    Generated by eAM&reg; | --%>
                                Received by 
