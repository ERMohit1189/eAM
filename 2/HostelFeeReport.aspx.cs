...
public partial class HostelFeeReport : Page
{
    ...
    {
        oo.ExportTolandscapeWord(Response, "HostelFeeReport", gdv1);
    }
    protected void ImageButton2_Click(object sender, EventArgs e)
    {
        oo.ExportDivToExcelWithFormatting(Response, "HostelFeeReport.xls", gdv1, Server.MapPath("~/Admin/css/style.css"));
    }
    protected void ImageButton3_Click(object sender, EventArgs e)
    {
        oo.ExporttolandscapePdf(Response, "HostelFeeReport", abc);
    }
    ...
    protected void loadData()
    {
        ...
        {
            heading.Text = "Hostel Fee Report From " + fromdate + " to " + todate + "";
            ...
            {
                param.Add(new SqlParameter("@Mode", DdlpaymentMode.SelectedItem.Text));
            }
            ...
            param.Add(new SqlParameter("@action", "HostelFee"));
            DataTable dt;
            DataSet ds;
