...
namespace _2
{
    public partial class TCCBSE_English : Page
    {
        private SqlConnection con;
        private readonly Campus oo;
        private string sql;
        string id = "";
        public TCCBSE_English()
        {
        ...
        public void loaddata()
        {
            ...
            sql = "select SessionName, Id,srno,bookno,DatePArt(dd,AdmissionFromDate) dd1,' '+DateNAme(MONTH,AdmissionFromDate)+' '+Convert(Varchar(4),DatePArt(YEAR,AdmissionFromDate)) as AdmissionFromDate,DatePArt(dd,TCIssueDate) dd2,' '+DateNAme(MONTH,TCIssueDate)+' '+Convert(Varchar(4),DatePArt(YEAR,TCIssueDate)) as TCIssueDate,Concession,";
            ...
            sql += " Sex,FatherContactNo,Amount,Remark,ConductandWork,AOR,IsQualified,IsQualifiedtowhichclass, tcType, PassStatus from TCCollection where BranchCode=" + Session["BranchCode"] + " and srno='" + Label31.Text + "' and RecieptNo='" + Request.QueryString["print"].ToString() + "' order by id asc";
            ...
            //AND 
            //Classid =  (Select AdmissionForClassId from StudentOfficialDetails where SrNo=@SrNo 
            ...
            //{
            //    Label16.Text = dtStudent1.Rows[0]["SubjectList"].ToString();
            //}
            //else
            //{
            //    Label16.Text = "NA";
