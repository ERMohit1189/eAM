...
namespace _2
{
    public partial class admtemplate2 : Page
    {
        string _sql = "";
        ...
        {
            _sql = "select afc.Id as Srno,Class,bm.BranchName Branch,StudentName+' '+MiddleName +' '+LastName as StudentName,Sex,SessionFor,afc.txnid,afc.AdmissionType, dob ";
