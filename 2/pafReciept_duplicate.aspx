<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="pafReciept_duplicate.aspx.cs" Inherits="_2.AdminPafRecieptDuplicate" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6 no-padding text-right menu-action">
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn-print-box" PostBackUrl="~/2/paf.aspx" Style="color: #CC0000"
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl">
                ...
                <div class="col-sm-12 ">
                    <table style="width: 100%; margin: 0; font-family: Courier New !important;">
                        ...
                        <tr>
                                                                                                      <td>
                            <asp:Label ID="Label24" runat="server" Text="Session " Font-Bold="False" Font-Size="12px"></asp:Label>
                        </td>
                        <td>: &nbsp;
<asp:Label ID="lblSession" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
 ...
 <asp:Label ID="lblMode" runat="server" Font-Names="Courier New" Font-Bold="True" Font-Size="12px"></asp:Label>
                                                                            ...
                                                                            <td>
                            <asp:Label ID="Label22" runat="server" Text="Status " Font-Bold="False" Font-Size="12px"></asp:Label>
                        </td>
                        <td>: &nbsp;
                ...
                <div class="col-sm-12 ">
                    <table style="width: 100%; margin: 0; font-family: Courier New !important;">
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                <asp:Label ID="lblAdmissionFees" runat="server" Font-Names="Courier New" Font-Size="12px">Admission Form</asp:Label>
                            </td>
                            <td class="text-right">
                        ...
                        <tr>
                             <td class="text-left"  style="font-family: Courier New; font-size: 11px;padding: 5px 0 0 0;">
                                           <div id="grdfeeDetailscancelleddiv1" runat="server" visible="false">
                                                Cancelled by
                   <asp:Label ID="Label10" runat="server" Text=""></asp:Label>&nbsp;on 
                ...
                <div class="col-sm-12 ">
                     <table style="width: 100%; margin: 0; font-family: Courier New !important;">
                        ...
                        <tr>
                            ...
                            <td class="text-left" style="width: 40%;">
                                <asp:Label ID="lblAdmissionFees0" runat="server" Font-Names="Courier New" Font-Size="12px">Admission Form</asp:Label>
                            </td>
