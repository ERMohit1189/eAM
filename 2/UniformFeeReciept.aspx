<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="UniformFeeReciept.aspx.cs" Inherits="UniformFeeReciept" %>
        ...
        <div class="col-sm-12 no-padding print-row marg-bot-30" runat="server" id="xyz">
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl">
                <div class="col-sm-12 no-padding">
                    <%-- <table class="print-table-text">
                        <tr>
                            <td class="print-font-set" id="header1" runat="server"></td>
                        </tr>
                         <tr>
                            <td>
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="lblTitle" runat="server" Text="INVOICE"></asp:Label>
                                        (ORIGINAL)
                                    </h3>
                                </div>
                            </td>
                ...
                <div  class="col-sm-12 ">
                    ...
                    <table class="print-table-text">
                        <tr>
                            <th class="text-left" style="width: 86%;" colspan="3">
                ...
                <div class="col-sm-12 ">
                     <table class="print-table-text">
                       <%-- <tr>
                           <td colspan="4" style="font-family: Courier New; font-size: 11px; font-weight: bold; text-align: right; border-top: 1px solid;">
                                Received by 
                        ...
                        <tr>
                            <td>
                            Cancelled by 
                            <asp:Label ID="lblCancelledBy" runat="server" Text=""></asp:Label>&nbsp;on 
                            <asp:Label ID="lblCancelledDate" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>--%>
                        <tr>
                            <td >
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl">
                <div class="col-sm-12 no-padding ">
                     <%--<table class="print-table-text">
                        <tr>
                            <td  class="print-font-set" id="header2" runat="server"></td>
                        </tr>
                        <tr>
                            <td>
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="lblTitle1" runat="server" Text="INVOICE"></asp:Label>
                                        (ORIGINAL)
                                    </h3>
                                </div>
                            </td>
                    ...
                    <asp:GridView ID="GridView10" runat="server" AutoGenerateColumns="False" Width="100%" GridLines="None" CssClass="print-table-text" Font-Size="12px" >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Received">
                                ...
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Center" Width="14%" Font-Names="Courier New" Font-Size="12px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Balance">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_Balance" runat="server" Text='<%# Bind("NextDeuAmt") %>'></asp:Label>
                ...
                <div class="col-sm-12 ">
                     <table class="print-table-text">
                       <%-- <tr>
                             ...
                             <td class="text-left" style="font-family: Courier New; font-size: 11px; font-weight: bold; text-align: right; border-top: 1px solid;">
                                    Cancelled by 
                                  <asp:Label ID="lblCancelledBy1" runat="server" Text=""></asp:Label>&nbsp;on 
                                   <asp:Label ID="lblCancelledDate1" runat="server" Text=""></asp:Label>
                             </td>
                           <td class="text-right" style="font-family: Courier New; font-size: 11px; font-weight: bold; text-align: right; border-top: 1px solid;">Received by 
