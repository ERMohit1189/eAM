...
public partial class admin_StudentRecipetForConvence : System.Web.UI.Page
{
    ...
    public void LaserPrint()
    {
        ...
        sql = sql + "  Substring(fd.FeeMonth,4,Len(fd.FeeMonth)) as FeeMonth,fd.Class as Class,fd.section as section,RecievedAmount,RemainingAmount,CurrentAmount,";
        ...
        sql = sql + "  where fd.RecieptSrNo='" + Label1.Text + "' and fd.BranchCode=" + Session["BranchCode"].ToString() + " and fd.SessionName='" + Session["SessionName"].ToString() + "'";
