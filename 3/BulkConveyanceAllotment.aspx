<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="BulkConveyanceAllotment.aspx.cs" Inherits="_3_BulkConveyanceAllotment" %>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="DropBranch" runat="server"
                                                        CssClass="form-control-blue " OnSelectedIndexChanged="DropBranch_SelectedIndexChanged" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            <div class="text-box-msg">
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-1-p4-p2  mgbt-xs-15">
                                        <div class="pull-left">
                                            <asp:LinkButton runat="server" ID="LinkShow" OnClick="LinkShow_Click" OnClientClick="ValidateDropdown('.validatedrp');return validationReturn();" CssClass="button form-control-blue">View</asp:LinkButton>
                                             <asp:LinkButton runat="server" ID="LinkButton1" OnClick="LinkButton1_Click" Visible="false"  CssClass="button form-control-blue">Copy Last Year ConveyanceAllotment</asp:LinkButton>
...
<div class="col-sm-12 mgbt-xs-15">
                                <span class="txt-bold txt-middle-l text-primary">Note:- </span><span class="txt-bold txt-middle-l text-danger blink">Before working on this page, please promote the students from the previous session first.
                                ...
                                <div class="col-sm-12  no-padding" id="Panel2" runat="server" style="display:none;">
                                    <div class="col-sm-12  ">
