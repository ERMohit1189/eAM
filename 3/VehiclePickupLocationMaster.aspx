<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="VehiclePickupLocationMaster.aspx.cs" Inherits="admin_VehiclePickupLocationMaster" %>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtPickupStopage" runat="server" CssClass="form-control-blue" AutoPostBack="True"  MaxLength="2" onBlur = "ChecktenDigitNumber(this);"  OnTextChanged="txtPickupStopage_TextChanged" Placeholder="Number here"></asp:TextBox>
                                                    <div class="text-box-msg">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPickupStopage" ErrorMessage="Please Enter Total No. of Stoppage!" ForeColor="red"
                                                ...
                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" class="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Pickup Stoppage Name">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtPickupName" placeholder="Enter Stoppage Name" runat="server" CssClass="form-control-blue" OnTextChanged="txtPickupName_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" CssClass="imp"
                                                                    ControlToValidate="txtPickupName" SetFocusOnError="true" Display="Dynamic" ValidationGroup="a">
                                                        ...
                                                        <asp:TemplateField HeaderText="Arrival Timing">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtAColon" runat="server" CssClass="form-control-blue" Text=":" Width="4px" Enabled="false" ReadOnly="true"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Departure Timing">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="txtDColon" runat="server" CssClass="form-control-blue" Text=":" Width="4px" Enabled="false" ReadOnly="true"></asp:TextBox>
                                                                <asp:TextBox ID="txtDMM" placeholder="MM" runat="server" CCssClass="form-control-blue text-center" MaxLength="2" Width="50px" onBlur = "ChecktenDigitNumber(this);"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Display Order">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtDisplayOrder" ReadOnly="true" runat="server" CssClass="form-control-blue text-center" MaxLength="2" Width="50px" Text='<%# Bind("srno") %>' ></asp:TextBox>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Stoppage Code" Visible="false">
                                                            <ItemTemplate>
                                ...
                                <div class="col-sm-12  ">
                                    <div class=" table-responsive  table-responsive2">
                                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ShowFooter="true" class="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="#">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Vehicle Type">
                                                            <ItemTemplate>
                                                                <asp:Label ID="PickupPointId" Visible="false" runat="server" Text='<%# Bind("PickupPointId") %>'></asp:Label>
                                                        ...
                                                        <asp:TemplateField HeaderText="Distance">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("PickupDistance") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                        </asp:TemplateField>
            ...
            <div style="overflow: auto; width: 2px; height: 1px">
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        ...
                        <tr>
                            <td>Pickup Stoppage Name<span class="vd_red">*</span>
                            </td>
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtPickupStopageName" runat="server" CssClass=" form-control-blue"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:TextBox ID="txtAColon0" runat="server" CssClass="textbox" Text=":" Width="4px" Enabled="false" ReadOnly="true"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtPickupDistance" runat="server" CssClass=" form-control-blue" MaxLength="2" onBlur = "ChecktenDigitNumber(this);"></asp:TextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ControlToValidate="txtPickupDistance" ErrorMessage="Enter numeric/decimal value."
                        ...
                        <tr style="display: none">
                            <td style="display: none; text-align: right;">Display Order <span class="vd_red">*</span>
                            </td>
                            <td style="display: none">
                                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtDisplayOrder" runat="server" CssClass="form-control-blue text-center" MaxLength="4" Width="50px"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
