...
public partial class common_G4_ddlClass_MarkEntry_4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            _sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and t1.BranchCode=" + Session["BranchCode"] + " and cm.BranchCode=" + Session["BranchCode"] + " and t1.SessionName='" + Session["SessionName"] + "' and GroupId='G4' Order by CIDOrder";
        ...
        else
        {
            ...
            _sql += " where T1.BranchCode=" + Session["BranchCode"] + " and t2.SessionName='" + Session["SessionName"] + "' and GroupId = 'G4' and ECode = '" + Session["LoginName"].ToString() + "'";
            _dt = DAL.DALInstance.GetValueInTable(_sql);
            if (_dt != null && _dt.Rows.Count > 0)
            {
                for (int i = 0; i < _dt.Rows.Count; i++)
