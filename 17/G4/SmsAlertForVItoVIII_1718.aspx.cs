...
public partial class common_SmsAlertFroVItoVIII_1718 : Page
{
    ...
    public void loadclass()
    {
        ...
        else
        {
            if (Session["SessionName"].ToString() == "2015-2016")
            {
                ...
                sql +=  " where GroupId='G4' and cm.SessionName='" + Session["SessionName"] + "'  and t1.SessionName='" + Session["SessionName"] + "' and sctm.SessionName='" + Session["SessionName"] + "' and Ecode='" + Session["LoginName"].ToString() + "' and ClassTeacher='Yes' Order by CIDOrder";
                BAL.objBal.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
            }
            else
            {
                ...
                sql +=  " where GroupId='G4'  and cm.BranchCode=" + Session["BranchCode"] + " and t2.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and EmpCode='" + Session["LoginName"].ToString() + "'   and cm.SessionName='" + Session["SessionName"] + "'  and T2.SessionName='" + Session["SessionName"] + "' and IsClassTeacher=1 and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
                BAL.objBal.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
            }
        }
    }
    ...
    public void loadStudents()
    {
        ...
        sql +=  "   and SC.SessionName='" + Session["SessionName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and sc.BranchCode=" + Session["BranchCode"] + " and so.BranchCode=" + Session["BranchCode"] + " and sg.BranchCode=" + Session["BranchCode"] + " and sf.BranchCode=" + Session["BranchCode"] + "  and";
        ...
        for (int i = 0; i < rptStudents.Items.Count; i++)
        {
            ...
            sql +=  " where sm.ClassId = '" + drpclass.SelectedValue.ToString() + "'  and sgm.BranchCode=" + Session["BranchCode"] + " and sm.BranchCode=" + Session["BranchCode"] + "  and sgm.SessionName='" + Session["SessionName"] + "' and sm.SectionName = '" + drpsection.SelectedItem.Text.ToString() + "' and sm.SessionName = '" + Session["SessionName"].ToString() + "'";
            sql +=  " and sgm.IsForOnlyExam = 1 and spm.IsForExam = 1 order by sgm.DisplayOrder Asc";
    ...
    public string GetMMarks(string Eval, string subjectid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_CCEVItoVIIIMMMarksForMessage", param);
    ...
    public string GetTestMarks(string Eval, string subjectid,string srno)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_CCEVItoVIIIMarksForMessage", param);
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        ...
        Campus camp = new Campus(); camp.msgbox(Page, divmsg, msg, symbol);
    }
