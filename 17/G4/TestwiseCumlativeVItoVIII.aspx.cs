...
public partial class TestwiseCumlativeVItoVIII : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            drptest.Items.Insert(3, new ListItem("H. Y. E.(Prac)", "PracHY"));
        }
    }
    protected void LoadTests()
    {
        ...
        else
        {
            ...
            drptest.Items.Insert(3, new ListItem("A. E.(Prac)", "PracAE"));
        }
    }
    ...
    public string GetMMarks(string Eval, string subjectid, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMMMarksVIToVIII_2021", param);
    ...
    public string GetTestMarks(string Eval, string subjectid, string srno, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMarksVIToVIII_2021", param);
