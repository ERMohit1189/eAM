<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClasswiseAllSubjectMarksListVItoVIII_1718.aspx.cs" Inherits="common_ClasswiseAllSubjectMarksListVItoVIII_1718" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>Class wise Cumulative (VI Ito VIII)</title>' + headContent + '</head>');
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ClassWiseCumulativeReport_VItoVIII_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
