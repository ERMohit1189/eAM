...
public partial class staff_MarkEntryReportVItoVIII_1617 : System.Web.UI.Page
{
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " and ctm.SessionName='" + Session["SessionName"].ToString() + "' and t1.GroupId='G4'";
            ...
            if (Convert.ToInt16(Session["count"].ToString()) > 0)
            {
                ...
                sql +=  " where GroupId='G4'  and cm.SessionName='" + Session["SessionName"].ToString() + "' and sctm.SessionName='" + Session["SessionName"] + "' and Ecode='" + Session["LoginName"].ToString() + "' Order by CIDOrder";
                oo.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
    ...
    public void loadsection()
    {
        ...
        sql +=  " inner join dt_ClassGroupMaster t1 on t1.ClassId=ctm.ClassId";
        sql +=  " where EmpCode='" + Session["LoginName"].ToString() + "' and IsClassTeacher=1";
        sql +=  " and t1.GroupId='G4' and ctm.ClassId='" + drpclass.SelectedValue.ToString() + "'";
        ...
        else
        {
            if (Convert.ToInt16(Session["count"].ToString()) > 0)
            {
                ...
                sql +=  " where EmpCode='" + Session["LoginName"].ToString() + "' and IsClassTeacher=1";
                sql +=  " and ctm.SessionName='" + Session["SessionName"].ToString() + "' and t1.GroupId='G4' and ctm.ClassId='" + drpclass.SelectedValue.ToString() + "'";
                sql +=  " UNION";
    ...
    private void loadSubjectGroup()
    {
        ...
        sql +=  " and Sectionid='" + drpsection.SelectedValue.ToString() + "' and t1.GroupId='G4'";
    ...
    public void loadgrid()
    {
        ...
        sql +=  "   and SO.Withdrwal is null order by FirstName Asc";
