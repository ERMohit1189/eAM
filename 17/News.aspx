                                ...
                                <div class="">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="controls txt-middle">
                                            <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal" CssClass="vd_checkbox checkbox-success validatecb" RepeatLayout="Flow">
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBoxList ID="CheckBoxList2" runat="server" CssClass="vd_checkbox checkbox-success validatecb1"
                                     OnSelectedIndexChanged="CheckBoxList2_SelectedIndexChanged" RepeatDirection="Horizontal" RepeatLayout="Flow">
