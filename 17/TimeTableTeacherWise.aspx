<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="TimeTableTeacherWise.aspx.cs" Inherits="TimeTableTeacherWise" %>
                            ...
                            <div class="panel-body ">
                                ...
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtDate" CssClass="form-control-blue validatetxt datepicker-normal" runat="server"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4  half-width-50  btn-a-devices-3-p6 mgbt-xs-15" style="padding-top: 26px;">
                                        <asp:LinkButton ID="btnView" runat="server" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();" OnClick="btnView_Click" CssClass="button form-control-blue">View</asp:LinkButton>
