...
public partial class admin_UploadSyllabus : System.Web.UI.Page
{
    string sql = "";
    ...
    private void loadSection(DropDownList drpsection, DropDownList drpclass)
    {
        ...
        else
        {
            ...
            sql +=  "and t1.BranchCode=" + Session["BranchCode"].ToString() + " and sm.BranchCode=" + Session["BranchCode"].ToString() + " and t1.Classid=" + drpclass.SelectedValue.ToString() + "";
            BAL.objBal.FillDropDown_withValue(sql, drpsection, "SectionName", "Id");
    ...
    private void loadBranch(DropDownList drpbranch, DropDownList drpclass)
    {
        ...
        else
        {
            ...
            sql +=  "  and bm.BranchCode=" + Session["BranchCode"].ToString() + " and t1.BranchCode=" + Session["BranchCode"].ToString() + " and  T1.SessionName='" + Session["SessionName"] + "' and T1.Classid='" + drpclass.SelectedValue.ToString() + "'";
        ...
        if (drpSection.SelectedIndex == 0)
        {
            for (int i = 1; i < drpSection.Items.Count; i++)
            {
                if (hfSllabusFile.Value != string.Empty && hfSllabusFile.Value != null)
                {
                    ...
                    {
                        fileName = "Circular_" + drpClass.SelectedItem.Text + "_" + txtTitle.Text.Trim() + "_" + DateTime.Now.ToString("dd-MM-yy_hhmmss") + hfSllabusFileext.Value.ToString();
                    ...
                    Msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("Std_Assignment_proc", param);
    ...
    private void loadGrid(string Id)
    {
        ...
        grdDocList.DataSource = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Assignment_proc", param);
        grdDocList.DataBind();
    }
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Assignment_proc", param);
        if (ds != null)
        {
