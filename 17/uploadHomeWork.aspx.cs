...
public partial class admin_uploadHomeWork : Page
{
    string sql = "";
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (hfSllabusFile.Value != string.Empty && hfSllabusFile.Value != null)
        {
            ...
            {
                fileName = "Homework_" + drpClass.SelectedItem.Text + "_" + txtTitle.Text.Trim() + "_" + DateTime.Now.ToString("dd-MM-yy_hhmmss") + hfSllabusFileext.Value.ToString();
                filePath = string.Format("~/Uploads/Docs/Homework/{0}", fileName);
            ...
            Msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("Std_Homework_proc", param);
    ...
    private void loadGrid(string Id)
    {
        ...
        grdDocList.DataSource = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Homework_proc", param);
        grdDocList.DataBind();
    }
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Homework_proc", param);
        if (ds != null)
        {
