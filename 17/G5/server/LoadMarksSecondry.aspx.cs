...
public partial class _17_G5_server_LoadMarksSecondry : System.Web.UI.Page
{
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        string sql1 = "Select MaxMarks1,MaxMarks2,MaxMarks4,MaxMarks5 from SGSMaxMarkEntrySecondary where ClassId=" + ClassId + " and SectionName='" + SectionName + "' and Evaluation='" + Evail.ToString().Trim() + "' and BranchCode=" + BranchCode.ToString() + " and SubjectId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "'";
