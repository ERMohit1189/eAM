...
public partial class _17_G5_server_ddlMedium_MarkEntry_5 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        _sql = "Select Distinct Medium from MediumMaster  where SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + "";
