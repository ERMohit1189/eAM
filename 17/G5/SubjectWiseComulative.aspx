<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/17/comman_root_manager.master" CodeFile="SubjectWiseComulative.aspx.cs" Inherits="_17_G5_SubjectWiseComulative" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadFillList() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ViewMarks.aspx") %>',
                data: {
                    'ClassName': ClassName,
