...
public partial class _17_G6_server_ViewMarks : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                sql += " and sg.SectionName='" + SectionName.ToString() + "' and sg.SessionName='" + Session.ToString() + "' and ";
                sql += " sg.BranchCode='" + BranchCode.ToString() + "' and sg.BranchId=" + BranchId + " and sg.CardId =" + StreamId.ToString().Trim() + " ";
                //if (isoptional)
                //{
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        string sql1 = "Select MaxMarks1,MaxMarks2,MaxMarks4,MaxMarks5 from SGSMaxMarkEntryXI where ClassId=" + ClassId + " and SectionName='" + SectionName + "' and Evaluation='" + Evail.ToString().Trim() + "' and BranchCode=" + BranchCode.ToString() + " and SubjectId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "'";

                        // string sql1 = "Select MaxMarks1,MaxMarks2,MaxMarks4,MaxMarks5 from SGSMaxMarkEntryXI ";
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            string sql3 = "Select Id,Test1,Test2,TH,Prac from SGSMarkEntryXI where  ClassId=" + ClassId + " and SectionName='" + SectionName + "' and SRNO='" + dt.Rows[i]["srno"].ToString() + "' and Evaluation='" + Evail.ToString().Trim() + "' and SubjectId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "' and BranchCode=" + BranchCode + "";
                            //  string sql3 = "Select Id,Test1,Test2,TH,Prac from SGSMarkEntryXI where SRNO='" + dt.Rows[i]["srno"].ToString() + "'  and SubjectId='" + SubjectId.ToString().Trim() + "' and ClassId =" + ClassId.ToString().Trim() + " and BranchId =" + BranchId.ToString().Trim() + "  and StreamId =" + StreamId.ToString().Trim() + " and SectionId =" + SectionId.ToString().Trim() + " ";
