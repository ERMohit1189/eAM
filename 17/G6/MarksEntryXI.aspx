<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/17/comman_root_manager.master" CodeFile="MarksEntryXI.aspx.cs" Inherits="_17_G6_MarksEntryXI" %>

<%--<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/17/comman_root_manager.master" CodeFile="MarksEntrySecondry.aspx.cs" Inherits="_17_G5_MarksEntrySecondry" %>--%>
<%--<%@ Page Title="" Language="C#" MasterPageFile="~/17/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryJunior.aspx.cs" Inherits="MarksEntryJunior" %>--%>
    ...
    <script>
        ...
        function LoadFillList() {
           ...
           $("[id*=divList]").html("");
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/LoadMarksXI.aspx")%>',
                data: {
