<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="RankPositionReport.aspx.cs" Inherits="RankPositionReport" %>
                                    ...
                                    <div class="col-sm-2  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="DrpAttenSection" runat="server" CssClass="form-control-blue validatedrp"></asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            <div class="text-box-msg">
                                            </div>
                                            ...
                                            <div id="gdv1" class="print-row col-sm-12   no-padding" runat="server">
                                                <div id="abc" class="print-row col-sm-12   no-padding" runat="server" visible="false">
                                                    ...
                                                    <div class="print-row col-sm-12  text-center no-padding">
                                                        <asp:Label ID="Label1" runat="server" Text="Rank-Position Report"></asp:Label>
                                                    ...
                                                    <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="S.R. No.">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblStreamId" runat="server" Text='<%# Bind("StreamId") %>' CssClass="hide"></asp:Label>
                                                                    <asp:Label ID="lblBranchId" runat="server" Text='<%# Bind("BranchId") %>' CssClass="hide"></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Class">
                                                                ...
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" Width="110px" />
                                                           ...
                                                           <asp:TemplateField HeaderText="Term1 Rank">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="T1Rank" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" Width="70px" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-n" />
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Term2 Rank">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="T2Rank" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" Width="70px" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-n" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Total Rank">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="TotalRank" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" Width="70px" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-n" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Term1 Position">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="T1Position" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" Width="70px" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-n" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Term2 Position">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="T2Position" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" Width="70px" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-n" />
                                                            </asp:TemplateField>
                                                             <asp:TemplateField HeaderText="Total Position">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="TotalPosition" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" Width="70px" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-n" />
                                                            </asp:TemplateField>
