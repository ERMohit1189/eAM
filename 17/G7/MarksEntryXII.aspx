<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/17/comman_root_manager.master" CodeFile="MarksEntryXII.aspx.cs" Inherits="_17_G7_MarksEntryXII" %>
    ...
    <script>
        ...
        function LoadFillList() {
           ...
           $("[id*=divList]").html("");
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/LoadMarksXII.aspx")%>',
                data: {
