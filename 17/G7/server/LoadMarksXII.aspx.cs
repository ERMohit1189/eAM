...
public partial class _17_G7_server_LoadMarksXII : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                sql += " and sg.SectionName='" + SectionName.ToString() + "' and sg.SessionName='" + Session.ToString() + "' and ";
                sql += " sg.BranchCode='" + BranchCode.ToString() + "' and sg.BranchId=" + BranchId + " ";
                //if (isoptional)
                //{
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        string sql1 = "Select MaxMarks1,MaxMarks2,MaxMarks4,MaxMarks5 from SGSMaxMarkEntryXII where ClassId=" + ClassId + " and SectionName='" + SectionName + "' and Evaluation='" + Evail.ToString().Trim() + "' and BranchCode=" + BranchCode.ToString() + " and SubjectId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "'";
