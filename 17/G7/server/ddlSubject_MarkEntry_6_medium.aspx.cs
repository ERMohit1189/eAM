...
public partial class _17_G7_server_ddlSubject_MarkEntry_6_medium : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            _sql = "Select SubjectName,Id from TTSubjectMaster where ClassId=" + drpclass.ToString() + "  and BranchId=" + BranchId + " and Medium='" + Medium + "'";
            _sql += " and  BranchCode = " + Session["BranchCode"] + " and SessionName='" + Session["SessionName"] + "' and ApplicableFor<>'TimeTable' and IsAditional=0";
        ...
        else
        {
            ...
            _sql += " and sm.BranchId=" + BranchId + " and sm.Medium='" + Medium + "' and  sctm.BranchCode = " + Session["BranchCode"] + " and sctm.SessionName='" + Session["SessionName"].ToString() + "' and IsAditional=0";
            _dt = DAL.DALInstance.GetValueInTable(_sql);
            if (_dt != null && _dt.Rows.Count > 0)
            {
                for (int i = 0; i < _dt.Rows.Count; i++)
