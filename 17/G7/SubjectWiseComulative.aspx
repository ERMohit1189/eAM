<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/17/comman_root_manager.master" CodeFile="SubjectWiseComulative.aspx.cs" Inherits="_17_G7_SubjectWiseComulative" %>
    ...
    <script>
        ...
        function LoadFillList() {
           ...
           $("[id*=divList]").html("");
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ShowMarks.aspx")%>',
                data: {
