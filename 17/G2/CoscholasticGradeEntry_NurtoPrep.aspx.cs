...
public partial class staff_CoscholasticGradeEntry : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/11/G1/CoscholasticGradeEntry_NurtoPrep.aspx");
        }
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " where GroupId='G2' and EmpCode='" + Session["LoginName"].ToString() + "' and T1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
    ...
    protected void TextBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        if (Text1.Text == "A" || Text1.Text == "B" || Text1.Text == "C" || Text1.Text == "D" || Text1.Text == "-" || Text1.Text == "")
        {
        ...
        {
            Campus camp = new Campus(); camp.msgbox(Page, msgbox, "Please enter grads A,B,C or (-) only!", "A");
            Text1.Text = "";
            Text1.Focus();
            return;
        }
