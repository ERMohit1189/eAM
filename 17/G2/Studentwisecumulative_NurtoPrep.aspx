    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#drpsection', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("Server/ddlSrNo_2.aspx") %>',
        ...
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>STUDENT WISE CUMLATIVE  FOR Nur to Prep</title>' + headContent + '</head>');
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/Studentwisecumulative_NurtoPrep_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
