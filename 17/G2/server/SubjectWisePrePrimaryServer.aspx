<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubjectWisePrePrimaryServer.aspx.cs" Inherits="_17_G2_server_SubjectWisePrePrimaryServer" %>
...
<head runat="server">
  ...
  input[type="text"] {
    ...
    -khtml-user-select: none; /* Disable text selection for older versions of Safari */
     border: none;
