<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClasswiseAllSubjectMarksListNurtoPrep_1718.aspx.cs" Inherits="common_ClasswiseAllSubjectMarksListNurtoPrep_1718" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadClass() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlClass_2.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadSection(classId) {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlSection_2.aspx") %>',
        ...
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>Class wise Cumulative (Nur Ito Prep)</title>' + headContent + '</head>');
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ClasswiseAllSubjectMarksListNurtoPrep_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
