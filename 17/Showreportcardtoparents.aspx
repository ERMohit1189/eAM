<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Showreportcardtoparents.aspx.cs" Inherits="Showreportcardtoparents" %>
                                        ...
                                        <table class="table table-striped no-bm table-hover no-head-border table-bordered pro-table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th class="p-pad-3 p-tot-tit" style="width: 7%; text-align:left !important;">
                                                        Attendance<br />
                                                        <asp:DropDownList ID="drpAttendanceH" runat="server" CssClass="form-control-blue" AutoPostBack="true" OnSelectedIndexChanged="drpAttendanceH_SelectedIndexChanged">
