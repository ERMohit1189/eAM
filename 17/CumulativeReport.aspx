<%@ Page Language="C#" MasterPageFile="~/17/comman_root_manager.master" AutoEventWireup="true" CodeFile="CumulativeReport.aspx.cs" Inherits="_17_CumulativeReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMainhead" runat="Server">
    ...
    <%-- <style>
        ...
        .report-title { text-align: center; font-weight: bold; font-size: 18px; margin-bottom: 10px; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                        ...
                        <div class="col-sm-12 no-padding" id="div1" runat="server">
                            <div class="col-sm-12  no-padding ">
                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                    ...
                                    <div id="div_drpclass">
                                       <asp:DropDownList runat="server" ID="drpclass" CssClass="form-control-blue" OnSelectedIndexChanged="drpclass_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                    <label class="control-label">Section&nbsp;<span class="vd_red">*</span></label>
                                    <div id="div_section">
                                        <asp:DropDownList ID="drpSection" runat="server" CssClass="form-control-blue" OnSelectedIndexChanged="drpSection_SelectedIndexChanged" AutoPostBack="true">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                               <div class="col-sm-4 half-width-50 mgbt-xs-15" runat="server" >
                                ...
                                <div class="col-sm-4 half-width-50 mgbt-xs-15" runat="server">
                                  ...
                                  <div class="col-sm-4 half-width-50 mgbt-xs-15" runat="server">
                                    ...
                                    <div class="">
                                         <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control-blue" OnSelectedIndexChanged="drpStatus_SelectedIndexChanged" AutoPostBack="true">
                             ...
                             <div class="col-sm-12  no-padding" runat="server" visible="false" id="icons" style="font-size: 19px;display:flex;justify-content: flex-end;">                            
                                <asp:LinkButton ID="ImageButton2" runat="server" OnClick="ImageButton2_Click" 
                                    CssClass="icon-excel-color" title="Export to Excel" ><i class="fa fa-file-excel-o "></i>
                                </asp:LinkButton>  
                                <a onclick="PrintDiv();" class="icon-print-color">&nbsp;<i class="fa fa-print "></i></a>
                             </div>
                             
                            <div class="col-sm-12" style="overflow:auto">
                                <div id="divExport" runat="server">
                                 <div class="report-title text-center" style="font-weight: bold;font-size: 15px;">Cumulative Report with Subject and Term</div>
    ...
    <script>
        ...
        function LoadFillList() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/MarksEntryJuniorServer.aspx") %>',
                data: {
                    'ClassName': ClassName,
        ...
        function SaveMarks() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/SaveMarksEntryJuniorServer.aspx") %>',
                data: {
                    'ClassId': ClassIds,
                    'SectionName': SectionName,
                    'SubjectId': SubjectId,
