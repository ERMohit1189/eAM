<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="uploadExamSchedule.aspx.cs" Inherits="admin_uploadExamSchedule" %>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:FileUpload ID="fu1" runat="server" CssClass="form-control-blue "
                                                onchange="checksFileSizeandFileTypeinupdatePanel_fordoc(this,'pdf|xlx|xlsx|doc|docx|txt|jpg|jpeg|png|gif|PDF|XLX|XLSX|DOC|DOCX|TXT|JPG|JPEG|PNG|GIF', 'ContentPlaceHolder1_ContentPlaceHolderMainBox_hfExamScheduleFile',
                                        'ContentPlaceHolder1_ContentPlaceHolderMainBox_hfExamScheduleFileext');" />
                                            <asp:HiddenField ID="hfExamScheduleFile" runat="server" />
                                            <asp:HiddenField ID="hfExamScheduleFileext" runat="server" />
                                            <div class="text-box-msg">
                                        ...
                                        <asp:GridView ID="grdDocList" runat="server" AutoGenerateColumns="false" CssClass="table table-striped no-bm table-hover no-head-border table-bordered pro-table">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Username">
                                                    ...
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np"  Width="200px" />
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                            ...
                            <td>
                                <asp:FileUpload ID="fu1panel" runat="server"
                                    onchange="checksFileSizeandFileTypeinupdatePanel_fordoc(this,'pdf|doc|docx|txt|jpg|jpeg|png|gif',
                                                                      'ContentPlaceHolder1_ContentPlaceHolderMainBox_hfExamScheduleFilepanel',
                                                                      'ContentPlaceHolder1_ContentPlaceHolderMainBox_hfExamScheduleFileextpanel');" />
                                <asp:HiddenField ID="hfExamScheduleFilepanel" runat="server" />
                                <asp:HiddenField ID="hfExamScheduleFileextpanel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>Title</td>
