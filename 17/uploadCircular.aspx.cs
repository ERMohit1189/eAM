...
public partial class admin_UploadSyllabus : System.Web.UI.Page
{
    ...
    private void loadSection(DropDownList drpsection, DropDownList drpclass)
    {
        ...
        else
        {
            ...
            sql +=  " and sm.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and t1.Classid=" + drpclass.SelectedValue.ToString() + "";
            BAL.objBal.FillDropDown_withValue(sql, drpsection, "SectionName", "Id");
    ...
    private void loadBranch(DropDownList drpbranch, DropDownList drpclass)
    {
        ...
        else
        {
            ...
            sql +=  "   where EmpCode='" + Session["LoginName"].ToString() + "' and IsClassTeacher=1 and bm.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and";
        ...
        if (drpSection.SelectedIndex == 0)
        {
            for (int i = 1; i < drpSection.Items.Count; i++)
            {
                if (hfSllabusFile.Value != string.Empty && hfSllabusFile.Value != null)
                {
                    ...
                    Msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("Std_Circular_proc", param);
    ...
    private void loadGrid(string Id)
    {
        ...
        grdDocList.DataSource = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Circular_proc", param);
        grdDocList.DataBind();
    }
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Circular_proc", param);
        if (ds != null)
        {
