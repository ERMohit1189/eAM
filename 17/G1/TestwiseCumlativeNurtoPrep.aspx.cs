...
public partial class TestwiseCumlativeNurtoPrep : Page
{
    ...
    public void loadclass()
    {
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and cm.BranchCode=" + Session["BranchCode"] + " and GroupId='G1' Order by CIDOrder";
        ...
        else
        {
            ...
            sql +=  " where GroupId='G1'  and sctm.SessionName='" + Session["SessionName"].ToString() + "' and sctm.BranchCode=" + Session["BranchCode"] + " and Ecode='" + Session["LoginName"].ToString() + "' Order by CIDOrder";
            oo.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
        }
    }
    ...
    {
        string sql = "Select sm.id SubjectId, SubjectName,'' marks from ttSubjectMaster  sm";
        ...
        sql +=  " and sm.ApplicableFor<>'TimeTable' order by sm.id Asc";
    ...
    public void loadStudents()
    {
        ...
        for (int i = 0; i < rptStudents.Items.Count; i++)
        {
            ...
            sql = "Select sm.id SubjectId, SubjectName,'' marks from ttSubjectMaster  sm";
            sql +=  " where sm.ClassId = '" + drpclass.SelectedValue.ToString() + "' and sm.SessionName='" + Session["SessionName"] + "'  and sm.BranchCode=" + Session["BranchCode"] + "";
            sql +=  " and sm.ApplicableFor<>'TimeTable' order by sm.id Asc";
    ...
    public string GetMMarks(string Eval, string subjectid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMMMarksNurToPrep_2021", param);
    ...
    public string GetTestMarks(string Eval, string subjectid,string srno)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMarksNurToPrep_2021", param);
