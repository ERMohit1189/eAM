            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        double Gpercentle = 0; double GTest1 = 0; double GTest2 = 0; double GNB = 0; double GSE = 0; double GSAT = 0; double Gtotal = 0;
                        double Gpercentle_2 = 0; double GTest1_2 = 0; double GTest2_2 = 0; double GNB_2 = 0; double GSE_2 = 0; double GSAT_2 = 0; double Gtotal_2 = 0;
                        ...
                        if (dss.Tables[0].Rows.Count > 0)
                        {
                            ...
                            {
                                double Test1 = 0; double Test2 = 0; double NB = 0; double SE = 0; double SAT = 0; double MaxMarks1 = 0; double MaxMarks2 = 0; double MaxMarks4 = 0; double MaxMarks5 = 0; double MaxMarks6 = 0;
                                double Test1_2 = 0; double Test2_2 = 0; double NB_2 = 0; double SE_2 = 0; double SAT_2 = 0; double MaxMarks1_2 = 0; double MaxMarks2_2 = 0; double MaxMarks4_2 = 0; double MaxMarks5_2 = 0; double MaxMarks6_2 = 0;
                                ...
                                if (totalmmmarks1 > 0)
                                {
                                    ...
                                    ObtMarks1 = (double.Parse(percentle1.ToString("0")) + NB + SE + double.Parse(SAT.ToString("0")));
                                ...
                                if (totalmmmarks_2 > 0)
                                {
                                    ...
                                    ObtMarks_2 = (double.Parse(percentle_2.ToString("0")) + NB_2 + SE_2 + double.Parse(SAT_2.ToString("0")));
                        ...
                        Response.Write("<tr class='p-pad-3 p-tot-tit'><td style='text-align:left; width:23%; !important'>Total</td><td></td><td></td><td></td><td></td><td></td><td></td><td>" + Gtotal.ToString("0") + "</td><td></td>");
                        Response.Write("<td></td><td></td><td></td><td></td><td></td><td></td><td>" + Gtotal_2.ToString("0") + "</td><td></td><td>" + (Gtotal + Gtotal_2).ToString("0") + "</td><td></td></tr>");
                        Response.Write("<tr class='p-pad-3 p-tot-tit'><td style='text-align:left; width:23%; !important'>Percentage</td><td></td><td></td><td></td><td></td><td></td><td></td><td>" + ((Gtotal * 100) / (100 * dss.Tables[0].Rows.Count)).ToString("0.00") + "</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>" + ((Gtotal_2 * 100) / (100 * dss.Tables[0].Rows.Count)).ToString("0.00") + "</td><td></td><td>" + (((Gtotal + Gtotal_2) * 100) / (200 * dss.Tables[0].Rows.Count)).ToString("0.00") + "</td><td></td></tr>");
                        ...
                        Response.Write("<li>Note - In both Half Yearly and Annual Examination, marks of best Unit Test will be taken and converterd into 10 marks.</li>");
                        Response.Write("</ul>");
                        Response.Write("</div>");
