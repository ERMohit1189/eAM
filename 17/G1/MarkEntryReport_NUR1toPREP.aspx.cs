...
public partial class staff_MarkEntryReport_PGtoPREP : Page
{
    ...
    public void loadclass()
    {
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and GroupId='G1' Order by CIDOrder";
        ...
        else
        {
            ...
            sql +=  " and ctm.SessionName='" + Session["SessionName"].ToString() + "' and t1.GroupId='G1'";
            ...
            if (Convert.ToInt16(Session["count"].ToString()) > 0)
            {
                ...
                sql +=  " where GroupId='G1'  and cm.SessionName='" + Session["SessionName"].ToString() + "' and sctm.SessionName='" + Session["SessionName"] + "' and Ecode='" + Session["LoginName"].ToString() + "' Order by CIDOrder";
                oo.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
