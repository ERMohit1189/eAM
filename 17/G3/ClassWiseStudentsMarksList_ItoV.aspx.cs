...
public partial class admin_ClassWiseStudentsMarksList_ItoV : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
               Response.Redirect("Studentwisecumulative_ItoV.aspx?check=ClassWiseStudentsMarksList_ItoV");
            }
            loadclass();
            loadsection();
            loadgrid();
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        if (RadioButtonList1.SelectedIndex == 0)
        {
            ...
            Response.Write("window.open('ReportCardofItoV.aspx?print=1','_blank')");
            Response.Write("</script>");
        }
        else
        {
            Response.Write("<script>");
            Response.Write("window.open('ParticularStudentMarksItoV.aspx','_blank')");
            Response.Write("</script>");
        }
    }
