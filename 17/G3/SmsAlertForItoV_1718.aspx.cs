...
public partial class common_SmsAlertFroItoV_1718 : Page
{
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                sql +=  " where GroupId='G3' and EmpCode='" + Session["LoginName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and t2.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + "  and T2.SessionName='" + Session["SessionName"] + "' and IsClassTeacher=1 and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
                BAL.objBal.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
            }
        }
    }
    ...
    public void loadSubjects()
    {
        ...
        sql +=  " where sm.ClassId = '" + drpclass.SelectedValue.ToString() + "' and sgm.BranchCode=" + Session["BranchCode"] + " and spm.BranchCode=" + Session["BranchCode"] + " and sm.BranchCode=" + Session["BranchCode"] + " and sm.SectionName = '" + drpsection.SelectedItem.Text.ToString() + "'  and spm.SessionName='" + Session["SessionName"] + "'  and sgm.SessionName='" + Session["SessionName"] + "' and sm.SessionName = '" + Session["SessionName"].ToString() + "'";
    ...
    public void loadStudents()
    {
        ...
        sql +=  "   and SC.SessionName='" + Session["SessionName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and sf.BranchCode=" + Session["BranchCode"] + " and so.BranchCode=" + Session["BranchCode"] + " and sc.BranchCode=" + Session["BranchCode"] + " and sg.BranchCode=" + Session["BranchCode"] + "  and";
    ...
    public string GetMMarks(string Eval, string subjectid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_CCEItoVMMMarksForMessage", param);
    ...
    public string GetTestMarks(string Eval, string subjectid,string srno)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_CCEItoVMarksForMessage", param);
    ...
    {
        ScriptManager.RegisterClientScriptBlock(this.Page, GetType(), "", "createHTML();", true);
