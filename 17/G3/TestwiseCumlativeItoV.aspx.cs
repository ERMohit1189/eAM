...
public partial class TestwiseCumlativeItoV : Page
{
    ...
    protected void LoadTests()
    {
        ...
        else
        {
            ...
            drptest.Items.Insert(2, new ListItem("A. E.(Theory)", "AE"));
            drptest.Items.Insert(3, new ListItem("A. E.(Prac)", "Prac"));
        }
    }
    ...
    {
        string sql = "Select sm.id Paperid, SubjectId, papername SubjectName,'' marks from ttpaperMaster  sm";
    ...
    public string GetMMarks(string Eval, string subjectid, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMMMarksIToV_2021", param);
    ...
    public string GetTestMarks(string Eval, string subjectid, string srno, string paperid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMarksIToV_2021", param);
