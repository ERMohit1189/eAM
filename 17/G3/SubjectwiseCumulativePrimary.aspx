<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/17/comman_root_manager.master" CodeFile="SubjectwiseCumulativePrimary.aspx.cs" Inherits="_17_G3_SubjectwiseCumulativePrimary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadSubject() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlSubject_MarkEntry_3.aspx") %>',
        ...
        function LoadPaper() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlPaper_MarkEntry_3.aspx") %>',
        ...
        function LoadFillList() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/LoadMarksEntrySubjectwise.aspx") %>',
                data: {
                    'ClassName': ClassName,
        ...
        function SaveMarks() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/SaveMarksEntryPrimaryServer.aspx") %>',
                data: {
                    'ClassId': ClassIds,
                    'SectionName': SectionName,
                    'SubjectId': SubjectId,
