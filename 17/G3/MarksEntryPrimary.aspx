<%@ Page Title="" Language="C#" MasterPageFile="~/17/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryPrimary.aspx.cs" Inherits="MarksEntryPrimary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadFillList() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/MarksEntryPrimaryServer.aspx") %>',
                data: {
                    'ClassName': ClassName,
