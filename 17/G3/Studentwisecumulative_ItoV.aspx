<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Studentwisecumulative_ItoV.aspx.cs" Inherits="common_G3_Studentwisecumulative_ItoV" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#drpsection', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("Server/ddlSrNo_3.aspx") %>',
        ...
        function LoadClass() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlClass_3.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadSection(classId) {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlSection_3.aspx") %>',
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/Studentwisecumulative_ItoV_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
