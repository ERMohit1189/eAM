<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClasswiseAllSubjectMarksList_ItoV.aspx.cs" Inherits="staff_ClasswiseAllSubjectMarksList" %>
                        ...
                        <div class="col-sm-12 no-padding ">
                            <div style="float: right">
                                <asp:Panel ID="Panel1" runat="server">
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="#" OnClick="ImageButton1_Click"
                                                ...
                                                <%--<tr>
                                                    ...
                                                    <td>
                                                        <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" Width="1200px" Style="margin-left: 260px">
                                                            <ItemTemplate>
                                                                <table style="margin: 0px 0px 0px -4px;">
                                                                    <tr style="background-color: lightgrey;">
                                                                        <td colspan="2" align="center" style="font-size: 12px; background-color: lightgrey;">
                                                                    ...
                                                                    <tr>
                                                                        <th style="padding: 0px 10px; font-size: 12px; background-color: lightgrey;">Test1</th>
                                                                        <th style="padding: 0px 10px; font-size: 12px; background-color: lightgrey;">Test2</th>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <asp:Repeater ID="Repeater1" runat="server">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <td colspan="2" class="p-pad-n p-tot-tit ">
                                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("id") %>' Visible="false"></asp:Label>
                                                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("SubjectGroup") %>'></asp:Label>
                                                                            </td>
                                                                        </ItemTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <asp:Repeater ID="Repeater2" runat="server" OnItemCreated="Repeater2_ItemCreated">
                                                                        <ItemTemplate>
                                                                            <td class="p-pad-n p-tot-tit sub-m-w-45">Test1</td>
                                                                            <td class="p-pad-n p-tot-tit sub-m-w-45">Test2</td>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
                                                                </tr>
                                                                <tr>
                                                                    <td class="p-pad-0" id="colsp" runat="server">
                                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ShowHeader="false" OnRowCreated="GridView1_RowCreated" class="table mp-table lbn-rbn-table no-tb no-bm  p-table-bordered table-bordered">
                                                                            <Columns>
                                                                                <asp:TemplateField>
                                                                                    <ItemTemplate>
