<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="UpdatePurchaseOrder.aspx.cs" Inherits="UpdatePurchaseOrder" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12 no-padding">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="dovPO">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtPONo" runat="server" CssClass="form-control-blue validatetxt" MaxLength="20" AutoPostBack="true" OnTextChanged="txtPONo_TextChanged"></asp:TextBox>
                                            <asp:HiddenField runat="server" ID="hfPONo" />
                                ...
                                <div class="col-sm-12 no-padding" id="pnlcontrols" runat="server" visible="false">
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="#">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="ButtonRemove" Visible="false" runat="server" class="btn menu-icon vd_bd-red vd_red" OnClick="ButtonRemove_Click" Style="padding: 1px 5px;"><i class="fa fa-close" style="font-size: 14px;"></i></asp:LinkButton>
                                    ...
                                    <div class="col-sm-4 btn-a-devices-1-p4-p2   mgbt-xs-15">
                                        <asp:LinkButton ID="btnSubmit" runat="server" CssClass="button form-control-blue" OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn();" OnClick="btnSubmit_Click">Update</asp:LinkButton>
