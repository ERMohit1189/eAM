<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="DamageOrLost.aspx.cs" Inherits="_10.DamageOrLost" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                <div class="col-sm-12 no-padding" runat="server">
                                    <div class="col-sm-2  half-width-50 mgbt-xs-15" runat="server" id="divProType">
                                        <label class="control-label">Type &nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                            <asp:DropDownList ID="rdoType" CssClass="form-control-blue validatedrp" runat="server">
                                    ...
                                    <div class="col-sm-12 btn-a-devices-3-p6  mgbt-xs-15">
                                ...
                                <div class="col-sm-12  mgbt-xs-10" runat="server" id="divExport" visible="false">
                                    ...
                                    <div class="col-sm-12 " runat="server" id="pnlcontrols">
                                                            ...
                                                            <asp:Repeater ID="Repeater1" runat="server">
                                                                <HeaderTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <th class="vd_bg-blue-np vd_white-np">Type</th>
