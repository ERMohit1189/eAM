<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="IssueProduct.aspx.cs" Inherits="_10.IssueProduct" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12 no-padding" runat="server">
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15" runat="server" id="divProType">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="txtStaff" CssClass="form-control-blue validatetxtss" runat="server" onblur="javascript:return fillTextbox();" AutoPostBack="true" OnTextChanged="txtHeaderEmpId_TextChanged"  placeholder="Enter Emp. ID/ Username/ Name"></asp:TextBox>
                                    ...
                                    <div class="col-sm-2 half-width-50 mgbt-xs-15">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="txtIssueDate" CssClass="form-control-blue datepicker-normal validatetxt" Enabled="false" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-2  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Product &nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                            <asp:DropDownList ID="ddlProduct" CssClass="form-control-blue validatedrp" runat="server">
                                            </asp:DropDownList>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-2  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Qty. &nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                            <asp:TextBox ID="txtQty" CssClass="form-control-blue validatetxt"  onkeypress="return fnNumeric();" MaxLength="100" runat="server" AutoPostBack="true" OnTextChanged="txtQty_TextChanged"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="txtremark" CssClass="form-control-blue validatetxt" MaxLength="100" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 btn-a-devices-3-p6  mgbt-xs-15" style="padding-top:24px;">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div id="gdv" runat="server" class="text-center" style="width: 100%;">
                                                                            <asp:Label ID="heading" CssClass="hide" runat="server" Style="font-weight: 700; font-size: 14px;"></asp:Label><br />
                                                                            <asp:Label ID="lblRegister" CssClass="hide" runat="server" Style="font-weight: 700; font-size: 14px;"></asp:Label>
                                                                            <div class="col-sm-12 no-padding" runat="server" id="divlistshow">
                                        ...
                                        <tr class="hide">
                                            ...
                                            <td>
                                                <div class="input-group input-group-margin">
                                                    ...
                                                    <asp:Label ID="txtLblQty" runat="server" Visible="false" ></asp:Label>
