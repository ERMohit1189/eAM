<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="InvoiceEntry.aspx.cs" Inherits="InvoiceEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMainhead" runat="Server">
    <script type="text/javascript">
        ...
        function getPONosList() {
            $(function () {
                $("[id$=txtPONos]").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: '<%=ResolveUrl("~/Admin/webservices/VendorIDName.asmx/GetPoNo") %>',
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12 no-padding">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="mgtp-6">
                                            <asp:RadioButtonList ID="rblInvoiceType" runat="server" CssClass="vd_radio radio-success" RepeatLayout="Flow" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rblInvoiceType_SelectedIndexChanged">
                                                <asp:ListItem Text="Vendor Wise (Without P.O.)" Value="Without Po" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="P.O. Wise" Value="POWise"></asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="divPo"  visible="false">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtPONos" runat="server" AutoPostBack="true" OnTextChanged="txtPONos_TextChanged" CssClass="form-control-blue validatetxt" MaxLength="20"></asp:TextBox>
                                ...
                                <div class="col-sm-12 no-padding" id="pnlcontrols" runat="server" visible="false">
                                        ...
                                        <div class=" table-responsive  table-responsive2">
                                            <asp:GridView ID="gvBankBranchList" runat="server" AutoGenerateColumns="false" class="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="QTN. No." Visible="false">
                                                        <ItemTemplate>
                                            ...
                                            <asp:GridView ID="gvBankBranchList2" runat="server" AutoGenerateColumns="false" class="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="#" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Container.DataItemIndex+1 %>'></asp:Label>
                                                            <asp:Label ID="lblVendorId" Visible="false" runat="server" Text='<%# Bind("ids") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="40px" CssClass="vd_bg-blue vd_white" />
                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Registration No.">
                                                        <ItemTemplate>
                                                            <asp:Label ID="RegistrationNo" runat="server" Text='<%# Bind("RegistrationNo") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="220px" />
                                                    ...
                                                    <asp:TemplateField HeaderText="PAN">
                                                        <ItemTemplate>
                                                            <asp:Label ID="PAN" runat="server" Text='<%# Bind("PAN") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="100px" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Contact Person">
                                                        <ItemTemplate>
                                                            <asp:Label ID="ContactPerson" runat="server" Text='<%# Bind("ContactPerson") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="100px" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Mobile No.">
                                                        <ItemTemplate>
                                                            <asp:Label ID="PhoneNo" runat="server" Text='<%# Bind("MobileNO") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="220px" />
                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Emai">
                                                        <ItemTemplate>
                                                            <asp:Label ID="MailID" runat="server" Text='<%# Bind("MailID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="100px" />
                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:TemplateField>
                                    ...
                                    <div class="col-sm-12 no-padding">
                                     ...
                                     <div class="col-sm-12 no-padding">
                                         <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                            <label class="control-label">Invoice Date&nbsp;<span class="vd_red">*</span></label>
                                            <div class=" ">
                                         <asp:TextBox ID="txtInvoiceDate" runat="server" CssClass="datepicker-normal validatetxt"></asp:TextBox>
                                                </div>
                                             </div>
                                        <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive2 table-responsive">
                                            <asp:GridView ID="Gridview2" runat="server" ShowFooter="true" AutoGenerateColumns="false" class="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group text-center">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Tax (Max 40%)">
                                                        <ItemTemplate>
                                                            <asp:Label ID="TaxPercent" runat="server" Text='<%# Bind("TaxPercent") %>' onkeypress="return fnNumeric();"></asp:Label>%=
                                                    ...
                                                    <asp:TemplateField HeaderText="Next Due On">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtNextDueOn" runat="server" CssClass="datepicker-normal"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
