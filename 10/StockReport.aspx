<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="StockReport.aspx.cs" Inherits="StockReport" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top ">
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding" id="tblInsert" runat="server">
                                    ...
                                    <div class="col-sm-8 half-width-50  btn-a-devices-3-p6 mgbt-xs-15" style="padding-top:26px;">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div id="gdv" runat="server" class="text-center" style="width: 100%;">
                                                                            ...
                                                                            <asp:Label ID="lblRegister" runat="server" Style="font-weight: 700; font-size: 14px;">Stock Report</asp:Label>
                                                                            <div class=" table-responsive  table-responsive2">
                                                                                <asp:GridView ID="gvInvoice" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center ">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="ProductType" HeaderText="Product Type" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" />
                                                                                        <asp:BoundField DataField="Name" HeaderText="Name of Product" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" />
                                                                                        <asp:BoundField DataField="Quantity" HeaderText="Quantity" HeaderStyle-CssClass="vd_bg-blue vd_white text-center"/>
                                                                                    </Columns>
                                                                                </asp:GridView>
                                                                            </div>
                                                                        </div>
