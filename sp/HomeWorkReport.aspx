<%@ Page Title="Homework | eAM&#174;" Language="C#" MasterPageFile="~/sp/sp_root-manager.master" AutoEventWireup="true"
    CodeFile="HomeWorkReport.aspx.cs" Inherits="admin_uploadHomeWork" %>
                                         ...
                                         <asp:GridView ID="grdDocList" runat="server" AutoGenerateColumns="false" CssClass="table table-striped no-bm table-hover no-head-border table-bordered pro-table">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Download">
                                                    <ItemTemplate>
                                                        <asp:HyperLink runat="server" ID="hy" NavigateUrl='<%# Bind("PDFurl") %>' Text="Download PDF" class="btn menu-icon vd_bd-yellow vd_yellow" download="homework"> 
