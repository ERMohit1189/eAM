...
CodeFile="verify.aspx.cs" Inherits="sp_Circular" %>
                ...
                <ContentTemplate>
                     <div class="panel widget light-widget" style="margin:12px 12px;">
                        ...
                        <div class="container" style="margin-top:20px;">       
                            <div class="card-form" style="margin-bottom:20px; min-height:300px;">         
                                <div style="background-color:lightgreen; padding:20px; font-size:18px;line-height:24px;text-align:center;font-weight:700; border-radius:8px;">
                                    You have successfully submitted Part A of the registration process. Your Temporary Reference Number (TRN) is 118911801142TRN
                                </div>
                               <p style="font-size:15px; line-height:22px;padding:12px 0px;">Using this TRN, you can access the application from My Saved Applications and submit on GST Portal. Part B of the application form needs to be completed within 15 days, i.e., by 1/18/2025 12:00:00 AM using this TRN.</p>
                            </div>
                       </div>
                          <!-- **************footer****************-->
