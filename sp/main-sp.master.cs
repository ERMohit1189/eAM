...
public partial class Student_main_students : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Session["SrnoNew"] = Session["Srno"];
            }
            if (Session["Srno"] == null)
            {
                Session["Srno"] = Session["SrnoNew"];
            }
