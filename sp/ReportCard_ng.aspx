<%@ Page Title="" Language="C#" MasterPageFile="~/sp/sp_root-manager.master" AutoEventWireup="true" CodeFile="ReportCard_ng.aspx.cs" Inherits="ReportCard_ng" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 ">
                            <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                    <label class="control-label">Select Term&nbsp;<span class="vd_red">*</span></label>
                                    <div id="div_terms">
    ...
    <script>
        ...
        function LoadData() {
            ...
            if (TermId == "") { alert("select Exam Term"); return true; }
            else {
