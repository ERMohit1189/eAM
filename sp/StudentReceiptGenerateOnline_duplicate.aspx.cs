...
public partial class StudentReceiptGenerateOnline_duplicate : Page
{
    ...
    public void LaserPrint()
    {
        ...
        sql = sql + "  convert(nvarchar,fd.FeeDepositeDate,106) as FeeDepositeDate,asr.TypeOFAdmision,asr.card,";
        ...
        Session["CardType"] = oo.ReturnTag(sql, "Card").Trim();
