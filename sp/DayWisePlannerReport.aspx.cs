...
public partial class sp_DayWisePlannerReport : System.Web.UI.Page
{
    string sql = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            sql = "Select FromDate,toDate from SessionMaster where SessionName='"+Session["SessionName"].ToString()+ "' and BranchCode=" + Session["BranchCode"] + "";
