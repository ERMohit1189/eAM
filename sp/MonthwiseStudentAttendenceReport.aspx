<%@ Page Title="Attendance Report | eAM&#174;" Language="C#" MasterPageFile="~/sp/sp_root-manager.master" AutoEventWireup="true" CodeFile="MonthwiseStudentAttendenceReport.aspx.cs" Inherits="sp_MonthwiseStudentAttendenceReport" %>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Attendance">
                                                 ...
                                                 <asp:TemplateField HeaderText="InTime">
                                                     ...
                                                     <FooterTemplate>
                                                         <%--Total Absent:&nbsp;<asp:Label ID="lblTotalAb1" runat="server" Text=""></asp:Label>--%>
                                                     </FooterTemplate>
                                                     <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                     <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                     <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                 ...
                                                 <asp:TemplateField HeaderText="OutTime">
                                                     ...
                                                     <FooterTemplate>
                                                         <%--Total Absent:&nbsp;<asp:Label ID="lblTotalAb2" runat="server" Text=""></asp:Label>--%>
                                                     </FooterTemplate>
                                                     <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np" />
                                                     <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                     <FooterStyle HorizontalAlign="Center" VerticalAlign="Middle" />
