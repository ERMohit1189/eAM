...
CodeFile="GST-login.aspx.cs" Inherits="sp_Circular" %>
                                   ...
                                   <div class="container">
                                    ...
                                    <div class="form-gst container" style="margin-top:20px;">                       
                                           <div class="card-form">     
                                             ...
                                             <!---->
                                             <form role="form" name="loginform" autocomplete="off" novalidate="">
                                                   <div class="row">
                                                      <div class="col-xs-12">
                                                         <label for="username" class="m-cir reg" data-ng-bind="trans.LBL_USRNAME">Username</label>
                                                         <div class="has-feedback">
                                                            <input id="username" class="form-control pad-r-0" type="text" placeholder="Enter Username" name="user_name" maxlength="15" required="true" data-ng-change="validName();" autofocus="" autocomplete="off">
                                                          </div>
                                                         <!---->
                                                         <!---->
                                                      </div>
                                                   ...
                                                   <div class="row" style="padding-top:12px;">
                                                      <div class="col-xs-12">
                                                         <label for="user_pass" class="m-cir reg" data-ng-bind="trans.LBL_PWD">Password</label>
                                                         <div class="has-feedback">
                                                            <input id="user_pass" class="form-control" type="password" name="user_pass" maxlength="15" required="true" placeholder="Enter Password" autocomplete="off">
                                                          </div>
                                                         <!---->
                                                      </div>
                                                   </div>
                                                   ...
                                                   <div class="row" style="padding-top:12px;">
                                                      <div class="col-lg-12">
                                                         <a href="GST-home.aspx" type="submit" class="btn btn-blue" style="color:#FFF;">Login</a>
                                                      </div>
                                                   </div>
                                                   <div class="row" style="padding-top:12px;">
                                                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 namechange">
                                                         <a class="link" href="javascript:void(0);">Forgot Username</a>
                                                      </div>
                                                      <!---->
                                                      <div data-ng-if="!hidemenu" class="col-lg-6 col-md-6 col-sm-6 col-xs-6 namechange">
                                                   ...
                                                   <div class="row">
                                                      <div class="col-sm-12">
                                                         <p class="help-block"><i class="fa fa-info-circle"></i><strong> First time login:</strong> If you are logging in for the first time, click <a href="#"><u>here</u></a> to log in.</p>
                                                      </div>
                                                   </div>
                                                </form>
                                      </div>
