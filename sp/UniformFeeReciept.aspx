<%@ Page Title="" Language="C#" MasterPageFile="~/sp/sp_root-manager.master" AutoEventWireup="true" CodeFile="UniformFeeReciept.aspx.cs" Inherits="UniformFeeReciept" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6 no-padding text-right menu-action">
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn-print-box" PostBackUrl="~/sp/UniformFeeDeposit.aspx" Style="color: #CC0000"
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="Label252" runat="server" Text="INVOICE"  Font-Size="15"></asp:Label><br /><asp:Label ID="Label15" runat="server" Text="(ORIGINAL)"  Font-Size="15"></asp:Label></h3>
