<%@ Page Title="" Language="C#" MasterPageFile="~/sp/sp_root-manager.master" AutoEventWireup="true" CodeFile="UniformFeeDeposit.aspx.cs" Inherits="_2.UniformFeeDeposit" %>
        ...
        <ContentTemplate>
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding hide">
                                    ...
                                    <div class="col-sm-4  half-width-50  mgbt-xs-15">
                                        <asp:LinkButton ID="LinkButton2" runat="server" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();" OnClick="LinkButton2_Click" class="button form-control-blue" ValidationGroup="a"> View</asp:LinkButton>
                                ...
                                <div class="col-sm-12 " id="Tables" runat="server" visible="false">

                                    <div class="col-sm-12  no-padding">

                                        <div class="col-sm-4  half-width-50 mgbt-xs-15 hide" style="padding-left: 0;">
                                        ...
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15" id="divModeNo" runat="server" visible="false">
                                            <asp:Label ID="Label42" class="control-label" runat="server"></asp:Label>
                                            <div class="">
                                                <asp:TextBox ID="txtModeNo" runat="server" CssClass="form-control-blue" TabIndex="5"></asp:TextBox>
                                                <div class="text-box-msg">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15" id="divModeDate"  runat="server" visible="false" style="padding-left: 0;">
                                        ...
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15" id="divbankname" runat="server" visible="false">
                                        ...
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15" id="divStatus" runat="server" visible="false">
                                        ...
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15" id="divRemark" runat="server" visible="false">
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table no-bm  table-striped table-hover no-head-border table-bordered" ShowFooter="True">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Quantity">
                                                                <ItemTemplate>
                                                                    <asp:TextBox runat="server" ID="HeadQty" Text="0" OnTextChanged="HeadQty_TextChanged" AutoPostBack="true"   onkeypress="return isNumber(event)"></asp:TextBox>
                                                                    <%--<asp:Label ID="HeadQty" runat="server" Text='<%# Bind("Qty") %>'>0</asp:Label>--%>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                                                    Grand Total
                                                                </FooterTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Total">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="HeadTotal" runat="server" Text='<%# Bind("Total") %>'>0</asp:Label>
                                                                </ItemTemplate>
                                                                <FooterTemplate>
                                    ...
                                    <div class="col-sm-1 col-xs-1 no-padding"></div>
                                    <div class="col-sm-3 col-xs-3 no-padding" runat="server" id="divSubmit" >
                                        <table class="table no-bm  show-payble-box">
                                            <tr>
                                                <th style="text-align: left; width:70%;">Total Amount</th>
                                                <td>
                                                    <asp:Label ID="LblHeadTotalAmount" runat="server" style="padding-left: 5px;">0</asp:Label></td>
                                            </tr>
                                            <tr class="hide">
                                                <th style="text-align: left; width:70%;">Total Paid Amount</th>
                                                <td>
                                                    <asp:Label ID="LblPaidAmount" runat="server" style="padding-left: 5px;">0</asp:Label></td>
                                            </tr>
                                            <tr class="hide">
                                                <th style="text-align: left; width:70%;">Total Due Amount</th>
                                                <td>
                                                    <asp:Label ID="LblDueAmount" runat="server" style="padding-left: 5px;">0</asp:Label></td>
                                            </tr>
                                            <tr>
                                                <th style="text-align: left; width:70%;">Exemption</th>
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtDiscount" CssClass="underlined text-left input-border-btm vd_bd-red"  AutoPostBack="true" OnTextChanged="txtDiscount_TextChanged" Text="0" onkeypress="return isNumber(event)"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="text-align: left; width:70%;">Pay</th>
                                                <td>
                                                    <asp:TextBox runat="server" ID="TextPay" CssClass="underlined text-left input-border-btm vd_bd-red" Text="0" onkeypress="return isNumber(event)" AutoPostBack="true" OnTextChanged="TextPay_TextChanged" Enabled="false"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr id="tr_BalAmt" runat="server" visible="false">
                                                <th style="text-align: left; width:70%;">Balance Amount</th>
                                                <td><asp:Label runat="server" ID="lblNextDueAmt" style="padding-left: 5px;">0</asp:Label></td>
                                                </tr>
                                        </table>
                                        <div class="col-sm-12  no-padding text-center text-primary">
                                            <br />
                                            <asp:Button ID="btnSubmit" CssClass="button form-control-blue" runat="server" OnClick="btnSubmit_Click" Text="Submit" OnClientClick="payWithPaystack()" />
                                ...
                                <div class="col-sm-12 " id="Div1" runat="server" visible="false">
                                            ...
                                            <asp:GridView ID="GridView2" runat="server" class="table table-striped table-hover no-bm no-head-border table-bordered" AutoGenerateColumns="False">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Receipt No.">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="LinkButton6" runat="server"
                                                                Text='<%# Bind("Receipt_no") %>' OnClick="viewReceipt_Click"></asp:LinkButton>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Deposit Date">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_date" runat="server" Text='<%# Bind("DepositDate", "{0:dd MMM yyyy hh:mm tt}") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:TemplateField>
                                                    ...
                                                    <div class="table-responsive2 table-responsive">
                                                        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" class="table table-striped table-hover no-head-border table-bordered" ShowFooter="True">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Total">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_HeadTotal" runat="server" Text='<%# Bind("Total") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
            ...
            <div style="display: none; visibility: hidden">
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnPayStack" runat="server" OnClick="btnPayStack_Click" Text="PayStack"></asp:Button>
                    </ContentTemplate>
                    <Triggers>
            ...
            <script>
                function payWithPaystack() {
                    ...
                    if ($("[id*=DropDownMOD]").val() == 'Online') {
                        ...
                        var data_amount = (parseFloat($("[id*=TextPay]").val()) * 100);
                        
                        var data_full_name = $("[id*=Grd] tr:eq(1)").find("td:eq(1) span").html();
                        var data_name = data_full_name.split(" ");
                        var data_firstname = data_name[0];
                        var data_lastname = data_name[1];
                        var data_value = $("[id*=Grd] tr:eq(1)").find("td:eq(6) span").html();
