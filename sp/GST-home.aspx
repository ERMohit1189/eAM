...
CodeFile="GST-home.aspx.cs" Inherits="sp_Circular" %>
                ...
                <ContentTemplate>
                    ...
                    <!--***********registration SECTION start***************-->
                       <div id="landing">   
                              ...
                              <div class="main-header">
                                  <div class="skip">
                                      <div class="container">
                                          <div class="row">
                                                <div class="col-md-6">
                                                    <div class="text-left" style="padding-top:5px;font-size: 12px;">This Site is for Education Purpose only</div>
                                                </div>
                                                <div class="col-md-6">
                                          ...
                                          <div class="col-xs-12">
                                              <div class="d-flex justify-content-between flex-wrap">
                                                  ...
                                                  <ul class="list-inline mlinks">
                                                      <li><a href="/sp/GST.aspx" class="button">Register</a></li>
                                                      <li><a href="/sp/GST-login.aspx" class="button">Login</a></li>
                                                  </ul>
                                               </div>
                                          </div>
                                      </div>
                           ...
                           <!-- <div id="dimmer"></div> -->
                        <div class="form-gst container">
                           <div class="lbanner">
                              <div class="col-xs-12 lbanner-img-r1"></div>
                              <div class="land-alerts" data-ng-controller="landingCtrl">
                                 <i style="padding-left: 18px; margin-top: 7px;" class="fa fa-bell" aria-hidden="true"></i>
                                 <p class="marquee" data-ng-bind-html="alerts"></p>
                              </div>
                           </div>
                                 ...
                                 <div class="container">
                                       ...
                                       <div class="col-md-5 col-sm-5 col-xs-12">
                                          <div class="row panels">
                                             <div class="col-sm-12 col-xs-12">
                                                <h4>News | Updates | Events</h4>
                                                <div class="panel news">
                                                   <div class="panel-body" data-ng-controller="newsCtrl" data-ng-init="getAllNews()">
                                                      <!---->
                                                      <!---->
                                                      <div class="row" data-ng-if="newsList.length > 0" data-ng-repeat="item in newsList | limitTo : 3">
                                                         <div class="col-sm-12">
                                                            <p class="dt" data-ng-bind="item.date">05/12/2018</p>
                                                            <p>
                                                               <!---->
                                                               <!---->
                                                               <!---->
                                                               <a data-ng-if="item.IsExternal != 'Y' &amp;&amp; !item.linkURl" data-ng-href="#" title="We have updated our website policy. As per this Scrapping of GST Site is strictly prohibited. For details please visit &quot;Website Policy&quot; link." data-ng-bind="item.title" href="#">We have updated our website policy. As per this Scrapping of GST Site is strictly prohibited. For details please visit "Website Policy" link.</a><!---->
                                                            </p>
                                                         </div>
                                                      </div>
                                                      <!---->
                                                      ...
                                                      <div class="row" data-ng-if="newsList.length > 0" data-ng-repeat="item in newsList | limitTo : 3">
                                                         <div class="col-sm-12">
                                                            <p class="dt" data-ng-bind="item.date">03/12/2018</p>
                                                            <p>
                                                               <!---->
                                                               <!---->
                                                               <!---->
                                                               <a data-ng-if="item.IsExternal != 'Y' &amp;&amp; !item.linkURl" data-ng-href="#" title="EXAMINATION FOR CONFIRMATION OF ENROLLMENT OF GST PRACTITIONERS" data-ng-bind="item.title" href="#">EXAMINATION FOR CONFIRMATION OF ENROLLMENT OF GST PRACTITIONERS</a><!---->
                                                            </p>
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="row" data-ng-if="newsList.length > 0">
                                                         <div class="col-sm-12">
                                                            <p class="pull-right">
                                                               <a href="#">View all <i class="fa fa-angle-double-right"></i>
                                                               </a>
                                                            </p>
                                                         </div>
                                                      </div>
                                             ...
                                             <div class="col-xs-12">
                                                <div style="display:flex; gap:10px; align-items:center; justify-content:space-between;">
                                                     ...
                                                     <div style="padding-left:10px;">
                                                        <img src="../img/youtube.png" style="height:30px;" alt="Youtube">
                                                        GST on
                                                        <a data-popup="true" href="https://www.youtube.com/channel/UCFYpOk92qurlO5t-Z_y-bOQ">Youtube <i class="fa fa-external-link-square"></i></a>
                                                     </div>
                                                    </div>
                                                <div class="panel">
                                                   <div>
                                                            ...
                                                            <ul class="shrt-info">
                                                               <li style="display:flex; gap:10px; align-items:center;">
                                                                  <i class="fa fa-arrow-circle-right"></i>
                                                                     <a target="_blank" href="#" rel="noopener noreferrer">How do I file GST return? </a>
                                                               </li>
                                                               <li style="display:flex; gap:10px; align-items:center;">
                                                                     <i class="fa fa-arrow-circle-right"></i>
                                                                     <a target="_blank" href="#" rel="noopener noreferrer">How can I use the Returns Offline tool? </a>
                                                                 
                                                               </li>
                                                                <li style="display:flex; gap:10px; align-items:center;">
                                                                 
                                                                     <i class="fa fa-arrow-circle-right"></i>
                                                                     <a target="_blank" href="/help/refund" rel="noopener noreferrer">How do I apply for refund?
                                                                     </a>
                                                                ...
                                                                <li style="display:flex; gap:10px; align-items:center;">
                                                                     <i class="fa fa-arrow-circle-right"></i>
                                                                     <a target="_blank" href="/help/demandRecovery" rel="noopener noreferrer">How do I file intimation about voluntary payment?</a>
                                                                  </p>
                                                               </li>
                                                               <li style="display:flex; gap:10px; align-items:center;">
                                                                     <i class="fa fa-arrow-circle-right"></i>
                                                                     <a target="_blank" href="/help/appeal" rel="noopener noreferrer">How to file an appeal?</a>
                                                                  </li>
                                                                <li style="display:flex; gap:10px; align-items:center;">
                                                                     <i class="fa fa-arrow-circle-right"></i>
                                                                     <a target="_blank" href="#" rel="noopener noreferrer">How do I register with GST? </a>
                                                                  </li>
                                                            </ul>
                                    ...
                                    <div class="row">
                                       <div class="col-sm-5 col-xs-12">
                                          <div class="row panels">
                                             <div class="col-xs-12">
                                                <h4>Taxpayers (Normal)</h4>
                                                <div class="panel one">
                                                   <div class="panel-body">
                                                      <div class="row">
                                                         <div class="col-sm-6">                                                            
                                                             <i class="fa fa-lock icon"></i> <a href="/sp/GST.aspx">Register Now</a>                                                                  
                                                         </div>
                                                         <div class="col-sm-6">
                                                           <i class="fa fa-user icon"></i> Find a GST Practitioner                                                                
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="panel one">
                                                   <div class="panel-body">
                                                      <div class="row">
                                                         ...
                                                         <div class="col-sm-6">                                                            
                                                            <i class="fa fa-user icon"></i> Find a Taxpayer                                                                
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12 col-xs-12">
                                                   <ul class="dates-list impul">
                                                            ...
                                                            <div class="col-xs-12">
                                                               <div class="square-box b3">
                                                                  <div class="square-content">
                                                                     <span>GSTR-6(Jan, 2019)</span>
                                                                  </div>
                                                               </div>
                                                               <p class="impcont">Feb 13th, 2019</p>
                                                            </div>
                                                         </div>
                                                      </li>
                                                      <li>
                                                         <div class="row">
                                                            <div class="col-xs-12">
                                                               <div class="square-box b3">
                                                                  <div class="square-content">
                                                                     <span>GSTR-7(Oct, 2018)</span>
                                                                  </div>
                                                               </div>
                                                               <p class="impcont">Feb 28th, 2019</p>
                                                            </div>
                                                         </div>
                                                      </li>
                                                      <li>
                                                      ...
                                                      <li>
                                                         <div class="row">
                                                            <div class="col-xs-12">
                                                               <div class="square-box b1">
                                                                  <div class="square-content">
                                                                     <span>GSTR-8(Jan, 2019)</span>
                                                                  </div>
                                                               </div>
                                                               <p class="impcont">Feb 10th, 2019</p>
                                                            </div>
                                                         </div>
                                                      </li>
                                                      <li>
                                                         <div class="row">
                                                            <div class="col-xs-12">
                                                               <div class="square-box b1">
                                                                  <div class="square-content">
                                                                     <span>GSTR-9(2017-2018)</span>
                                                                  </div>
                                                               </div>
                                                               <p class="impcont">Jun 30th, 2019</p>
                                                            </div>
                                                         </div>
                                                      </li>
                                                      <li>
                                                      ...
                                                      <li style="width: 98.7% !important;">
                                                         <div class="row">
                                                            <div class="col-xs-12">
                                                               ...
                                                               <p style="margin-top: 11px; float: left; width: 80%; padding-left: 12px;">Eighteen months after end of the quarter for which refund is to be claimed</p>
                                                            </div>
                                                         </div>
                                                      </li>
                                                      <p class="text-center" style="font-size: 12px !important; margin-top: 10px;"><strong>Quarterly return for registered persons with aggregate turnover up to Rs. 1.50 Crores</strong></p>
                                                      <li style="width: 98.7%;">
                                                         <div class="row">
                                                            <div class="col-xs-12">
                                                               <div class="square-box b2" style="width: 50%;">
                                                                  <div class="square-content">
                                                                     <span>GSTR-1(Jan-Mar, 2019)</span>
                                                                  </div>
                                                               </div>
                                                               <p class="impcont" style="width: 20%;">Apr 30th, 2019</p>
                                                            </div>
                                                         </div>
                                                      </li>
                                                      <p class="text-center" style="font-size: 12px !important; margin-top: 10px;"><strong>Turnover exceeding Rs. 1.50 Crores or opted to file monthly Return</strong></p>
                                                      <li style="width: 98.7%;">
                                                         <div class="row">
                                                            <div class="col-xs-12">
                                                               <div class="square-box b3" style="width: 50%;">
                                                                  <div class="square-content">
                                                                     <span>GSTR-1(Jan, 2019)</span>
                                                                  </div>
                                                               </div>
                                                               <p class="impcont">Feb 11th, 2019</p>
                                                            </div>
                                                         </div>
                                                      </li>
                                                   </ul>
