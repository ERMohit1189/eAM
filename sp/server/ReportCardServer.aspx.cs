...
public partial class ReportCardServer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string srno = Session["Srno"].ToString().Trim();
        string TermId = Request.Form["TermId"].ToString().Trim();
        string TermName = Request.Form["TermName"].ToString().Trim();
        string AttendanceType = "1";
        string SessionName = Session["SessionName"].ToString().Trim();
        string BranchCode = Session["BranchCode"].ToString().Trim();
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        try
                        {
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                present = int.Parse(ds.Tables[3].Rows[0]["totaldays"].ToString() == "" ? "0" : ds.Tables[3].Rows[0]["totaldays"].ToString().Trim());
                                totaldays = int.Parse(ds.Tables[3].Rows[0]["attendence"].ToString() == "" ? "0" : ds.Tables[3].Rows[0]["attendence"].ToString().Trim());
