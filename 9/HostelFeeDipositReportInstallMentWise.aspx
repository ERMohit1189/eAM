<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true"
    CodeFile="HostelFeeDipositReportInstallMentWise.aspx.cs" Inherits="HostelFeeDipositReportInstallMentWise" EnableEventValidation="false" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-6 col-xs-6" style="padding-top: 25px;">
                                        <div class="col-sm-9 col-xs-5 half-width-50 mgbt-xs-15" id="divStudent" runat="server">
                                        ...
                                        <div class="col-sm-9 col-xs-5 half-width-50 mgbt-xs-15" id="divStaff" runat="server" visible="false">
                                                                ...
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="#">
                                                                     ...
                                                                     <asp:TemplateField HeaderText="S.R. No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" ID="lblSrNoOrEmpId" Text='<%# Bind("SrNoOrEmpId") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Mode">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" ID="lblModeO" Text='<%# Bind("PaymentMode") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="80px" CssClass="vd_bg-blue vd_white" />
                                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Total">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <asp:Label runat="server" ID="lll">Total </asp:Label>
                                                                        </FooterTemplate>
                                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="70px" CssClass="vd_bg-blue vd_white" />
                                                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Status" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" ID="lblsts" Text='<%# Bind("Status") %>'></asp:Label>
                                                                        </ItemTemplate>
