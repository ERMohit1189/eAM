<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="RoomTypeMaster.aspx.cs" Inherits="RoomTypeMaster" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtRoomType" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                            
                                            <div class="text-box-msg">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRoomType" ErrorMessage="Can't leave blank!"
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-9">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtRemark" runat="server" CssClass="textbox" Rows="1" TextMode="MultiLine"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                                    ...
                                    <tr>
                                        <td >Room Type</td>
                                        <td >
                                            <asp:TextBox ID="txtRoomType0" runat="server" CssClass="form-control-blue" SkinID="TxtBoxDef"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td>Remark </td>
                                        <td >
                                            <asp:TextBox ID="txtRemark0" runat="server" SkinID="txtmulti" CssClass="form-control-blue"  Rows="1"
