<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="HostelFeeRecieptInstallment.aspx.cs" Inherits="HostelFeeRecieptInstallment" %>
                     ...
                     <table class="print-table-text">
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="Label6" runat="server" Text="FEE RECEIPT"  Font-Size="15"></asp:Label><br /><asp:Label ID="Label16" runat="server" Text="(ORIGINAL)"  Font-Size="15"></asp:Label></h3>
                                    <h3 class="sub-adds-l text-center">
