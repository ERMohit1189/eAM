...
public partial class HostelFeeRecieptInstallment_duplicate : Page
{
    ...
    public void DisplayStudentCopy()
    {
        ...
        sql = sql + " where ofc.SrNoOrEmpid='" + srno + "' and ofc.ReceiptNo='" + Label1.Text + "' and ofc.BranchCode=" + Session["BranchCode"].ToString() + " ";
        ...
        sql = "Select sum(Paid) Paid, SUM(NextDue) balance  from HostelFeeDeposit where ReceiptNo='" + Label1.Text + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
    ...
    {
        sql = "select mm.MonthName AS HeadName, Amount, '' AS remark from  HostelFeeDeposit hfd inner join MonthMaster mm on mm.MonthId=hfd.InstallmentId and hfd.SessionName=mm.SessionName where ReceiptNo='" + Session["HostelReceiptNo"].ToString() + "' and mm.BranchCode=" + Session["BranchCode"].ToString() + " and hfd.BranchCode=" + Session["BranchCode"].ToString() + "";
