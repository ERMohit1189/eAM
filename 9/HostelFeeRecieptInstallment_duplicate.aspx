<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="HostelFeeRecieptInstallment_duplicate.aspx.cs" Inherits="HostelFeeRecieptInstallment_duplicate" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        ...
                        <div class="col-sm-6 no-padding text-right menu-action">
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="btn-print-box" PostBackUrl="~/9/HostelFeePayment.aspx" Style="color: #CC0000"
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="Label252" runat="server" Text="FEE RECEIPT"  Font-Size="15"></asp:Label><br /><asp:Label ID="Label15" runat="server" Text="(DUPLICATE)"  Font-Size="15"></asp:Label></h3>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" GridLines="None" CssClass="print-table-text" Font-Size="12px" >
                       <Columns>
                            ...
                            <asp:TemplateField HeaderText="Installment">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_ReceiptNo" runat="server" Text='<%# Bind("InstallmentName") %>' Font-Size="12px"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                    ...
                    <table class="print-table-text">
                        <tr>
                            ...
                            <th class="text-right" style="width: 80%;">
                                <asp:Label ID="lblTotalAmt" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>.00 <asp:Label ID="lblAmountinWords" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </th>
                        </tr>

                        <tr>
                            <th class="text-left" style="width: 20%;">
                                <asp:Label ID="Label19" runat="server" Text="Balance" Font-Size="12px"></asp:Label>
                            </th>

                            <th class="text-right" style="width: 80%;">
                                <asp:Label ID="lblBalanceAmt" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>.00 <asp:Label ID="lblBalanceAmtinWord" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                     ...
                     <table class="print-table-text">
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <div class="print-side-titel-box text-center">
                                    <h3 class="main-name-l text-center">
                                        <asp:Label ID="Label6" runat="server" Text="FEE RECEIPT"  Font-Size="15"></asp:Label><br /><asp:Label ID="Label16" runat="server" Text="(DUPLICATE)"  Font-Size="15"></asp:Label></h3>
                                    <h3 class="sub-adds-l text-center">
                ...
                <div class="col-sm-12 ">
                    <table class="print-table-text">
                        <tr>
                            ...
                            <th class="text-right" style="width: 80%;">
                                <asp:Label ID="lblTotalAmt0" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>.00 <asp:Label ID="lblAmountinWords0" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                            </th>
                        </tr>

                        <tr>
                            <th class="text-left"  style="width: 20%;">
                                <asp:Label ID="Label139" runat="server" Text="Balance" Font-Size="12px"></asp:Label>
                            </th>

                            <th class="text-right"  style="width: 80%;">
                                <asp:Label ID="lblBalanceAmt0" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>.00 <asp:Label ID="lblBalanceAmtinWord0" runat="server" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
