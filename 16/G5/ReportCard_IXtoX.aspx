<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_IXtoX.aspx.cs" Inherits="ReportCard_IXtoX" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                                                                        ...
                                                                        <table id="Term1Mark"  class="Term1Mark table term2 tbl mp-table p-table-bordered table-bordered text_center" style="margin-bottom: 3px">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm1">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle;' rowspan="2">SUBJECT</th>
                                                                                             <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test1</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test2</th>
                                                                                            <th style='vertical-align: middle;' colspan="3">H.Y.</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL</th>
                                                                                            <th style='vertical-align: middle;' rowspan="3">GRADE</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle;'>TH</th>
                                                                                            <th style='vertical-align: middle;'>ASSI</th>
                                                                                            <th style='vertical-align: middle;'>H.Y. TOTAL</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle;'>M.M.</th>
                                                                                            <th style='vertical-align: middle;'>50</th>
                                                                                            <th style='vertical-align: middle;display:none;'>25</th>
                                                                                            <th style='vertical-align: middle;display:none;'>25</th>
                                                                                            <th style='vertical-align: middle;'>70</th>
                                                                                            <th style='vertical-align: middle;'>30</th>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                             <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                                      ...
                                                                                                      <asp:Label runat="server" ID="Label2"><%# CalculateSum(Eval("HighestValue"), Eval("SecondHighestValue")) %></asp:Label>
                                                                                                </td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT1"><%# Eval("HighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT2"><%# Eval("SecondHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblHY"><%# Eval("HYTH") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblHYASSI"><%# Eval("HYASSI") %></asp:Label></td>
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal1"><%# Eval("Total1") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal"><%# Eval("HYGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm1Aditional">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle; text-align:center;' colspan="7">ADDITIONAL SUBJECT</th>
                                                                                        </tr>
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                             <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                              <td style="text-align: center">
                                                                                                      <asp:Label runat="server" ID="Label2"><%# Eval("HighestValue") %></asp:Label>
                                                                                                </td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT1"><%# Eval("HighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                 ...
                                                                                 <tr class="text_center">
                                                                                    <th class="text-left"><span><b>TOTAL</b></span></th>
                                                                                     <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblbetstIXUTI1"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Total_T1"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Total_T1"></asp:Label></b></td>
                                                                                     <td><asp:Label runat="server" ID="Label9"></asp:Label></b></td>
                                                                                     <td><asp:Label runat="server" ID="Label10"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYTotal_T1"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalHY_T1"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>PERCENTAGE</b></span></th>
                                                                                    <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label11"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Per_T1"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Per_T1"></asp:Label></b></td>
                                                                                   <td></td>
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYPer_T1"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalPerHY_T1"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                ...
                                                                                <tr class="text_center">
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYTrm1Rank_T1"></asp:Label></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <table id="Term2Mark" class="Term2Mark table term2 tbl mp-table p-table-bordered table-bordered text_center hide" style="margin-bottom: 3px">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL</th>
                                                                                             <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test3</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test4</th>
                                                                                            <th style='vertical-align: middle;' colspan="3">A.E.</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">G. TOTAL</th>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;'>TH</th>
                                                                                            <th style='vertical-align: middle;'>ASSI</th>
                                                                                            <th style='vertical-align: middle;'>A.E. Total</th>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            ...
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal"><%# Eval("HYGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                  <asp:Label runat="server" ID="Label3"><%# CalculateSum(Eval("ThirdHighestValue"), Eval("ThirdSecondHighestValue")) %></asp:Label>
                                                                                                </td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT3"><%# Eval("ThirdHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT4"><%# Eval("ThirdSecondHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblAE"><%# Eval("AETH") %></asp:Label></td>
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblAEASSI"><%# Eval("AEASSI") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal2"><%# Eval("Total2") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotalAE"><%# Eval("AEGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblGGtotal"><%# Eval("GGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblGGradeNew"></asp:Label></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2Aditional">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle; text-align: center;' colspan="15">ADDITIONAL SUBJECT</th>
                                                                                        </tr>
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                             <th style="text-align: center;"><%# Eval("HighestValue") %></th>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT1"><%# Eval("HighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT2"><%# Eval("SecondHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center" colspan="4">
                                                                                              ...
                                                                                              <th style="text-align: center" colspan="1"><%# Eval("ThirdHighestValue") %></th>
                                                                                ...
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>TOTAL</b></span></th>
                                                                                    <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label12"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none">
                                                                                        <asp:Label runat="server" ID="lblUT1Total_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none">
                                                                                        <asp:Label runat="server" ID="lblUT2Total_T2"></asp:Label></b></td>
                                                                                    <td><asp:Label runat="server" ID="Label16"></asp:Label></b></td>
                                                                                    <td>  <asp:Label runat="server" ID="Label17"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYTotal_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalHY_T2"></asp:Label></b></td>
                                                                                     <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label13"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none">
                                                                                        <asp:Label runat="server" ID="lblUT3Total_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none">
                                                                                        <asp:Label runat="server" ID="lblUT4Total_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label18"></asp:Label></b></td>
                                                                                    <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label19"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAETotal_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalAE_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGGTotal_T2"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>PERCENTAGE</b></span></th>
                                                                                     <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label14"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Per_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Per_T2"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYPer_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalPerHY_T2"></asp:Label></b></td>
                                                                                     <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label15"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none">
                                                                                        <asp:Label runat="server" ID="lblUT3Per_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none">
                                                                                        <asp:Label runat="server" ID="lblUT4Per_T2"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAEPer_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalPerAE_T2"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGGTotalPer_T2"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>DIVISION</b></span></th>
                                                                                ...
                                                                                <tr class="text_center">
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAETrm1Rank_T2"></asp:Label></td>
                                                                                    <td></td>
                                                                                     <td></td>
                                                                                    <td style="display:none"></td>
                                                                                    <td style="display:none"></td>
                                                                                   ...
                                                                                   <%-- <td></td>--%>
                                                                                     <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAETrm2Rank_T2"></asp:Label></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAEAllRank_T2"></asp:Label></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        
                                                                        <table id="Term1Mark_X"  class="Term1Mark_X table term2 tbl mp-table p-table-bordered table-bordered text_center" style="margin-bottom: 3px">
                                                                            <tbody>
                                                                                  <asp:Repeater runat="server" ID="rptMarkTerm1_X">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle;' rowspan="2">SUBJECT</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS</th>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            ...
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT1X"><%# Eval("HighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT2X"><%# Eval("SecondHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblHYX"><%# Eval("HYTH") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblHYASSIX"><%# Eval("HYASSI") %></asp:Label></td>
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal1X"><%# Eval("HYTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotalCX"><%# Eval("HYGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblGradeX"></asp:Label></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                    
                                                                                </asp:Repeater>
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm1_XAditional">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle; text-align:center;' colspan="7">ADDITIONAL SUBJECT</th>
                                                                                        </tr>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            ...
                                                                                            <td style="text-align: center;display:none">
                                                                                                <asp:Label runat="server" ID="lblUT2X"><%# Eval("SecondHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center" colspan="3">
                                                                                                <asp:Label runat="server" ID="lblHYX"><%# Eval("HY") %></asp:Label></td>
                                                                                            <td style="text-align: center"></td>
                                                                                 ...
                                                                                 <tr class="text_center">
                                                                                    <th class="text-left"><span><b>TOTAL</b></span></th>
                                                                                     <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="lblBestTotalT1X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Total_T1X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Total_T1X"></asp:Label></b></td>
                                                                                     <td> <asp:Label runat="server" ID="lblTerm1XTotalHYTH"></asp:Label></b></td>
                                                                                     <td><asp:Label runat="server" ID="lblTerm1XTotalHYASSI"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYTotal_T1X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalHY_T1X"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>PERCENTAGE</b></span></th>
                                                                                     <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="lblBestNewPer_T1X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Per_T1X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Per_T1X"></asp:Label></b></td>
                                                                                   <td></td>
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYPer_T1X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalPerHY_T1X"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>DIVISION</b></span></th>
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalDevHY_T1X"></asp:Label></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>RANK</b></span></th>
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYTrm1Rank_T1X"></asp:Label></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                              <%--  <asp:Repeater runat="server" ID="rptMarkTerm1_X">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle;' rowspan="2">SUBJECT</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">Test1</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">Test2</th>
                                                                                            <th style='vertical-align: middle;' colspan="3">H.Y.</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL</th>
                                                                                            <th style='vertical-align: middle;' rowspan="3">GRADE</th>
                                                                                        </tr>
                                                                                        ...
                                                                                        <tr class="text_center">
                                                                                            ...
                                                                                            <td style="text-align: center">
                                                                                             ...
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal1"><%# Eval("Total1") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal"><%# Eval("HYTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblGrade"></asp:Label></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm1_XAditional">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle; text-align:center;' colspan="8">ADDITIONAL SUBJECT</th>
                                                                                        </tr>
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                ...
                                                                                <tr class="text_center">
                                                                                 ...
                                                                                 <tr class="text_center">
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalDevHYX_T1X"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                 <tr class="text_center">
                                                                                    <th class="text-left"><span><b>RANK</b></span></th>
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYTrm1Rank_T1x"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>--%>
                                                                            </tbody>
                                                                        </table>
                                                                        <table id="Term2Mark_X" class="Term2Mark_X table term2 tbl mp-table p-table-bordered table-bordered text_center hide" style="margin-bottom: 3px">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2_X">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                             <th style='vertical-align: middle;' rowspan="2">SUBJECT</th>
                                                                                             <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS</th>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test3</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test4</th>
                                                                                            <th style='vertical-align: middle;' colspan="3">PRE BOARD</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">G. TOTAL</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">GRADE</th>
                                                                                        </tr>
                                                                                         <tr>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;'>TH</th>
                                                                                            <th style='vertical-align: middle;'>ASSI</th>
                                                                                            <th style='vertical-align: middle;'>PRE BOARD Total</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle;'>M.M.</th>
                                                                                             <th style='vertical-align: middle;'>50</th>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                           <tr class="text_center">
                                                                                            <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                                <td style="text-align: center">
                                                                                                       <asp:Label runat="server" ID="Label5"><%# CalculateSum(Eval("HighestValue"), Eval("SecondHighestValue")) %></asp:Label>
                                                                                                </td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="Label1"><%# Eval("HighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="Label2"><%# Eval("SecondHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label3"><%# Eval("HYTH") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label4"><%# Eval("HYASSI") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal1"><%# Eval("HYTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal"><%# Eval("HYGTotal") %></asp:Label></td>
                                                                                                 <td style="text-align: center">
                                                                                                  <asp:Label runat="server" ID="Label6"><%# CalculateSum(Eval("ThirdHighestValue"), Eval("ThirdSecondHighestValue")) %></asp:Label>
                                                                                                </td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT3"><%# Eval("ThirdHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                            ...
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal2"><%# Eval("Total2") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotalAE"><%# Eval("AETotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblGGtotal"><%# Eval("GGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2_XAditional">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle; text-align: center;' colspan="13">ADDITIONAL SUBJECT</th>
                                                                                        </tr>
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                            ...
                                                                                            <td style="text-align: center" colspan="3">
                                                                                                ...
                                                                                                <asp:Label runat="server" ID="Label7"><%# Eval("ThirdHighestValue") %></asp:Label></td>
                                                                                                 <td style="text-align: center" colspan="3">
                                                                                                <asp:Label runat="server" ID="Label8"><%# Eval("AE") %></asp:Label></td>
                                                                                            <td style="text-align: center"></td>
                                                                                               <td style="text-align: center"></td> 
                                                                                            <td></td>
                                                                                        </tr>
                                                                                   ...
                                                                                   <tr class="text_center">
                                                                                    <th class="text-left"><span><b>TOTAL</b></span></th>
                                                                                         <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="lblBestUT1Total_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Total_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Total_T2X"></asp:Label></b>
                                                                                    </td>
                                                                                    <td><asp:Label runat="server" ID="lblHYTH_T2X" Text="10"></asp:Label></b></td>
                                                                                    <td><asp:Label runat="server" ID="lblHYASS_T2X" Text="10"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYTotal_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalHY_T2X"></asp:Label></b></td>
                                                                                       <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="lblBestUT4Total_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT3Total_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT4Total_T2X"></asp:Label></b></td>
                                                                                    <td><asp:Label runat="server" ID="lblAETH_T2X"></asp:Label></b></td>
                                                                                    <td><asp:Label runat="server" ID="lblAEAS_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAETotal_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalAE_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGGTotal_T2X"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>PERCENTAGE</b></span></th>
                                                                                    <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="lblUT1Percentage"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Per_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Per_T2X"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblHYPer_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalPerHY_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="lblUT2Percentage"></asp:Label></b></td>
                                                                                    <td style="text-align: center ;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT3Per_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT4Per_T2X"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAEPer_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalPerAE_T2X"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGGTotalPer_T2X"></asp:Label></b></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                  <tr class="text_center">
                                                                                    <th class="text-left"><span><b>DIVISION</b></span></th>
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalDevHY_T2X"></asp:Label></td>
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td></td>
                                                                                    <td style="display:none;"></td>
                                                                                    ...
                                                                                    <td></td>
                                                                                     <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGTotalDevAE_T2X"></asp:Label></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblGGTotalDev_T2X"></asp:Label></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                                  ...
                                                                                  <tr class="text_center">
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAETrm1Rank_T2X"></asp:Label></td>
                                                                                     <td></td>
                                                                                    <td style="display:none;"></td>
                                                                                    <tdstyle="display:none;"></td>
                                                                                    <td></td>
                                                                                    ...
                                                                                    <td></td>
                                                                                     <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAETrm2Rank_T2X"></asp:Label></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAEAllRank_T2X"></asp:Label></td>
                                                                                    <td></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        ...
                                                                        <table class="table term2 tbl mp-table p-table-bordered table-bordered text-uppercase" style="margin-bottom: 2px;">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptAttendance1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="width: 25%;">Attendance</th>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptAttendance2">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="width:13%;">Attendance</th>
                                                                                            <td style="width:39%;" class="text-center"><%# Eval("t1Att") %></td>
                                                                         ...
                                                                         <table class="table term2 tbl mp-table p-table-bordered table-bordered text-uppercase" id="tblResult" visible="false" runat="server" style="margin-top: 3px; margin-bottom: 0px; width: 100%;">
                                                                            <tbody>
                                                                                <tr>
    ...
    <script>
        ...
        function showHide() {
            if ($("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpEval").val() == "Term1" && $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpclass option:selected").text() == "IX") {
                $(".Term1Mark").removeClass('hide');
                $(".Term2Mark").addClass('hide');
                $(".Term1Mark_X").addClass('hide');
                $(".Term2Mark_X").addClass('hide');
            }
            if ($("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpEval").val() == "Term2" && $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpclass option:selected").text() == "IX") {
                $(".Term1Mark").addClass('hide');
                $(".Term2Mark").removeClass('hide');
                $(".Term1Mark_X").addClass('hide');
                $(".Term2Mark_X").addClass('hide');
            }
            if ($("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpEval").val() == "Term1" && $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpclass option:selected").text() == "X") {
                $(".Term1Mark").addClass('hide');
                $(".Term2Mark").addClass('hide');
                $(".Term1Mark_X").removeClass('hide');
                $(".Term2Mark_X").addClass('hide');
            }
            if ($("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpEval").val() == "Term2" && $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_drpclass option:selected").text() == "X") {
                $(".Term1Mark").addClass('hide');
                $(".Term2Mark").addClass('hide');
                $(".Term1Mark_X").addClass('hide');
                $(".Term2Mark_X").removeClass('hide');
            }
        }
    </script>
</asp:Content>
