...
public partial class TestwiseCumlativeIXtoX : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            drptest.Items.Insert(1, new ListItem("UT1", "Test1"));
            drptest.Items.Insert(2, new ListItem("UT2", "Test2"));
            drptest.Items.Insert(3, new ListItem("UT3", "Test3"));
            drptest.Items.Insert(4, new ListItem("HYE", "HY"));
    ...
    protected void LoadTests()
    {
        ...
        {
            drptest.Items.Insert(0, new ListItem("<--Select-->", "0"));
            drptest.Items.Insert(1, new ListItem("UT4", "Test4"));
            drptest.Items.Insert(2, new ListItem("UT5", "Test5"));
            drptest.Items.Insert(3, new ListItem("UT6", "Test6"));
        ...
        {
            drptest.Items.Insert(0, new ListItem("<--Select-->", "0"));
            //drptest.Items.Insert(1, new ListItem("PRE BOARD 1", "Pre1"));
            //drptest.Items.Insert(2, new ListItem("PRE BOARD-2", "Pre2"));
            //drptest.Items.Insert(3, new ListItem("PRE BOARD-3", "Pre3"));
            drptest.Items.Insert(1, new ListItem("UT4", "Test4"));
            drptest.Items.Insert(2, new ListItem("UT5", "Test5"));
            drptest.Items.Insert(3, new ListItem("UT6", "Test6"));
            drptest.Items.Insert(4, new ListItem("AE", "AE"));
    ...
    public string GetMMarks(string subjectid, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEMIXtoX", param);
            if (ds != null)
            {
    ...
    public string GetTestMarks(string srno, string subjectid, string paperid, string IsAdditional)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEIXtoXNew", param);
    ...
    {
        BAL.objBal.ExportTolandscapeWord(Response, "ClassCumulativeIXtoX" + ".doc", divExport);
    }
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
        BAL.objBal.ExportDivToExcelWithFormatting(Response, "ClassCumulativeIXtoX", divExport, Server.MapPath("~/css/theme.min.css"));
    }
    protected void lnkPdf_Click(object sender, EventArgs e)
    {
        BAL.objBal.ExporttolandscapePdf(Response, "ClassCumulativeIXtoX", divExport);
    }
