...
public partial class SaveMarksEntryIXtoX_1920Server : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string IsAditional = Request.Form["IsAditional"].ToString().Trim();
            ...
            try
            {
                ...
                for (int j = 0; j < MarksFullArr1.Length - j; j++)
                {
                    ...
                    if (IsAditional == "0")
                    {
                        ...
                        if (MarksArr1[6].ToLower() != "" && MarksArr1[6].ToLower() != "np" && MarksArr1[6].ToLower() != "nad" && MarksArr1[6].ToLower() != "ml")
                        {
                ...
                if (error1 == false)
                {
                    ...
                    cmd.CommandText = "SetMaxMinMarksProc_IXtoX1920";
                    ...
                    if (ClassName == "IX")
                    {
                        if (IsAditional != "0")
                        {
                            ...
                            cmd.Parameters.AddWithValue("@MaxMarks7", MaxMarksArr[2]);
                            cmd.Parameters.AddWithValue("@MaxMarks5", MaxMarksArr[3]);
                            cmd.Parameters.AddWithValue("@MaxMarks6", MaxMarksArr[4]);
                        }
                        else
                        {
                            cmd.Parameters.AddWithValue("@MaxMarks1", MaxMarksArr[0]);
                            cmd.Parameters.AddWithValue("@MaxMarks2", MaxMarksArr[1]);
                            cmd.Parameters.AddWithValue("@MaxMarks4", MaxMarksArr[2]);
                            cmd.Parameters.AddWithValue("@MaxMarks5", MaxMarksArr[3]);
                            cmd.Parameters.AddWithValue("@MaxMarks6", MaxMarksArr[4]);
                            cmd.Parameters.AddWithValue("@MaxMarks7", MaxMarksArr[5]);
                        }
                    }
                    if (ClassName == "X" && TermName=="TERM1")
                    {
                        if (IsAditional != "0")
                        {
                            cmd.Parameters.AddWithValue("@MaxMarks1", MaxMarksArr[0]);
                    ...
                    if (ClassName == "X" && TermName == "TERM2")
                    {
                        if (IsAditional != "0")
                        {
                            cmd.Parameters.AddWithValue("@MaxMarks1", MaxMarksArr[0]);
                            cmd.Parameters.AddWithValue("@MaxMarks7", MaxMarksArr[1]);
                            cmd.Parameters.AddWithValue("@MaxMarks5", MaxMarksArr[2]);
                            cmd.Parameters.AddWithValue("@MaxMarks6", MaxMarksArr[3]);
                            cmd.Parameters.AddWithValue("@MaxMarks8", MaxMarksArr[4]);
                        }
                        else
                        {
                            cmd.Parameters.AddWithValue("@MaxMarks1", MaxMarksArr[0]);
                            cmd.Parameters.AddWithValue("@MaxMarks3", MaxMarksArr[1]);
                            cmd.Parameters.AddWithValue("@MaxMarks4", MaxMarksArr[2]);
                            cmd.Parameters.AddWithValue("@MaxMarks5", MaxMarksArr[3]);
                            cmd.Parameters.AddWithValue("@MaxMarks6", MaxMarksArr[4]);
                            cmd.Parameters.AddWithValue("@MaxMarks8", MaxMarksArr[5]);
                        }
                    }
                    ...
                    for (int i = 0; i < MarksFullArr.Length - 1; i++)
                    {
                        ...
                        cmd.CommandText = "USP_MarkEntry_CCEIXtoX_1920";
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        if (ClassName == "IX")
                        {
                            if (IsAditional != "0")
                            {
                                ...
                                cmd.Parameters.AddWithValue("@Prac", MarksArr[3]);
                                cmd.Parameters.AddWithValue("@Port", MarksArr[4]);
                                cmd.Parameters.AddWithValue("@SAT", MarksArr[5]);
                            }
                            else
                            {
                                cmd.Parameters.AddWithValue("@TEST1", MarksArr[1]);
                                cmd.Parameters.AddWithValue("@TEST2", MarksArr[2]);
                                cmd.Parameters.AddWithValue("@SE", MarksArr[3]);
                                cmd.Parameters.AddWithValue("@MA", MarksArr[4]);
                                cmd.Parameters.AddWithValue("@Port", MarksArr[5]);
                        ...
                        if (ClassName == "X" && TermName == "TERM2")
                        {
                            ...
                            {
                                cmd.Parameters.AddWithValue("@TEST1", MarksArr[1]);
                                cmd.Parameters.AddWithValue("@Prac", MarksArr[2]);
                                cmd.Parameters.AddWithValue("@Port", MarksArr[3]);
                                cmd.Parameters.AddWithValue("@SAT", MarksArr[4]);
                                cmd.Parameters.AddWithValue("@SAT2", MarksArr[5]);
                            }
                            else
                            {
                                cmd.Parameters.AddWithValue("@TEST1", MarksArr[1]);
                                cmd.Parameters.AddWithValue("@SE", MarksArr[2]);
                                cmd.Parameters.AddWithValue("@MA", MarksArr[3]);
                                cmd.Parameters.AddWithValue("@Port", MarksArr[4]);
                                cmd.Parameters.AddWithValue("@SAT", MarksArr[5]);
                                cmd.Parameters.AddWithValue("@SAT2", MarksArr[6]);
                            }
                        }
                        cmd.Parameters.AddWithValue("@SessionName", Session.ToString().Trim());
                        cmd.Parameters.AddWithValue("@BranchCode", BranchCode.Trim());
