...
public partial class common_G5_ReportCard_IXtoX_1718 : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                _sql = "Select ClassName,cm.Id as Id,CIDOrder from ClassMaster cm ";
                _sql = _sql + " inner join dt_ClassGroupMaster t1 on t1.ClassId=cm.Id and t1.SessionName=cm.SessionName and t1.BranchCode=cm.BranchCode";
                _sql = _sql + " where cm.SessionName='" + Session["SessionName"] + "' and t1.SessionName='" + Session["SessionName"] + "'  and t1.BranchCode=" + Session["BranchCode"] + " and GroupId='G5' Order by CIDOrder";
                _oo.FillDropDown_withValue(_sql, drpclass, "ClassName", "id");
            }
            else
            {
                _sql = "Select ClassName,cm.Id,CIDOrder from ClassTeacherMaster ctm";
                ...
                _sql = _sql + " where EmpCode='" + Session["LoginName"].ToString() + "' ";
                _sql = _sql + " and ctm.SessionName='" + Session["SessionName"].ToString() + "' and ctm.BranchCode = " + Session["BranchCode"] + " ";
                _sql = _sql + " and cm.id in(select ClassId from dt_ClassGroupMaster where GroupId='G5' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + ")";
    ...
    public void LoadReportCard()
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            {
                cmd.Connection = conn;
                cmd.CommandText = "ReportCard_IXtoX_2021";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        cmd.Parameters.AddWithValue("@BranchCode", Session["BranchCode"]);
                        cmd.Parameters.AddWithValue("@status", drpStatus.SelectedValue);
                        cmd.Parameters.AddWithValue("@isManual", (Session["Logintype"].ToString() == "Guardian"?"1":drpAttendance.SelectedValue));
                        ...
                        try
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                if (drpEval.SelectedValue.ToUpper() == "TERM1")
                                {
                                    ...
                                    {
                                        double MaxMarks1 = 0; double MaxMarks2 = 0; double Test1 = 0; double Test2 = 0; double SE = 0; double MA = 0; double Port = 0; double SAT = 0;
                                        ...
                                        if (ds.Tables[0].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[0].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[0].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[0].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "" || ds.Tables[0].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[0].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[0].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { MA = double.Parse(ds.Tables[0].Rows[m]["MA_1"].ToString().Trim()); }
                                        if (ds.Tables[0].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[0].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[0].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[0].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "" || ds.Tables[0].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[0].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[0].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { Port = double.Parse(ds.Tables[0].Rows[m]["Port_1"].ToString().Trim()); }
                                        ...
                                        double conv1 = (MaxMarks1 > 0 ? ((Test1 * 20) / MaxMarks1) : 0);
                                        double conv2 = (MaxMarks2 > 0 ? ((Test2 * 20) / MaxMarks2) : 0);
                                        totalmarks1 = (conv1 > conv2 ? conv1 : conv2);
                                        IA1 = ((double.Parse(totalmarks1.ToString("0")) * 5)/ 20) + double.Parse(SE.ToString("0")) + double.Parse(MA.ToString("0"))  + double.Parse(Port.ToString("0"));

                                        double ObtMarks1 = (double.Parse(IA1.ToString("0")) + double.Parse(SAT.ToString("0")));
                                        ...
                                        lblTheory.Text = (SAT == 0 ? "NP" : SAT.ToString("0"));
                                        ...
                                        hi = hi + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0)+isnull(TRY_CONVERT(decimal(10,0),MA),0) +isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))highestMarks, m.SrNo ";
                                        hi = hi + " from CCEixtox_1718 m   ";
                                        hi = hi + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                        hi = hi + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "'  ";
                                        hi = hi + " and SubjectId=" + ds.Tables[0].Rows[m]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                        hi = hi + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                        hi = hi + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                        hi = hi + ")T1";
                                        double highestMarks = double.Parse((_oo.ReturnTag(hi, "highestMarks").ToString() == "" ? "0" : _oo.ReturnTag(hi, "highestMarks")));
                                        string avg = "select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0)+isnull(TRY_CONVERT(decimal(10,0),MA),0) +isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))avgMarks ";
                                        avg = avg + " from CCEixtox_1718 m   ";
                                        avg = avg + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                        avg = avg + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "'  ";
                                        avg = avg + " and SubjectId=" + ds.Tables[0].Rows[m]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                        avg = avg + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                    ...
                                    {
                                        double MaxMarks1 = 0; double MaxMarks2 = 0; double Test1 = 0; double Test2 = 0; double SE = 0; double MA = 0; double Port = 0; double Prac = 0; double SAT = 0;
                                        ...
                                        if (ds.Tables[1].Rows[m]["SE_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[m]["SE_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[m]["SE_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[m]["SE_1"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[m]["SE_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[m]["SE_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[m]["SE_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { SE = double.Parse(ds.Tables[1].Rows[m]["SE_1"].ToString().Trim()); }
                                        if (ds.Tables[1].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[m]["MA_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { MA = double.Parse(ds.Tables[1].Rows[m]["MA_1"].ToString().Trim()); }
                                        if (ds.Tables[1].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[m]["Port_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { Port = double.Parse(ds.Tables[1].Rows[m]["Port_1"].ToString().Trim()); }
                                        ...
                                        IA1 = ((double.Parse(totalmarks1.ToString("0")) * 5) / 20) + double.Parse(SE.ToString("0")) + double.Parse(MA.ToString("0")) + double.Parse(Port.ToString("0")) + double.Parse(Prac.ToString("0"));
                                        ...
                                        Label lblTheory = (Label)rptmarksT1Additional.Items[m].FindControl("lblTheory");
                                        ...
                                        lblIA.Text = (IA1 == 0 ? "NP" : IA1.ToString("0"));
                                        lblTheory.Text = (SAT == 0 ? "NP" : (SAT == 0 ? ds.Tables[1].Rows[m]["SAT_1"].ToString() : SAT.ToString("0")));
                                        lblTotal.Text = ObtMarks1.ToString("0");
                                        string grade1 = grade(double.Parse(ObtMarks1.ToString("0")));
                                        lblGrade.Text = grade1;

                                        string hi = "select isnull(TRY_CONVERT(decimal(10,0),max(t1.highestMarks)),0) highestMarks from ( ";
                                        hi = hi + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),Prac),0) +isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))highestMarks, m.SrNo ";
                                        hi = hi + " from CCEixtox_1718 m   ";
                                        hi = hi + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                        hi = hi + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "'  ";
                                        hi = hi + " and SubjectId=" + ds.Tables[1].Rows[m]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                        hi = hi + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                        hi = hi + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                        hi = hi + ")T1";
                                        double highestMarks = double.Parse((_oo.ReturnTag(hi, "highestMarks").ToString() == "" ? "0" : _oo.ReturnTag(hi, "highestMarks")));
                                        string avg = "select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),Prac),0) +isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))avgMarks ";
                                        avg = avg + " from CCEixtox_1718 m   ";
                                        avg = avg + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                        avg = avg + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "'  ";
                                        avg = avg + " and SubjectId=" + ds.Tables[1].Rows[m]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                        avg = avg + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                        avg = avg + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '') ";
                                        double avgMarks = double.Parse((_oo.ReturnTag(avg, "avgMarks").ToString() == "" ? "0" : _oo.ReturnTag(avg, "avgMarks")));
                                    ...
                                    lblHTotal.Text = totalM1.ToString("0").Trim() + "/" + totalMM1.ToString("0").Trim();
                                    lblHPercentage.Text = ((double.Parse(totalM1.ToString("0")) * 100) / totalMM1).ToString("0.00") + " %";
                                ...
                                if (drpEval.SelectedValue.ToUpper() == "TERM2")
                                {
                                    ...
                                    for (int p = 0; p < ds.Tables[0].Rows.Count; p++)
                                    {
                                        ...
                                        if (ds.Tables[0].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[0].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[0].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[0].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "" || ds.Tables[0].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[0].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[0].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { MA = double.Parse(ds.Tables[0].Rows[p]["MA_1"].ToString().Trim()); }
                                        if (ds.Tables[0].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[0].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[0].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[0].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "" || ds.Tables[0].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[0].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[0].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { Port = double.Parse(ds.Tables[0].Rows[p]["Port_1"].ToString().Trim()); }
                                        ...
                                        double MaxMarks1_2 = 0; double Test1_2 = 0; double Test2_2 = 0; double SE_2 = 0; double MA_2 = 0; double Port_2 = 0; double SAT_2 = 0; double SAT2_2=0;
                                        ...
                                        else { MA_2 = double.Parse(ds.Tables[0].Rows[p]["MA_2"].ToString().Trim()); }
                                        if (ds.Tables[0].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "NP" || ds.Tables[0].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[0].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "ML" || ds.Tables[0].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "" || ds.Tables[0].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "AB" || ds.Tables[0].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "NA" || ds.Tables[0].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { Port_2 = double.Parse(ds.Tables[0].Rows[p]["Port_2"].ToString().Trim()); }
                                        ...
                                        if (ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "NP" || ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "ML" || ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "" || ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "AB" || ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "NA" || ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { SAT2_2 = double.Parse(ds.Tables[0].Rows[p]["SAT2_2"].ToString().Trim()); }

                                        double totalmarks2 = 0; double bestSAT = 0; double IA2 = 0; double ObtMarks2 = 0;
                                        if (drpclass.SelectedItem.Text == "X")
                                        {
                                            totalmarks2 = (MaxMarks1_2>0? (Test1_2*5)/ MaxMarks1_2:0);
                                            IA2 = (double.Parse(totalmarks2.ToString("0")) + double.Parse(SE_2.ToString("0")) + double.Parse(MA_2.ToString("0")) + double.Parse(Port_2.ToString("0")));
                                            bestSAT = (SAT_2 > SAT2_2 ? SAT_2 : SAT2_2);
                                            ObtMarks2 = (double.Parse(IA2.ToString("0")) + double.Parse(bestSAT.ToString("0")));
                                        }
                                        if (drpclass.SelectedItem.Text == "IX")
                                        {
                                            totalmarks2 = Test1_2 > Test2_2 ? Test1_2 : Test2_2;
                                            bestSAT = SAT_2;
                                            IA2 = ((double.Parse(totalmarks2.ToString("0")) * 5) / 20) + double.Parse(SE_2.ToString("0")) + double.Parse(MA_2.ToString("0")) + double.Parse(Port_2.ToString("0"));
                                            ObtMarks2 = (double.Parse(IA2.ToString("0")) + double.Parse(SAT_2.ToString("0")));
                                        }
                                        totalM2 = totalM2 + ObtMarks2;
                                        totalMM2 = totalMM2 + 100;
                                        string grade2 = grade(double.Parse(ObtMarks2.ToString("0"))); 
                                        string totalGrade = grade(double.Parse((ObtMarks2 == 0 ? ObtMarks1 : (ObtMarks1 + ObtMarks2) / 2).ToString("0")));
                                        ...
                                        lblIA1.Text = (IA1 == 0 ? "NP" : IA1.ToString("0"));
                                        lblTheory1.Text = (SAT == 0 ? "NP" : SAT.ToString("0"));
                                        lblTotal1.Text = ObtMarks1.ToString("0");
                                        lblGrade1.Text = grade1;
                                        lblIA2.Text = (IA2 == 0 ? "NP" : IA2.ToString("0"));
                                        lblTheory2.Text = (bestSAT == 0 ? "NP" : bestSAT.ToString("0"));
                                        lblTotal2.Text = ObtMarks2.ToString("0");
                                        lblGrade2.Text = grade2;
                                        lblGrandTotal.Text = (ObtMarks1 + ObtMarks2).ToString("0");
                                        lblGrandTotal2.Text = (ObtMarks2 == 0 ? ObtMarks1 : (ObtMarks1 + ObtMarks2) / 2).ToString("0");
                                        lblGrandGrade2.Text = totalGrade;

                                        if (drpclass.SelectedItem.Text.ToUpper() == "IX")
                                        {
                                            string hi = "select max(highestMarks)highestMarks from (select sum(isnull(TRY_CONVERT(decimal(10,0),t1.highestMarks),0)) highestMarks,t1.srno from ( ";
                                            hi = hi + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0) +isnull(TRY_CONVERT(decimal(10,0),MA),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))highestMarks, m.SrNo ";
                                            hi = hi + " from CCEixtox_1718 m   ";
                                            hi = hi + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            hi = hi + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' ";
                                            hi = hi + " and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                            hi = hi + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                            hi = hi + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                            hi = hi + " union all";
                                            hi = hi + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0) +isnull(TRY_CONVERT(decimal(10,0),MA),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))highestMarks, m.SrNo ";
                                            ...
                                            hi = hi + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "'  ";
                                            hi = hi + " and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                            hi = hi + "  and Eval='Term2' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                            hi = hi + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                            hi = hi + ")T1 group by t1.srno)T2";

                                            double highestMarks = double.Parse((_oo.ReturnTag(hi, "highestMarks").ToString() == "" ? "0" : _oo.ReturnTag(hi, "highestMarks")));
                                            string avg = "select sum(isnull(TRY_CONVERT(decimal(10,0),t1.avgMarks),0)) avgMarks from ( ";
                                            avg = avg + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0) +isnull(TRY_CONVERT(decimal(10,0),MA),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))avgMarks, m.SrNo ";
                                            avg = avg + " from CCEixtox_1718 m   ";
                                            avg = avg + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            avg = avg + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' ";
                                            avg = avg + " and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                            avg = avg + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                            avg = avg + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                            avg = avg + " union all";
                                            avg = avg + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0) +isnull(TRY_CONVERT(decimal(10,0),MA),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))avgMarks, m.SrNo ";
                                            avg = avg + " from CCEixtox_1718 m   ";
                                            avg = avg + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            avg = avg + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "'  ";
                                            avg = avg + " and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                            avg = avg + "  and Eval='Term2' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                            avg = avg + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                            avg = avg + ")T1 ";
                                        ...
                                        {
                                            string hi = "select max(highestMarks)highestMarks from (select sum(isnull(TRY_CONVERT(decimal(10,0),t1.highestMarks),0)) highestMarks,t1.srno from ( ";
                                            hi = hi + " select sum(distinct case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0) +isnull(TRY_CONVERT(decimal(10,0),MA),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +(case when isnull(TRY_CONVERT(decimal(10,0),SAT),0)>isnull(TRY_CONVERT(decimal(10,0),SAT2),0) then isnull(TRY_CONVERT(decimal(10,0),SAT),0) else isnull(TRY_CONVERT(decimal(10,0),SAT2),0) end  )))highestMarks, m.SrNo ";
                                            hi = hi + " from CCEixtox_1718 m   ";
                                            hi = hi + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            hi = hi + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' ";
                                            hi = hi + " and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                            ...
                                            string avg = "select sum(isnull(TRY_CONVERT(decimal(10,0),t1.highestMarks),0)) avgMarks from ( ";
                                            avg = avg + " select sum(distinct case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end+ (isnull(TRY_CONVERT(decimal(10,0),SE),0) +isnull(TRY_CONVERT(decimal(10,0),MA),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +(case when isnull(TRY_CONVERT(decimal(10,0),SAT),0)>isnull(TRY_CONVERT(decimal(10,0),SAT2),0) then isnull(TRY_CONVERT(decimal(10,0),SAT),0) else isnull(TRY_CONVERT(decimal(10,0),SAT2),0) end  )))highestMarks, m.SrNo ";
                                            avg = avg + " from CCEixtox_1718 m   ";
                                            avg = avg + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            avg = avg + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' ";
                                            avg = avg + " and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                    ...
                                    {
                                        double MaxMarks1 = 0; double MaxMarks2 = 0; double Test1 = 0; double Test2 = 0; double SE = 0; double MA = 0; double Prac = 0; double Port = 0; double SAT = 0;
                                        ...
                                        if (ds.Tables[1].Rows[p]["SE_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[p]["SE_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[p]["SE_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[p]["SE_1"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[p]["SE_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[p]["SE_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[p]["SE_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { SE = double.Parse(ds.Tables[1].Rows[p]["SE_1"].ToString().Trim()); }
                                        if (ds.Tables[1].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[p]["MA_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { MA = double.Parse(ds.Tables[1].Rows[p]["MA_1"].ToString().Trim()); }
                                        if (ds.Tables[1].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[p]["Port_1"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { Port = double.Parse(ds.Tables[1].Rows[p]["Port_1"].ToString().Trim()); }
                                        ...
                                        if (drpclass.SelectedItem.Text == "X")
                                        {
                                            ...
                                            double conv2 = (MaxMarks2 > 0 ? ((Test2 * 20) / MaxMarks2) : 0);
                                            totalmarks1 = (conv1 > conv2 ? conv1 : conv2);
                                            IA1 = (double.Parse(((totalmarks1 * 5) / 20).ToString("0"))+ double.Parse(Port.ToString("0")) + double.Parse(Prac.ToString("0")));
                                        }
                                        if (drpclass.SelectedItem.Text == "IX")
                                        {
                                        ...
                                        double MaxMarks1_2 = 0;
                                        double Test1_2 = 0; double Test2_2 = 0; double Port_2 = 0; double Prac_2 = 0; double SAT_2 = 0; double SAT2_2 = 0;
                                        ...
                                        if (ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { SAT2_2 = double.Parse(ds.Tables[1].Rows[p]["SAT2_2"].ToString().Trim()); }
                                        ...
                                        if (ds.Tables[1].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "NP" || ds.Tables[1].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "NAD" || ds.Tables[1].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "ML" || ds.Tables[1].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "" || ds.Tables[1].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "AB" || ds.Tables[1].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "NA" || ds.Tables[1].Rows[p]["Port_2"].ToString().Trim().ToUpper() == "M.L") { }
                                        else { Port_2 = double.Parse(ds.Tables[1].Rows[p]["Port_2"].ToString().Trim()); }

                                        double totalmarks2 = 0; double bestSAT = 0; double IA2 = 0; double ObtMarks2 = 0;
                                        if (drpclass.SelectedItem.Text == "X")
                                        {
                                            totalmarks2 = (MaxMarks1_2 > 0 ? ((Test1_2 * 20) / MaxMarks1_2) : 0);
                                            IA2 = (double.Parse(((totalmarks2 * 5) / 20).ToString("0")) + double.Parse(Port_2.ToString("0")) + double.Parse(Prac_2.ToString("0")));
                                            bestSAT = (SAT_2 > SAT2_2 ? SAT_2 : SAT2_2);
                                            ObtMarks2 = (double.Parse(IA2.ToString("0")) + double.Parse(bestSAT.ToString("0")));
                                        }
                                        if (drpclass.SelectedItem.Text == "IX")
                                        ...
                                        string grade2 = grade(double.Parse(ObtMarks2.ToString("0")));
                                        string totalGrade = grade(double.Parse((ObtMarks2 == 0 ? ObtMarks1 : (ObtMarks1 + ObtMarks2) / 2).ToString("0")));
                                        Label lblIA1 = (Label)rptmarksT2Additional.Items[p].FindControl("lblIA1");
                                        Label lblTheory1 = (Label)rptmarksT2Additional.Items[p].FindControl("lblTheory1");
                                        Label lblTotal1 = (Label)rptmarksT2Additional.Items[p].FindControl("lblTotal1");
                                        Label lblGrade1 = (Label)rptmarksT2Additional.Items[p].FindControl("lblGrade1");
                                        Label lblIA2 = (Label)rptmarksT2Additional.Items[p].FindControl("lblIA2");
                                        Label lblTheory2 = (Label)rptmarksT2Additional.Items[p].FindControl("lblTheory2");
                                        ...
                                        Label lblGrandTotal2 = (Label)rptmarksT2Additional.Items[p].FindControl("lblGrandTotal2");
                                        Label lblGrandGrade2 = (Label)rptmarksT2Additional.Items[p].FindControl("lblGrandGrade2");
                                        lblIA1.Text = (IA1 == 0 ? "NP" : IA1.ToString("0"));
                                        lblTheory1.Text = (SAT == 0 ? "NP" : SAT.ToString("0"));
                                        lblTotal1.Text = ObtMarks1.ToString("0");
                                        lblGrade1.Text = grade1;
                                        ...
                                        if (drpclass.SelectedItem.Text.ToUpper() == "IX")
                                        {
                                            ...
                                            hi = hi + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            hi = hi + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' ";
                                            hi = hi + " and SubjectId=" + ds.Tables[1].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                            hi = hi + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                            hi = hi + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                            hi = hi + " union all";
                                            hi = hi + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),Prac),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))highestMarks, m.SrNo ";
                                            ...
                                            double highestMarks = double.Parse((_oo.ReturnTag(hi, "highestMarks").ToString() == "" ? "0" : _oo.ReturnTag(hi, "highestMarks")));
                                            string avg = "select sum(isnull(TRY_CONVERT(decimal(10,0),t1.avgMarks),0)) avgMarks from ( ";
                                            avg = avg + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),Prac),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))avgMarks, m.SrNo ";
                                            avg = avg + " from CCEixtox_1718 m   ";
                                            avg = avg + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            avg = avg + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' ";
                                            avg = avg + " and SubjectId=" + ds.Tables[1].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                            avg = avg + "  and Eval='Term1' and SrNo in (select SrNo from AllStudentRecord_UDF('" + Session["SessionName"] + "'," + Session["BranchCode"] + ") stu  where stu.sessionName='" + Session["SessionName"] + "' and isnull(stu.Promotion, '')<>'Cancelled' ";
                                            avg = avg + " and stu.ClassId=" + drpclass.SelectedValue + " and stu.SectionName='" + drpsection.SelectedItem.Text + "'  and isnull(Withdrwal,'') = ''  and isnull(blocked,'') = '')  group by SrNo ";
                                            avg = avg + " union all";
                                            avg = avg + " select sum(distinct case when (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end)>  (case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) else 0 end) then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else (isnull(TRY_CONVERT(decimal(10,0),Test2),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks2),0) end+ (isnull(TRY_CONVERT(decimal(10,0),Prac),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +isnull(TRY_CONVERT(decimal(10,0),SAT),0)))avgMarks, m.SrNo ";
                                            ...
                                            dts.Rows.Add(sname, (highestMarks/2).ToString("0"), totalObt.ToString("0"), (avgMarks2 / optCount));
                                            totalForPer = totalForPer + double.Parse((ObtMarks2 == 0 ? ObtMarks1 : (ObtMarks1 + ObtMarks2) / 2).ToString("0"));
                                        }
                                        else
                                        {
                                            string hi = "select max(highestMarks)highestMarks from (select sum(isnull(TRY_CONVERT(decimal(10,0),t1.highestMarks),0)) highestMarks,t1.srno from ( ";
                                            hi = hi + " select sum(distinct case when isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),Test1),0)*5)/isnull(TRY_CONVERT(decimal(10,0),MaxMarks1),0) else 0 end+ (isnull(TRY_CONVERT(decimal(10,0),Prac),0)+isnull(TRY_CONVERT(decimal(10,0),Port),0) +(case when isnull(TRY_CONVERT(decimal(10,0),SAT),0)>isnull(TRY_CONVERT(decimal(10,0),SAT2),0) then isnull(TRY_CONVERT(decimal(10,0),SAT),0) else isnull(TRY_CONVERT(decimal(10,0),SAT2),0) end  )))highestMarks, m.SrNo ";
                                            hi = hi + " from CCEixtox_1718 m   ";
                                            hi = hi + " inner join SetMaxMinMarks_IXtoX mm on mm.SubjectActivityId=m.SubjectId and mm.PaperId=m.PaperId and mm.Eval=m.Evaluation ";
                                            hi = hi + " and mm.BranchCode=m.BranchCode  and mm.SessionName=m.SessionName  where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' ";
                                            hi = hi + " and SubjectId=" + ds.Tables[1].Rows[p]["SubjectId_1"].ToString() + "   and m.BranchCode=" + Session["BranchCode"] + " and m.SessionName='" + Session["SessionName"] + "'    ";
                                    ...
                                    Chart myChart = (Chart)rptStudent.Items[i].FindControl("myChart");
                                    chart(myChart, dts);
                                    Label lblHTotalT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHTotalT2");
                                    Label lblHTotal2T2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHTotal2T2");
                                    Label lblHTotalGT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHTotalGT2");
                                    Label lblHPercentageT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHPercentageT2");
                                    Label lblHPercentage2T2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHPercentage2T2");
                                    Label lblHPercentageGT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHPercentageGT2");
                                    Label lblHRankT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHRankT2");
                                    Label lblHRank2T2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHRank2T2");
                                    Label lblHRankGT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHRankGT2");
                                    Label lblHPositionT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHPositionT2");
                                    Label lblHPosition2T2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHPosition2T2");
                                    Label lblHPositionGT2 = (Label)rptmarksT2Additional.Controls[rptmarksT2Additional.Controls.Count - 1].Controls[0].FindControl("lblHPositionGT2");
                                    lblHTotalT2.Text = totalM1.ToString("0").Trim() + "/" + totalMM1.ToString("0").Trim();
                                    lblHTotal2T2.Text = totalM2.ToString("0").Trim() + "/" + totalMM2.ToString("0").Trim();
                                    lblHTotalGT2.Text = totalForPer.ToString("0").Trim() + "/" + ((totalMM1 + totalMM2)/2).ToString("0");
                                    lblHPercentageT2.Text = ((double.Parse(totalM1.ToString("0")) * 100) / totalMM1).ToString("0.00") + " %";
                                    lblHPercentage2T2.Text = ((double.Parse(totalM2.ToString("0")) * 100) / totalMM2).ToString("0.00") + " %";
                                    lblHPercentageGT2.Text = ((totalForPer * 100) / (totalMM1)).ToString("0.00") + " %";
    ...
    protected void drpclass_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            _sql = " Select sm.SectionName,sm.id from ClassTeacherMaster sctm";
            ...
            _sql = _sql + " where sctm.BranchCode=" + Session["BranchCode"].ToString() + " and sctm.BranchCode = " + Session["BranchCode"] + " and ClassId='" + drpclass.SelectedValue + "' ";
            _sql = _sql + " and EmpCode='" + Session["LoginName"].ToString() + "' ";
            _oo.FillDropDown_withValue(_sql, drpsection, "SectionName", "id");
        }
        drpsection.Items.Insert(0, new ListItem("<--Select-->", ""));
    }
