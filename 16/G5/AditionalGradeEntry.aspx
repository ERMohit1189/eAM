                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12" id="table1" runat="server">
                                    <div class="table-responsive2 table-responsive">
                                        ...
                                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table  table-header-group ">
                                            <Columns>
                                                <asp:TemplateField HeaderText="#">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblid" runat="server" Visible="false" Text='<%# Bind("id") %>'></asp:Label>
                                               ...
                                               <%-- <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        <asp:Label ID="monthlytest" runat="server" Text="Monthly Test"></asp:Label>
                                                    </HeaderTemplate>
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtmonthlytest" runat="server" Width="80px" CssClass="form-control-blue text-center" Text='<%# Bind("monthlytest") %>' onblur="grade(this);"></asp:TextBox>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>--%>
                                                <asp:TemplateField>
