<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryReportIXtoX_1718.aspx.cs" Inherits="common_MarksEntryReportIXtoX_1718" %>
                                                ...
                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                    ...
                                                    <div class="">
                                                        <asp:DropDownList ID="drpEval" runat="server" CssClass="form-control-blue">
                                                            ...
                                                            <asp:ListItem Value="TERM1" Selected="True">TERM 1</asp:ListItem>
                                                                ...
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Student's Name">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Labe3" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Father's Name">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="Labe4" runat="server" Text='<%# Bind("FatherName") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n " />
                                                                            <HeaderStyle CssClass="p-sub-tit p-pad-n sub-w-175" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe5" runat="server" Text="TEST1"></asp:Label>
                                                                                <br />
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe6" runat="server" Text="TEST2"></asp:Label>
                                                                                <br />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Best One">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblBest" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Con. in 5">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblConv10" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe7" runat="server" Text="S.E."></asp:Label>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe8" runat="server" Text="M.A."></asp:Label>
                                                                                <asp:Label ID="lblMMMA" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe9" runat="server" Text="Port."></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblMMPort" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe10" runat="server" Text="H.Y."></asp:Label>
                                                                                <br />
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe11" runat="server" Text="Prac."></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblMMPrac" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblPrac" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15  tab-in" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe12" runat="server" Text="TOTAL"></asp:Label>
                                                                                <br />
                                                                                
                                                                                <asp:Label ID="Labe13" runat="server" Text="100"></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe14" runat="server" Text="TEST3"></asp:Label>
                                                                                <br />
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe15" runat="server" Text="TEST4"></asp:Label>
                                                                                <br />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Best One">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblBest2" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Con. in 5">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblConv102" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe16" runat="server" Text="S.E."></asp:Label>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe17" runat="server" Text="M.A."></asp:Label>
                                                                                <asp:Label ID="lblMMMA2" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblMA2" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15  tab-in" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe18" runat="server" Text="Port."></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblMMPort2" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblPort2" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15  tab-in" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe19" runat="server" Text="A.E."></asp:Label>
                                                                                <br />
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe25s" runat="server" Text="Pre. Board 2"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblMMHY2_2" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblHY2_2" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15  tab-in" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe20" runat="server" Text="Prac."></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblMMPrac2" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe21" runat="server" Text="TOTAL"></asp:Label>
                                                                                <br />
                                                                                
                                                                                <asp:Label ID="Labe22" runat="server" Text="100"></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="G. TOTAL">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="Labe23" runat="server" Text="G. TOTAL"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="Labe24" runat="server" Text="200"></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
