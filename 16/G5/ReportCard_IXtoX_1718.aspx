                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptRemark1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan='4' style='padding: 2px !important; width: 77%;'><span class='sentence-case'><%# Eval("Caption1") %></span></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                                <asp:Repeater runat="server" ID="rptRemark2">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="padding: 2px !important;" colspan="4"><span class='sentence-case'><%# Eval("Caption1") %></span></td>
                                                                                            <td style="padding: 2px !important;" colspan="7"><span class='sentence-case'><%# Eval("Caption2") %></span></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                            </tbody>
