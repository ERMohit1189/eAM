...
public partial class common_MarksEntryReportIXtoX_1718 : Page
{
    ...
    {
        sql = "Select MaxMarks1,MaxMarks2,MaxMarks3,MaxMarks4,MaxMarks5,MaxMarks6, MaxMarks7,MaxMarks8 from SetMaxMinMarks_IXtoX where Eval='" + drpEval.SelectedValue + "' and BranchCode=" + Session["BranchCode"] + " and paperid='" + drpSubject.SelectedValue.ToString() + "' and SessionName='" + Session["SessionName"].ToString() + "'";
    ...
    protected void loadMarks()
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                Label lblMMHY2 = (Label)GridView1.HeaderRow.FindControl("lblMMHY2");
                Label lblMMHY2_2 = (Label)GridView1.HeaderRow.FindControl("lblMMHY2_2");
                double mm1 = 0; double mm2 = 0; double mmHY = 0; double mm3 = 0; double mm4 = 0; double mmAE = 0; double mmAE2 = 0;
                double.TryParse(lblMMT1.Text, out mm1);
                double.TryParse(lblMMT2.Text, out mm2);
                double.TryParse(lblMMHY.Text, out mmHY);
                double.TryParse(lblMMT3.Text, out mm3);
                double.TryParse(lblMMT4.Text, out mm4);
                double.TryParse(lblMMHY2.Text, out mmAE);
                double.TryParse(lblMMHY2_2.Text, out mmAE2);
                ...
                if (Evail == 1)
                {
                    if (isAdditional)
                    {
                        ...
                        double test11 = (Test1 * 20) / mm1;
                        double test22 = (Test2 * 20) / mm2;
                        Best1 = (test11> test22? test11: test22);
                        lblBest.Text = Best1.ToString("0");
                        Conv10_1 = (double.Parse(Best1.ToString("0")) * 5)/20;
                        lblConv10.Text = Conv10_1.ToString("0");
                        Total1 = double.Parse(Conv10_1.ToString("0"))+Port + HY + Prac;
                    ...
                    else
                    {
                        ...
                        Conv10_1 = (double.Parse(Best1.ToString("0")) * 5) / 20;
                        lblConv10.Text = Conv10_1.ToString("0");
                        Total1 = double.Parse(Conv10_1.ToString("0")) + SE + MA + Port + HY;
                        lblTotal.Text = Total1.ToString("0");
                    }
                }
                ...
                if (Evail == 2)
                {
                    if (isAdditional)
                    {
                        if (ClassName.ToUpper() == "IX")
                        {
                            ...
                            if (mm3 > 0)
                            {
                                double.TryParse(((Test3 * 20) / mm3).ToString(), out test33);
                            }
                            if (mm3 > 0)
                            {
                                double.TryParse(((Test4 * 20) / mm4).ToString(), out test44);
                            }
                            Best2 = (test33 > test44 ? test33 : test44);
                            lblBest2.Text = Best2.ToString("0");
                            Conv10_2 = (double.Parse(Best2.ToString("0")) * 5) / 20;
                            lblConv102.Text = Conv10_2.ToString("0");
                            Total2 = double.Parse(Conv10_2.ToString("0")) + Port2 + AE + Prac2;
                        ...
                        if (ClassName.ToUpper() == "X")
                        {
                            ...
                            Conv10_2 = (double.Parse(Best2.ToString("0")) * 5) / 20;
                            lblConv102.Text = Conv10_2.ToString("0");
                            Total2 = double.Parse(Conv10_2.ToString("0")) + Port2+ Prac2 + (AE > AE2 ? AE : AE2);
                            lblTotal2.Text = Total2.ToString("0");
                        }
                    }
                    else
                    {
                        if (ClassName.ToUpper() == "IX")
                        {
                            ...
                            Conv10_2 = (double.Parse(Best2.ToString("0")) * 5) / 20;
                            lblConv102.Text = Conv10_2.ToString("0");
                            Total2 = double.Parse(Conv10_2.ToString("0"))+SE2+MA2 + Port2 + AE;
                            lblTotal2.Text = Total2.ToString("0");
                        ...
                        if (ClassName.ToUpper() == "X")
                        {
                            ...
                            Conv10_2 = (double.Parse(Best2.ToString("0")) * 5) / 20;
                            lblConv102.Text = Conv10_2.ToString("0");
                            Total2 = double.Parse(Conv10_2.ToString("0")) + SE2+MA2+Port2 + (AE > AE2 ? AE : AE2);
                            lblTotal2.Text = Total2.ToString("0");
                        }
                    }
                }
