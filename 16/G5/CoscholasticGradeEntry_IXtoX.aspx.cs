...
public partial class staff_CoscholasticGradeEntry_VItoX : Page
{
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " where GroupId='G5' and EmpCode='" + Session["LoginName"].ToString() + "' and T1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
    ...
    protected void TextBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        {
            Campus camp = new Campus(); camp.msgbox(Page, msgbox, "Please enter grads A,B,C,D or E only!", "A");
            lblGrade.Text = Text1.Text = "";
            Text1.Focus();
            return;
        }
