                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            ...
                                                                                            <td style="text-align: center">
                                                                                             ...
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal1X"><%# Eval("Total1") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotalCX"><%# Eval("HYTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                        ...
                                                                        <table id="Term2Mark_X" class="Term2Mark_X table term2 tbl mp-table p-table-bordered table-bordered text_center hide" style="margin-bottom: 3px">
                                                                            <tbody>
                                                                              ...
                                                                              <%--   <tr class="text_center">
                                                                                    ...
                                                                                    <td></td>
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="lblAETrm1Rank_T1x"></asp:Label></b></td>
                                                                                     <td></td>
                                                                                     <td></td>
                                                                                    <td></td>
                                                                                    <td></td>
