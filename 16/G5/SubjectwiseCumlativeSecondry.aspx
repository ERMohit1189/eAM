<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/11/comman_root_manager.master" CodeFile="SubjectWiseCumlativeSecondry.aspx.cs" Inherits="_16_G5_SubjectWiseCumlativeSecondry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        <div class="col-sm-12 no-padding" id="div1" runat="server">
                            ...
                            <div class="col-sm-12  no-padding" id="icons" style="border-bottom: 2px solid #000; margin-bottom: 20px; padding-bottom: 5px !important;">
    ...
    <script>
        function PrintDiv() {
            ...
            var divContents = document.getElementById("divList").innerHTML;
            var printWindow = window.open('', '', 'height=700,width=1000, class="tbls"');
            printWindow.document.write('<html><head><title>STUDENT WISE CUMLATIVE FOR </title>' + headContent + '</head>');
        ...
        $(document).ready(function () {
            ...
            $(document).on('blur', 'input[type=text]', function () {
                ...
                if (values != 'AB' && values != 'NAD' && values != 'ML' && isNaN(parseFloat($(this).val()))) {
                    ...
                    //{
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(0) th:eq(4) input[type=text]').val()))) {
                    //        MonthlyTestm = parseFloat($('[id*=divList] table tbody tr:eq(0) th:eq(4) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(0) th:eq(5) input[type=text]').val()))) {
                    //        UT1m = parseFloat($('[id*=divList] table tbody tr:eq(0) th:eq(5) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(0) th:eq(6) input[type=text]').val()))) {
                    //        UT2m = parseFloat($('[id*=divList] table tbody tr:eq(0) th:eq(6) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(0) input[type=text]').val()))) {
                    //        HYTHm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(0) input[type=text]').val());
                    //    }
                    ...
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(4) input[type=text]').val()))) {
                    //        MonthlyTest = parseFloat($(this).closest('tr').find('td:eq(4) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(5) input[type=text]').val()))) {
                    //        UT1 = parseFloat($(this).closest('tr').find('td:eq(5) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(6) input[type=text]').val()))) {
                    //        UT2 = parseFloat($(this).closest('tr').find('td:eq(6) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(7) input[type=text]').val()))) {
                    //        HYTH = parseFloat($(this).closest('tr').find('td:eq(7) input[type=text]').val());
                    //    }
                    ...
                    //if (ClassName == "X" && EvalName == "TERM2") {
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(0) input[type=text]').val()))) {
                    //        Pre1THm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(0) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(1) input[type=text]').val()))) {
                    //        Pre1ASSIm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(1) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(2) input[type=text]').val()))) {
                    //        Pre1Vivam = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(2) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(3) input[type=text]').val()))) {
                    //        Pre2THm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(3) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(4) input[type=text]').val()))) {
                    //        Pre2ASSIm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(4) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(5) input[type=text]').val()))) {
                    //        Pre2Vivam = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(5) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(6) input[type=text]').val()))) {
                    //        Pre3THm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(6) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(7) input[type=text]').val()))) {
                    //        Pre3ASSIm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(7) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(8) input[type=text]').val()))) {
                    //        Pre3Vivam = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(8) input[type=text]').val());
                    //    }

                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(4) input[type=text]').val()))) {
                    //        Pre1TH = parseFloat($(this).closest('tr').find('td:eq(4) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(5) input[type=text]').val()))) {
                    //        Pre1ASSI = parseFloat($(this).closest('tr').find('td:eq(5) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(6) input[type=text]').val()))) {
                    //        Pre1Viva = parseFloat($(this).closest('tr').find('td:eq(6) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(7) input[type=text]').val()))) {
                    //        Pre2TH = parseFloat($(this).closest('tr').find('td:eq(7) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(8) input[type=text]').val()))) {
                    //        Pre2ASSI = parseFloat($(this).closest('tr').find('td:eq(8) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(9) input[type=text]').val()))) {
                    //        Pre2Viva = parseFloat($(this).closest('tr').find('td:eq(9) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(10) input[type=text]').val()))) {
                    //        Pre3TH = parseFloat($(this).closest('tr').find('td:eq(10) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(11) input[type=text]').val()))) {
                    //        Pre3ASSI = parseFloat($(this).closest('tr').find('td:eq(11) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(12) input[type=text]').val()))) {
                    //        Pre3Viva = parseFloat($(this).closest('tr').find('td:eq(12) input[type=text]').val());
                    //    }
                    ...
                    //  total = parseInt(UT1 + UT2 + UT3 + HYTH + HYASSI + HYViva);

                    // }
                    //if (ClassName == "X" && EvalName == "TERM1") {
                    //    total = parseFloat(MonthlyTest + UT1 + UT2 + HYTH + HYASSI + HYViva);
                    //}
                    ...
                    //if (ClassName == "X" && EvalName == "TERM1") {
                    //    if ($(this).attr('name') == "1") {
                    //        if (parseFloat(thisVal) > parseFloat(MonthlyTestm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    ...
                    //if (ClassName == "X" && EvalName == "TERM2") {
                    //    if ($(this).attr('name') == "1") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre1THm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    //    }
                    //    if ($(this).attr('name') == "2") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre1ASSIm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    //    }
                    //    if ($(this).attr('name') == "3") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre1Vivam)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    ...
                    //    if ($(this).attr('name') == "4") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre2THm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    //    }
                    //    if ($(this).attr('name') == "5") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre2ASSIm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    //    }
                    //    if ($(this).attr('name') == "6") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre2Vivam)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    ...
                    //    if ($(this).attr('name') == "7") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre3THm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    //    }
                    //    if ($(this).attr('name') == "8") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre3ASSIm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    //    }
                    //    if ($(this).attr('name') == "9") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre3Vivam)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
        ...
        function LoadFillList() {
            ...
            var urls = "";
            if (ClassName == "IX") {
                urls = '<%=ResolveUrl("Server/MarksSubjectComulativeIX.aspx")%>';
            }
            else {
                urls = '<%=ResolveUrl("Server/MarksSubjectComulativeX.aspx")%>';
            }
            $("[id*=divList]").html("");
            ShowLoader();
            ...
            var ClassName = $("[id*=drpclass] option:selected").text();
            var SectionName = $("[id*=drpsection] option:selected").text();
            var StreamName = $("[id*=drpBranch] option:selected").text();
            var SubjectName = $("[id*=drpSubject] option:selected").text();
