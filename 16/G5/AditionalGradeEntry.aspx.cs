...
public partial class AditionalGradeEntry : System.Web.UI.Page
{
    ...
    public void loadclass()
    {
        ...
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and t1.BranchCode=" + Session["BranchCode"] + " and cm.BranchCode=" + Session["BranchCode"] + " and GroupId='G5' Order by CIDOrder";
        ...
        else
        {
            ...
            sql +=  " and cm.id in(select ClassId from dt_ClassGroupMaster where GroupId='G5' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + ")";
    ...
    {
        sql = "select * from (   ";
        sql += "  select isnull(g.SubjectId,0) SubjectId, isnull(g.PaperId,0) PaperId, g.id, asr.SrNo, Name, FatherName,UT1, UT2, HY,UT3  from AllStudentRecord_UDF('" + Session["SessionName"].ToString() + "', " + Session["BranchCode"].ToString() + ") asr    ";
        sql +=  "  left join UPEAditionalEntryIXtoX g on g.ClassId=asr.ClassId and g.BranchId=asr.BranchId and g.SectionId=asr.SectionID and g.BranchCode=asr.BranchCode and g.SessionName=asr.SessionName and g.SrNo=asr.SrNo and SubjectId=" + drpSubject.SelectedValue + " and PaperId=" + drpPaper.SelectedValue + "";
        ...
        if (drpStatus.SelectedValue != "0")
        {
            ...
            sql +=  "  union all ";
        sql += "  select isnull(g.SubjectId,0) SubjectId,isnull(g.PaperId,0) PaperId, g.id, asr.SrNo, Name, FatherName,UT4 as UT1, UT5 as UT2, AE as HY,UT6 as UT3  from AllStudentRecord_UDF('" + Session["SessionName"].ToString() + "', " + Session["BranchCode"].ToString() + ") asr ";
        sql +=  "  left join UPEAditionalEntryIXtoX g on g.ClassId=asr.ClassId and g.BranchId=asr.BranchId and g.SectionId=asr.SectionID and g.BranchCode=asr.BranchCode and g.SessionName=asr.SessionName and g.SrNo=asr.SrNo  and SubjectId=" + drpSubject.SelectedValue + " and PaperId=" + drpPaper.SelectedValue + "";
    ...
    public void loadgrid2()
    {
        ...
        sql +=  "  where asr.ClassId=" + drpclass.SelectedValue + " and asr.BranchId=" + drpBranch.SelectedValue + " and asr.SectionID=" + drpsection.SelectedValue + " ";
        sql +=  " and asr.SessionName='" + Session["SessionName"].ToString() + "' and asr.BranchCode=" + Session["BranchCode"].ToString() + " and asr.Medium='" + drpMedium.SelectedValue + "' ";
        sql +=  "  and Withdrwal is null and  isnull(Promotion,'')<>'Cancelled' and '" + drpEval.SelectedValue.ToLower() + "'='term1' ";
        sql +=  "  union all ";
        sql += "  select isnull(g.SubjectId,0) SubjectId,isnull(g.PaperId,0) PaperId, g.id, asr.SrNo, Name, FatherName,UT4 as UT1, UT5 as UT2, Pre3 as HY,UT6 as UT3  from AllStudentRecord_UDF('" + Session["SessionName"].ToString() + "', " + Session["BranchCode"].ToString() + ") asr ";
        sql +=  "  left join UPEAditionalEntryIXtoX g on g.ClassId=asr.ClassId and g.BranchId=asr.BranchId and g.SectionId=asr.SectionID and g.BranchCode=asr.BranchCode and g.SessionName=asr.SessionName and g.SrNo=asr.SrNo  and SubjectId=" + drpSubject.SelectedValue + " and PaperId=" + drpPaper.SelectedValue + "";
        sql +=  " where asr.ClassId=" + drpclass.SelectedValue + " and asr.BranchId=" + drpBranch.SelectedValue + " and asr.SectionID=" + drpsection.SelectedValue + "  and asr.Medium='" + drpMedium.SelectedValue + "'";
        sql +=  " and asr.SessionName='" + Session["SessionName"].ToString() + "' and asr.BranchCode=" + Session["BranchCode"].ToString() + " ";
        sql +=  " and Withdrwal is null and  isnull(Promotion,'')<>'Cancelled' and '" + drpEval.SelectedValue.ToLower() + "'='term2' ";
        sql +=  " )T1 order by t1.Name asc ";
        ...
        if (GridView2.Rows.Count > 0)
        {
            if (drpEval.SelectedValue.ToLower() == "term2")
            {
                ...
                //Label ut1 = (Label)GridView2.HeaderRow.FindControl("ut1");
                //ut1.Text = "Pre. 1";
                //Label ut2 = (Label)GridView2.HeaderRow.FindControl("ut2");
                //ut2.Text = "Pre. 2";
                //Label hy = (Label)GridView2.HeaderRow.FindControl("hy");
                //hy.Text = "Pre. 3";
                ...
                Label ut2 = (Label)GridView2.HeaderRow.FindControl("ut2");
                ut2.Text = "UT-5";
                Label ut3 = (Label)GridView2.HeaderRow.FindControl("ut3");
                ut3.Text = "UT-6";
                Label hy = (Label)GridView2.HeaderRow.FindControl("hy");
                hy.Text = "AE";
            }
        ...
        if (drpclass.SelectedItem.Text == "IX")
        {
            if (GridView1.Rows.Count > 0)
            {
                ...
                foreach (GridViewRow gvr in GridView1.Rows)
                {
                    ...
                    cmd = new SqlCommand();
                    cmd.CommandText = "sp_UPEAditionalEntryIXtoX";
