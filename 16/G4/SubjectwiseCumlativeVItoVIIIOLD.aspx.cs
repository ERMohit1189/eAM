...
public partial class SubjectwiseCumlativeVItoVIII : Page
{
    ...
    {
        cmd.Connection = con;
        cmd.CommandText = "SubjectWiseCumlativeVItoVIII_UP";
    ...
    {
        oo.ExporttolandscapePdf(Response, "SubjectwiseCumlativeVItoVIII", table1);
    }
    protected void ImageButton1_Click(object sender, EventArgs e)
    {
        oo.ExportTolandscapeWord(Response, "SubjectwiseCumlativeVItoVIII", table1);
    }
    protected void ImageButton2_Click(object sender, EventArgs e)
    {
        oo.ExportDivToExcelWithFormatting(Response, "SubjectwiseCumlativeVItoVIII.xls", table1, Server.MapPath("~/Admin/css/style.css"));
    }
