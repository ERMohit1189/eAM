...
public partial class staff_ClasswiseAllSubjectMarksList : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("ClasswiseAllSubjectMarksListVItoVIII_1617.aspx?check=ClasswiseAllSubjectMarksList_VItoVIII");
            }
            else
            {
    ...
    protected void loadClassName()
    {
        ...
        sql = "Select Left(SubjectGroup,9) as SubjectGroup,Id from SubjectGroupMaster where Classid='" + drpclass.SelectedValue.ToString() + "' and SectionName='"+drpsection.SelectedItem.ToString()+"'";
        DataTable dt;
        dt = oo.Fetchdata(sql);
