<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_VItoVIII.aspx.cs" Inherits="ReportCard_VItoVIII" %>
                                                                        ...
                                                                        <table class="table term2 tbl mp-table p-table-bordered table-bordered text-uppercase" style="margin-bottom: 2px;">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptAttendance1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="    width: 34.9%;">Attendance</th>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptAttendance2">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="width:19.8%;">Attendance</th>
                                                                                            <td style="width: 28.3%;" class="text-center"><%# Eval("t1Att") %></td>
