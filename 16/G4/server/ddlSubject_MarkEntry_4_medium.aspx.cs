...
public partial class common_G4_ddlSubject_MarkEntry_4_medium : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            _sql = "Select SubjectName,Id from TTSubjectMaster where ClassId=" + drpclass.ToString() + " and Medium='" + Medium + "'";
        ...
        else
        {
            ...
            _sql +=  " and sm.Medium='" + Medium + "' and  sctm.BranchCode = " + Session["BranchCode"] + " and sctm.SessionName='" + Session["SessionName"].ToString() + "' and IsAditional=0";
            _dt = DAL.DALInstance.GetValueInTable(_sql);
            if (_dt != null && _dt.Rows.Count > 0)
            {
                for (int i = 0; i < _dt.Rows.Count; i++)
