...
public partial class _16_G4_server_ShowMarksEntryServer : System.Web.UI.Page
{
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        string sql1 = "Select UT1TH, UT1Viva, UT2TH, UT2Viva, HYTH, HYASSI, HYViva,UT3TH, UT3Viva, UT4TH, UT4Viva, AETH, AEASSI, AEViva from UPEMVItoVIII ";
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            string sql3 = "Select Id,UT1TH, UT1Viva, UT2TH, UT2Viva, HYTH, HYASSI, HYViva, HYTotal, HYGrade, UT3TH, UT3Viva, UT4TH, UT4Viva, AETH, AEASSI, AEViva, AETotal, AEGrade,GTotal,GGrade from UPEVItoVIII where SRNO='" + dt.Rows[i]["srno"].ToString() + "'  and SubjectId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and Medium='" + Medium + "' and SessionName='" + Session.ToString() + "' and BranchCode=" + BranchCode + "";
