<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryVItoVIII.aspx.cs" Inherits="MarksEntryVItoVIII" %>
        ...
        function SaveMarks() {
          ...
          //  counts=counts-1;
            for (var i = 2; i < counts; i++) {
                ...
                Marks += $("[id*=divList] table tbody tr:eq(" + (i) + ") td:eq(12) span").html() + "$";
            }
            $.ajax({
                type: "POST",
