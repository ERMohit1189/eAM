...
public partial class TestwiseCumlativeVItoVIII : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            drptest.Items.Insert(3, new ListItem("HY", "HY"));
            drptest.Items.Insert(4, new ListItem("Prac", "PracHY"));
    ...
    protected void LoadTests()
    {
        ...
        {
            drptest.Items.Insert(0, new ListItem("<--Select-->", "0"));
            drptest.Items.Insert(1, new ListItem("UT-3", "Test3"));
            drptest.Items.Insert(2, new ListItem("UT-4", "Test4"));
            drptest.Items.Insert(3, new ListItem("AE", "AE"));
        }
    }
    public void loadclass()
    {
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and cm.BranchCode=" + Session["BranchCode"] + " and GroupId='G4' Order by CIDOrder";
        ...
        else
        {
            ...
            sql +=  " where GroupId='G4'  and sctm.SessionName='" + Session["SessionName"].ToString() + "' and sctm.BranchCode=" + Session["BranchCode"] + " and Ecode='" + Session["LoginName"].ToString() + "' Order by CIDOrder";
            oo.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
        }
    }
    ...
    public void setTitle()
    {
       // lblClass.Text = (drpclass.SelectedItem.Text.Trim() + " " + drpBranch.SelectedItem.Text.Trim() + " (" + drpsection.SelectedItem.Text.Trim() + ")");
        lblClass.Text = (drpclass.SelectedItem.Text.Trim() + " (" + drpsection.SelectedItem.Text.Trim() + ")");
    ...
    {
        sql = "Select pm.id Paperid, SubjectId, papername SubjectName,'' marks,sm.IsAditional from TTSubjectMaster  sm";
    ...
    public string GetMMarks(string subjectid, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEMVItoVIII", param);
            if (ds != null)
            {
    ...
    public string GetTestMarks(string srno, string subjectid, string paperid, string IsAdditional)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEVItoVIIINew", param);
    ...
    {
        BAL.objBal.ExportTolandscapeWord(Response, "ClassCumulativeXI" + ".doc", divExport);
    }
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
        BAL.objBal.ExportDivToExcelWithFormatting(Response, "ClassCumulativeXI", divExport, Server.MapPath("~/css/theme.min.css"));
    }
    protected void lnkPdf_Click(object sender, EventArgs e)
    {
        BAL.objBal.ExporttolandscapePdf(Response, "ClassCumulativeXI", divExport);
    }
