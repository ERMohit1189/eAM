...
public partial class staff_CoscholasticGradeEntry_XII : Page
{
    ...
    protected void TextBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        if (Text1.Text == "A" || Text1.Text == "B" || Text1.Text == "C" || Text1.Text == "D"
            ...
            || Text1.Text == "A2" || Text1.Text == "B2" || Text1.Text == "C2" || Text1.Text == "D2" || Text1.Text == "E" || Text1.Text == "")
        {
        ...
        {
            Campus camp = new Campus(); camp.msgbox(Page, msgbox, "Please enter grads A, B ,C , D, A1, B1, C1, D1, A2, B2, C2, D2, or E only!", "A");
            lblGrade.Text = Text1.Text = "";
            Text1.Focus();
            return;
        }
