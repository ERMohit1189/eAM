...
public partial class SubjectwiseCumlativeXII : Page
{
    ...
    {
        cmd.Connection = con;
        cmd.CommandText = "SubjectWiseCumlativeXII_UP";
        ...
        if (ds != null && ds.Tables.Count > 1)
        {
            ...
            if (GridView1.Rows.Count>0)
            {
                ...
                if (drpEval.SelectedIndex == 2)
                {
                    ...
                    hy.Text = "Pre.-3 (" + ds.Tables[0].Rows[0]["HYTH"].ToString() + ")";
                    HYt.Text = "Total (" + ds.Tables[0].Rows[0]["HYTotal"].ToString() + ")";
                }
            }
        }
    ...
    {
        oo.ExporttolandscapePdf(Response, "SubjectwiseCumlativeXII", table1);
    }
    protected void ImageButton1_Click(object sender, EventArgs e)
    {
        oo.ExportTolandscapeWord(Response, "SubjectwiseCumlativeXII", table1);
    }
    protected void ImageButton2_Click(object sender, EventArgs e)
    {
        oo.ExportDivToExcelWithFormatting(Response, "SubjectwiseCumlativeXII.xls", table1, Server.MapPath("~/Admin/css/style.css"));
    }
