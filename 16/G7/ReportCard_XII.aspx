<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_XII.aspx.cs" Inherits="ReportCard_XII" %>
                                                                                    ...
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                           ...
                                                                                           <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS<br />(50)</th>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;' colspan="3">H.Y. (100)</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL<br />(150)</th>
                                                                                          <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS(50)</th>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;' colspan="3">Pre Board (100)</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL<br />(150)</th>
                                                                        ...
                                                                        <table class="table term2 tbl mp-table p-table-bordered table-bordered text-uppercase" style="margin-bottom: 2px;">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptAttendance1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="width: 21.8%;">Attendance</th>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptAttendance2">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="width:12.2%;">Attendance</th>
                                                                                            <td style="width:36.8%;" class="text-center"><%# Eval("t1Att") %></td>
