<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="SubjectwiseCumlativeXII.aspx.cs" Inherits="SubjectwiseCumlativeXII" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="col-sm-12  no-padding ">
                                                ...
                                                <div class="col-sm-4" runat="server" id="divHideForGardian8">
                                                    ...
                                                    <div class="table-responsive2 table-responsive">
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered pro-table  table-header-group ">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        <asp:Label ID="hy" runat="server" Text="TH"></asp:Label>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="txthy" runat="server" Text='<%# Bind("HYTH") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <HeaderTemplate>
                                                                        <asp:Label ID="hyPrac" runat="server" Text="Prac."></asp:Label>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="txthyPrac" runat="server" Text='<%# Bind("HYPrac") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
