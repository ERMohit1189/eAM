...
public partial class common_G7_Studentwisecumulative_XII_1718Server : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "StudentWiseCumulative_XII_2021";
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        Response.Write("<tr class='p-pad-3 p-tot-tit trBg'><th style='width:23%; !important' rowspan='2'>EXAM<i class='fa fa-arrow-right'></i></th><th colspan='2'>U.T 1</th><th rowspan='2'>Conversion <br>into (20)</th><th colspan='2'>U.T 2</th><th rowspan='2'>Conversion <br>into (20)</th><th rowspan='2'>Conversion <br>into (10)<br>(A)</th><th colspan='2'>Practical/I.A</th><th colspan='2'>Term-1</th><th rowspan='2'>Conversion<br>(A+B) into <br>Board Marks<br></th><th>Total</th><th rowspan='2'>Grade</th><th colspan='2'>Plellminary</th><th rowspan='2'>Conversion <br>into (10)<br>(C)</th><th colspan='2'>Practical/I.A</th><th colspan='2'>Preboard-1</th><th colspan='2'>Preboard-2</th><th rowspan='2'>Conversion<br>(C+D) into <br>Board Marks</th><th>Total</th><th rowspan='2'>Grade</th><th>Grand Total</th><th>Conversion into</th></tr>");
                        Response.Write("<tr class='p-pad-3 p-tot-tit trBg'><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.(B)</th><th>100</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.(D1)</th><th>M.M</th><th>M.O.(D2)</th><th>100</th><th>200</th><th>100</th></tr>");
                        ...
                        if (dss.Tables[0].Rows.Count > 0)
                        {
                            ...
                            for (int p = 0; p < dss.Tables[0].Rows.Count; p++)
                            {
                                ...
                                double Test1_2 = 0; double Test2_2 = 0; double MaxMarks5_2 = 0; double SE_2 = 0; double SAT_2 = 0; double SAT2_2 = 0; double Prac_2 = 0; double MaxMarks1_2 = 0; double MaxMarks2_2 = 0; double MaxMarks3_2 = 0; double MaxMarks4_2 = 0;
                                ...
                                double Test1Conv = (double.Parse(Test1.ToString("0")) * 20) / MaxMarks1;
                                double Test2Conv = (double.Parse(Test2.ToString("0")) * 20) / MaxMarks2;
                                totalmmmarks1 = 20;
                                ...
                                if (totalmmmarks1 > 0)
                                {
                                    ...
                                    ConvinBoard = ((double.Parse(percentle1.ToString("0")) + double.Parse(SAT.ToString("0"))) / (10 + MaxMarks3)) * MaxMarks3;
                                    ObtMarks1 = (double.Parse(ConvinBoard.ToString("0")) + double.Parse(Prac.ToString("0")));
                                ...
                                Response.Write("<td>" + MaxMarks1.ToString() + "</td><td>" + Test1.ToString() + "</td><td>" + Test1Conv.ToString("0.0") + "</td><td>" + MaxMarks2.ToString() + "</td><td>" + Test2.ToString() + "</td><td>" + Test2Conv.ToString("0.0") + "</td>");
                                Response.Write("<td>" + percentle1.ToString("0.0") + "</td>");
                                Response.Write("<td>" + MaxMarks4.ToString() + "</td><td>" + Prac.ToString() + "</td><td>" + MaxMarks3.ToString() + "</td><td>" + SAT.ToString() + "</td>");
                                Response.Write("<td>" + ConvinBoard.ToString("0.0") + "</td><td>" + ObtMarks1.ToString("0") + "</td>");
                                ...
                                if (dss.Tables[0].Rows[p]["SAT2"].ToString().Trim().ToUpper() == "NP" || dss.Tables[0].Rows[p]["SAT2"].ToString().Trim().ToUpper() == "NAD" || dss.Tables[0].Rows[p]["SAT2"].ToString().Trim().ToUpper() == "ML" || dss.Tables[0].Rows[p]["SAT2"].ToString().Trim().ToUpper() == "" || dss.Tables[0].Rows[p]["SAT2"].ToString().Trim().ToUpper() == "AB" || dss.Tables[0].Rows[p]["SAT2"].ToString().Trim().ToUpper() == "NA" || dss.Tables[0].Rows[p]["SAT2"].ToString().Trim().ToUpper() == "M.L") { }
                                else { SAT2_2 = double.Parse(dss.Tables[0].Rows[p]["SAT2"].ToString().Trim()); }
                                ...
                                totalmarks_2 = Test1_2;
                                totalmmmarks_2 = MaxMarks1_2;
                                double ConvinBoard2 = 0;
                                if (totalmmmarks_2 >0)
                                {
                                    percentle_2 = (((totalmarks_2) * 10) / totalmmmarks_2);
                                    double best1 = (SAT_2 > SAT2_2 ? SAT_2 : SAT2_2);
                                    double best1max = (SAT_2 > SAT2_2 ? MaxMarks4_2 : MaxMarks5_2);

                                    ConvinBoard2 = (((double.Parse(percentle_2.ToString("0")) + double.Parse(best1.ToString("0"))) / (10 + best1max)) * best1max);
                                    ObtMarks_2 = (double.Parse(ConvinBoard2.ToString("0")) + double.Parse(Prac_2.ToString("0")));
                                ...
                                Response.Write("<td>" + MaxMarks1_2.ToString() + "</td><td>" + Test1_2.ToString() + "</td>");
                                Response.Write("<td>" + percentle_2.ToString("0.0") + " </td>");
                                Response.Write("<td>" + MaxMarks3_2.ToString() + "</td><td>" + Prac_2.ToString() + "</td><td>" + MaxMarks4_2.ToString() + "</td><td>" + SAT_2.ToString() + "</td><td>" + MaxMarks5_2.ToString() + "</td><td>" + SAT2_2.ToString() + "</td>");
                                Response.Write("<td>" + ConvinBoard2.ToString("0.0") + "</td><td>" + ObtMarks_2.ToString("0") + " </td>");
                                Response.Write("<td>" + grade(ObtMarks_2) + "</td>");
                                Response.Write("<td>" + (ObtMarks1 + ObtMarks_2).ToString() + "</td>");
                                Response.Write("<td>" + ((ObtMarks1 + ObtMarks_2) / 2) + "</td>");
                                Response.Write("</tr>");
                            }
                            if (dss.Tables[1].Rows.Count > 0)
                            {
                                Response.Write("<tr class='p-pad-3 p-tot-tit trBg'><th style='width:23%; !important' rowspan='2'>EXAM<i class='fa fa-arrow-right'></i></th><th colspan='2'>U.T. 1</th><th rowspan='2'>Conversion <br>into (20)</th><th colspan='2'>U.T. 2</th><th rowspan='2'>Conversion <br>into (20)</th><th rowspan='2'>Conversion <br>into (5)<br>(A)</th><th colspan='2'>Practical/I.A</th><th colspan='2'>Term-1</th><th colspan='2'>Conversion<br>(A+B) into <br>Board Marks<br></th><th>Total</th><th rowspan='2'>Grade</th><th colspan='2'>PLELLMINARY</th><th rowspan='2'>Conversion <br>into (5)<br>(C)</th><th colspan='2'>Practical/I.A</th><th colspan='2'>Preboard-1</th><th colspan='2'>Preboard-2</th><th colspan='2'>Conversion<br>(C+D) into <br>Board Marks</th><th>Total</th><th rowspan='2'>Grade</th><th>Grand Total</th><th>Conversion into</th></tr>");
                                Response.Write("<tr class='p-pad-3 p-tot-tit trBg'><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.(B)</th><th>100</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.</th><th>M.M</th><th>M.O.(D1)</th><th>M.M</th><th>M.O.(D2)</th><th>100</th><th>200</th><th>100</th></tr>");
                                Response.Write("<tr class='trBg'><th>SUBJECT<i class='fa fa-arrow-down'></i></th><td colspan='13' class='text-center'><B>TERM 1</B></td><td colspan='13' class='text-center'><B>TERM 2</B></td></tr>");
                                for (int p = 0; p < dss.Tables[1].Rows.Count; p++)
                                {
                                    ...
                                    {
                                        percentle1 = (((totalmarks1) * 10) / totalmmmarks1);
                                        ConvinBoard = ((double.Parse(percentle1.ToString("0")) + double.Parse(SAT.ToString("0"))) / (10 + MaxMarks4)) * MaxMarks4;
                                        ObtMarks1 = (double.Parse(ConvinBoard.ToString("0")) + double.Parse(Prac.ToString("0")));
                                        ObtMarks1 = double.Parse(ObtMarks1.ToString("0"));
                                    }
                                    Response.Write("<td style='text-align:left; width:23%; !important'>" + dss.Tables[1].Rows[p]["SubjectName"].ToString() + "</td>");
                                    Response.Write("<td>" + MaxMarks1.ToString() + "</td><td>" + Test1.ToString() + "</td><td>" + Test1Conv.ToString() + "</td><td>" + MaxMarks2.ToString() + "</td><td>" + Test2.ToString() + "</td><td>" + Test1Conv.ToString() + "</td>");
                                    ...
                                    percentle_2 = (MaxMarks1_2 > 0 ? ((double.Parse(Test1_2.ToString("0")) * 10) / MaxMarks1_2) : 0);
                                    ...
                                    double ConvinBoard2 = (((double.Parse(percentle_2.ToString("0")) + double.Parse(bestSat.ToString("0"))) / (10 + bestSatMM)) * bestSatMM);

                                    double ObtMarks2 = (double.Parse(ConvinBoard2.ToString("0")) + double.Parse(Prac_2.ToString("0")));
                                    ...
                                    Response.Write("<td>" + ConvinBoard2.ToString("0.0") + "</td><td>" + ObtMarks_2.ToString("0") + "</td>");
                                    Response.Write("<td>" + grade(ObtMarks_2) + "</td>");
                                    Response.Write("<td>" + (ObtMarks1 + ObtMarks_2).ToString("0") + "</td>");
                                    Response.Write("<td>" + ((ObtMarks1 + ObtMarks_2) / 2) + "</td>");
                                    Response.Write("</tr>");
                                }
                            }
                        }
                        Response.Write("<tr class='p-pad-3 p-tot-tit'><td style='text-align:left; width:23%; !important'>Total</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>" + Gtotal.ToString("0") + "</td><td></td>");
