...
public partial class SaveResultServer : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string Eval = "Term2";
        string result = Request.Form["result"].ToString().Trim();
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            try
            {
                ...
                if (Eval == "Term1")
                {
                    cmd.Parameters.AddWithValue("@SA1Result", result);
                }
                else
                {
                    cmd.Parameters.AddWithValue("@SA2Result", result);
                }
