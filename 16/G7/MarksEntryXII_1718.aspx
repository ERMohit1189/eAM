<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryXII_1718.aspx.cs" Inherits="MarksEntryXII_1718" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                                        ...
                                        <ContentTemplate>
                                            <div class="col-sm-12  no-padding ">
                                                ...
                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                    ...
                                                    <div class="">
                                                        <asp:DropDownList ID="drpEval" runat="server" CssClass="form-control-blue term" AutoPostBack="True"
                                            ...
                                            <div class="col-sm-12   mgbt-xs-15">
                                                <asp:Label ID="Label33" runat="server" class="txt-bold txt-middle-l text-primary">
                                                    Note:-<span class="txt-bold txt-middle-l text-danger blink">Type ML For Medical Leave, NAD for New Admission and NP for Not Present.</span>
                                                </asp:Label>
                                            </div>
                                            <div class="col-sm-12   mgbt-xs-15">
                                            ...
                                            <div class="col-sm-12  ">
                                                <div class=" table-responsive  table-responsive2 " id="table1" runat="server">
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" class="table mp-table p-table-bordered table-bordered tbl1">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblconvin20_1h" runat="server" Text="Conv. into 20"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblconvin20_1" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15 tab-in" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblconvin20_2h" runat="server" Text="Conv. into 20"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblconvin20_2" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15 tab-in" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="LblConv10H" runat="server" Text="Conv. into (10) (A)"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblHY" runat="server" Text="Term-1 (B)"></asp:Label>
                                                                    <br />
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblConvinBoardH" runat="server" Text="Conversion into Board (A+B)"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                    ...
                                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" class="table mp-table p-table-bordered table-bordered  tbl2">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="LblId" runat="server" Visible="false"></asp:Label>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblPreliminary" runat="server" Text="Prelims."></asp:Label>
                                                                    <br />
                                                                    <asp:TextBox ID="txtPreliminaryMax" runat="server" CssClass="form-control-blue text-center" Width="40px" MaxLength="4"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtPreliminary" runat="server"  CssClass="form-control-blue text-center" Width="40px" MaxLength="4"
                                                                        AutoPostBack="true" OnTextChanged="txtPreliminary_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15 tab-in" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="LblConv_2_10H" runat="server" Text="Conv. into (10)(C)"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="LblConv_2_10" runat="server" Text="0.00"></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblPrac_2" runat="server" Text="Practical/IA"></asp:Label>
                                                                    <br />
                                                                    <asp:TextBox ID="txtPrac_2Max" runat="server" CssClass="form-control-blue text-center" Width="40px"
                                                                        MaxLength="4" Text=""></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtPrac_2" runat="server" AutoPostBack="true" CssClass="form-control-blue text-center" Width="40px"
                                                                        MaxLength="4"  OnTextChanged="txtPrac_2_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblPrBoard1" runat="server" Text="Pre-Board 1(D1)"></asp:Label>
                                                                    <br />
                                                                    <asp:TextBox ID="txtPrBoard1Max" runat="server" CssClass="form-control-blue text-center" Width="40px"
                                                                        MaxLength="4" Text="80"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtPrBoard1" runat="server" CssClass="form-control-blue text-center" Width="40px"
                                                                        MaxLength="4"  AutoPostBack="true" OnTextChanged="txtPrBoard1_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15  tab-in" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblPrBoard2" runat="server" Text="Pre-Board 2(D2)"></asp:Label>
                                                                    <br />
                                                                    <asp:TextBox ID="txtPrBoard2Max" runat="server" CssClass="form-control-blue text-center" Width="40px"
                                                                        MaxLength="4" Text="80"></asp:TextBox>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtPrBoard2" runat="server" CssClass="form-control-blue text-center" Width="40px"
                                                                        MaxLength="4"  AutoPostBack="true" OnTextChanged="txtPrBoard2_TextChanged"></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15  tab-in" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblCDH" runat="server" Text="Conversion into Board (C+D)"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblH1Total_2" runat="server" Text="TOTAL"></asp:Label>
                                                                    <br />
                                                                    <asp:Label ID="lblH2Total_2" runat="server" Text="100"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblTotal_2" runat="server" Text=""></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                            </asp:TemplateField>
                                                             ...
                                                             <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblGradeH_2" runat="server" Text="Grade"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblGrade_2" runat="server" Text=""></asp:Label>
                                                                </ItemTemplate>
                                                                <ItemStyle CssClass=" p-pad-n text-center" />
                                                                <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                            </asp:TemplateField>
    ...
    <script>
        function changeTab(tis) {
            if ($('.term').val() == "TERM1") {
                var rows = $('.tbl1 tbody tr').length;
                var cols = $('.tbl1 tbody tr:eq(0)').find('th').length;
                if ($(tis).val() == "Vertical") {
                    var tab = 1;
                    for (var j = 4; j < cols; j++) {
                        for (var i = 1; i < rows; i++) {
                            $('.tbl1 tbody tr:eq(' + i + ')').find('td:eq(' + j + ')').find('input[type=text]').attr('tabindex', tab++);
                        }
                    }
                }
                else {
                    for (var j = 4; j < cols; j++) {
                        for (var i = 1; i < rows; i++) {
                            $('.tbl1 tbody tr:eq(' + i + ')').find('td:eq(' + j + ')').find('input[type=text]').removeAttr('tabindex');
                        }
                    }
                }
            }
            else {
                var rows = $('.tbl2 tbody tr').length;
                var cols = $('.tbl2 tbody tr:eq(0)').find('th').length;
                if ($(tis).val() == "Vertical") {
                    var tab = 1;
                    for (var j = 4; j < cols; j++) {
                        for (var i = 1; i < rows; i++) {
                            $('.tbl2 tbody tr:eq(' + i + ')').find('td:eq(' + j + ')').find('input[type=text]').attr('tabindex', tab++);
                        }
                    }
                }
                else {
                    for (var j = 4; j < cols; j++) {
                        for (var i = 1; i < rows; i++) {
                            $('.tbl2 tbody tr:eq(' + i + ')').find('td:eq(' + j + ')').find('input[type=text]').removeAttr('tabindex');
                        }
                    }
                }
            }
