...
public partial class ReportCard_XII : Page
{
    ...
    public void LoadReportCard()
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            {
                cmd.Connection = conn;
                cmd.CommandText = "ReportCard_XII_UP";
                ...
                if (dt.Rows.Count > 0)
                {
                    cmd.CommandText = "UPCalculateRank_XII";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ClassId", drpclass.SelectedValue);
                    cmd.Parameters.AddWithValue("@SectionId", drpsection.SelectedValue);
                    cmd.Parameters.AddWithValue("@BranchId", drpBranch.SelectedValue);
                    ...
                    cmd.CommandText = "UPDevision_XII";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@ClassId", drpclass.SelectedValue);
                    cmd.Parameters.AddWithValue("@SectionId", drpsection.SelectedValue);
                    cmd.Parameters.AddWithValue("@BranchId", drpBranch.SelectedValue);
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                if (drpEval.SelectedValue.ToUpper() == "TERM1")
                                {
                                    ...
                                    for (int m = 0; m < rptMarkTerm1.Items.Count; m++)
                                    {
                                      ...
                                      //  Label Label2 = (Label)rptMarkTerm1.Items[i].FindControl("Label2");
                                       // Label2.Text = totalBestUT1.ToString("0");
                                    }
                                    Label lblUT1Total_T1 = (Label)rptStudent.Items[i].FindControl("lblUT1Total_T1");
                                    lblUT1Total_T1.Text = totalUT1.ToString("0");
                                    Label lblUT2Total_T1 = (Label)rptStudent.Items[i].FindControl("lblUT2Total_T1");
                                ...
                                if (drpEval.SelectedValue.ToUpper() == "TERM2")
                                {
                                   ...
                                   string Term2Dev = (from t in dtDiv.AsEnumerable() where t.Field<string>("SrNo") == srno select t.Field<string>("AE")).FirstOrDefault().ToString();
                                    ...
                                    //    double Pre1Total = 0;
                                    //    double.TryParse(ds.Tables[0].Rows[m]["Pre1Total"].ToString(), out Pre1Total);
                                    //    totalPre1 = totalPre1 + Pre1Total;
                                    //    double Pre2Total = 0;
                                    //    double.TryParse(ds.Tables[0].Rows[m]["Pre2Total"].ToString(), out Pre2Total);
                                    //    totalPre2 = totalPre2 + Pre2Total;
                                    //    double Pre3Total = 0;
                                    //    double.TryParse(ds.Tables[0].Rows[m]["Pre3Total"].ToString(), out Pre3Total);
                                    //    totalPre3 = totalPre3 + Pre3Total;
                                    ...
                                    //Label lblPre1Total_T2 = (Label)rptStudent.Items[i].FindControl("lblPre1Total_T2");
                                    //lblPre1Total_T2.Text = totalPre1.ToString("0");
                                    //Label lblPre2Total_T2 = (Label)rptStudent.Items[i].FindControl("lblPre2Total_T2");
                                    //lblPre2Total_T2.Text = totalPre2.ToString("0");
                                    //Label lblPre3Total_T2 = (Label)rptStudent.Items[i].FindControl("lblPre3Total_T2");
                                    //lblPre3Total_T2.Text = totalPre3.ToString("0");
                                    ...
                                    //Label lblPre1Per_T2 = (Label)rptStudent.Items[i].FindControl("lblPre1Per_T2");
                                    //lblPre1Per_T2.Text = ((totalPre1 * 100) / (25 * rptMarkTerm2.Items.Count)).ToString("0.00");
                                    //Label lblPre2Per_T2 = (Label)rptStudent.Items[i].FindControl("lblPre2Per_T2");
                                    //lblPre2Per_T2.Text = ((totalPre2 * 100) / (25 * rptMarkTerm2.Items.Count)).ToString("0.00");
                                    //Label lblPre3Per_T2 = (Label)rptStudent.Items[i].FindControl("lblPre3Per_T2");
                                    //lblPre3Per_T2.Text = ((totalPre3 * 100) / (100 * rptMarkTerm2.Items.Count)).ToString("0.00");
    ...
    protected void drpsection_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            _sql +=  " and EmpCode='" + Session["LoginName"].ToString() + "' and sm.SessionName='" + Session["SessionName"].ToString() + "' ";
            _oo.FillDropDown_withValue(_sql, drpBranch, "BranchName", "id");
            drpBranch.Items.Insert(0, new ListItem("<--Select-->", ""));
        }
