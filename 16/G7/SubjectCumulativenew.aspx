<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/11/comman_root_manager.master" CodeFile="SubjectCumulativenew.aspx.cs" Inherits="_16_G7_SubjectCumulativenew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
            ...
            $(document).on('blur', 'input[type=text]', function () {
               ...
               // var strss = /^(\+|-)?(\d*\.?\d*)$/;
                ...
                if (values != 'AB' && values != 'NAD' && values != 'ML' && isNaN(parseFloat($(this).val()))) {
                    ...
                    var MonthlyTest = 0, UT1 = 0, UT2 = 0, UT3 = 0, HYTH = 0, HYPrac = 0;
                    var MonthlyTestm = 0, UT1m = 0, UT2m = 0, UT3m = 0, HYTHm = 0, HYPracm = 0;

                    var Pre1TH = 0, Pre1Prac = 0, Pre2TH = 0, Pre2Prac = 0, Pre3TH = 0, Pre3Prac = 0;
                    var Pre1THm = 0, Pre1Pracm = 0, Pre2THm = 0, Pre2Pracm = 0, Pre3THm = 0, Pre3Pracm = 0;
                   ...
                   // }
                    ...
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(1) input[type=text]').val()))) {
                    //        Pre1Pracm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(1) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(2) input[type=text]').val()))) {
                    //        Pre2THm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(2) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(3) input[type=text]').val()))) {
                    //        Pre2Pracm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(3) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(4) input[type=text]').val()))) {
                    //        Pre3THm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(4) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(5) input[type=text]').val()))) {
                    //        Pre3Pracm = parseFloat($('[id*=divList] table tbody tr:eq(1) th:eq(5) input[type=text]').val());
                    //    }
                    ...
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(5) input[type=text]').val()))) {
                    //        Pre1Prac = parseFloat($(this).closest('tr').find('td:eq(5) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(6) input[type=text]').val()))) {
                    //        Pre2TH = parseFloat($(this).closest('tr').find('td:eq(6) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(7) input[type=text]').val()))) {
                    //        Pre2Prac = parseFloat($(this).closest('tr').find('td:eq(7) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(8) input[type=text]').val()))) {
                    //        Pre3TH = parseFloat($(this).closest('tr').find('td:eq(8) input[type=text]').val());
                    //    }
                    //    if (!isNaN(parseFloat($(this).closest('tr').find('td:eq(9) input[type=text]').val()))) {
                    //        Pre3Prac = parseFloat($(this).closest('tr').find('td:eq(9) input[type=text]').val());
                    //    }
                    //}
                    //if (EvalName == "TERM1")
                    //{
                   ...
                   // }
                    ...
                    //    }
                    //    if ($(this).attr('name') == "2") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre1Pracm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    ...
                    //    }
                    //    if ($(this).attr('name') == "4") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre2Pracm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
                    ...
                    //    }
                    //    if ($(this).attr('name') == "6") {
                    //        if (parseFloat(thisVal) > parseFloat(Pre3Pracm)) {
                    //            isMax = "Yes";
                    //            $(this).addClass('borders');
                    //            $(this).focus();
                    //        }
        ...
        function LoadMedium() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlMedium_MarkEntry_7.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadClass() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlClass_MarkEntry_7.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadBranch() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlBranch_MarkEntry_7.aspx") %>',
        ...
        function LoadStream() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlStream_7.aspx") %>',
        ...
        function LoadSection() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlSection_MarkEntry_7.aspx") %>',
                data: { 'classId': $("#drpclass").val() },
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadSubject() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlSubject_MarkEntry_7_medium.aspx") %>',
        ...
        function LoadPaper() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlPaper_MarkEntry_7_medium.aspx") %>',
        ...
        function LoadFillList() {
           ...
           $("[id*=divList]").html("");
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/LoadShowMarks.aspx")%>',
                data: {
