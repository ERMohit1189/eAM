...
public partial class SubjectwiseCumlativeXI : Page
{
    ...
    private void loadSubject()
    {
        ...
        if (Session["Logintype"].ToString() == "Admin")
        {
            sql = "Select SubjectName,Id from ttSubjectMaster where ClassId='" + drpclass.SelectedValue.ToString() + "' and BranchId='" + drpBranch.SelectedValue.ToString() + "' and BranchCode=" + Session["BranchCode"] + " and SessionName='" + Session["SessionName"].ToString() + "' and ApplicableFor<>'TimeTable' and medium='" + ddlMedium.SelectedItem.Text + "'";
        ...
        else
        {
            ...
            sql +=  "  and sm.BranchId='" + drpBranch.SelectedValue.ToString() + "' and  sctm.BranchCode = " + Session["BranchCode"] + " and sctm.SessionName='" + Session["SessionName"].ToString() + "' and sm.medium='" + ddlMedium.SelectedItem.Text + "'";
    ...
    {
        cmd.Connection = con;
        cmd.CommandText = "SubjectWiseCumlativeXI_UP";
        ...
        if (ds != null && ds.Tables.Count > 1)
        {
            ...
            if (GridView1.Rows.Count>0)
            {
                ...
                var hyPrac = (Label)GridView1.HeaderRow.FindControl("hyPrac");
                if (drpEval.SelectedIndex == 1)
                {
                    ut1h.Text = "UT1 (" + ds.Tables[0].Rows[0]["UT1"].ToString() + ")";
                    ut2.Text = "UT2 (" + ds.Tables[0].Rows[0]["UT2"].ToString() + ")";
                    hy.Text = "TH (" + ds.Tables[0].Rows[0]["HYTH"].ToString() + ")";
                    hyPrac.Text = "Prac. (" + ds.Tables[0].Rows[0]["HYPrac"].ToString() + ")";
