...
public partial class TestwiseCumlativeXI : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
          ...
          //  drptest.Items.Insert(5, new ListItem("Prac", "PracHY"));
    ...
    public string GetMMarks(string subjectid, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEMXI", param);
            if (ds != null)
            {
    ...
    public string GetTestMarks(string srno, string subjectid,string paperid, string IsAdditional)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEXINew", param);
