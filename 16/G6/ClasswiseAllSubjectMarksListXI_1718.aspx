<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClasswiseAllSubjectMarksListXI_1718.aspx.cs" Inherits="common_ClasswiseAllSubjectMarksListXI_1718" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>Class wise Cumulative (XI)</title>' + headContent + '</head>');
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ClassWiseCumulativeReport_XI_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
