...
public partial class staff_MarkEntryReport_XI : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("MarkEntryReportXI_1617.aspx?check=MarkEntryReport_XI");
            }
            else
            {
                Response.Redirect("MarksEntryReportXI_1718.aspx?check=MarkEntryReport_XI");
            }
    ...
    private void loadSubjectGroup()
    {
        ...
        else
        {
            ...
            sql +=  " Inner join SubjectGroupMaster sgm on sgm.Id=sm.GroupID and sgm.SessionName=sctm.SessionName";
    ...
    public void loadSubject()
    {
        ...
        else
        {
            ...
            sql +=  " and sm.GroupID='" + drpSubjectGroup.SelectedValue.ToString() + "'";
    ...
    public void loadsection()
    {
        ...
        {
            sql = "Select sm.SectionName,sm.id from SubjectClassTeacherMaster sctm";
