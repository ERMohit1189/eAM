<%@ Page Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="SubjectwiseColmulativeNew.aspx.cs" Inherits="_16_G6_SubjectwiseColmulativeNew" %>
    ...
    <script>
        ...
        function LoadFillList() {
           ...
           $("[id*=divList]").html("");
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ShowMarksLoad.aspx")%>',
                data: {
