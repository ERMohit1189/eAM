...
public partial class common_SmsAlertFroXI_1718 : Page
{
    ...
    private void loadBranch()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                sql +=  "   where EmpCode='" + Session["LoginName"].ToString() + "'   and bm.SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + " and IsClassTeacher=1 and T1.SessionName='" + Session["SessionName"] + "' and T1.Classid='" + drpclass.SelectedValue.ToString() + "'";
                BAL.objBal.FillDropDown_withValue(sql, drpBranch, "BranchName", "Id");
                drpBranch.Items.Insert(0, new ListItem("<--Select-->", "0"));
            }
        }
    ...
    public void loadSubjects()
    {
        ...
        sql +=  "   and sm.SectionName='" + drpsection.SelectedItem.Text + "' and spm.BranchCode=" + Session["BranchCode"] + " and sgm.BranchCode=" + Session["BranchCode"] + " and sm.BranchCode=" + Session["BranchCode"] + " and IsForExam=1 and IsForOnlyExam=1";
        sql +=  "     and sgm.SessionName='" + Session["SessionName"] + "'  and spm.SessionName='" + Session["SessionName"] + "'  and sm.SessionName='" + Session["SessionName"] + "' order by sgm.DisplayOrder Asc,sm.id Asc";
    ...
    public void loadStudents()
    {
        ...
        sql +=  "   where sc.SectionName='" + drpsection.SelectedItem.Text + "' and sg.SessionName='" + Session["SessionName"].ToString() + "' and ";
        sql +=  "   so.SessionName='" + Session["SessionName"].ToString() + "' and sf.SessionName='" + Session["SessionName"].ToString() + "' and cm.SessionName='" + Session["SessionName"].ToString() + "'";
        sql +=  "   and SC.SessionName='" + Session["SessionName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and sg.BranchCode=" + Session["BranchCode"] + " and sf.BranchCode=" + Session["BranchCode"] + " and sc.BranchCode=" + Session["BranchCode"] + " and so.BranchCode=" + Session["BranchCode"] + "  and";
        ...
        for (int i = 0; i < rptStudents.Items.Count; i++)
        {
            ...
            sql +=  "   inner join S02_SubjectPaperMaster spm on spm.S02ID=sm.PaperID and spm.SessionName=sm.SessionName   ";
            sql +=  "   inner join SubjectGroupMaster sgm on sgm.Id=spm.SubjectGroupID and sgm.SessionName=sm.SessionName  ";
            sql +=  "   where sm.Classid='" + drpclass.SelectedValue.ToString() + "' and spm.BranchCode=" + Session["BranchCode"] + " and sgm.BranchCode=" + Session["BranchCode"] + " and sm.BranchCode=" + Session["BranchCode"] + " and sm.branchid='" + drpBranch.SelectedValue.ToString() + "'";
    ...
    public string GetMMarks(string Eval, string subjectid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_CCEXIMMMarksForMessage", param);
    ...
    public string GetTestMarks(string Eval, string subjectid,string srno)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_CCEXIMarksForMessage", param);
