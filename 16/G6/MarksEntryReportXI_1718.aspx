<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryReportXI_1718.aspx.cs" Inherits="common_MarksEntryReportXI_1718" %>
                                                                ...
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowCreated="GridView1_RowCreated"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Prac. (B)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblPrac" runat="server" Text="Prac."></asp:Label>
                                                                                <br />
