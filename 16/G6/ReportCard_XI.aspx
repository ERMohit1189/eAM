<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_XI.aspx.cs" Inherits="ReportCard_XI" %>
                                                                            ...
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm1">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS <br />50</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test1<br />(25)</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test2<br />(25)</th>
                                                                                            <th style='vertical-align: middle;' colspan="3">H.Y. (100)</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL<br />(150)</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">GRADE</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th style='vertical-align: middle;'>TH</th>
                                                                                            <th style='vertical-align: middle;'>PRAC</th>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            ...
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblHYASSI"><%# Eval("HYPrac") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotal"><%# Eval("HYTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblHYGTotal"><%# Eval("HYGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblGrade"><%# Eval("HYGrade") %></asp:Label></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm1Aditional">
                                                                                 ...
                                                                                 <tr class="text_center">
                                                                                    <th class="text-left"><span><b>TOTAL</b></span></th>
                                                                                      <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label4"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT1Total_T1"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                        <asp:Label runat="server" ID="lblUT2Total_T1"></asp:Label></b></td>
                                                                                      <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label6"></asp:Label></b></td>
                                                                                       <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label7"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                                ...
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>PERCENTAGE</b></span></th>
                                                                                     <td style="text-align: center;">
                                                                                        <asp:Label runat="server" ID="Label5"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                        ...
                                                                        <table id="Term2Mark" class="Term2Mark table term2 tbl mp-table p-table-bordered table-bordered text_center hide" style="margin-bottom: 3px">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test1<br />(25)</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test2<br />(25)</th>
                                                                                         <%--   <th style='vertical-align: middle;' rowspan="2">Test1<br />(25)</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">Test2<br />(25)</th>--%>
                                                                                            <th style='vertical-align: middle;' colspan="3">H.Y. (100)</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL<br />(150)</th>
                                                                                             <th style='vertical-align: middle;' rowspan="2">TOTAL OF BEST 2 UTS<br />(50)</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test3<br />(25)</th>
                                                                                            <th style='vertical-align: middle;display:none;' rowspan="2">Test4<br />(25)</th>
                                                                                            <th style='vertical-align: middle;' colspan="3">A.E. (100)</th>
                                                                                            <th style='vertical-align: middle;' rowspan="2">TOTAL<br />(150)</th>
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            ...
                                                                                            <td style="text-align: center">
                                                                                             ...
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblAEASSI"><%# Eval("AEPrac") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblTotalAE"><%# Eval("AETotal") %></asp:Label></td>
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="lblAEGTotal"><%# Eval("AEGTotal") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2Aditional">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label8"><%# Eval("HighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT1"><%# Eval("HighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT2"><%# Eval("SecondHighestValue") %></asp:Label></td>
                                                                                            ...
                                                                                            <td></td>
                                                                                             <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label9"><%# Eval("ThirdHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT3"><%# Eval("ThirdHighestValue") %></asp:Label></td>
                                                                                            <td style="text-align: center;display:none;">
                                                                                                <asp:Label runat="server" ID="lblUT4"><%# Eval("ThirdSecondHighestValue") %></asp:Label></td>
                                                                                ...
                                                                                <tr class="text_center">
                                                                                    <th class="text-left"><span><b>TOTAL</b></span></th>
                                                                                     <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="Label10"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                ...
                                                                                <tr class="text_center">
                                                                                    ...
                                                                                    <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="Label21"></asp:Label></b></td>
                                                                                    <td style="text-align: center;display:none;">
                                                                                   ...
                                                                                   <td style="text-align: center">
                                                                                        <asp:Label runat="server" ID="Label20"></asp:Label></b></td>
                                                                                    <td style="text-align: center">
                                                                        ...
                                                                        <table class="table term2 tbl mp-table p-table-bordered table-bordered text-uppercase" style="margin-bottom: 2px;">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptAttendance1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="width: 23.2%;">Attendance</th>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptAttendance2">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th class="text-left" style="width:13.2%;">Attendance</th>
                                                                                            <td style="width:36.5%;" class="text-center"><%# Eval("t1Att") %></td>
