...
public partial class common_G6_ClassWiseCumulativeReport_XI_1718Server : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            {
                cmd.Connection = conn;
                cmd.CommandText = "ClasswiseCumulative_XI_2021";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int s = 0; s < dt.Rows.Count; s++)
                    {
                        ...
                        Response.Write("<tr><td>"+( TermNmae.Trim().ToLower() == "term1"?"T1":"T3" )+ "</td><td>" + (TermNmae.Trim().ToLower() == "term1" ? "T2" : "T4") + "</td><td>" + (TermNmae.Trim().ToLower() == "term1" ? "HY" : "AE") + "</td><td>PR.</td></tr>");
