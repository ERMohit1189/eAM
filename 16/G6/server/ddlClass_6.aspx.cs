...
public partial class common_G6_ddlClass_6 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["Logintype"].ToString() == "Admin" || Session["Logintype"].ToString() == "Guardian")
        {
            ...
            _sql +=  " inner join dt_ClassGroupMaster t1 on t1.ClassId=cm.Id and t1.SessionName=cm.SessionName";
            _sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and cm.BranchCode=" + Session["BranchCode"].ToString() + " and t1.BranchCode=" + Session["BranchCode"].ToString() + " and t1.SessionName='" + Session["SessionName"] + "' and GroupId='G6' Order by CIDOrder";
