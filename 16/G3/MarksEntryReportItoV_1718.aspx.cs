...
public partial class common_MarksEntryReportItoV_1718  : Page
{
    ...
    public void loadgrid()
    {
        ...
        if(drpEval.SelectedIndex!=0)
        {
            ...
            if (GridView1.Rows.Count > 0)
            {
                ...
                Label lblgrd1MMPrac = (Label)GridView1.HeaderRow.FindControl("lblMMPrac");
                ...
                lblgrd1MMPrac.Text = string.Empty;
            }
        }
        else
        {
            ...
            if (GridView2.Rows.Count > 0)
            {
                ...
                Label lblMMPrac = (Label)GridView2.HeaderRow.FindControl("lblMMPrac");
                ...
                Label lblMMPrac2 = (Label)GridView2.HeaderRow.FindControl("lblMMPrac2");
    ...
    {
        sql = "Select MaxMarks1,MaxMarks2,MaxMarks4,MaxMarks5,MaxMarks6,MaxMarks7 from SetMaxMinMarks_ItoV where Eval='" + Eval + "' and BranchCode=" + Session["BranchCode"] + " and paperid='" + drpSubject.SelectedValue.ToString().Trim() + "' and SessionName='" + Session["SessionName"].ToString() + "'";
    ...
    protected void loadMarks(GridView grd,string Eval,string test1,string test2,string nb,string se,string final, string prac, string total,string tenper, string finaltotal, string grademarks, string mmt1, string mmt2, string mmnb, string mmse, string mmfinal, string mmPrac)
    {
        if (grd.Rows.Count > 0)
        {
            ...
            foreach (GridViewRow gvr in grd.Rows)
            {
                ...
                sql = "Select Test1,Test2,SAT,NB,SE, Prac from CCEItoV where SRNO='" + lblsrno.Text + "' and BranchCode=" + Session["BranchCode"] + " and Evaluation='" + Eval + "' and paperid='" + drpSubject.SelectedValue.ToString() + "'";
