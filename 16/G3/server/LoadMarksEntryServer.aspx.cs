...
public partial class common_G4_LoadMarksEntryServer : System.Web.UI.Page
{
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        string sql1 = "Select UT1TH, UT1Viva, UT2TH, UT2Viva, HYTH, HYASSI, HYViva,UT3TH, UT3Viva, UT4TH, UT4Viva, AETH, AEASSI, AEViva from UPEMItoV ";
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            string sql3 = "Select Id,UT1TH, UT1Viva, UT2TH, UT2Viva, HYTH, HYASSI, HYViva, HYTotal, HYGrade, UT3TH, UT3Viva, UT4TH, UT4Viva, AETH, AEASSI, AEViva, AETotal, AEGrade,GTotal,GGrade from UPEItoV where SRNO='" + dt.Rows[i]["srno"].ToString() + "'  and SubjectId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and Medium='" + Medium + "' and SessionName='" + Session.ToString() + "' and BranchCode=" + BranchCode + "";
                            ...
                            if (Evail.ToLower() == "term1")
                            {
                                ...
                                HYTotal = (Convert.ToInt32((UT1TH.ToString() == "AB" || UT1TH.ToString() == "NAD" || UT1TH.ToString() == "ML") || string.IsNullOrEmpty(UT1TH.ToString()) ? "0" : UT1TH.ToString()) + Convert.ToInt32((UT1Viva.ToString() == "AB" || UT1Viva.ToString() == "NAD" || UT1Viva.ToString() == "ML") || string.IsNullOrEmpty(UT1Viva.ToString()) ? "0" : UT1Viva.ToString()) + Convert.ToInt32((UT2TH.ToString() == "AB" || UT2TH.ToString() == "NAD" || UT2TH.ToString() == "ML") || string.IsNullOrEmpty(UT2TH.ToString()) ? "0" : UT2TH.ToString()) + Convert.ToInt32((UT2Viva.ToString() == "AB" || UT2Viva.ToString() == "NAD" || UT2Viva.ToString() == "ML") || string.IsNullOrEmpty(UT2Viva.ToString()) ? "0" : UT2Viva.ToString()) + Convert.ToInt32((HYTH.ToString() == "AB" || HYTH.ToString() == "NAD" || HYTH.ToString() == "ML") || string.IsNullOrEmpty(HYTH.ToString()) ? "0" : HYTH.ToString()) + Convert.ToInt32((HYASSI.ToString() == "AB" || HYASSI.ToString() == "NAD" || HYASSI.ToString() == "ML") || string.IsNullOrEmpty(HYASSI.ToString()) ? "0" : HYASSI.ToString()) + Convert.ToInt32((HYViva.ToString() == "AB" || HYViva.ToString() == "NAD" || HYViva.ToString() == "ML") || string.IsNullOrEmpty(HYViva.ToString()) ? "0" : HYViva.ToString())).ToString();
                            ...
                            if (Evail.ToLower() == "term2")
                            {
                                ...
                                AETotal = oo.ReturnTag(sql3, "AETotal");
                                AEGrade = oo.ReturnTag(sql3, "AEGrade");
                                AETotal = (Convert.ToInt32((UT3TH.ToString() == "AB" || UT3TH.ToString() == "NAD" || UT3TH.ToString() == "ML") || string.IsNullOrEmpty(UT3TH.ToString()) ? "0" : UT3TH.ToString()) + Convert.ToInt32((UT3Viva.ToString() == "AB" || UT3Viva.ToString() == "NAD" || UT3Viva.ToString() == "ML") || string.IsNullOrEmpty(UT3Viva.ToString()) ? "0" : UT3Viva.ToString()) + Convert.ToInt32((UT4TH.ToString() == "AB" || UT4TH.ToString() == "NAD" || UT4TH.ToString() == "ML") || string.IsNullOrEmpty(UT4TH.ToString()) ? "0" : UT4TH.ToString()) + Convert.ToInt32((UT4Viva.ToString() == "AB" || UT4Viva.ToString() == "NAD" || UT4Viva.ToString() == "ML") || string.IsNullOrEmpty(UT4Viva.ToString()) ? "0" : UT4Viva.ToString()) + Convert.ToInt32((AETH.ToString() == "AB" || AETH.ToString() == "NAD" || AETH.ToString() == "ML") || string.IsNullOrEmpty(AETH.ToString()) ? "0" : AETH.ToString()) + Convert.ToInt32((AEASSI.ToString() == "AB" || AEASSI.ToString() == "NAD" || AEASSI.ToString() == "ML") || string.IsNullOrEmpty(AEASSI.ToString()) ? "0" : AEASSI.ToString()) + Convert.ToInt32((AEViva.ToString() == "AB" || AEViva.ToString() == "NAD" || AEViva.ToString() == "ML") || string.IsNullOrEmpty(AEViva.ToString()) ? "0" : AEViva.ToString())).ToString();
                                Response.Write("<tr id=" + id + ">");
                                Response.Write("<td class='p-tot-tit p-pad-n'><span id=''>" + (i + 1) + "</span></td>");
                                Response.Write("<td class='p-tot-tit p-pad-n'><span id=''>" + dt.Rows[i]["srno"].ToString().ToUpper() + "</span></td>");
                                Response.Write("<td class='p-tot-tit p-pad-n' style='text-align:left !important; width:20%;'><span id=''>" + dt.Rows[i]["Name"].ToString().ToUpper() + "</span></td>");
