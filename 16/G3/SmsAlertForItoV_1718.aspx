<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" CodeFile="SmsAlertForItoV_1718.aspx.cs" Inherits="common_SmsAlertFroItoV_1718" %>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="p-pad-3 p-tot-tit" colspan="100">
                                                            <div id="header" runat="server" class="col-sm-12"></div>
