...
public partial class AditionalGradeEntry : System.Web.UI.Page
{
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " and cm.id in(select ClassId from dt_ClassGroupMaster where GroupId='G3' and SessionName='" + Session["SessionName"] + "' and BranchCode=" + Session["BranchCode"] + ")";
    ...
    public void loadgrid()
    {
        ...
        sql +=  "  left join UPEAditionalEntryItoV g on g.ClassId=asr.ClassId and g.BranchId=asr.BranchId and g.SectionId=asr.SectionID and g.BranchCode=asr.BranchCode and g.SessionName=asr.SessionName and g.SrNo=asr.SrNo and SubjectId=" + drpSubject.SelectedValue + " and PaperId=" + drpPaper.SelectedValue + "";
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (GridView1.Rows.Count > 0)
        {
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                cmd = new SqlCommand();
                cmd.CommandText = "sp_UPEAditionalEntryItoV";
