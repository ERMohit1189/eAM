...
public partial class staff_MarkEntryReportItoV : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("MarkEntryReportItoV_1617.aspx?check=MarkEntryReport_ItoV");
            }
            else
            {
    ...
    public void loadgrid()
    {
        ...
        sql +=  " where SO.AdmissionForClassId='" + drpclass.SelectedValue.ToString() + "' and Scm.SectionName='" + drpsection.SelectedValue.ToString() + "' and scm.ClassNameId='" + drpclass.SelectedValue.ToString() + "'";
        ...
        if (GridView1.Rows.Count > 0)
        {
            if (GridView1.Rows.Count > 0)
            {
                for (int i = 0; i < GridView1.Rows.Count; i++)
                {
                  ...
                  loadFA1Data(i, "EVALUATION1", "Label2", "Label6", "Label9", "Label19", "Label20", "Label21");
        ...
        if (GridView2.Rows.Count > 0)
        {
            if (GridView2.Rows.Count > 0)
            {
                for (int i = 0; i < GridView2.Rows.Count; i++)
                {
                 ...
                 loadFA1Data1(i, drpEval.SelectedItem.ToString().ToUpper(), "Label2", "Label6", "Label9", "Label19", "Label20", "Label21");
    ...
    public void loadFA1Data1(int i, string Eval, string Srno, string text1, string text2, string total, string percent, string grade)
    {
    ...
    protected void GridView1_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 5, "EVALUATION1", System.Drawing.Color.LightGray.Name);
            //AddMergedCells(objgridviewrow, objtablecell, 1, "", System.Drawing.Color.LightGray.Name);
    ...
    protected void GridView2_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            AddMergedCells(objgridviewrow, objtablecell, 1, "S.R.No.", System.Drawing.Color.LightGray.Name);
            AddMergedCells(objgridviewrow, objtablecell, 1, "Student's Name", System.Drawing.Color.LightGray.Name);
            AddMergedCells(objgridviewrow, objtablecell, 5, drpEval.SelectedItem.ToString().ToUpper(), System.Drawing.Color.LightGray.Name);
            objGridView.Controls[0].Controls.AddAt(0, objgridviewrow);
