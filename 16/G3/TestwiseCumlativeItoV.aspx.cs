...
public partial class TestwiseCumlativeItoV : Page
{
    ...
    public void loadclass()
    {
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and cm.BranchCode=" + Session["BranchCode"] + " and GroupId='G3' Order by CIDOrder";
        ...
        else
        {
            ...
            sql +=  " where GroupId='G3'  and sctm.SessionName='" + Session["SessionName"].ToString() + "' and sctm.BranchCode=" + Session["BranchCode"] + " and Ecode='" + Session["LoginName"].ToString() + "' Order by CIDOrder";
            oo.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
        }
    }
    ...
    public string GetMMarks(string subjectid, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEMItoV", param);
            if (ds != null)
            {
    ...
    public string GetTestMarks(string srno, string subjectid, string paperid, string IsAdditional)
    {
        ...
        try
        {
            ...
            if (srno== "27/2600")
            {
                ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEItoVNew", param);
            }
            else
            {
                ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeUPEItoVNew", param);
