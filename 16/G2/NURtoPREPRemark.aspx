<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="NURtoPREPRemark.aspx.cs" Inherits="common_NURtoPREPRemark" %>
                                    ...
                                    <div id="mainDiv" class="col-sm-12  no-padding " runat="server">
                                        ...
                                        <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="drpRemark" runat="server" AutoPostBack="True"
                                                            OnSelectedIndexChanged="drpRemark_SelectedIndexChanged" CssClass="form-control-blue ">
                                                            <asp:ListItem Value="generalremark">General Remark</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                                <div class="text-box-msg">
                                        ...
                                        <asp:Repeater ID="rpt" runat="server">
                                            <HeaderTemplate>
                                                ...
                                                <div class="col-md-12 well" style="padding: 3px 0 3px 0; margin-bottom: 5px; background-color: rgba(35, 112, 158, 0.85); color: white;">
