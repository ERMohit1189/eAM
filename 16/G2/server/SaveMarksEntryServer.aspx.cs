...
public partial class _16_G2_server_SaveMarksEntryServer : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            try
            {
                ...
                if (double.TryParse(MaxMarksArr1[0], out mno) == false || double.TryParse(MaxMarksArr1[1], out mno) == false || double.TryParse(MaxMarksArr1[2], out mno) == false || double.TryParse(MaxMarksArr1[3], out mno) == false || double.TryParse(MaxMarksArr1[4], out mno) == false || double.TryParse(MaxMarksArr1[5], out mno) == false || double.TryParse(MaxMarksArr1[6], out mno) == false)
                {
                    error1 = true;
                ...
                if (error1 == false)
                {
                    ...
                    cmd.CommandText = "Sp_PrePrimaryEntryMarks";
                    ...
                    {
                        cmd.Parameters.AddWithValue("@UT1TH", MaxMarksArr[0]);
                        cmd.Parameters.AddWithValue("@UT1Viva", MaxMarksArr[1]);
                        cmd.Parameters.AddWithValue("@UT2TH", MaxMarksArr[2]);
                        cmd.Parameters.AddWithValue("@UT2Viva", MaxMarksArr[3]);
                    ...
                    {
                        cmd.Parameters.AddWithValue("@UT3TH", MaxMarksArr[0]);
                        cmd.Parameters.AddWithValue("@UT3Viva", MaxMarksArr[1]);
                        cmd.Parameters.AddWithValue("@UT4TH", MaxMarksArr[2]);
                        cmd.Parameters.AddWithValue("@UT4Viva", MaxMarksArr[3]);
                        cmd.Parameters.AddWithValue("@AETH", MaxMarksArr[4]);
                        cmd.Parameters.AddWithValue("@AEASSI", MaxMarksArr[5]);
                        cmd.Parameters.AddWithValue("@AEViva", MaxMarksArr[6]);
                    }
                    ...
                    for (int i = 0; i < MarksFullArr.Length - 1; i++)
                    {
                        ...
                        if (Evaluation.ToLower() == "term1")
                        {
                            cmd.Parameters.AddWithValue("@UT1TH", MarksArr[1]);
                            cmd.Parameters.AddWithValue("@UT1Viva", MarksArr[2]);
                            cmd.Parameters.AddWithValue("@UT2TH", MarksArr[3]);
                            cmd.Parameters.AddWithValue("@UT2Viva", MarksArr[4]);
                            cmd.Parameters.AddWithValue("@HYTH", MarksArr[5]);
                            cmd.Parameters.AddWithValue("@HYASSI", MarksArr[6]);
                            cmd.Parameters.AddWithValue("@HYViva", MarksArr[7]);
                            cmd.Parameters.AddWithValue("@HYTotal", MarksArr[8]);
                            cmd.Parameters.AddWithValue("@HYGrade", MarksArr[9]);
                        }
                        if (Evaluation.ToLower() == "term2")
                        {
                            cmd.Parameters.AddWithValue("@UT3TH", MarksArr[1]);
                            cmd.Parameters.AddWithValue("@UT3Viva", MarksArr[2]);
                            cmd.Parameters.AddWithValue("@UT4TH", MarksArr[3]);
                            cmd.Parameters.AddWithValue("@UT4Viva", MarksArr[4]);
                            cmd.Parameters.AddWithValue("@AETH", MarksArr[5]);
                            cmd.Parameters.AddWithValue("@AEASSI", MarksArr[6]);
                            cmd.Parameters.AddWithValue("@AEViva", MarksArr[7]);
                            cmd.Parameters.AddWithValue("@AETotal", MarksArr[8]);
                            cmd.Parameters.AddWithValue("@AEGrade", MarksArr[9]);
                        }
