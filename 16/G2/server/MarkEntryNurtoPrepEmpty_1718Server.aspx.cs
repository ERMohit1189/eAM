            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        if (DisableTest1 == "hide" && DisableTest2 == "hide")
                        {
                            monthlyTest1 = "hide";
                        }
                        if (DisableTest4 == "hide" && DisableTest5 == "hide")
                        {
                            monthlyTest2 = "hide";
                        }

                        string MaxMarks1 = "", MaxMarks2 = "", MaxMarks4 = "", MaxMarks5 = "", MaxMarks6 = "";
                        double MaxMarks1M = 0, MaxMarks2M = 0, MaxMarks4M = 0, MaxMarks5M = 0, MaxMarks6M = 0;
                        string sql1 = "Select MaxMarks1,MaxMarks2,MaxMarks3,MaxMarks4,MaxMarks5,MaxMarks6 from SetMaxMinMarks_NurtoPrep where Eval='" + Evail.ToString().Trim() + "' and BranchCode=" + BranchCode.ToString() + " and SubjectActivityId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "'";
                        ...
                        if (Evail.ToLower()=="term1")
                        {
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in " + DisableTest1 + "' scope='col'><span id=''> U. T. I </span><br><input name='' type='text' value='" + MaxMarks1.ToString() + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in " + DisableTest2 + "' scope='col'><span id=''> U. T. II </span><br><input name='' type='text' value='" + MaxMarks2.ToString() + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70 " + monthlyTest1 + "' scope='col'>Best One Test</th>");
                            Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70 " + monthlyTest1 + "' scope='col'>Conv. into 10</th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> N.B.A.</span><br><input name='' type='text' value='" + (MaxMarks4 == "" ? "5" : MaxMarks4).ToString() + "' id='MaxMarks4' class='form-control-blue text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> S.E.</span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "5" : MaxMarks5).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;'></th>");
                        ...
                        {
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in " + DisableTest4 + "' scope='col'><span id=''> U. T. III </span><br><input name='' type='text' value='" + MaxMarks1.ToString() + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in " + DisableTest5 + "' scope='col'><span id=''> U. T. IV </span><br><input name='' type='text' value='" + MaxMarks2.ToString() + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70 " + monthlyTest2 + "' scope='col'>Best One Test</th>");
                            Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70 " + monthlyTest2 + "' scope='col'>Conv. into 10</th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> N.B.A.</span><br><input name='' type='text' value='" + (MaxMarks4 == "" ? "5" : MaxMarks4).ToString() + "' id='MaxMarks4' class='form-control-blue text-center' style='width:40px;'></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> S.E.</span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "5" : MaxMarks5).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;'></th>");
                        ...
                        {
                            string Test1 = "", Test2 = "", NB = "", SE = "", SAT = "", id = "";
                            double Test1M = 0, Test2M = 0,  NBM = 0, SEM = 0, SATM = 0;
                            string sql3 = "Select Id,Test1,Test2,Test3,SAT,NB,SE from CCENurtoPrep_1718 where SRNO='" + dt.Rows[i]["srno"].ToString() + "' and Evaluation='" + Evail.ToString().Trim() + "' and BranchCode=" + BranchCode.ToString() + " and SubjectId='" + SubjectId.ToString().Trim() + "' and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "' and SectionName='" + SectionName.ToString() + "' and BranchCode=" + BranchCode + "";
                            ...
                            ObtMarks1 = (Math.Round(percentle1 + NBM + SEM + SATM)).ToString();
                            ...
                            Response.Write("<td class='p-pad-n text-center tab-in " + (Evail.ToLower() == "term1" ? DisableTest1 : DisableTest4) + "'><input type='text' value='" + Test1.ToString() + "' class='form-control-blue text-center' name='1' style='width:40px;'></td>");
                            Response.Write("<td class='p-pad-n text-center tab-in " + (Evail.ToLower() == "term1" ? DisableTest2 : DisableTest5) + "'><input type='text' value='" + Test2.ToString() + "' class='form-control-blue text-centern' name='2' style='width:40px;'></td>");
                            ...
                            Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + NB.ToString() + "' class='form-control-blue text-center' name='4' style='width:40px;'></td>");
                            Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + SE.ToString() + "' class='form-control-blue text-center' name='5' style='width:40px;'></td>");
