...
public partial class ddlSubject_MarkEntry_2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            _sql +=  " where Ecode='" + Session["LoginName"].ToString() + "'  and ApplicableFor<>'TimeTable' and  IsAditional=0 and sctm.ClassId=" + drpclass.ToString() + " and sctm.sectionid=" + sectionId + " ";
