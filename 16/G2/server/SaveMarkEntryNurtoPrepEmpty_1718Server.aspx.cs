        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            try
            {
                ...
                if(error1==false)
                {
                    ...
                    cmd.CommandText = "SetMaxMinMarksProc_NurtoPrep";
                    ...
                    for (int i = 0; i < MarksFullArr.Length - 1; i++)
                    {
                        ...
                        string[] MarksArr = MarksFullArr[i].Split(new string[] { "##" }, StringSplitOptions.None);
                            ...
                            cmd.CommandText = "USP_MarkEntry_CCENurtoPrep_1718";
                            cmd.CommandType = CommandType.StoredProcedure;
                            ...
                            cmd.Parameters.AddWithValue("@NB", MarksArr[3]);
                            cmd.Parameters.AddWithValue("@SE", MarksArr[4]);
