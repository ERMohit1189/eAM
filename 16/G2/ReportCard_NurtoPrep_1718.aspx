<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_NurtoPrep_1718.aspx.cs" Inherits="common_G2_ReportCard_NurtoPrep_1718" %>
                                    ...
                                    <div id="divExport">
                                        <div class="col-sm-12 box-border-solid-h-a3 text-uppercase" style="padding: 5px;">
                                            <asp:Repeater runat="server" ID="rptStudent">
                                                <ItemTemplate>
                                                    <div id="break_div" class="term2 table-responsive" style="height: 1020px; page-break-after: always; padding: 5px; margin-top: 5px; border: 3px double #000;">
                                                        <table class="front table mp-table text-uppercase" style="margin-bottom: 5px; text-transform: uppercase; width: 100%;">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td colspan="3" style="padding: 5px !important; padding-bottom: 2px !important;">
                                                                    ...
                                                                    <td colspan="3" style="padding: 5px !important; padding-top: 0px !important;">
                                                                        <table class="front table term2 tbl mp-table p-table-bordered table-bordered text_center" style="margin-bottom: 10px">
                                                                            <tbody>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptmarksT1">
                                                                                    ...
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th class="text_center" style=" vertical-align: middle;">SCHOLASTIC AREAS</th>
                                                                                            <th colspan="4" style=" vertical-align: middle;">HALF YEARLY EXAMINATION</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptmarksT2">
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            <th class="text_center" style=" vertical-align: middle;">SCHOLASTIC AREAS</th>
                                                                                            <th colspan="4" style=" vertical-align: middle;">HALF YEARLY EXAMINATION</th>
                                                                                            <th colspan="7" style=" vertical-align: middle;">ANNUAL EXAMINATION</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <th style=' vertical-align: middle;'>SUBJECT</th>
                                                                                            <th style=' vertical-align: middle;'>IA<br>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptRemark1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td class="text-left"><span class='sentence-case'><%# Eval("Caption1") %></span></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                                <asp:Repeater runat="server" ID="rptRemark2">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="width: 32%;" class="text-left"><span class='sentence-case'><%# Eval("Caption1") %></span></td>
                                                                                            <td style="width: 32%;" class="text-left"><span class='sentence-case'><%# Eval("Caption2") %></span></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                            </tbody>
                                                                        ...
                                                                        <div class="col-sm-12 no-padding text-uppercase" style="padding: 0px; margin: 0px;">
                                                                            <table class="table" style="text-align: center; margin: 0px; padding: 10px; margin-top: 5px; width: 100%;">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="width: 49%; padding: 0px !important; vertical-align: top; padding-right: 5px !important;">
                                                                                            <table class="table mp-table tbl p-table-bordered table-bordered" style="text-align: center; margin-bottom: 0px;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <th style="padding: 6px 5px !important;" colspan="4" class="text-center">GRADING SCALE FOR SCHOLASTIC AREAS</th>
                                                                                                        <th style="padding: 6px 5px !important;" colspan="2" class="text-center">GRADING SCALE FOR CO-SCHOLASTIC AREAS</th>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th style="padding: 6px 5px !important;" class="text-center">MARKS RANGE</th>
                                                                                                        <th style="padding: 6px 5px !important;" class="text-center">GRADE</th>
                                                                                                        <th style="padding: 6px 5px !important;" class="text-center">MARKS RANGE</th>
                                                                                                        <th style="padding: 6px 5px !important;" class="text-center">GRADE</th>
                                                                                                        <th style="padding: 6px 5px !important;" class="text-center">3-POINT GRADING SCALE</th>
                                                                                                        <th style="padding: 6px 5px !important;" class="text-center">GRADE</th>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">91-100</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">A1</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">51-60</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">C1</td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">81-90</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">A2</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">40-50</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">C2</td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">71-80</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">B1</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center" rowspan="2">39 &amp; Below</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center" rowspan="2">E (Essential Repeat)</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">Fair</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">C</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">61-70</td>
                                                                                                        <td style="padding: 6px 5px !important;" class="text-center">B2</td>
                                                                                        ...
                                                                                        <td style="width: 49%; padding: 0px !important; vertical-align: top;">
                                                                                            ...
                                                                                            <asp:Chart ID="myChart" runat="server" BorderWidth="0" Width="550" Height="150" BackImage="" style="margin-right: 5px !important; margin-top: 25px !important;">
                                                                                                <Titles>
                                                    ...
                                                    <div id="break_div" class="term2" style="height: 1020px; page-break-after: always; padding: 10px; border: 3px double #000;">
                                                        <table class="table term2 tbl mp-table p-table-bordered table-bordered text-uppercase" style="margin-top: 0px; margin-bottom: 10px">
                                                            <tbody>
                                                                <asp:Repeater runat="server" ID="rptSkil1">
                                                                    <HeaderTemplate>
                                                                        <tr>
                                                                            <th style="padding: 1.5px 5px !important;" class="text-left text-uppercase">SKILL DEVELOPMENT Term-1<br>
                                                                                <span style="font-weight: 100 !important;">[on a 3-point(A-C) grading scale]</span></th>
                                                                            <th style="padding: 1.5px 5px !important;" style="width: 10%; vertical-align: top;" class="text-uppercase">Grade</th>
                                                                        </tr>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                ...
                                                                <asp:Repeater runat="server" ID="rptSkil2">
                                                                    <HeaderTemplate>
                                                                        <tr>
                                                                            <th style="padding: 1.5px 5px !important;" class="text-left text-uppercase">SKILL DEVELOPMENT Term-1<br>
                                                                                <span style="font-weight: 100 !important;">[on a 3-point(A-C) grading scale]</span></th>
                                                                            <th style="width: 10%; vertical-align: top;padding: 1.5px 5px !important;" class="text-uppercase">Grade</th>
                                                                            <th style="padding: 1.5px 5px !important;" class="text-left text-uppercase">SKILL DEVELOPMENT Term-2<br>
                                                                                <span style="font-weight: 100 !important;">[on a 3-point(A-C) grading scale]</span></th>
                                                                            <th style="width: 10%; vertical-align: top;padding: 1.5px 5px !important;">Grade</th>
                                                                        </tr>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            <th colspan="4" style="text-align: left;padding: 1.5px 5px !important;"><span class="text-uppercase"><%# Eval("CoscholasticGroup") %></span></th>
                                                                        </tr>
                                                                        <asp:Repeater runat="server" ID="rptSkil2A">
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    <td style="padding: 1.5px 5px !important;"><span class="text-uppercase"><%# Eval("CoscholasticName_1") %></span></td>
                                                                                    <td style="padding: 1.5px 5px !important;" class="text-center"><span><%# Eval("Grade_1") %></span></td>
                                                                                    <td style="padding: 1.5px 5px !important;"><span class="text-uppercase"><%# Eval("CoscholasticName_2") %></span></td>
