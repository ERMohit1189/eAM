<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/11/comman_root_manager.master" CodeFile="ClasswiseReportPrePrimary.aspx.cs" Inherits="_16_G2_ClasswiseReportPrePrimary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadMedium() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlMedium_MarkEntry_2.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadBranch() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlBranch_MarkEntry_2.aspx") %>',
        ...
        function LoadFillList() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ShowMarksEntry.aspx") %>',
                data: {
