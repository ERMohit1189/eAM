        ...
        $(document).ready(function () {
            ...
            $(document).on('blur', 'input[type=text]', function () {
                ...
                if (values != 'NP' && values != 'NAD' && values != 'ML' && isNaN(parseFloat($(this).val()))) {
                    ...
                    var Test1 = 0, Test2 = 0, NB = 0, SE = 0, SAT = 0;
                    var MaxMarks1 = 0, MaxMarks2 = 0, MaxMarks4 = 0, MaxMarks5 = 0, MaxMarks6 = 0;
                    ...
                    if (!isNaN(parseFloat($("[id*=divList] table tbody tr:eq(0) th:eq(9) input[type=text]").val()))) {
                        MaxMarks4 = parseFloat($("[id*=divList] table tbody tr:eq(0) th:eq(9) input[type=text]").val());
                    }
                    ...
                    var sum1 = 0, maxsum1 = 0, sum2 = 0, maxsum2 = 0, totalmarks1 = 0, totalmmmarks1 = 0, percentle1 = 0, total = 0;
                    ...
                    if (percentle1 != 0) {
                        total = parseFloat(percentle1 + NB + SE + SAT);
                    }
                    var grade1 = "";
                    if (total < 33) {
                        grade1 = "E";
                    ...
                    if (isMax != "Yes") {
                        ...
                        $(this).closest('tr').find('td:eq(11) span').html(total.toFixed(0));
