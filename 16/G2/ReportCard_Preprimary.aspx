<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/11/comman_root_manager.master" CodeFile="ReportCard_Preprimary.aspx.cs" Inherits="_16_G2_ReportCard_Preprimary" %>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm1Aditional">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                             <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label1"><%# Eval("UT1") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label2"><%# Eval("UT2") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label3"><%# Eval("HY") %></asp:Label></td>
                                                                                            <td></td>
                                                                                            <td></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label4"><%# Eval("UT1") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label5"><%# Eval("UT2") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label6"><%# Eval("HY") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptMarkTerm2Aditional">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <tr class="text_center">
                                                                                            <th style="text-align: left;"><%# Eval("SubjectName") %></th>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label7"><%# Eval("UT1") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label8"><%# Eval("UT2") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label9"><%# Eval("HY") %></asp:Label></td>
                                                                                            <td></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label10"><%# Eval("UT3") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label11"><%# Eval("UT4") %></asp:Label></td>
                                                                                            <td style="text-align: center">
                                                                                                <asp:Label runat="server" ID="Label12"><%# Eval("AE") %></asp:Label></td>
                                                                                            <td></td>
                                                                                            <td></td>
                                                                                            <td></td>
                                                                                        </tr>
