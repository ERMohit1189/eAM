<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true"
     CodeFile="TestwiseCumlativeNurtoPrep.aspx.cs" Inherits="TestwiseCumlativeNurtoPrep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            ...
                                            <asp:DropDownList ID="drptest" runat="server" CssClass="form-control-blue" AutoPostBack="True" OnSelectedIndexChanged="drptest_SelectedIndexChanged">
                                                <asp:ListItem Value="Test1">U. T. I</asp:ListItem>
                                                <asp:ListItem Value="Test2">U. T. II</asp:ListItem>
                                                <asp:ListItem Value="HY">H. Y. E.</asp:ListItem>
                                                <asp:ListItem Value="Test4">U. T. III</asp:ListItem>
                                                <asp:ListItem Value="Test5">U. T. IV</asp:ListItem>
                                                <asp:ListItem Value="AE">A. E.</asp:ListItem>
                                            </asp:DropDownList>
                                            ...
                                            <table class="table table-striped no-bm no-head-border table-bordered pro-table table-header-group">
                                                <tbody>
                                                    ...
                                                    <asp:Repeater ID="rptStudents" runat="server">
                                                     ...
                                                     <tr><th colspan="9" style="height: 30px;">Teacher's Sign</th></tr>
                                                    <tr><td style="height: 70px;"></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
                                                    <tr><td style="height: 70px;" colspan="9">
  ...
  function exceller() {
    ...
    link.download = "TestwiseCumulativeNurToPrep.xls";
