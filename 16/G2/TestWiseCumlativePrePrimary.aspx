...
<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" 
    ValidateRequest="false" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="TestWiseCumlativePrePrimary.aspx.cs" Inherits="_16_G2_TestWiseCumlativePrePrimary" %>
        ...
        <ContentTemplate>
                                        ...
                                        <div class=" table-responsive  table-responsive2 " id="abc" runat="server">
                                            ...
                                            <div class="col-sm-12 text-center">
                                                <span style="font-weight: bold; font-family: Verdana; font-size: 14px">Test:&nbsp;</span><asp:Label ID="lblTest" runat="server" Text="" Style="font-size: 14px"></asp:Label>&nbsp;|&nbsp;
                                                                ...
                                                                <span style="font-weight: bold; font-family: Verdana; font-size: 14px">Eval.:&nbsp;</span>
                                                <asp:Label ID="lblEval" runat="server" Text="" Style="font-size: 14px"></asp:Label>
                                            </div>
            ...
            <script>
                function exceller() {
                    ...
                    link.download = "TestwiseCumulativeVItoVIII.xls";
