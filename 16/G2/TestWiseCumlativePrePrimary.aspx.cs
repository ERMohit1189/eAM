...
public partial class _16_G2_TestWiseCumlativePrePrimary : System.Web.UI.Page
{
    ...
    public string GetMMarks(string subjectid, string paperid)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativePreMaxPrimary", param);
            if (ds != null)
            {
    ...
    public string GetTestMarks(string srno, string subjectid, string paperid,string IsAdditional)
    {
        ...
        try
        {
            ...
            ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativePrePrimaryNew", param);
