        ...
        updateCalendars: function () {
            ...
            for (var range in this.ranges) {
                if (this.timePicker) {
                    ...
                    if (this.startDate.format('dd-MMM-yyyy') == this.ranges[range][0].format('dd-MMM-yyyy') && this.endDate.format('dd-MMM-yyyy') == this.ranges[range][1].format('dd-MMM-yyyy')) {
                        customRange = false;
                        this.container.find('.ranges li:eq(' + i + ')').addClass('active');
                    }
                }
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if ((minDate && calendar[row][col].isBefore(minDate)) || (maxDate && calendar[row][col].isAfter(maxDate))) {
                        cname = ' off disabled ';
                    } else if (calendar[row][col].format('dd-MMM-yyyy') == selected.format('dd-MMM-yyyy')) {
                        cname += ' active ';
                        if (calendar[row][col].format('dd-MMM-yyyy') == this.startDate.format('dd-MMM-yyyy')) {
                            cname += ' start-date ';
                        }
                        if (calendar[row][col].format('dd-MMM-yyyy') == this.endDate.format('dd-MMM-yyyy')) {
                            cname += ' end-date ';
                        }
