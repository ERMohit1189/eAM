    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        var body =
                   ...
                   '<input class="note-image-url form-control-blue span12" type="text" />';
      ...
      var tplLinkDialog = function () {
        var body = '<div class="form-group">' +
                     ...
                     '<input class="note-link-text form-control-blue span12" type="text" />' +
                   '</div>' +
                   '<div class="form-group">' +
                     '<label>' + lang.link.url + '</label>' +
                     '<input class="note-link-url form-control-blue span12" type="text" />' +
                   '</div>' +
      ...
      var tplVideoDialog = function () {
        var body = '<div class="form-group">' +
                     ...
                     '<input class="note-video-url form-control-blue span12" type="text" />' +
                   '</div>';
