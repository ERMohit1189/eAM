                                                ...
                                                <ItemTemplate>
                                                    <div class="term2" style="page-break-after: always; padding: 5px; border: 3px double #000;">
                                                        <table class="front table mp-table text-uppercase" style="margin-bottom: 5px; text-transform: uppercase; width: 100%;">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="border: none !important; padding-bottom: 2px !important;">
                                                                        ...
                                                                        <table class="front table term2 tbl mp-table p-table-bordered table-bordered text_center" style="margin-bottom: 10px; page-break-after: always;">
                                                                            <tbody>
                                                    ...
                                                    <div class="term2" style="page-break-after: always; padding: 10px; border: 3px double #000;">
                                                        <table class="front table mp-table text-uppercase" style="margin-bottom: 5px; text-transform: uppercase; width: 100%;">
                                                            <tbody>
                                                                        ...
                                                                        <asp:Repeater runat="server" ID="rptSkil1">
                                                                            <HeaderTemplate>
                                                                                <tr>
                                                                                    <th style="vertical-align: middle; text-align: center; width: 7%;color: #0054b6 !important;">S.R. NO.</th>
                                                                                    <th style="padding: 1px 5px !important; vertical-align: middle; text-align: center; width: 43%;color: #0054b6 !important;" class="text-left text-uppercase">CO-SCHOLASTIC</span></th>
                                                                                    <th style="padding: 1px 5px !important; vertical-align: middle; text-align: center;color: #0054b6 !important;" class="text-left text-uppercase">TERM 1</span></th>
                                                                                </tr>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    <th style="text-align: center; font-weight: bold;">
                                                                                        <asp:Label runat="server" ID="Sno1"></asp:Label></th>
                                                                                    <th colspan="2" style="text-align: left; padding: 1px 5px !important;"><span class="text-uppercase" style="color: #0054b6 !important;"><%# Eval("CoscholasticGroup") %></span></th>
                                                                                </tr>
                                                                                <asp:Repeater runat="server" ID="rptSkil1A">

                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th style="text-align: center; font-weight: bold; color: #000 !important; width: 7%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label runat="server" Style="color: #000 !important;" ID="Sno2"></asp:Label></th>
                                                                                            <td style="padding: 1px 5px !important;"><span class="text-uppercase"><%# Eval("CoscholasticName_1") %></span></td>
                                                                                            <td style="padding: 1px 5px !important;" class="text-center"><span><%# Eval("Grade_1") %></span></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:Repeater runat="server" ID="rptSkil2">
                                                                            <HeaderTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <th style="padding: 1px 5px !important; vertical-align: middle; text-align: center; width: 43%;color: #0054b6 !important;" class="text-left text-uppercase">CO-SCHOLASTIC</span></th>
                                                                                    <th style="padding: 1px 5px !important; vertical-align: middle; text-align: center;color: #0054b6 !important;" class="text-left text-uppercase">TERM 1</span></th>
                                                                                    <th style="padding: 1px 5px !important; vertical-align: middle; text-align: center ;color: #0054b6 !important;" class="text-left text-uppercase">TERM 2</span></th>
                                                                                </tr>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    <th style="text-align: center; font-weight: bold;vertical-align: middle; text-align: center; width: 7%;">
                                                                                        <asp:Label runat="server" ID="Sno1"></asp:Label></th>
                                                                                    <th colspan="3" style="text-align: left; padding: 1px 5px !important;vertical-align: middle; width: 93%;"><span class="text-uppercase" style="color: #0054b6 !important;"><%# Eval("CoscholasticGroup") %></span></th>
                                                                                </tr>
                                                                                <asp:Repeater runat="server" ID="rptSkil2A">

                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th style="text-align: center; font-weight: bold; color: #000 !important;vertical-align: middle; text-align: center; width: 7%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label runat="server" Style="color: #000 !important;" ID="Sno2"></asp:Label></th>
                                                                                            <td style="padding: 1px 5px !important;vertical-align: middle; text-align: left; width: 43%;"><span class="text-uppercase"><%# Eval("CoscholasticName_1") %></span></td>
                                                                                            <td style="padding: 1px 5px !important;vertical-align: middle; text-align: left; width: 25%;" class="text-center"><span><%# Eval("Grade_1") %></span></td>
                                                                                            <td style="padding: 1px 5px !important;vertical-align: middle; text-align: left; width: 25%;" class="text-center"><span><%# Eval("Grade_2") %></span></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <table class="table tbl term2 mp-table p-table-bordered table-bordered text-uppercase" style="margin-bottom: 0px; margin-top: 0px; width: 100%;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th>
                                                                                        <asp:Label runat="server" ID="lblHeightTerm1" Style="color: #000 !important;"></asp:Label></th>
                                                                                    <th class="thTerm2">
                                                                                        <asp:Label runat="server" ID="lblHeightTerm2" Style="color: #000 !important;"></asp:Label></th>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th colspan="2" style="text-align: left; color: #000 !important;">WEIGHT (KG.)</th>
                                                                                    <th>
                                                                                        <asp:Label runat="server" ID="lblWeightTerm1" Style="color: #000 !important;"></asp:Label></th>
                                                                                    <th class="thTerm2">
                                                                                        <asp:Label runat="server" ID="lblWeightTerm2" Style="color: #000 !important;"></asp:Label></th>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <table class="table tbl term2 mp-table p-table-bordered table-bordered text-uppercase" style="margin-bottom: 0px; margin-top: 0px; width: 100%;">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptAttendance1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th style="width: 50%;" class="text-left">Attendance</th>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptAttendance2">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th style="width: 50%" class="text-left">Attendance</th>
                                                                                            <td style="width: 25%;" class="text-center"><%# Eval("t1Att") %></td>
                                                                                            <td style="width: 25%;" class="text-center"><%# Eval("t2Att") %></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                            </tbody>
                                                                        ...
                                                                        <table class='table mp-table tbl p-table-bordered table-bordered text-uppercase' style="margin-bottom: 0px; margin-top: 0px; width: 100%;">
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptRemark1">
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                            <th style="width: 50%;" class="text-left">CLASS TEACHER'S REMARK</th>
                                                                        ...
                                                                        <table class="table mp-table p-table-bordered table-bordered text-uppercase" style="margin-bottom: 5px;">
                                                                            ...
                                                                            <table class="table mp-table p-table-bordered table-bordered text-uppercase" style="text-align: center; margin: 0px; padding: 10px; width: 100%;">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="width: 100%; padding: 0px !important; vertical-align: top;">
