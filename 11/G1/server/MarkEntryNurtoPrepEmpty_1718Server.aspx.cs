            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        {
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> EVAL. 1 </span><br><input name='' type='text' value='" + MaxMarks1 + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> EVAL. 2 </span><br><input name='' type='text' value='" + MaxMarks2 + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> EVAL. 3 </span><br><input name='' type='text' value='" + MaxMarks3 + "' id='MaxMarks3' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                        }
                        if (Evail.ToLower() == "term2")
                        {
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> EVAL. 4 </span><br><input name='' type='text' value='" + MaxMarks1 + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> EVAL. 5 </span><br><input name='' type='text' value='" + MaxMarks2 + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                            Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> EVAL. 6 </span><br><input name='' type='text' value='" + MaxMarks3 + "' id='MaxMarks3' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                        }
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            Response.Write("<td class='p-pad-n text-center tab-in' style='text-align:center !important; width:7%;'><input type='text' value='" + Evel1 + "' class='form-control-blue text-center' name='1' style='width:40px;' " + disabledAttribute + "></td>");
                            Response.Write("<td class='p-pad-n text-center tab-in' style='text-align:center !important; width:7%;'><input type='text' value='" + Evel2 + "' class='form-control-blue text-centern' name='2' style='width:40px;' " + disabledAttribute + "></td>");
                            Response.Write("<td class='p-pad-n text-center tab-in' style='text-align:center !important; width:7%;'><input type='text' value='" + Evel3 + "' class='form-control-blue text-centern' name='3' style='width:40px;' " + disabledAttribute + "></td>");
