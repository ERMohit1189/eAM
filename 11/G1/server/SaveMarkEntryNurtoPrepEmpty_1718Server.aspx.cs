...
public partial class common_G2_SaveMarkEntryNurtoPrepEmpty_1718Server : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            try
            {
                ...
                if (double.TryParse(MaxMarksArr1[0], out mno) == false || double.TryParse(MaxMarksArr1[1], out mno) == false || double.TryParse(MaxMarksArr1[2], out mno) == false)
                {
                    error1 = true;
                ...
                if(error1==false)
                {
                    ...
                    cmd.CommandText = "SetMaxMinMarksProc_NurtoPrepGrade";
                    ...
                    for (int i = 0; i < MarksFullArr.Length - 1; i++)
                    {
                        ...
                        string[] MarksArr = MarksFullArr[i].Split(new string[] { "##" }, StringSplitOptions.None);
                            ...
                            cmd.CommandText = "USP_MarkEntry_CCENurtoPrep_Grade";
                            cmd.CommandType = CommandType.StoredProcedure;
                            cmd.Parameters.AddWithValue("@Classid", ClassId.Trim());
                            ...
                            cmd.Parameters.AddWithValue("@Evel1", MarksArr[1]);
                            cmd.Parameters.AddWithValue("@Evel2", MarksArr[2]);
                            cmd.Parameters.AddWithValue("@Evel3", MarksArr[3]);
                            cmd.Parameters.AddWithValue("@Best2", MarksArr[4]);
                            cmd.Parameters.AddWithValue("@Conversion", MarksArr[5]);
                            cmd.Parameters.AddWithValue("@Grade", MarksArr[6]);
                            cmd.Parameters.AddWithValue("@SessionName", Session.ToString().Trim());
                            cmd.Parameters.AddWithValue("@BranchCode", BranchCode.Trim());
                            cmd.Parameters.AddWithValue("@LoginName", LoginName.ToString().Trim());
                            cmd.ExecuteNonQuery();
