<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="CoscholasticGradeEntry_NurtoPrep.aspx.cs" Inherits="staff_CoscholasticGradeEntry" %>
                    ...
                    <div class="panel-body">
                        <div class="col-sm-12 no-padding">
                            ...
                            <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                ...
                                <div class="">
                                    <asp:DropDownList ID="drpEval" runat="server" CssClass="form-control-blue"></asp:DropDownList>
                                    <div class="text-box-msg">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpmedium" runat="server" CssClass="form-control-blue" OnSelectedIndexChanged="drpmedium_SelectedIndexChanged" AutoPostBack="true">
                                            </asp:DropDownList>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                <label class="control-label">Select Coscholastic Group&nbsp;<span class="vd_red">* </span></label>
                                <div class="">
                                    <asp:DropDownList ID="drpCoscholasticGroup" runat="server" CssClass="form-control-blue validatedrp" AutoPostBack="True"
                                        OnSelectedIndexChanged="drpCoscholasticGroup_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <div class="text-box-msg">
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4 half-width-50 mgbt-xs-15 hide">
                                ...
                                <div class="">
                                    <asp:TextBox ID="txtMax" runat="server" CssClass="form-control-blue" Width="100px" Enabled="false"></asp:TextBox>
                                    <div class="text-box-msg">
                                    </div>
                                </div>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="TextBox1" runat="server" Width="80px" CssClass="form-control-blue"
                                                    AutoPostBack="true" OnTextChanged="TextBox1_TextChanged" ControlToValidate="TextBox1"></asp:TextBox>
                                            </ItemTemplate>
    ...
    <script>
        function grade(tis) {
            ...
            if (val == 'A' || val == 'B' || val == 'C' || val == '') {
                ...
                $(tis).val('');
                alert('Please enter grads A,B or C only!');
                return;
            }
        }
    </script>
