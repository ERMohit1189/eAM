<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClassWiseStudentsMarksList_NUR1toPrep.aspx.cs" Inherits="admin_ClassWiseStudentsMarksList_ItoV" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                               ...
                               <%-- <div class="col-sm-4 no-padding">
                                    <div class="vd_input-wrapper txt-middle">
                                       
                                        <div class="col-sm-12 vd_input-margin controls">
                                            ...
                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="vd_radio radio-success" AutoPostBack="True" RepeatDirection="Horizontal" RepeatLayout="flow">
                                                ...
                                                <asp:ListItem Selected="True">Report Card</asp:ListItem>
                                                <asp:ListItem>Student Marks Deatil</asp:ListItem>
                                ...
                                <div class="col-sm-4 no-padding ">
                                    <div class="form-group ">
                                        <asp:Label ID="Label16" runat="server" class="col-sm-4 txt-bold txt-middle-l" Text="Class :"></asp:Label>
                                ...
                                <div class="col-sm-4 no-padding mgbt-xs-20">
                                    <div class="form-group ">
                                        <asp:Label ID="Label6" runat="server" class="col-sm-4 txt-bold txt-middle-l" Text="Section :"></asp:Label>
                                        <div class="col-sm-8 controls ">
