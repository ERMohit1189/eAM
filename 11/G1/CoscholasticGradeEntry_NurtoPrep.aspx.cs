...
public partial class staff_CoscholasticGradeEntry : Page
{
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " where GroupId='G1' and EmpCode='" + Session["LoginName"].ToString() + "' and T1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
    ...
    public void loadCoscholasticGroup()
    {
        ...
        sql +=  " where ClassId='" + drpclass.SelectedValue.ToString() + "' and BranchCode=" + Session["BranchCode"] + " and SessionName='" + Session["SessionName"] + "' and Medium='" + drpmedium.SelectedValue.ToString() + "' order by Id";
        ...
        // sql += " where cm.SessionName='" + Session["SessionName"] + "' and cm.BranchCode=" + Session["BranchCode"] + " and t1.SessionName='" + Session["SessionName"] + "' and t1.BranchCode=" + Session["BranchCode"] + " and GroupId='G2' Order by CIDOrder";
    ...
    public void loadCoscholastic()
    {
        ...
        sql +=" where cm.ClassId='" + drpclass.SelectedValue.ToString() + "' and cm.Groupid=" + drpCoscholasticGroup.SelectedValue.ToString() + " and cm.BranchCode=" + Session["BranchCode"] + " and cm.Medium='" + drpmedium.SelectedValue.ToString() + "' order by cm.Id";
    ...
    protected void TextBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        if (Text1.Text == "A" || Text1.Text == "B" || Text1.Text == "C" || Text1.Text == "D" || Text1.Text == "")
        {
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (GridView1.Rows.Count > 0)
        {
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                cmd = new SqlCommand();
                cmd.CommandText = "CCENurtoPREPCoscholasticProc";
    ...
    protected void drpCoscholastic_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                sql = "Select Id,Grade from CCENurtoPREPCoscholastic where SRNO='" + lblsrno.Text + "' and BranchCode=" + Session["BranchCode"] + " and Evaluation='" + drpEval.SelectedItem.Text + "' and CoscholasticId='" + drpCoscholastic.SelectedValue.ToString() + "'";
