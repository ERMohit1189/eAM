                    ...
                    <div class="col-sm-12 mgbt-xs-20">
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                ...
                                <asp:RadioButtonList ID="rptType" runat="server" CssClass="vd_radio radio-success" 
                                    RepeatDirection="Horizontal" RepeatLayout="flow" AutoPostBack="true" 
                                    OnSelectedIndexChanged="rptType_SelectedIndexChanged">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="Classdiv">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="BatchDiv" visible="false">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="Sectiondiv">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="Streamdiv">
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-2-p2 mgbt-xs-15" runat="server" id="divClassbtn">
                                      ...
                                      <div class="col-sm-4  half-width-50  btn-a-devices-2-p2 mgbt-xs-15" runat="server" id="divBatchbtn" visible="false">
                                        <asp:LinkButton ID="btnShow1" runat="server" OnClick="btnShow1_Click" OnClientClick="ValidateDropdown('.validatedrp1');return validationReturn();" CssClass="button form-control-blue">View</asp:LinkButton>
                                       

                                    </div>
                                     <div class="col-sm-12   mgbt-xs-15">
                                        <span class="txt-bold txt-middle-l text-danger">Note:- </span><span class="txt-bold txt-middle-l text-danger blink">SMS will be sent from this page if the SMS service is active.</span>
                                    </div>
                                </div>
                                                    ...
                                                    <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Roll No.">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_rollno" runat="server" Text='<%# Bind("instituterollno") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Class">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="LabelClass" runat="server" Text='<%# Bind("ClassName") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-3" />
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Date of Admission">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDob" runat="server" Text='<%# Bind("Admissiondate") %>'></asp:Label>
                                                                </ItemTemplate>
                                                                 <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="vd_bg-blue-np vd_white-np p-pad-n" />
                                                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="p-pad-3" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Delay" Visible="false">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <td class="valign-t">
                                                                        <ajaxToolkit:Accordion runat="server" ID="Accordion1" Width="100%"
                                                                            ...
                                                                            <Panes>
                                                                                ...
                                                                                <ajaxToolkit:AccordionPane runat="server" ID="AccordionPane5" Width="100%" Visible="false">
                                                                                    <Header>
                                                                                        <ul class="vd_li" style="padding: 0 !important; margin-bottom: 5px;">
