...
namespace _11
{
    public partial class UpdateStudentRegistration : Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["Logintype"].ToString() == "Staff")
                {
                    ...
                    else
                    {
                        ...
                        _sql += " and ctm.SessionName='" + Session["SessionName"].ToString() + "' and ctm.BranchCode = " + Session["BranchCode"] + " and IsClassTeacher=1";
        ...
        {
            _sql = "Select Medium,id from MediumMaster where  BranchCode=" + Session["BranchCode"].ToString() + "";
        ...
        private void LoadDefaultHouse()
        {
            ...
            _sql = "select HouseName from HouseMaster where BranchCode=" + Session["BranchCode"].ToString() + "";
        ...
        private void LoadDefaultBoard()
        {
            ...
            BAL.objBal.FillDropDown_withValue(_sql, drpPreviousBoard, "BoardName", "id");
            using (var objBll = new BLL())
            {
                try
                {
                    objBll.loadDefaultvalue("Board", DrpBoard);
                    objBll.loadDefaultvalue("Board", drpPreviousBoard);
                }
                catch
                {
                    // ignored
        ...
        public void GeneralDetailsDisplay()
        {
            ...
            _sql += "   isSmsAck,isEmailAck,Pen from StudentGenaralDetail sg";
            ...
            try
            {
                ...
                txtpen.Text = _oo.ReturnTag(_sql, "Pen");
                string sqlnew = _sql;
        ...
        public void PreviousDetailsDisplay()
        {
            string studentId = "";
            if (Session["Logintype"].ToString() == "Admin")
            {
            ...
            _sql = "Select top 1 * from StudentPreviousSchool sg ";
            _sql += "  Where sg.SrNo='" + studentId.Trim() + "' and sg.SessionName='" + Session["SessionName"] + "' and sg.BranchCode=" + Session["BranchCode"] + " order by RecordDate desc";
            var dts = _oo.Fetchdata(_sql);
            try
            {

                txtPreviousInstituteName.Text = dts.Rows[0]["SchoolName"].ToString();
                txtUdiaseCode.Text = dts.Rows[0]["UDISECode"].ToString();
                txtContactNoPrevious.Text = dts.Rows[0]["ContactNo"].ToString();
                txtAddress.Text = dts.Rows[0]["Schooladdress"].ToString();
                txtRollNo1.Text = dts.Rows[0]["RollNo"].ToString();
                // ddlPreviousClass.SelectedValue = dts.Rows[0]["PreviousClass"].ToString();
                txtAttendance.Text = dts.Rows[0]["Attendance"].ToString();

                txtMarksPercentage.Text = dts.Rows[0]["MarksPercentage"].ToString();
                //try
                //{

                //    ddlPreviousClass.SelectedValue = ddlPreviousClass.Items.FindByValue(dts.Rows[0]["PreviousClass"].ToString()).Value;
                //}
                //catch (Exception) {
                //    ddlPreviousClass.SelectedIndex = 1;
                //}

                string _sql1 = "Select ID,ClassName from PreviousClass_tb ";
                BAL.objBal.FillDropDown_withValue(_sql1, ddlPreviousClass, "ClassName", "ID");
                using (var objBll = new BLL())
                {
                    try
                    {
                ...
                try
                {
                    if (dts.Rows[0]["PreviousClass"].ToString() != DBNull.Value.ToString())
                    {
                        ddlPreviousClass.SelectedValue = ddlPreviousClass.Items.FindByValue(dts.Rows[0]["PreviousClass"].ToString()).Value;
                    }
                    else
                ...
                try
                {
                    if (dts.Rows[0]["Board"].ToString() != DBNull.Value.ToString())
                    {
                        drpPreviousBoard.SelectedValue = drpPreviousBoard.Items.FindByText(dts.Rows[0]["Board"].ToString()).Value;
                    }
                    else
                    {
                        drpPreviousBoard.SelectedIndex = 1;
                    }
                }
                catch (Exception)
                {
                ...
                try
                {
                    if (dts.Rows[0]["Medium"].ToString() != DBNull.Value.ToString())
                    {
                        ddlMediumprevious.SelectedValue = ddlMediumprevious.Items.FindByText(dts.Rows[0]["Medium"].ToString()).Value;
                    }
                    else
                    {
                        ddlMediumprevious.SelectedIndex = 1;
                    }
                }
                catch
                {
                ...
                try
                {
                    if (dts.Rows[0]["Result"].ToString() != DBNull.Value.ToString())
                    {
                        ddlResult.SelectedValue = ddlResult.Items.FindByText(dts.Rows[0]["Result"].ToString()).Value;
                    }
                    else
                    {
                ...
                try
                {
                    drpExamCrackedof.SelectedValue = dts.Rows[0]["ExamId"].ToString();
                    txtRollNo1.Text = dts.Rows[0]["RollNo"].ToString();
                    txtRank.Text = dts.Rows[0]["Rank"].ToString();
                    txtCategoryRank.Text = dts.Rows[0]["CatRank"].ToString();
                    txtAnyOtherCategoryRank.Text = dts.Rows[0]["AnyOther"].ToString();
                }
                catch
                {
                }
        ...
        public void FamilyDetailsDisplay()
        {
            ...
            _sql += " FatherHealthAdhaarNo, FatherHealthDOB, FatherHealthWeight, FatherHealthHeight, FatherHealthBloodgroup, MotherHealthAdhaarNo, MotherHealthDOB, MotherHealthWeight, MotherHealthHeight, MotherHealthBloodgroup, CWSN,FatherAadhaarCardNo,MotherAadhaarCardNo from StudentFamilyDetails";
            ...
            try
            {
                ...
                string FatherAadhaarCardNo = _oo.ReturnTag(_sql, "FatherAadhaarCardNo");
                txtfaadhaarcardno.Text = FatherAadhaarCardNo == string.Empty ? FatherAadhaarCardNo : FatherAadhaarCardNo;


                string MotherAadhaarCardNo = _oo.ReturnTag(_sql, "MotherAadhaarCardNo");
                txtmaadharcardno.Text = MotherAadhaarCardNo == string.Empty ? MotherAadhaarCardNo : MotherAadhaarCardNo;
                ...
                try
                {
                    //drpOccupationfa.S = _oo.ReturnTag(_sql, "FatherOccupation");
                    drpOccupationfa.SelectedValue = _oo.ReturnTag(_sql, "FatherOccupation");
                }
                catch (Exception)
                {
                ...
                try
                {
                    if (_oo.ReturnTag(_sql, "FatherQualification") != string.Empty)
                    {
                        txtqufa.SelectedValue = _oo.ReturnTag(_sql, "FatherQualification");

                    }
                    else
                    {
                        txtqufa.SelectedIndex = 0;
                    }
                }
                catch (Exception)
                {
                ...
                //txtqualimother.SelectedValue = _oo.ReturnTag(_sql, "MotherQualification");
                try
                {
                    if (_oo.ReturnTag(_sql, "MotherQualification") != string.Empty)
                    {
                        txtqualimother.SelectedValue = _oo.ReturnTag(_sql, "MotherQualification");
                    ...
                    {
                        txtqualimother.SelectedIndex = 0;
                    }
                }
                catch (Exception)
                {
                ...
                string G1Pin = _oo.ReturnTag(_sql, "G1Pin");
                txtG1Pin.Text = G1Pin;
                ...
                string G2Pin = _oo.ReturnTag(_sql, "G2Pin");
                txtG2Pin.Text = G2Pin;
        ...
        public void PreviousSchoolDetailsDisplay()
        {
            ...
            _sql += " Percentage as Per,SchoolName as Institute,MaxMarks,Yop,Subjects as Subject,RollNo,CertificateNo,MarksSheetNo,ExamId,Rank,CatRank,AnyOther,UDISECode,ContactNo,PreviousClass,Attendance,MarksPercentage,Schooladdress,ContactNo,UDISECode,AnyOther";
        ...
        protected void setDropdownValue()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                //    DropDownList ddlMediumprevious = (DropDownList)rptPreviousEducation.Items[i].FindControl("ddlMediumprevious");
                ...
                //    //ddlMediumprevious.SelectedValue = dt.Rows[i]["Medium"].ToString();
                //}
            }
        }
        public void OfficialDetailDisplay()
        {
            ...
            try
            {
                ...
                txtAparid.Text = _oo.ReturnTag(_sql, "APAARID");
                txtProspectus.Text = _oo.ReturnTag(_sql, "BookletNo");
                ...
                try
                {
                    ...
                    ddlMediumprevious.SelectedValue = ddlMediumprevious.Items.FindByText(_oo.ReturnTag(_sql, "Medium")).Value;
                }
                catch (Exception) { }
                try
                {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        drpPanelCardType_SelectedIndexChanged(drpPanelCardType, EventArgs.Empty);
                    }
                }
                catch (Exception) { }
                ...
                //try
                //{
                //    if (_oo.ReturnTag(_sql, "GroupNa") != string.Empty)
                //    {
                //        drpBranchforStaff.SelectedValue = _oo.ReturnTag(_sql, "GroupNa");

                //    }
                //    else
                //    {
                //        drpBranchforStaff.SelectedIndex = 1;
                //    }
                //}
                //catch (Exception) { }
                ...
                string sql_shift = "Select ShiftId from StudentShiftMapping where SrNo='"+ studentId.Trim() +"' and SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
                ddlShift.SelectedValue = _oo.ReturnTag(sql_shift, "shiftId") == "" ? "0" : _oo.ReturnTag(sql_shift, "shiftId");
                try
                {
        ...
        public void updatestudent()
        {
            ...
            if (i == 0 && j == 0 && k == 0)
            {
                ...
                //   ClientScript.RegisterStartupScript(this.GetType(), "ReloadPage", "setTimeout(function() { location.reload(); }, 2000);", true);
                // Inject JavaScript for delayed redirection
                string script = "setTimeout(function() { window.location.href = '" + Request.RawUrl + "'; }, 2000);";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "DelayedRedirect", script, true);
            }
        }
        ...
        private void ShowDetails(bool withdraw_msg_shown=true)
        {
            string studentId = "";
            if (Session["Logintype"].ToString() == "Admin")
            {
            ...
            if (_oo.ReturnTag(_sql, "Withdrwal") != "")
            {
                ...
                if (withdraw_msg_shown == true)
                {
                    Campus camp = new Campus(); camp.msgbox(this.Page, msgbox, "Warning: This student has been withdrawn. Please review carefully before making any changes to their records.", "A");
                }
            }
            //else
            //{
        ...
        public void FamilyDetails()
        {
            ...
            cmd.Parameters.AddWithValue("@FatherQualification", txtqufa.SelectedValue.ToString());
            ...
            cmd.Parameters.AddWithValue("@MotherQualification", txtqualimother.SelectedValue.ToString());
        ...
        public void OfficialDetails()
        {
            ...
            cmd.Parameters.AddWithValue("@APAARID", txtAparid.Text.Trim());
            cmd.Parameters.AddWithValue("@BookletNo", txtProspectus.Text.Trim());
        ...
        protected void loadBoard()
        {
            if (rptPreviousEducation.Items.Count > 0)
            {
                for (int i = 0; i < rptPreviousEducation.Items.Count; i++)
                {
                    DropDownList drpBoard = (DropDownList)rptPreviousEducation.Items[i].FindControl("drpBoardPrevious");
            ...
            else
            {
                ...
                ////  DropDownList drpBoard = (DropDownList)rptPreviousEducation.Items[0].FindControl("drpBoardPrevious");
                //  _oo.FillDropDown_withValue(_sql, drpBoardPrevious, "ShiftName", "ID");
                //  drpBoardPrevious.Items.Insert(0, new ListItem("<-- Select Board/ University -->", "0"));
                // _oo.FillDropDown(_sql, drpPreviousBoard, "BoardName");
                //   _oo.FillDropDown(_sql, drpPreviousBoard, "BoardName");
            }
        ...
        {
            _sql = "Select CourseName,Id from CourseMaster where  BranchCode=" + Session["BranchCode"].ToString() + "";
        ...
        public void setEntranceExamRecord()
        {
            ...
            param.Add(new SqlParameter("@RollNo", txtRollNo1.Text.Trim()));
            ...
            if (ds != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        txtRollNo1.Text = dt.Rows[0][1].ToString();
        ...
        private void loadSection(DropDownList drpsection, DropDownList drpclass)
        {
            ...
            else
            {
                ...
                _sql += " where sctm.BranchCode=" + Session["BranchCode"].ToString() + " and sctm.SessionName = '" + Session["SessionName"] + "' and ClassId='" + drpclass.SelectedValue + "' and IsClassTeacher=1";
        ...
        private void loadBranch(DropDownList drpbranch, DropDownList drpclass, DropDownList drpsection)
        {
            ...
            else
            {
                ...
                _sql += " where sctm.BranchCode=" + Session["BranchCode"].ToString() + " and sctm.SessionName = '" + Session["SessionName"] + "' and sctm.ClassId='" + drpclass.SelectedValue + "' and SectionId=" + drpsection.SelectedValue + " and IsClassTeacher=1";
                _sql += " and EmpCode='" + Session["LoginName"].ToString() + "' ";
        ...
        protected void txtmaadharcardno_TextChanged(object sender, EventArgs e)
        {
            if (txtmaadharcardno.Text != "" && txtmaadharcardno.Text.Length == 12)
            {
                ...
                if (_oo.ReturnTag(sql, "val") == "1")
                {
                    ...
                    _sql = "select MotherAadhaarCardNo from StudentFamilyDetails where Case When Left('" + studentId.Trim() + "',3)='eAM' Then StEnRCode Else SrNo End !='" + studentId.Trim() + "'";
                    _sql += " and MotherAadhaarCardNo='" + txtmaadharcardno.Text + "'";
        ...
        protected void txtProspectus_TextChanged(object sender, EventArgs e)
        {
            if (txtProspectus.Text != "")
            {
                ...
                _sql = "select BookletNo from StudentOfficialDetails where Case When Left('" + studentId.Trim() + "',3)='eAM' Then StEnRCode Else SrNo End !='" + studentId.Trim() + "'";
                _sql += " and BookletNo='" + txtProspectus.Text + "'";
        ...
        protected void txtAadharNo_TextChanged(object sender, EventArgs e)
        {
            if (txtAadharNo.Text != "" && txtAadharNo.Text.Length == 12)
            {
                ...
                if (_oo.ReturnTag(sql, "val") == "1")
                {
                    ...
                    _sql = "select AadharNo from StudentGenaralDetail where Case When Left('" + studentId.Trim() + "',3)='eAM' Then StEnRCode Else SrNo End !='" + studentId.Trim() + "'";
                    _sql += " and AadharNo='" + txtAadharNo.Text + "'";
        ...
        protected void txtfaadhaarcardno_TextChanged(object sender, EventArgs e)
        {
            ...
            //            studentId = TxtEnter.Text.Trim();
            //        }
            //        _sql = "select FatherAadhaarCardNo from StudentFamilyDetails where Case When Left('" + studentId.Trim() + "',3)='eAM' Then StEnRCode Else SrNo End !='" + studentId.Trim() + "'";
        ...
        protected void txtAparid_TextChanged(object sender, EventArgs e)
        {
            if (txtAparid.Text != "")
            {
                ...
                if (_oo.ReturnTag(sql, "val") == "1")
                {
                    ...
                    _sql = "select APAARID from StudentOfficialDetails where Case When Left('" + studentId.Trim() + "',3)='eAM' Then StEnRCode Else SrNo End !='" + studentId.Trim() + "'";
                    _sql += " and APAARID='" + txtAparid.Text + "'";
