...
public partial class staff_CoscholasticGradeEntry_XII : Page
{
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " where GroupId='G7' and EmpCode='" + Session["LoginName"].ToString() + "' and T1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
    ...
    public void loadCoscholasticGroup()
    {
        ...
        sql +=  "  and BranchCode=" + Session["BranchCode"].ToString() + " and BranchCode=" + Session["BranchCode"] + " and ClassID='" + drpclass.SelectedValue.ToString() + "' order by id Asc";
    ...
    public void loadCoscholastic()
    {
        ...
        sql +=  " where cm.ClassId='" + drpclass.SelectedValue.ToString() + "' and cgm.BranchCode=" + Session["BranchCode"] + " and cm.BranchCode=" + Session["BranchCode"] + " and Groupid='" + drpGroupName.SelectedValue.ToString() + "'";
        sql +=  " except";
        sql +=  " Select CoscholasticName,cm.id as Id from CoscholasticMaster cm";
