...
public partial class TestwiseCumlativeXII : System.Web.UI.Page
{
    ...
    protected void LoadTests()
    {
        ...
        {
            drptest.Items.Insert(0, new ListItem("Preliminary", "Test3"));
            drptest.Items.Insert(1, new ListItem("PrBoard-1", "AE"));
            drptest.Items.Insert(2, new ListItem("PrBoard-2", "AE2"));
    ...
    public string GetMMarks(string Eval, string subjectid, string paperid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMMMarksXII_2021", param);
    ...
    public string GetTestMarks(string Eval, string subjectid,string srno, string paperid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMarksXII_2021", param);
