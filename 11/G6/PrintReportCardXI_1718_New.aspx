<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="PrintReportCardXI_1718_New.aspx.cs" Inherits="PrintReportCardXI_1718_New" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                                                                            ...
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptmarksT1">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <tr class="text_center">
                                                                                            <th style="text-align: left;">INTERNAL ASSMT./PRAC.</th>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptmarksT2Additional">
                                                                                    ...
                                                                                    <FooterTemplate>
                                                                                        <tr class="text_center">
                                                                                            <th class="text-left" colspan="2"><span><b></b></span></th>
                                                                                            <td colspan="5"></td>
                                                                                            <td style="text-align: center"><b>
                                                                                                <asp:Label runat="server" ID="lblHTotal"></asp:Label></b></td>
                                                                                            <td></td>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptRemark1">
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan='7' style='padding: 2px !important;'><span class='upper-case'><%# Eval("Caption1") %></span></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
                                                                                <asp:Repeater runat="server" ID="rptRemark2">
                                                                                    <ItemTemplate>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan='7' style='padding: 2px !important;'><span class='upper-case'><%# Eval("Caption1") %></span></td>
                                                                                            <td colspan='7' style='padding: 2px !important;'><span class='upper-case'><%# Eval("Caption2") %></span></td>
                                                                                            <td colspan="3"></td>
                                                                                        </tr>
                                                                                    </ItemTemplate>
                                                                                </asp:Repeater>
    ...
    <script>
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>REPORT CARD FOR XI</title>' + headContent + '</head>');
