...
public partial class Comman_G6_XIGRADEENTRY : System.Web.UI.Page
{
    string sql = "";
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " where GroupId='G6' and ECode='" + Session["LoginName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and t2.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
            BAL.objBal.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
            drpclass.Items.Insert(0, new ListItem("<--Select-->", "-1"));
        }
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            else
            {
                ...
                Campus camp = new Campus(); camp.msgbox(this.Page, msgbox, "Sorry, Record not updated!", "S");       
