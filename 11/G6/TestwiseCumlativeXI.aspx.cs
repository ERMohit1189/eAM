...
public partial class TestwiseCumlativeXI : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            drptest.Items.Insert(2, new ListItem("Term -1", "HY"));
            drptest.Items.Insert(3, new ListItem("Practical/I.A", "PracHY"));
    ...
    protected void LoadTests()
    {
        ...
        else
        {
            ...
            drptest.Items.Insert(2, new ListItem("Term -2", "AE"));
            drptest.Items.Insert(3, new ListItem("Practical/I.A", "PracAE"));
        }
    }
    ...
    {
        string sql = "Select pm.id Paperid, SubjectId, papername SubjectName,'' marks from TTSubjectMaster  sm";
        ...
        sql +=  " where sm.ClassId = '" + drpclass.SelectedValue.ToString() + "'  and sm.branchid='" + drpBranch.SelectedValue.ToString() + "' and sm.SessionName='" + Session["SessionName"] + "'  and sm.BranchCode=" + Session["BranchCode"] + "";
        sql +=  " and sm.ApplicableFor<>'TimeTable' order by pm.id Asc";
    ...
    public string GetMMarks(string Eval, string subjectid, string paperid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMMMarksXI_2021", param);
    ...
    public string GetTestMarks(string Eval, string subjectid,string srno, string paperid)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("TestwiseCumlativeMarksXI_2021", param);
