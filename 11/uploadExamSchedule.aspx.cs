...
public partial class admin_uploadExamSchedule : System.Web.UI.Page
{
    string sql = "";
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (drpSection.SelectedIndex == 0)
        {
            ...
            {
                if (hfExamScheduleFile.Value != string.Empty && hfExamScheduleFile.Value != null)
                {
                    ...
                    string base64std = hfExamScheduleFile.Value;
                    if (base64std != string.Empty)
                    {
                        fileName = "ExamSchedule_" + drpClass.SelectedItem.Text + "_" + txtTitle.Text.Trim() + "_" + DateTime.Now.ToString("dd-MM-yy_hhmmss") + hfExamScheduleFileext.Value.ToString();
                        filePath = string.Format("~/Uploads/Docs/ExamSchedule/{0}", fileName);
                    ...
                    Msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("Std_ExamSchedule_proc", param);
    ...
    private void loadGrid(string Id)
    {
        ...
        param.Add(new SqlParameter("@ClassId", drpClass.SelectedValue.ToString()));
        param.Add(new SqlParameter("@BranchId", drpBranch.SelectedValue.ToString()));
        param.Add(new SqlParameter("@SectionId", (drpSection.SelectedValue.ToString()==""?"-1": drpSection.SelectedValue.ToString())));
        param.Add(new SqlParameter("@SessionName", Session["SessionName"].ToString()));
        param.Add(new SqlParameter("@BranchCode", Session["BranchCode"].ToString()));
        param.Add(new SqlParameter("@QueryFor", "S"));

        grdDocList.DataSource = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_ExamSchedule_proc", param);
        grdDocList.DataBind();
    }
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_ExamSchedule_proc", param);
        if (ds != null)
        {
    ...
    protected void lnkUpdate_Click(object sender, EventArgs e)
    {
        ...
        string base64std = hfExamScheduleFilepanel.Value;
        if (base64std != string.Empty)
        {
            fileName = "ExamSchedule_" + drpClasspanel.SelectedItem.Text + "_" + txtTitlepanel.Text.Trim() + "_" + DateTime.Now.ToString("dd-MM-yy_hhmmss") + hfExamScheduleFileextpanel.Value.ToString();
            filePath = string.Format("~/Uploads/Docs/ExamSchedule/{0}", fileName);
        ...
        if (Msg == "S")
        {
            ...
            txtTitlepanel.Text = "";
            hfExamScheduleFilepanel.Value = null;
            hfExamScheduleFileextpanel.Value = null;
        }
        else if (Msg == "D")
        {
            Campus camp = new Campus(); camp.msgbox(this.Page, msgbox, "Duplicate Entry!", "A");
