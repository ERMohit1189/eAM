<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="CumlativeReport_ng.aspx.cs" Inherits="CumlativeReport_ng" %>
    ...
    <script>
        ...
        function LoadData() {
            ...
            if (ClassId == "") { alert("Select Class"); return true; }
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("server/CumlativeReportServer_ng.aspx") %>',
                    data: {
                        'ClassId': ClassId,
                        'SectionId': SectionId,
                        'BranchId': BranchId,
                    ...
                    success: function (result) {
                        ...
                        $(".form-name").html("");
                        $(".form-name").html("<span class='span'>Cumulative Report " + SessionName + " Session</span>");
                    },
                    error: function (result) {
                        HideLoader();
                        $("[id*=divExport]").html(result.responseText);
