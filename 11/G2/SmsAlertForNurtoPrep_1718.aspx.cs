...
public partial class common_SmsAlertFroNurtoPrep_1718 : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/11/G1/SmsAlertForNurtoPrep_1718.aspx");
        }
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                sql +=  " where GroupId='G2' and EmpCode='" + Session["LoginName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and t2.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and IsClassTeacher=1  and t2.SessionName='" + Session["SessionName"] + "' and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
                BAL.objBal.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
            }
        }
    }
