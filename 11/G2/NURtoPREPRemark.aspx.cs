...
public partial class common_NURtoPREPRemark : System.Web.UI.Page
{
    string sql = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("~/11/G1/NURtoPREPRemark.aspx");
        }
    ...
    public void loadclass()
    {
        if (Session["Logintype"].ToString() == "Admin")
        {
            ...
            sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and cm.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and t1.SessionName='" + Session["SessionName"] + "' and GroupId='G2' Order by CIDOrder";
        ...
        else
        {
            ...
            sql +=  " where GroupId='G2' and EmpCode='" + Session["LoginName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and t2.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
            BAL.objBal.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
    ...
    public void setRemark()
    {
        ...
        param.Add(new SqlParameter("@Exam_NURtoPREPRemark_Type", dt));

        SqlParameter para = new SqlParameter("@msg", "");
        para.Direction = ParameterDirection.Output;
        param.Add(para);

        msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("USP_Exam_NURtoPREPRemark_BulkInsert", param);
    ...
    public void getRemark()
    {
        ...
        param.Add(new SqlParameter("@status", DropDownList1.SelectedValue));
        param.Add(new SqlParameter("@displayorder", DropDownList2.SelectedValue));
        ...
        rpt.DataSource = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_Get_NURtoPREPRemark", param);
        rpt.DataBind();
