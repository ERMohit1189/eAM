...
public partial class common_G2_ClasswiseAllSubjectMarksListNurtoPrep_1718Server : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "ClasswiseCumulative_NurtoPrep_2021";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int s = 0; s < dt.Rows.Count; s++)
                    {
                        ...
                        Response.Write("<tr><td class='" + DisableTest1 + "'>" + (TermNmae.Trim().ToLower() == "term1" ? "T1" : "T3") + "</td><td class='" + DisableTest2 + "'>" + (TermNmae.Trim().ToLower() == "term1" ? "T2" : "T4") + "</td><td>NB</td><td>SE</td><td>" + (TermNmae.Trim().ToLower() == "term1" ? "HY" : "AE") + "</td></tr>");
                        Response.Write("<tr><td class='" + DisableTest1 + "'>" + dt.Rows[s]["MaxMarks1"].ToString().Trim() + "</td><td class='" + DisableTest2 + "'>" + dt.Rows[s]["MaxMarks2"].ToString().Trim() + "</td><td>" + dt.Rows[s]["MaxMarks4"].ToString().Trim() + "</td><td>" + dt.Rows[s]["MaxMarks5"].ToString().Trim() + "</td><td>" + dt.Rows[s]["MaxMarks6"].ToString().Trim() + "</td></tr>");
                            ...
                            for (int s2 = 0; s2 < dt.Rows.Count; s2++)
                            {
                                ...
                                if (dt2.Rows.Count > 0)
                                {
                                    for (int m = 0; m < dt2.Rows.Count; m++)
                                    {
                                        ...
                                        Response.Write("<tr><td class='" + DisableTest1 + "'>" + dt2.Rows[m]["Test1"].ToString().Trim() + "</td><td class='" + DisableTest2 + "'>" + dt2.Rows[m]["Test2"].ToString().Trim() + "</td><td>" + dt2.Rows[m]["NB"].ToString().Trim() + "</td><td>" + dt2.Rows[m]["SE"].ToString().Trim() + "</td><td>" + dt2.Rows[m]["SAT"].ToString().Trim() + "</td></tr>");
                                        Response.Write("</table>");
                                        Response.Write("</td>");
                                    }
                                }
