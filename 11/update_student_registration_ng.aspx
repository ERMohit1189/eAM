<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="update_student_registration_ng.aspx.cs" Inherits="_11.update_student_registration_ng" %>
                            ...
                            <div class="col-sm-4  half-width-50 mgbt-xs-15 ">
                                    ...
                                    <asp:UpdatePanel ID="dgv" runat="server">
                                        <ContentTemplate>
                                            <asp:LinkButton ID="lnkShow" runat="server" OnClick="lnkShow_Click"
                                                class="button form-control-blue">View</asp:LinkButton>
                                ...
                                <div class=" pull-right" style="display: none;">
                                    <asp:LinkButton ID="lnkPreview" runat="server" OnClick="lnkPreview_Click" ValidationGroup="bb"
                                        class="button form-control-blue">Preview</asp:LinkButton>
                                    <asp:Label ID="Label4" runat="server" Visible="False"></asp:Label>
                                </div>
                                <div class=" pull-right" style="display: none">
                                    <asp:LinkButton ID="lnkQuickReg" runat="server" OnClick="lnkQuickReg_Click"
                                        class="button form-control-blue">Quick Updation</asp:LinkButton>
                                </div>
                            </div>
                                                                        ...
                                                                        <div class="col-sm-8  no-padding ">
                                                                            <div class="col-sm-6  mgbt-xs-15">
                                                                                ...
                                                                                <div class="vd_input-wrapper controls ">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtStudentDOB" placeholder="" onchange="BeginRequestHandlerNorm();"
                                                                            ...
                                                                            <div class="col-sm-6  no-padding ">
                                                                                ...
                                                                                <div class="col-sm-12  mgbt-xs-15">
                                                                                    <asp:CheckBox ID="chkStEmail" runat="server" CssClass="vd_checkbox checkbox-success  "
                                                                                        RepeatDirection="Horizontal" RepeatLayout="Flow" Text="Tick for E-mail Alert" />
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <ContentTemplate>
                                                                    ...
                                                                    <div class="col-sm-12  half-width-50 half-width-100-tc mgbt-xs-15">
                                                                        ...
                                                                        <div class="vd_input-wrapper controls ">
                                                                            <span class="menu-icon"><i class="fa  fa-tag"></i></span>
                                                                            <%-- ReSharper disable once Asp.SkinNotResolved --%>
                                                                            <asp:TextBox ID="txtAadharNo" placeholder="0000 0000 0000" runat="server"
                                                                                SkinID="TxtBoxDef" CssClass="form-control-blue"></asp:TextBox>
                                                                            <div class="text-box-msg">
                                                                            </div>
                                                                    ...
                                                                    <script>
                                                                        function Aadhar() {
                                                                            $('#ContentPlaceHolder1_ContentPlaceHolderMainBox_txtAadharNo').on('keyup', function () {
                                                                                $(this).val(
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-8  no-padding">
                                                                            ...
                                                                            <div class="col-sm-6  half-width-50 ">
                                                                                ...
                                                                                <div class="col-sm-12  no-padding mgbt-xs-10">
                                                                                    <asp:CheckBox ID="chkMoEmail" runat="server" Text="Tick for E-mail Alert"
                                                                                ...
                                                                                <div class="col-sm-12  set-box-in-center no-padding">
                                                                                    <div class="group-pic-box">
                                                                                        <div class="group-pic-box-main">
                                                                                            ...
                                                                                            <asp:Image ID="imgGroupPhoto" runat="server" Class="imgGroupPhoto" Style="height: 260px;"
                                                                                                ImageUrl="../img/user-pic/group-photo.jpg" />
                                                                    ...
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-6  half-width-50 ">
                                                                            ...
                                                                            <div class="col-sm-12  no-padding mgbt-xs-5">
                                                                                <asp:CheckBox ID="chkGuaEmail" runat="server" Text="Tick for E-mail Alert"
                                                                                    CssClass="vd_checkbox checkbox-success" RepeatDirection="Horizontal" RepeatLayout="Flow" />
                                                                                <div class="text-box-msg"></div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <asp:UpdatePanel ID="UpdatePanel76" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                            <label class="control-label">Select Type of Admission&nbsp;<span class="vd_red">*</span></label>
                                                                            <div class="">
                                                            ...
                                                            <div class="row">
                                                                <asp:UpdatePanel ID="UpdatePanel85" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                                            <label class="control-label">Admission done at INR (Rupees ) </label>
                                                                            <div class="vd_input-wrapper controls ">
                                                                                <span class="menu-icon"><i class="fa  fa-tag"></i></span>
                                                                                <asp:TextBox ID="txtAddDoneat" runat="server" CssClass="form-control-blue"></asp:TextBox>
                                                                                <div class="text-box-msg"></div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <div class="col-sm-12  no-padding ">
                                                                                    ...
                                                                                    <div class="col-sm-4  half-width-50 btn-a-devices-1-p4-p2 mgbt-xs-15 ">
                                                                                        ...
                                                                                        <div class="col-sm-4 col-xs-6 mgtp-6">
                                                                                            ...
                                                                                            <asp:CheckBox ID="chkVerified" runat="server" Text="Verified"
                                                                                                class="vd_checkbox checkbox-success" TextAlign="Right"
                                                                                                Checked='<%# Eval("Verified").ToString()=="True" %>' />
                                                                                    ...
                                                                                    <div class="col-sm-4  half-width-50 mgbt-xs-9">
                                                                                        ...
                                                                                        <div class="vd_input-wrapper ">
                                                                                            ...
                                                                                            <asp:TextBox ID="txtRemark" placeholder="" runat="server" Text='<%# Eval("Remark").ToString() %>' TextMode="MultiLine"
                                                                                    ...
                                                                                    <div class="col-sm-10 col-xs-10 set-box-in-center no-padding">
                                                                                        <div class="group-pic-box">
                                                                                            <div class="group-pic-box-main">
                                                                                                ...
                                                                                                <img height="261px" class="imgGroupPhoto" src="../img/user-pic/group-photo.jpg" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
