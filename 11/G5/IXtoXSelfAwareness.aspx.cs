...
public partial class common_IXtoXSelfAwareness : System.Web.UI.Page
{
    string sql = "";
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " where GroupId='G5' and EmpCode='" + Session["LoginName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and t2.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
            BAL.objBal.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
    ...
    public void setSelfAwareness()
    {
        ...
        foreach (RepeaterItem ri in rpt.Items)
        {
            ...
            dt.Rows.Add(srno, "generalremark", caption, sessionname, loginname, branchcode);
        }

        List<SqlParameter> param = new List<SqlParameter>();

        param.Add(new SqlParameter("@IXtoXSelfAwarenessTable", dt));
        ...
        msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("USP_BULKINSERT_IXtoXSelfAwareness", param);
    ...
    public void getSelfAwareness()
    {
        ...
        param.Add(new SqlParameter("@SessionName", Session["SessionName"].ToString()));
        param.Add(new SqlParameter("@BranchCode", Session["BranchCode"].ToString()));
        param.Add(new SqlParameter("@SelfAwarenessFor", "generalremark"));
        ...
        param.Add(new SqlParameter("@status", DropDownList1.SelectedValue.ToString()));
        param.Add(new SqlParameter("@displayorder", DropDownList2.SelectedValue.ToString()));

        param.Add(new SqlParameter("@Eval", drpEval.SelectedItem.Text.ToString()));

        rpt.DataSource=DLL.objDll.Sp_SelectRecord_usingExecuteDataset("USP_Get_IXtoXSelfAwareness", param);
        rpt.DataBind();
