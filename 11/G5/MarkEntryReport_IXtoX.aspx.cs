...
public partial class staff_MarkEntryReport : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("MarkEntryReportIXtoX_1617.aspx?check=MarkEntryReportIXtoX");
            }
            else
            {
                Response.Redirect("MarksEntryReportIXtoX_1718.aspx?check=MarkEntryReportIXtoX");
            }
