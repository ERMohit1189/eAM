        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (subType == "Compulsory")
                {
                    ...
                    sql +=  " where asr.ClassId='" + ClassId.ToString() + "' ";
                    sql +=  " and asr.SectionName='" + SectionName.ToString() + "'  and Withdrwal is null and isnull(Promotion, '')<>'Cancelled' order by Name Asc";
                }
                else if (subType == "Optional")
                {
                    ...
                    sql +=  " where asr.ClassId='" + ClassId + "' and asr.SectionName='" + SectionName + "' and asr.SessionName='" + Session.ToString() + "'  and asr.BranchCode=" + BranchCode + "";
                    sql +=  "  and sos.OptSubjectId='" + SubjectId + "' and Withdrwal is null and isnull(Promotion, '')<>'Cancelled' ";
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        MaxMarks4 = oo.ReturnTag(sql1, "MaxMarks4");
                        MaxMarks5 = oo.ReturnTag(sql1, "MaxMarks5");
                        MaxMarks6 = oo.ReturnTag(sql1, "MaxMarks6");
                        MaxMarks7 = oo.ReturnTag(sql1, "MaxMarks7");
                        MaxMarks8 = oo.ReturnTag(sql1, "MaxMarks8");
                        ...
                        Response.Write("<tr>");
                        Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-35' scope='col' style='width:40px;'>#<input type='hidden' id='hdnAditional' value='"+ (isAdditional == "Yes" ? "1":"0") + "' /></th>");
                        ...
                        if (Evail.ToLower() == "term1")
                        {
                            if (isAdditional == "Yes")
                            {
                                ...
                                {
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>U. T. I </span><br><input name='' type='text' value='" + (MaxMarks1 == "" ? "20" : MaxMarks1.ToString()) + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>U. T. II </span><br><input name='' type='text' value='" + (MaxMarks2 == "" ? "20" : MaxMarks2.ToString()) + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                }
                                if (ClassName.ToUpper() == "X")
                                {
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>U. T. I </span><br><input name='' type='text' value='" + (MaxMarks1 == "" ? "20" : MaxMarks1.ToString()) + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>Conv. <br>into 20 </th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>U. T. II </span><br><input name='' type='text' value='" + (MaxMarks2 == "" ? "80" : MaxMarks2.ToString()) + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>Conv. <br>into 20</th>");
                                }
                                Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>P.T.<br>5</th>");
                                Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> PRACTICAL</span><br><input name='' type='text' value='" + (MaxMarks7 == "" ? "30" : MaxMarks7).ToString() + "' id='MaxMarks7' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> Project Work/Field Visit / Portfolio </span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "15" : MaxMarks5).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> H.Y.E.</span><br><input name='' type='text' value='" + (MaxMarks6 == "" ? "50" : MaxMarks6).ToString() + "' id='MaxMarks6' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                            ...
                            else
                            {
                                if (ClassName.ToUpper() == "IX")
                                {
                                    ...
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> U. T. II </span><br><input name='' type='text' value='" + (MaxMarks2 == "" ? "20" : MaxMarks2.ToString()) + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>P.T.<br>5</th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> S.E.</span><br><input name='' type='text' value='" + (MaxMarks4 == "" ? "5" : MaxMarks4).ToString() + "' id='MaxMarks3' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''>M.A.</span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "5" : MaxMarks5).ToString() + "' id='MaxMarks4' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> PORT.</span><br><input name='' type='text' value='" + (MaxMarks6 == "" ? "5" : MaxMarks6).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> H.Y.E.</span><br><input name='' type='text' value='" + (MaxMarks7 == "" ? "80" : MaxMarks7).ToString() + "' id='MaxMarks6' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                ...
                                if (ClassName.ToUpper() == "X")
                                {
                                    ...
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>Conv. <br>into 20 </th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>P.T.<br>5</th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> S.E.</span><br><input name='' type='text' value='" + (MaxMarks3 == "" ? "5" : MaxMarks3).ToString() + "' id='MaxMarks3' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''>M.A.</span><br><input name='' type='text' value='" + (MaxMarks4 == "" ? "5" : MaxMarks4).ToString() + "' id='MaxMarks4' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> PORT.</span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "5" : MaxMarks5).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> H.Y.E.</span><br><input name='' type='text' value='" + (MaxMarks6 == "" ? "80" : MaxMarks6).ToString() + "' id='MaxMarks6' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                }
                                 Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'><span id=''> TOTAL </span><br><span id=''>100</span></th><th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>GRADE</th>");
                            }
                        ...
                        if (Evail.ToLower() == "term2")
                        {
                            if (isAdditional == "Yes")
                            {
                                if (ClassName.ToUpper() == "IX")
                                {
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> U. T. III </span><br><input name='' type='text' value='" + (MaxMarks1 == "" ? "20" : MaxMarks1.ToString()) + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''> U. T. IV </span><br><input name='' type='text' value='" + (MaxMarks2 == "" ? "20" : MaxMarks2.ToString()) + "' id='MaxMarks2' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>P.T.<br>5</th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> PRACTICAL</span><br><input name='' type='text' value='" + (MaxMarks7 == "" ? "30" : MaxMarks7).ToString() + "' id='MaxMarks7' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> Project Work/Field Visit / Portfolio </span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "15" : MaxMarks5).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> A.E.</span><br><input name='' type='text' value='" + (MaxMarks6 == "" ? "50" : MaxMarks6).ToString() + "' id='MaxMarks6' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'><span id=''> TOTAL </span><br><span id=''>100</span></th><th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>GRADE</th>");

                                }
                                if (ClassName.ToUpper() == "X")
                                {
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>Prelims.</span><br><input name='' type='text' value='" + (MaxMarks1 == "" ? "50" : MaxMarks1.ToString()) + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>P.T.<br>5</th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> PRACTICAL</span><br><input name='' type='text' value='" + (MaxMarks7 == "" ? "30" : MaxMarks7).ToString() + "' id='MaxMarks7' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> Project Work/Field Visit / Portfolio </span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "15" : MaxMarks5).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> A.E.</span><br><input name='' type='text' value='" + (MaxMarks6 == "" ? "50" : MaxMarks6).ToString() + "' id='MaxMarks6' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> A.E.</span><br><input name='' type='text' value='" + (MaxMarks8 == "" ? "50" : MaxMarks8).ToString() + "' id='MaxMark8' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'><span id=''> TOTAL </span><br><span id=''>100</span></th><th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>GRADE</th>");
                                }
                            }
                            else
                            {
                                if (ClassName.ToUpper() == "IX")
                                {
                                    ...
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''>M.A.</span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "5" : MaxMarks5).ToString() + "' id='MaxMarks4' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> PORT.</span><br><input name='' type='text' value='" + (MaxMarks6 == "" ? "5" : MaxMarks6).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> A.E.</span><br><input name='' type='text' value='" + (MaxMarks7 == "" ? "80" : MaxMarks7).ToString() + "' id='MaxMarks6' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'><span id=''> TOTAL </span><br><span id=''>100</span></th><th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>GRADE</th>");
                                }
                                if (ClassName.ToUpper() == "X")
                                {
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15 tab-in' scope='col'><span id=''>Prelims.</span><br><input name='' type='text' value='" + (MaxMarks1 == "" ? "80" : MaxMarks1.ToString()) + "' id='MaxMarks1' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>P.T.<br>5</th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> S.E.</span><br><input name='' type='text' value='" + (MaxMarks3 == "" ? "5" : MaxMarks3).ToString() + "' id='MaxMarks3' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''>M.A.</span><br><input name='' type='text' value='" + (MaxMarks4 == "" ? "5" : MaxMarks4).ToString() + "' id='MaxMarks4' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> PORT.</span><br><input name='' type='text' value='" + (MaxMarks5 == "" ? "5" : MaxMarks5).ToString() + "' id='MaxMarks5' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> Pre. <br>Board-1</span><br><input name='' type='text' value='" + (MaxMarks6 == "" ? "80" : MaxMarks6).ToString() + "' id='MaxMarks6' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n tab-b-15  tab-in' scope='col'><span id=''> Pre. <br>Board-2</span><br><input name='' type='text' value='" + (MaxMarks8 == "" ? "80" : MaxMarks8).ToString() + "' id='MaxMarks8' class='form-control-blue text-center' style='width:40px;' " + disabledAttribute + "></th>");
                                    Response.Write("<th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'><span id=''> TOTAL </span><br><span id=''>100</span></th><th class='p-tot-tit p-pad-n sub-m-w-70' scope='col'>GRADE</th>");
                                }
                            }
                        }
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            if (Evail.ToLower() == "term1")
                            {
                                if (isAdditional == "Yes")
                                {
                                    if (ClassName.ToUpper() == "IX")
                                    {
                                        Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + Test1.ToString() + "' class='form-control-blue text-center' name='1' style='width:40px;' " + disabledAttribute + "></td>");
                                        Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + Test2.ToString() + "' class='form-control-blue text-center' name='2' style='width:40px;' " + disabledAttribute + "></td>");
                                    }
                                    if (ClassName.ToUpper() == "X")
                                    {
                                        Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + Test1.ToString() + "' class='form-control-blue text-center' name='1' style='width:40px;' " + disabledAttribute + "></td>");
                                    ...
                                    Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + Port.ToString() + "' class='form-control-blue text-center' name='5' style='width:40px;' " + disabledAttribute + "></td>");
                                ...
                                else
                                {
                                    ...
                                    Response.Write("<td class='p-pad-n text-center tab-in'><span id=''>" + percentle1.ToString("0.00") + "</span></td>");
                                    Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + SE.ToString() + "' class='form-control-blue text-center' name='3' style='width:40px;' " + disabledAttribute + "></td>");
                                    Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + MA.ToString() + "' class='form-control-blue text-center' name='4' style='width:40px;' " + disabledAttribute + "></td>");
                                    Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + Port.ToString() + "' class='form-control-blue text-center' name='5' style='width:40px;' " + disabledAttribute + "></td>");
                                    Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + SAT.ToString() + "' class='form-control-blue text-center' name='6' style='width:40px;' " + disabledAttribute + "></td>");
                                    Response.Write("<td class='p-pad-n text-center tab-in'><span id=''>" + double.Parse(ObtMarks1).ToString("0") + "</span></td>");
                                    Response.Write("<td class='p-pad-n text-center tab-in'><span id=''>" + (double.Parse(ObtMarks1) == 0 ? "" : grade1.ToString()) + "</span></td>");
                            ...
                            if (Evail.ToLower() == "term2")
                            {
                                if (isAdditional == "Yes")
                                {
                                    ...
                                    if (ClassName.ToUpper() == "X")
                                    {
                                        ...
                                        Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + Port.ToString() + "' class='form-control-blue text-center' name='5' style='width:40px;' " + disabledAttribute + "></td>");
                                        Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + SAT.ToString() + "' class='form-control-blue text-center' name='6' style='width:40px;' " + disabledAttribute + "></td>");
                                        Response.Write("<td class='p-pad-n text-center tab-in'><input type='text' value='" + SAT2.ToString() + "' class='form-control-blue text-center' name='6' style='width:40px;' " + disabledAttribute + "></td>");
                                        Response.Write("<td class='p-pad-n text-center tab-in'><span id=''>" + double.Parse(ObtMarks1).ToString("0") + "</span></td>");
                                        Response.Write("<td class='p-pad-n text-center tab-in'><span id=''>" + (double.Parse(ObtMarks1) == 0 ? "" : grade1.ToString()) + "</span></td>");
                                    }
