                        ...
                        if (dss.Tables[0].Rows.Count > 0)
                        {
                            ...
                            for (int p = 0; p < dss.Tables[0].Rows.Count; p++)
                            {
                                ...
                                if (ClassName == "X")
                                {
                                    if (MaxMarks1 > 0)
                                    {
                                        Test1convin20 = Math.Round((Test1 * 20) / MaxMarks1,2);
                                    }
                                    if (MaxMarks1 > 0)
                                    {
                                        Test2convin20 = Math.Round((Test2 * 20) / MaxMarks2, 2);
                                    }
                                ...
                                if (totalmmmarks1 > 0)
                                {
                                    percentle1 = Math.Round(((totalmarks1) * 5) / 20,2);
                                ...
                                if (ClassName == "IX")
                                {
                                    if (totalmmmarks_2 > 0)
                                    {
                                        percentle_2 = Math.Round(((totalmarks_2) * 5) / totalmmmarks_2,2);
                                    }
                                ...
                                if (ClassName == "X")
                                {
                                    ...
                                    {
                                        percentle_2 = Math.Round(((Test1_2) * 5) / MaxMarks1_2,2);
                                    }
                            ...
                            if (dss.Tables[1].Rows.Count > 0)
                            {
                                ...
                                for (int p = 0; p < dss.Tables[1].Rows.Count; p++)
                                {
                                    ...
                                    if (totalmmmarks1 > 0)
                                    {
                                        percentle1 = Math.Round(((totalmarks1) * 5) / totalmmmarks1,2);
                                        if (ClassName == "IX")
                                        {
                                            ObtMarks1 = (double.Parse(percentle1.ToString("0")) + double.Parse(SAT.ToString("0")) + double.Parse(Port.ToString("0")) + double.Parse(Prac.ToString("0")));
                                        }
                                        else
                                        {
