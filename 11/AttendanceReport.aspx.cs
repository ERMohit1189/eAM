...
public partial class admin_AttendanceReport : System.Web.UI.Page
{
    ...
    {
        string type = rptType.SelectedValue;
        ...
        obj.FileName = type;
        obj.EmpID = DropDownList1.SelectedValue;

        dt = null;

        dt = DAL.DALInstance.GetAttendanceReport1(obj);
        ...
        if (dt != null && dt.Rows.Count > 0)
        {
            ...
            //    foreach (DataControlField column in gvAttendance.Columns)
            //    {
