...
public partial class _11_G3_server_ClasswiseAllSubjectJunior : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "ClasswiseCumulative_Junior";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int s = 0; s < dt.Rows.Count; s++)
                    {
                        ...
                        string maxmarks4 = "0";
                        string maxmarks5 = "0";
                        if (dt.Rows[s]["MaxMarks1"].ToString().Trim()!= "")
                        {
                            maxmarks1 = dt.Rows[s]["MaxMarks1"].ToString().Trim();
                        }
                        if (dt.Rows[s]["MaxMarks2"].ToString().Trim() != "")
                        {
                            maxmarks2 = dt.Rows[s]["MaxMarks2"].ToString().Trim();
                        }
                        if (dt.Rows[s]["MaxMarks3"].ToString().Trim() != "")
                        {
                            maxmarks3 = dt.Rows[s]["MaxMarks3"].ToString().Trim();
                        }
                        if (dt.Rows[s]["MaxMarks4"].ToString().Trim() != "")
                        {
                            maxmarks4 = dt.Rows[s]["MaxMarks4"].ToString().Trim();
                        }
                        if (dt.Rows[s]["MaxMarks5"].ToString().Trim() != "")
                        {
                            maxmarks5 = dt.Rows[s]["MaxMarks5"].ToString().Trim();
                        }
                        Response.Write("<tr><td class='" + DisableTest1 + "'>" + maxmarks1.ToString() + "</td><td class='" + DisableTest2 + "'>" + maxmarks2.ToString() + "</td><td>" + maxmarks4.ToString() + "</td><td>" + maxmarks5.ToString() + "</td></tr>");
                            ...
                            for (int s2 = 0; s2 < dt.Rows.Count; s2++)
                            {
                                ...
                                if (dt2.Rows.Count > 0)
                                {
                                    for (int m = 0; m < dt2.Rows.Count; m++)
                                    {
                                        ...
                                        string maxmarks4 = "0";
                                        string maxmarks5 = "0";
                                        if (dt2.Rows[m]["Test1"].ToString().Trim() != "")
                                        {
                                            maxmarks1 = dt2.Rows[m]["Test1"].ToString().Trim();
                                        }
                                        if (dt2.Rows[m]["Test2"].ToString().Trim() != "")
                                        {
                                            maxmarks2 = dt2.Rows[m]["Test2"].ToString().Trim();
                                        }
                                        if (dt2.Rows[m]["TH"].ToString().Trim() != "")
                                        {
                                            maxmarks3 = dt2.Rows[m]["TH"].ToString().Trim();
                                        }
                                        if (dt2.Rows[m]["Prac"].ToString().Trim() != "")
                                        {
                                            maxmarks4 = dt2.Rows[m]["Prac"].ToString().Trim();
                                        }
                                        ...
                                        Response.Write("<tr><td class='" + DisableTest1 + "'>" + maxmarks1.ToString() + "</td><td class='" + DisableTest2 + "'>" + maxmarks2.ToString() + "</td><td>" + maxmarks3.ToString() + "</td><td>" + maxmarks4.ToString() + "</td></tr>");
                                        Response.Write("</table>");
                                        Response.Write("</td>");
                                    }
                                }
                                else
                                {
                                    Response.Write("<td style='font-size:11px !important; vertical-align: top;'>");
                                    Response.Write("<table class='innerTable' style='margin-bottom: 0px !important;'>");
                                    Response.Write("<tr><td class='" + DisableTest1 + "'>0</td><td class='" + DisableTest2 + "'>0</td><td>0</td><td>0</td></tr>");
                                    Response.Write("</table>");
                                    Response.Write("</td>");
                                }
                                //Response.Write("</tr>");
