            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int s = 0; s < dt.Rows.Count; s++)
                    {
                        ...
                        Response.Write("<tr><td class='" + DisableTest1 + "'>" + (TermNmae.Trim().ToLower() == "term1" ? "T1" : "T3") + "</td><td class='" + DisableTest2 + "'>" + (TermNmae.Trim().ToLower() == "term1" ? "T2" : "T4") + "</td><td>NB</td><td>SE</td><td>" + (TermNmae.Trim().ToLower()=="term1"?"HY":"AE") + "</td><td>PRAC</td></tr>");
