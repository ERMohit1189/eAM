<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClasswiseAllSujectMarksListPrePrimary.aspx.cs" Inherits="_11_G3_ClasswiseAllSujectMarksListPrePrimary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ClasswiseAllSubjectPrePrimaryNew.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
