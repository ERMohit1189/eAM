<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClasswiseAllSubjectMarksListJunior.aspx.cs" Inherits="_11_G3_ClasswiseAllSubjectMarksListJunior" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ClasswiseAllSubjectJunior.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
