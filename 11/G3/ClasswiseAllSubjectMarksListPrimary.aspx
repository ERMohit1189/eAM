<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClasswiseAllSubjectMarksListPrimary.aspx.cs" Inherits="_11_G3_ClasswiseAllSubjectMarksListPrimary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ClasswiseAllSubjectPrePrimaryServer.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
