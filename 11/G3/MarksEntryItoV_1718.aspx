<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryItoV_1718.aspx.cs" Inherits="common_MarksEntryItoV_1718" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <script>
        ...
        function LoadFillList() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/MarksEntryItoV_1718Server.aspx") %>',
                data: {
                    'ClassName': ClassName,
        ...
        function SaveMarks() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/SaveMarksEntryItoV_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassIds,
                    'SectionName': SectionName,
                    'SubjectId': SubjectId,
