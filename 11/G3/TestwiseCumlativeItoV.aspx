<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" CodeFile="TestwiseCumlativeItoV.aspx.cs" Inherits="TestwiseCumlativeItoV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                                    ...
                                    <div runat="server" id="divExport">
                                        <div class=" table-responsive  table-responsive2 " id="abc" runat="server">
                                                    ...
                                                    <asp:Repeater ID="rptStudents" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class=" hide"><asp:Label ID="lblMonth" runat="server" Text=""></asp:Label>
                                                                   </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                            ...
                                            <table class="table table-striped no-bm no-head-border table-bordered pro-table table-header-group">
                                                <tbody>
                                                    <tr>
                                                    <th colspan="9" style="height: 30px;">Teacher's Sign</th></tr>
                                                    <tr><td style="height: 70px;"></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
  ...
  function exceller() {
    ...
    link.download = "TestwiseCumulativeItoV.xls";
