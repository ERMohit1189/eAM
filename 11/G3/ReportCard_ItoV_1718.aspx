<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_ItoV_1718.aspx.cs" Inherits="common_G4_ReportCard_ItoV_1718" %>
                                    ...
                                    <div class="col-sm-12  no-padding">
                                        ...
                                        <div class="col-sm-3" id="div2" runat="server" visible="false">
                                            ...
                                            <asp:DropDownList ID="drpPromoTo" runat="server" CssClass="form-control-blue ">
                                                ...
                                                <asp:ListItem Value="7">Promoted on the basis of Half Yearly Examination to Class</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                                                                            ...
                                                                                            <table class="table mp-table tbl p-table-bordered table-bordered" style="text-align: center; margin-bottom: 0px;">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <th style="padding: 0px 4px !important;" class="text-center">MARKS RANGE</th>
                                                                                                        <th style="padding: 0px 4px !important;" class="text-center">GRADE</th>
                                                                                                        <th style="padding: 0px 4px !important;" class="text-center">5-POINT GRADING SCALE</th>
                                                                                                        <th style="padding: 0px 4px !important;" class="text-center">GRADE</th>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="padding: 0px 4px !important;" class="text-center">40-50</td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="padding: 0px 4px !important;" class="text-center" rowspan="2">39 &amp; Below</td>
                                                                                                        <td style="padding: 0px 4px !important;" class="text-center" rowspan="2">E (Essential Repeat)</td>
