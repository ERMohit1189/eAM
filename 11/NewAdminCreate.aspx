<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="NewAdminCreate.aspx.cs"
    Inherits="admin_NewUserCreate" %>
        ...
        <ContentTemplate>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-sm-4   mgbt-xs-15">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="text-box-msg">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtEmail" ErrorMessage="Can't leave blank!"
                                            ...
                                            <div class="col-sm-4   mgbt-xs-15">
                                                ...
                                                <div class="">
                                                    <asp:TextBox ID="txtContactNo" runat="server" onblur="ChecktenDigitMobileNumber(this)" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                                    <div class="text-box-msg">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12   ">
                                                <fieldset>
                                                    ...
                                                    <div class="col-sm-4   mgbt-xs-15">
                                                        ...
                                                        <div class="">
                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:TextBox ID="txtUserId" placeholder="" runat="server" AutoPostBack="True"
                                                                        OnTextChanged="txtUserId_TextChanged" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                                                    <div class="text-box-msg">
                                                    ...
                                                    <div class="col-sm-4   mgbt-xs-15" style="display: none">
                                                        ...
                                                        <div class="">
                                                            <asp:DropDownList ID="DrpBranchName" runat="server" CssClass="form-control-blue">
                                                            </asp:DropDownList>
                                                            <div class="text-box-msg">
                                                            </div>
                                                        </div>
            ...
            <div style="overflow: auto; width: 1px; height: 1px">
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <div data-rel="scroll" data-scrollheight="450px" class="scroll-show-always">
                        <div class="col-sm-12 ">
                            <table class="tab-popup">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="vd_input-wrapper controls">
                                            <span class="menu-icon cursor-p" id="Span3" title="View" data-toggle="tooltip"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="LinkButton4" runat="server" OnClientClick="ValidateTextBox('.validatetxt1');return validationReturn();" CausesValidation="False" CssClass=" button-y" OnClick="LinkButton4_Click">Update</asp:LinkButton>
                                        &nbsp;
