...
public partial class staff_CoscholasticGradeEntry_XI : Page
{
    ...
    public void loadgrid()
    {
        ...
        sql +=  "   and  BranchId='" + drpBranch.SelectedValue + "'";
        sql +=  "   and SectionName='" + drpsection.SelectedValue + "' and SessionName='" + Session["SessionName"].ToString() + "' and ";
        sql +=  "   BranchCode=" + Session["BranchCode"].ToString() + " and Medium='" + drpmedium.SelectedValue.ToString() + "' and Withdrwal is null and  isnull(Promotion,'')<>'Cancelled' order by Name Asc";
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            sql +=  " where GroupId='G6' and EmpCode='" + Session["LoginName"].ToString() + "' and T1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
    ...
    public void loadCoscholastic()
    {
        ...
        sql +=  " except";
        sql +=  " Select CoscholasticName,cm.id as Id from CoscholasticMaster cm";
        sql +=  " inner join CoscholasticGroupMaster cgm on cgm.Id=cm.GroupId where cm.ClassId='" + drpclass.SelectedValue.ToString() + "' and cm.Medium='" + drpmedium.SelectedValue.ToString() + "'";
        sql +=  " and Groupid='" + drpGroupName.SelectedValue.ToString() + "' and cgm.BranchCode=" + Session["BranchCode"] + " and cm.BranchCode=" + Session["BranchCode"] + " and SelectedItem=0 order by id Asc ";
    ...
    public void loadBranch()
    {
        if (Session["Logintype"].ToString() == "Admin")
        {
            sql = "Select Id, BranchName from BranchMaster where ClassId='" + drpclass.SelectedValue.ToString() + "'";
            sql +=  " and   BranchCode=" + Session["BranchCode"].ToString() + " and SessionName='" + Session["SessionName"].ToString() + "'";
            oo.FillDropDown_withValue(sql, drpBranch, "BranchName", "Id");
        }
        else
        {
            sql = "Select  cm.Id, BranchName from ClassTeacherMaster T1";
            sql +=  " inner join BranchMaster cm on cm.ClassId=T1.ClassId and cm.id=T1.BranchId and cm.SessionName=t1.SessionName and cm.BranchCode=t1.BranchCode";
            sql +=  " where  T1.ClassId=" + drpclass.SelectedValue + " and EmpCode='" + Session["LoginName"].ToString() + "' and T1.BranchCode=" + Session["BranchCode"] + " and T1.SessionName='" + Session["SessionName"] + "'";
            oo.FillDropDown_withValue(sql, drpBranch, "BranchName", "Id");
        }
    }
    ...
    protected void TextBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        if (Text1.Text == "A" || Text1.Text == "B" || Text1.Text == "C" || Text1.Text == "D" 
            || Text1.Text == "A1" || Text1.Text == "B1" || Text1.Text == "C1" || Text1.Text == "D1" 
            || Text1.Text == "A2" || Text1.Text == "B2" || Text1.Text == "C2" || Text1.Text == "D2" || Text1.Text == "E" || Text1.Text == "-" || Text1.Text == "")
        {
        ...
        {
            Campus camp = new Campus(); camp.msgbox(Page, msgbox, "Please enter grads A, B ,C , D, A1, B1, C1, D1, A2, B2, C2, D2,E or (-) only!", "A");
            lblGrade.Text = Text1.Text = "";
            Text1.Focus();
            return;
        }
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        if (GridView1.Rows.Count > 0)
        {
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                cmd = new SqlCommand();
                cmd.CommandText = "CCEXItoXIICoscholasticProc";
    ...
    protected void drpCoscholastic_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (GridView1.Rows.Count > 0)
        {
            ...
            foreach (GridViewRow gvr in GridView1.Rows)
            {
                ...
                sql = "Select Id,Grade,GradePoint from CCEXItoXIICoscholastic where SRNO='" + lblsrno.Text + "' and BranchCode=" + Session["BranchCode"] + " and Evaluation='" + drpEval.SelectedItem.Text + "' and CoscholasticId='" + drpCoscholastic.SelectedValue.ToString() + "'";
