...
public partial class comman_ClasswiseAllSubjectMarksList : Page
{
    string sql = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("ClasswiseAllSubjectMarksListXI_1617.aspx?check=ClasswiseAllSubjectMarksList_XI");
            }
            else
            {
                Response.Redirect("ClasswiseAllSubjectMarksListXI_1718.aspx?check=ClasswiseAllSubjectMarksList_XI");
            }
    ...
    public void loadclass()
    {
        ...
        else
        {
            if (Session["SessionName"].ToString() == "2015-2016")
            {
                ...
                sql +=  " where GroupId='G6' and cm.SessionName='" + Session["SessionName"] + "' and sctm.SessionName='" + Session["SessionName"] + "' and Ecode='" + Session["LoginName"].ToString() + "' and ClassTeacher='Yes' Order by CIDOrder";
                oo.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
            }
            else
            {
                ...
                sql +=  " where GroupId='G6' and EmpCode='" + Session["LoginName"].ToString() + "' and cm.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and t2.BranchCode=" + Session["BranchCode"] + " and IsClassTeacher=1 and T1.SessionName='" + Session["SessionName"] + "' Order by CIDOrder";
                oo.FillDropDown_withValue(sql, drpclass, "ClassName", "Id");
            }
        }
    ...
    public void loadsection()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                sql +=  " where EmpCode='" + Session["LoginName"].ToString() + "' and sm.BranchCode=" + Session["BranchCode"] + " and t1.BranchCode=" + Session["BranchCode"] + " and IsClassTeacher=1 and T1.SessionName='" + Session["SessionName"] + "'";
    ...
    protected void loadClassName()
    {
        ...
        sql = "Select Left(SubjectName,9) as SubjectGroup,Id from SubjectMaster where Classid='" + drpclass.SelectedValue.ToString() + "' and BranchCode=" + Session["BranchCode"] + " and (branchid is null or branchid='" + drpBranch.SelectedValue.ToString() + "')";
    ...
    protected void loadSubject()
    {
        ...
        sql +=  "   where sc.SectionName='" + drpsection.SelectedItem.Text + "' and sg.SessionName='" + Session["SessionName"].ToString() + "' and so.BranchCode=" + Session["BranchCode"] + " and cm.BranchCode=" + Session["BranchCode"] + " and sf.BranchCode=" + Session["BranchCode"] + " and so.BranchCode=" + Session["BranchCode"] + " and ";
    ...
    protected void loadStudentDataForFA2_Fa3_Fa4()
    {
        for (int k = 0; k < Repeater1.Items.Count; k++)
        {
            ...
            sql +=  " where scm.SectionName='" + drpsection.SelectedItem.Text + "' and sg.BranchCode=" + Session["BranchCode"] + " and sm.BranchCode=" + Session["BranchCode"] + " and cv.BranchCode=" + Session["BranchCode"] + " and so.SessionName='" + Session["SessionName"].ToString() + "' and sg.SessionName='" + Session["SessionName"].ToString() + "' and cv.SessionName='" + Session["SessionName"].ToString() + "' and sm.id='" + lblSubjectGroupId.Text + "'";
    ...
    protected void loadStudentDataForSA1_SA2()
    {
        for (int k = 0; k < Repeater1.Items.Count; k++)
        {
            ...
            sql +=  " and scm.SessionName='" + Session["SessionName"].ToString() + "' and scm.BranchCode=" + Session["BranchCode"] + " and sm.BranchCode=" + Session["BranchCode"] + " and sg.BranchCode=" + Session["BranchCode"] + " and cv.BranchCode=" + Session["BranchCode"] + "";
