...
public partial class commom_ClassWiseActivity : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            loadAlbum(drpAlbum, drpClass, drpSection, drpBranch);
            //loadPanelClass(drpClassPanel);
            //loadToClass(drpToClass);

            loadGrid("-1", drpAlbum.SelectedValue.ToString());
        }
        drpClass.Focus();
    }
    ...
    private void loadAlbum(DropDownList drpalbum,DropDownList drpclass, DropDownList drpsection, DropDownList drpbranch)
    {
        sql = "Select Title,id from ClassWiseActivityAlbum where SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"] + "";
        sql +=  " and ClassId='" + drpclass.SelectedValue.ToString() + "' and SectionId='" + drpsection.SelectedValue.ToString() + "' and BranchId='" + drpbranch.SelectedValue.ToString() + "'";
        if (Session["Logintype"].ToString() != "Staff")
        {
            BAL.objBal.FillDropDown_withValue_withSelect(sql, drpalbum, "Title", "Id");
        }
        else
        {
            BAL.objBal.FillDropDown_withValue(sql, drpalbum, "Title", "Id");
            BAL.objBal.fillSelectvalue(drpalbum, "<--Select-->", "0");
        }     
    }
    ...
    private void insert()
    {
        ...
        param.Add(new SqlParameter("@CWAAID", drpAlbum.SelectedValue.ToString()));
        ...
        {
            filePath = @"../Uploads/AlbumActivity/";
            fileName = txtTitle.Text + '_' + drpClass.SelectedValue.Trim() + '_' + drpSection.SelectedValue.Trim() + '_' + drpBranch.SelectedValue.Trim() + '_' + drpAlbum.SelectedValue.Trim() + ".jpg";
        ...
        msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("ClassWiseActivity_Proc", param);
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        if (ds != null)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                loadAlbum(drpAlbumPanel, drpClassPanel, drpSectionPanel, drpBranchPanel);
                drpAlbumPanel.SelectedValue = dt.Rows[0]["CWAAID"].ToString();
            }
        }
    ...
    private void update()
    {
        ...
        param.Add(new SqlParameter("@CWAAID", drpAlbumPanel.SelectedValue.ToString()));
        ...
        {
            filePath = @"../Uploads/AlbumActivity/";
            fileName = txtTitlePanel.Text + '_' + drpClassPanel.SelectedValue.Trim() + '_' + drpSectionPanel.SelectedValue.Trim() + '_' + drpBranchPanel.SelectedValue.Trim() + '_' + drpAlbumPanel.SelectedValue.Trim() + ".jpg";
    ...
    protected void drpAlbum_SelectedIndexChanged(object sender, EventArgs e)
    {
         loadGrid("-1", drpAlbum.SelectedValue.ToString());
    }
}