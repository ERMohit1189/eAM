 <%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClassWiseActivityAlbum.aspx.cs" Inherits="commom_ClassWiseActivity" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Album Name&nbsp;<span class="vd_red">*</span></label>
                                        <div class="">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpSection" runat="server" CssClass="form-control-blue validatedrp" 
                                                AutoPostBack="true" OnSelectedIndexChanged="drpSection_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpBranch" runat="server" CssClass="form-control-blue validatedrp" 
                                                AutoPostBack="true" OnSelectedIndexChanged="drpBranch_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>

                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Upload Cover Page&nbsp;<span class="vd_red"></span></label>
                                        <div class="">
                                                ...
                                                <asp:Repeater ID="rpt1" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblSectionId" runat="server" Text='<%# Eval("SectionId") %>'
                                                                    Visible="false"></asp:Label>
                                    ...
                                    <div style="overflow: auto; width: 1px; height: 1px">
                                        <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                                            <table class="tab-popup">
                                                <tr>
                                                    <td>Album Name <span class="vd_red">*</span>
                                                    </td>
                                                    <td class="controls">
                                                ...
                                                <tr>
                                                    <td>Upload Cover Page <span class="vd_red">*</span>
                                                    </td>
                                                    <td class="controls">
