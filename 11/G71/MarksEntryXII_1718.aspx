                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="col-sm-12  ">
                                                <div class=" table-responsive  table-responsive2 " id="table1" runat="server">
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowDataBound="GridView1_RowDataBound" class="table mp-table p-table-bordered table-bordered tbl1">
                                                        <Columns>
                                                    ...
                                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" OnRowDataBound="GridView2_RowDataBound"
                                                        class="table mp-table p-table-bordered table-bordered  tbl2">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="LblId" runat="server" Visible="false"></asp:Label>
