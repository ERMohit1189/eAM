<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClasswiseAllSubjectMarksListXII_1718.aspx.cs" Inherits="common_ClasswiseAllSubjectMarksListXII_1718" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                        ...
                        <div class="col-sm-12 ">
                            ...
                            <div id="Div1" class="col-sm-12  no-padding" runat="server">
                                ...
                                <div class="col-sm-2  half-width-50 mgbt-xs-15">
                                    ...
                                    <div id="div_Stream">
                                        <select id="drpStream" class="form-control-blue"></select>
                                    </div>
                                </div>
                                <div class="col-sm-2  half-width-50 mgbt-xs-15">
    ...
    <script>
        ...
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>Class wise Cumulative (XII)</title>' + headContent + '</head>');
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ClassWiseCumulativeReport_XII_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
