                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                if (drpEval.SelectedValue.ToUpper() == "TERM1")
                                {
                                    ...
                                    for (int m = 0; m < rptmarksT1.Items.Count; m++)
                                    {
                                        ...
                                        string hi = "select isnull(TRY_CONVERT(decimal(10,0),max(T1.highestMarks)),0) highestMarks from (select sum((((isnull(TRY_CONVERT(decimal(10,0),  case when ";
                                        hi = hi + " (case when isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),m.Test1),0)*20)/isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks1),1) else 0 end)> ";
                                        hi = hi + " (case when isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),m.Test2),0)*20)/isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks2),1) else 0 end)  ";
                                        hi = hi + " then ((case when isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks1),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),m.Test1),0)*20)/isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks1),1) else 0 end)*10)/20  ";
                                        hi = hi + " else  ((case when isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks2),0)>0 then (isnull(TRY_CONVERT(decimal(10,0),m.Test2),0)*20)/isnull(TRY_CONVERT(decimal(10,0),mm.MaxMarks2),1) else 0 end)*10)/20 end),0) ";
                                        hi = hi + " +isnull(TRY_CONVERT(decimal(10,0),m.SAT),0))  /(10+isnull(TRY_CONVERT(decimal(10,0), MaxMarks3),0)))  *isnull(TRY_CONVERT(decimal(10,0), MaxMarks3),0))   ";
