<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="RemarkForXII_1718.aspx.cs" Inherits="Comman_G7_RemarkForXII" %>
                                    ...
                                    <div class="col-sm-3">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                    <ContentTemplate>
                                                         <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control-blue" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="">
                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                    <ContentTemplate>
                                                         <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control-blue " OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="true">
