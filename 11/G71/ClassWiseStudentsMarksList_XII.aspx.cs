...
public partial class comman_ClassWiseStudentsMarksList_XII : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Response.Redirect("Studentwisecumulative_XII.aspx?check=ClassWiseStudentsMarksList_XII");
            }
            loadclass();
            loadsection();
            loadBranch();
    ...
    public void loadclass()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                sql +=  " where EmpCode='" + Session["LoginName"].ToString() + "' and IsClassTeacher=1 and T1.SessionName='" + Session["SessionName"].ToString() + "' Order by CIDOrder";
                oo.FillDropDown_withValue(sql, drpClass, "ClassName", "Id");
            }       
        }
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        if (RadioButtonList1.SelectedIndex == 0)
        {
            ...
            Response.Write("window.open('ReportCardofXII.aspx?print=1','_blank')");
            Response.Write("</script>");
        }
        else
        {
            Response.Write("<script>");
            Response.Write("window.open('ParticularStudentMarksXII.aspx?print=1','_blank')");
            Response.Write("</script>");
        }
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (RadioButtonList1.SelectedIndex == 0)
        {
            Response.Redirect("PrintReportCardXII.aspx?print=1");
        }
    }
}