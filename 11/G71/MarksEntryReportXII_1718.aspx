<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryReportXII_1718.aspx.cs" Inherits="common_MarksEntryReportXII_1718" %>
                                                             ...
                                                             <td colspan="4">
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowCreated="GridView1_RowCreated"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Best Two Test Total">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Con. in 10">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Con. in Bord Patt. (A)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblConinBoard" runat="server" Text="Con. in Bord Patt. (A)"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblConinBoardMM" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblConinBoardMarks" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>

                                                                        <asp:TemplateField HeaderText="Prac. (B)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblPrac" runat="server" Text="H.Y."></asp:Label>
                                                                                <br />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="(A+B)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblGTotal1" runat="server" Text="TOTAL (A+B)"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblGMM1" runat="server" Text="100"></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblGTotal1" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblH1Total" runat="server" Text="TOTAL"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblH2Total" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblTotal" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Prac. (B)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblPrac" runat="server" Text="Prac. (B)"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblPracMM" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblPracMarks" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField Visible="false">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblHY22" runat="server" Text="H.Y."></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblMMHY22" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblHY22" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center tab-in" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n tab-b-15  tab-in" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Con. in Bord Patt. (A)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblConinBoard2" runat="server" Text="Con. in Bord Patt. (A)"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblConinBoardMM2" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblConinBoardMarks2" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Prac. (B)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblPrac2" runat="server" Text="Prac. (B)"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblPracMM2" runat="server" Text=""></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblPracMarks2" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="(A+B)">
                                                                            <HeaderTemplate>
                                                                                <asp:Label ID="lblGTotal2" runat="server" Text="TOTAL (A+B)"></asp:Label>
                                                                                <br />
                                                                                <asp:Label ID="lblGMM2" runat="server" Text="100"></asp:Label>
                                                                            </HeaderTemplate>
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblGTotal2" runat="server" Text=""></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="G. TOTAL">
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lnlGTotal" runat="server" Text=""></asp:Label>
                                                                                <asp:Label ID="lblGGrade" runat="server" Text="" Visible="false"></asp:Label>
                                                                            </ItemTemplate>
                                                                            <ItemStyle CssClass=" p-pad-n text-center" />
                                                                            <HeaderStyle CssClass="p-tot-tit p-pad-n sub-m-w-70" />
                                                                        </asp:TemplateField>
