...
public partial class admin_UploadSyllabus : System.Web.UI.Page
{
        ...
        if (drpSection.SelectedIndex == 0)
        {
            for (int i = 1; i < drpSection.Items.Count; i++)
            {
                if (hfSllabusFile.Value != string.Empty && hfSllabusFile.Value != null)
                {
                    ...
                    Msg = DLL.objDll.Sp_Insert_Update_Delete_usingExecuteNonQuery("Std_Downloads_proc", param);
    ...
    private void loadGrid(string Id)
    {
        ...
        grdDocList.DataSource = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Downloads_proc", param);
        grdDocList.DataBind();
    }
    ...
    protected void lnkEdit_Click(object sender, EventArgs e)
    {
        ...
        ds = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("Std_Downloads_proc", param);
        if (ds != null)
        {
