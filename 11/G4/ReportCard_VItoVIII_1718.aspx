<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ReportCard_VItoVIII_1718.aspx.cs" Inherits="common_G4_ReportCard_VItoVIII_1718" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
                                                                ...
                                                                <tr>
                                                                    <td colspan="3" style="padding: 5px !important; padding-top:0px !important;">
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptmarksT1">
                                                                                    ...
                                                                                    <HeaderTemplate>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th colspan="4" style=" vertical-align: middle; width:32%;">HALF YEARLY EXAMINATION</th>
                                                                                        </tr>
                                                                                        <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <asp:Repeater runat="server" ID="rptSkil1">
                                                                                    <HeaderTemplate>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th style="padding: 0px 2px !important; vertical-align: top;" class="text-uppercase">HALF YEARLY</th>
                                                                                        </tr>
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                                ...
                                                                                <asp:Repeater runat="server" ID="rptSkil2">
                                                                                    <HeaderTemplate>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th style="padding: 0px 2px !important; width: 32%; vertical-align: top;" class="text-uppercase">HALF YEARLY</th>
                                                                                            <th style="padding: 0px 2px !important; vertical-align: top;" class="text-uppercase">ANNUAL</th>
                                                                                        </tr>
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <tr>
                                                                        ...
                                                                        <div class="col-sm-12 no-padding text-uppercase" style="padding: 0px; margin: 0px;">
                                                                            <table class="table" style="text-align: center; margin: 0px; margin-top: 0px;">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td style="width: 49%; padding: 0px !important; vertical-align: top; padding-right: 10px !important;">
                                                                                            <table class="table mp-table tbl p-table-bordered table-bordered" style="text-align: center; margin-bottom: 0px;">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <th style="padding: 0px 5px !important;" colspan="4" class="text-center">GRADING SCALE FOR SCHOLASTIC AREAS</th>
                                                                                                        <th style="padding: 0px 5px !important;" colspan="2" class="text-center">GRADING SCALE FOR CO-SCHOLASTIC AREAS</th>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <th style="padding: 0px 5px !important;" class="text-center">MARKS RANGE</th>
                                                                                                        <th style="padding: 0px 5px !important;" class="text-center">GRADE</th>
                                                                                                        <th style="padding: 0px 5px !important;" class="text-center">MARKS RANGE</th>
                                                                                                        <th style="padding: 0px 5px !important;" class="text-center">GRADE</th>
                                                                                                        <th style="padding: 0px 5px !important;" class="text-center">5-POINT GRADING SCALE</th>
                                                                                                        <th style="padding: 0px 5px !important;" class="text-center">GRADE</th>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">91-100</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">A1</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">51-60</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">C1</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">Exemplary</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">A</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">81-90</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">A2</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">40-50</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">C2</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">Proficient</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">B</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">71-80</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">B1</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center" rowspan="2">39 &amp; Below</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center" rowspan="2">E (Essential Repeat)</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">Developing</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">C</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">61-70</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">B2</td>
                                                                                                         <td style="padding: 0px 5px !important;" class="text-center">Emerging</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">D</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center" colspan="4"></td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">Beginner</td>
                                                                                                        <td style="padding: 0px 5px !important;" class="text-center">E</td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
                                                                        ...
                                                                        <table class="table term2 tbl mp-table p-table-bordered table-bordered text-uppercase" id="tblResult" runat="server" style="margin-top: 2px; margin-bottom: 0px; width: 100%;">
                                                                            <tbody>
                                                                                <tr>
    ...
    <script>
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>REPORT CARD FOR VItoVIII</title>' + headContent + '</head>');
