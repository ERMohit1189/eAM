...
using System.Web.UI;
public partial class common_G4_SaveMarksEntryVItoVIII_1718Server : Page
{
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            try
            {
                ...
                if (error1 == false)
                {
                    ...
                    cmd.CommandText = "SetMaxMinMarksProc_VItoVIII";
                    ...
                    for (int i = 0; i < MarksFullArr.Length - 1; i++)
                    {
                        ...
                        cmd.CommandText = "USP_MarkEntry_CCEVItoVIII_1718";
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        cmd.Parameters.AddWithValue("@Prac", MarksArr[6]);
                        cmd.Parameters.AddWithValue("@SessionName", Session.ToString().Trim());
                        cmd.Parameters.AddWithValue("@BranchCode", BranchCode.Trim());
                        cmd.Parameters.AddWithValue("@LoginName", LoginName.ToString().Trim());
                        cmd.ExecuteNonQuery();
