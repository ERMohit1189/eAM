...
public partial class common_G4_MarksEntryVItoVIII_1718Server : System.Web.UI.Page
{
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    try
                    {
                        ...
                        string sql1 = "Select MaxMarks1,MaxMarks2,MaxMarks4,MaxMarks5,MaxMarks6,MaxMarks7 from SetMaxMinMarks_VItoVIII where Eval='" + Evail.ToString().Trim() + "' and BranchCode=" + BranchCode.ToString() + " and SubjectActivityId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "'";
                        ...
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            string sql3 = "Select Id,Test1,Test2,Test3,SAT,NB,SE,Prac from CCEVItoVIII_1718 where SRNO='" + dt.Rows[i]["srno"].ToString() + "' and Evaluation='" + Evail.ToString().Trim() + "' and SubjectId='" + SubjectId.ToString().Trim() + "'  and PaperId='" + PaperId.ToString().Trim() + "' and SessionName='" + Session.ToString() + "' and BranchCode=" + BranchCode + "";
                            ...
                            ObtMarks1 = (percentle1 + NBM + SEM + SATM + PracM).ToString("0");
