<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="MarksEntryReportVItoVIII_1718.aspx.cs" Inherits="common_MarksEntryReportVItoVIII_1718" %>
                                                ...
                                                <div class=" table-responsive  table-responsive2 " id="table1" runat="server">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowCreated="GridView1_RowCreated"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblHY1" runat="server" Text="H.Y."></asp:Label>
                                                                    <br />
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblPrac1" runat="server" Text="Prac."></asp:Label>
                                                                    <br />
                                                    ...
                                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" OnRowCreated="GridView2_RowCreated"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblTEST4" runat="server" Text="TEST3"></asp:Label>
                                                                    <br />
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblTEST5" runat="server" Text="TEST4"></asp:Label>
                                                                    <br />
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblPrac2" runat="server" Text="Prac."></asp:Label>
                                                                    <br />
