<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="ClassWiseStudentsMarksList_VItoVIII.aspx.cs" Inherits="ClassWiseStudentsMarksList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <asp:UpdatePanel ID="tyu" runat="server">
            ...
            <td colspan="3">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Selected="True">
                         Report Card (Only Grade)
                    </asp:ListItem>
                    <asp:ListItem >
                         Report Card (Grade + Per.)
                    </asp:ListItem>
                    <asp:ListItem>
                         Student Marks Deatil
                    </asp:ListItem>
                </asp:RadioButtonList>
            </td>
        ...
        <tr>
            ...
            <td>Section:  <span class="imp">*</span>
            </td>
            <td>
