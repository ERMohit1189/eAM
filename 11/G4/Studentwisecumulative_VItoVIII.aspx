<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Studentwisecumulative_VItoVIII.aspx.cs" Inherits="common_G4_Studentwisecumulative_VItoVIII" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '#drpsection', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%=ResolveUrl("Server/ddlSrNo_4.aspx") %>',
        ...
        function LoadClass() {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlClass_4.aspx") %>',
                data: {},
                dataType: "json",
                async: true,
                success: function (result) {
        ...
        function LoadSection(classId) {
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/ddlSection_4.aspx") %>',
        ...
        function PrintDiv() {
            ...
            printWindow.document.write('<html><head><title>STUDENT WISE CUMLATIVE FOR I to V</title>' + headContent + '</head>');
        ...
        function LoadData() {
            ...
            $.ajax({
                type: "POST",
                url: '<%=ResolveUrl("Server/Studentwisecumulative_VItoVIII_1718Server.aspx") %>',
                data: {
                    'ClassId': ClassId,
                    'ClassName': ClassName,
                    'SectionID': SectionID,
