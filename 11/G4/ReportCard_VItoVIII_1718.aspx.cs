...
public partial class common_G4_ReportCard_VItoVIII_1718 : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["Logintype"].ToString() == "Admin" || Session["Logintype"].ToString() == "Guardian")
            {
                ...
                _sql +=  " where cm.SessionName='" + Session["SessionName"] + "' and t1.SessionName='" + Session["SessionName"] + "'  and t1.BranchCode=" + Session["BranchCode"] + " and GroupId='G4' Order by CIDOrder";
    ...
    public void LoadReportCard()
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            {
                cmd.Connection = conn;
                cmd.CommandText = "ReportCard_VItoVIII_2021";
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                if (drpEval.SelectedValue.ToUpper() == "TERM1")
                                {
                                    ...
                                    for (int m = 0; m < rptmarksT1.Items.Count; m++)
                                    {
                                        ...
                                        string hi = "select max(T1.highestMarks)highestMarks from (select sum(TRY_CONVERT(decimal(10,2),((case when isnull(TRY_CONVERT(decimal(10,2),Test1),0)>isnull(TRY_CONVERT(decimal(10,2),Test2),0) then isnull(TRY_CONVERT(decimal(10,2),Test1),0)  ";
                                        hi = hi + " else  isnull(TRY_CONVERT(decimal(10,2),Test2),0) end)*10)/20+isnull(TRY_CONVERT(decimal(10,2),NB),0)+isnull(TRY_CONVERT(decimal(10,2),SE),0) +isnull(TRY_CONVERT(decimal(10,2),SAT),0)+isnull(TRY_CONVERT(decimal(10,2),Prac),0))) highestMarks ";
                                        hi = hi + " from CCEVItoVIII_1718 where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' and SubjectId=" + ds.Tables[0].Rows[m]["SubjectId_1"].ToString() + "  ";
                                        hi = hi + " and BranchCode=" + Session["BranchCode"] + " and PaperId!=0 and SessionName='" + Session["SessionName"] + "'  and Evaluation='Term1' ";
                                        ...
                                        string avg = "select T1.avgMarks from (select sum(((case when isnull(TRY_CONVERT(decimal(10,2),Test1),0)>isnull(TRY_CONVERT(decimal(10,2),Test2),0) ";
                                        avg = avg + " then isnull(TRY_CONVERT(decimal(10,2),Test1),0) else  isnull(TRY_CONVERT(decimal(10,2),Test2),0) end)*10)/20+isnull(TRY_CONVERT(decimal(10,2),NB),0)+isnull(TRY_CONVERT(decimal(10,2),SE),0)+isnull(TRY_CONVERT(decimal(10,2),SAT),0)+isnull(TRY_CONVERT(decimal(10,2),Prac),0)) avgMarks";
                                        avg = avg + " from CCEVItoVIII_1718 where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' and Evaluation='TERM1' and SubjectId=" + ds.Tables[0].Rows[m]["SubjectId_1"].ToString() + "  ";
                                        avg = avg + " and BranchCode=" + Session["BranchCode"] + " and PaperId!=0  and SessionName='" + Session["SessionName"] + "' ";
                                ...
                                if (drpEval.SelectedValue.ToUpper() == "TERM2")
                                {
                                    ...
                                    for (int p = 0; p < ds.Tables[0].Rows.Count; p++)
                                    {
                                        ...
                                        string hi = "select max(T1.highestMarks)highestMarks from (select Round(sum(Round(((case when isnull(TRY_CONVERT(decimal(10,2),Test1),0)>isnull(TRY_CONVERT(decimal(10,2),Test2),0) then isnull(TRY_CONVERT(decimal(10,2),Test1),0)  ";
                                        hi = hi + " else  isnull(TRY_CONVERT(decimal(10,2),Test2),0) end)*10)/20,0)+isnull(TRY_CONVERT(decimal(10,2),NB),0)+isnull(TRY_CONVERT(decimal(10,2),SE),0) +isnull(Round(TRY_CONVERT(decimal(10,2),SAT),0),0)+isnull(TRY_CONVERT(decimal(10,2),Prac),0)),0) highestMarks ";
                                        hi = hi + " from CCEVItoVIII_1718 where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "  ";
                                        ...
                                        hi = hi + "  )T1 ";
                                        double highestMarks = double.Parse((_oo.ReturnTag(hi, "highestMarks").ToString() == "" ? "0" : _oo.ReturnTag(hi, "highestMarks")));
                                        string avg = "select sum(T1.avgMarks)avgMarks from (select TRY_CONVERT(decimal(10,0),(TRY_CONVERT(decimal(10,2), (((case when isnull(TRY_CONVERT(decimal(10,2),Test1),0)> isnull(TRY_CONVERT(decimal(10,2),Test2),0)  then isnull(TRY_CONVERT(decimal(10,2),Test1),0) else  isnull(TRY_CONVERT(decimal(10,2),Test2),0) end)*10)/20)+isnull(TRY_CONVERT(decimal(10,2),NB),0)+isnull(TRY_CONVERT(decimal(10,2),SE),0) +isnull(TRY_CONVERT(decimal(10,2),SAT),0)+isnull(TRY_CONVERT(decimal(10,2),Prac),0))/2)) avgMarks";
                                        avg = avg + " from CCEVItoVIII_1718 where ClassId=" + drpclass.SelectedValue + " and SectionName='" + drpsection.SelectedItem.Text + "' and SubjectId=" + ds.Tables[0].Rows[p]["SubjectId_1"].ToString() + "  ";
