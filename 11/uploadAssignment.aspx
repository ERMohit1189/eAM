<%@ Page Title="" Language="C#" MasterPageFile="~/11/comman_root_manager.master" AutoEventWireup="true" CodeFile="uploadAssignment.aspx.cs" Inherits="admin_UploadSyllabus" %>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="#">
                                                 ...
                                                 <asp:TemplateField HeaderText="Title">
                                                    <ItemTemplate>
                                                        <asp:HyperLink runat="server" ID="idd" CssClass="link" NavigateUrl='<%# Bind("DocPath") %>' download="Assignment" style="color:blue;">
