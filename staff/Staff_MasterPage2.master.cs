...
public partial class Staff_MasterPage2 : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SubjectTeacherLink();
            ClassTeacherLink();
            sql = "select BrandName from BrandTab where  BranchId=" + Session["BranchCode"] + "";
            ...
            Image1.ImageUrl = BAL.objBal.ReturnTag(sql, "CologeLogoPath") + "?print=" + DateTime.Now;
    ...
    private void ADDTopMenuItem()
    {
        ...
        sql = sql + " where " + isfor + "=" + value + " and Login_Id='" + Session["LoginId"].ToString() + "' and Permission_Value='Yes' and ParentId is NUll";
        if (logintypeid != "0")
        {
