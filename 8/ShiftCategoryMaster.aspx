<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ShiftCategoryMaster.aspx.cs"
    Inherits="ShiftCategoryMaster" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtdesi" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>

                                            <div class="text-box-msg">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtdesi" ErrorMessage="*"
                                    ...
                                    <div class="col-sm-4  mgbt-xs-9">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtre" TextMode="MultiLine" runat="server" CssClass="form-control-blue" Rows="1"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center ">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Shift Category">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("EmpDesName") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Remark">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("EmpDesRemark") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                        <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label36" runat="server" Text='<%# Eval("EmpDesId") %>' Visible="false"></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label37" runat="server" Text='<%# Bind("EmpDesId") %>' Visible="false"></asp:Label>
            ...
            <div style="overflow: auto; width: 1px; height: 1px">
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        <tr>
                            <td>Shift Category <span class="vd_red">*</span></td>
                            <td>

                                <asp:TextBox ID="txtDepartmentNamePanel" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
