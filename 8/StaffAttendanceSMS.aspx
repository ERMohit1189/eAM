<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="StaffAttendanceSMS.aspx.cs" Inherits="_8_EmpAttendanceReportNew" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12">
                                 ...
                                 <div class="col-sm-12  half-width-50  btn-a-devices-1-p4-p2 mgbt-xs-15">
                                    <asp:LinkButton ID="Link_Send" OnClick="Link_Send_Click" runat="server" Visible="false" CssClass="button form-control-blue"> <i class="fa fa-paper-plane"></i> Send In Time SMS </asp:LinkButton>
                                    <div id="msgbox" runat="server" style="left: 155px;"></div>
                                </div>
                                  <div class="col-sm-12  half-width-50  btn-a-devices-1-p4-p2 mgbt-xs-15">
                                    <asp:LinkButton ID="LinkButton1" OnClick="LinkButton1_Click" runat="server" Visible="false" CssClass="button form-control-blue"> <i class="fa fa-paper-plane"></i> Send Out Time SMS </asp:LinkButton>
                                    <div id="Div1" runat="server" style="left: 155px;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
