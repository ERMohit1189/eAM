<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="employee_department.aspx.cs"
    Inherits="admin_employee_department" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtdep" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>

                                            <div class="text-box-msg">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtdep" ErrorMessage="*"
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-9">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtrem" TextMode="MultiLine" runat="server" CssClass="form-control-blue" Rows="1"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center ">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Remark">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("EmpDepRemark") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                        <ItemStyle HorizontalAlign="left" VerticalAlign="Middle" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
                                                            <%-- <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" Text='<%# Bind("EmpDepId") %>'
                                        CausesValidation="False" CssClass="edit" Height="16px" Width="16px"></asp:LinkButton>--%>
                                                            <asp:Label ID="Label36" runat="server" Text='<%# Eval("EmpDepId") %>' Visible="false"></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Delete">
                                                        <ItemTemplate>
                                                            <asp:Label ID="Label37" runat="server" Text='<%# Bind("EmpDepId") %>' Visible="false"></asp:Label>
