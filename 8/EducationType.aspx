<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="EducationType.aspx.cs"
    Inherits="EducationType" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtEducationType" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                        ...
                                        <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Education Type">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblEducationType" runat="server" Text='<%# Bind("EducationType") %>'></asp:Label>
                                                    </ItemTemplate>
                        ...
                        <div class="col-sm-12 ">
                            <table class="tab-popup">
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtEducationTypeUpdate" runat="server"  CssClass="form-control-blue"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
