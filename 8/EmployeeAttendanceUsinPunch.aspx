<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="EmployeeAttendanceUsinPunch.aspx.cs" Inherits="_8.EmployeeAttendanceUsinPunch" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtPunchInTime" runat="server" CssClass="form-control-blue"
                                                                         ...
                                                                         Text='<%# Eval("PunchInTime") %>' ReadOnly="True"></asp:TextBox></td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtPunchOutTime" runat="server" CssClass="form-control-blue"
                                                                                 AutoPostBack="True" OnTextChanged="txtPunchTime_OnTextChanged"
                                                                         Text='<%# Eval("PunchOutTime") %>' ReadOnly="True"></asp:TextBox></td>
                                                                <td>
