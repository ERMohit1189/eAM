<%@ Page Title="" Language="C#" MasterPageFile="~/master/admin_root-manager.master" AutoEventWireup="true" CodeFile="EmployeeAttendanceDayWiseUpdate.aspx.cs"
    Inherits="admin_EmployeeAttendanceDayWiseUpdate" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                        <ContentTemplate>
                                            <asp:Label ID="lbmrrr" runat="server" Style="text-align: center; color: #CC0000; font-weight: 700;"></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                        ...
                                        <ContentTemplate>
                                            <asp:Panel ID="Panel1" runat="server">
                                                <div class="col-sm-12 ">
                                                    <div class=" table-responsive  table-responsive2">
                                                        ...
                                                        <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="False" 
                                                            CssClass="table mp-table no-tb no-bm p-table-bordered table-bordered
                                                             vd_bg-green form-control-blue vd_white" OnSelectedIndexChanged="Grd_SelectedIndexChanged">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Attendance">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control-blue" AutoPostBack="true"
                                                                ...
                                                                <asp:TemplateField HeaderText="Delay" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtHours" runat="server" placeholder="HH" CssClass="form-control-blue left" Width="35" MaxLength="2" Enabled="false"></asp:TextBox>
                                                                        <%--<asp:TextBox ID="txtColon" runat="server" Text=":" CssClass="textbox" Width="6" Enabled="false"></asp:TextBox>--%>
                                                                        <span class="animated infinite pulse left">: </span>
                                                                        <asp:TextBox ID="txtMinutes" runat="server" placeholder="MM" CssClass="form-control-blue left" Width="35" MaxLength="2" Enabled="false"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="tab-in" Width="100px" />
                                                                </asp:TemplateField>
                                                            </Columns>
                                              ...
                                              <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Panel ID="Panel2" runat="server">
                                                            <div class="col-sm-12 text-center no-padding mgbt-xs-15 ">
                                                                <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" CssClass="button form-control-blue">Submit</asp:LinkButton>
                                                    ...
                                                    <tr>
                                                        <td class="valign-t">
                                                            <h5 class="text-left no-bm font-semibold">Total No. of Employee &nbsp; : &nbsp;
                                                                <span class="vd_red">
