<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="EmpAttendanceReportSendSMS.aspx.cs" Inherits="_8.AdminEmpAttendanceReportSendSMS" %>
        ...
        <ContentTemplate>
                    ...
                    <div class="col-sm-12 ">
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-4  half-width-50 mgbt-xs-15 hidden" style="display:none;" runat="server" Visible="false">
                                ...
                                <div class="col-sm-12  half-width-50  btn-a-devices-1-p4-p2 mgbt-xs-15">
                                    <asp:LinkButton ID="Link_Send" OnClick="Link_Send_Click" runat="server" CssClass="button form-control-blue"> <i class="fa fa-paper-plane"></i> Send SMS </asp:LinkButton>
           ...
           <%-- <script type = "text/javascript">
                $(document).ready(function () {
                    $("[id*=Link_Send]").click(function () {
                        $("#ContentPlaceHolder1_ContentPlaceHolderMainBox_Link_Send").attr('disabled', 'disabled');
                    });
                });
                </script>--%>
