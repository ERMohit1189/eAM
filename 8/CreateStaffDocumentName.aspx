<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="CreateStaffDocumentName.aspx.cs" Inherits="admin_frm_CreateDocumentName" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <asp:UpdatePanel ID="tyu" runat="server">
        <ContentTemplate>
                                ...
                                <div class="col-sm-12  no-padding" id="table1" runat="server">
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-2-p2 mgbt-xs-15">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <asp:LinkButton ID="btnSubmit" runat="server" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();" CssClass="button form-control-blue" OnClick="btnSubmit_Click">Submit</asp:LinkButton>
                                ...
                                <div class="col-sm-12  ">
                                    <div class=" table-responsive  table-responsive2">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center ">
                                                    <Columns>
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                                    <ContentTemplate>
                                                                        ...
                                                                        <asp:LinkButton ID="lnkEdit" runat="server" title="Edit "  OnClick="lnkEdit_Click" class="btn menu-icon vd_bd-yellow vd_yellow"><i class="fa fa-pencil"></i></asp:LinkButton>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtDocumentTypePanel" runat="server" CssClass="form-control-blue"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
            ...
            <div style="overflow: hidden; width: 1px; height: 1px">
                <asp:Panel runat="server" ID="Panel2" CssClass="popup animated2 fadeInDown">
