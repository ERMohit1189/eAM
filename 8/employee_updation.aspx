<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="employee_updation.aspx.cs"
    Inherits="_8.AdminEmployeeUpdation" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        <div class="col-sm-12 no-padding">
                            <div class="col-sm-4  select-list-hide hidden" runat="server" visible="False">
                            ...
                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                <asp:UpdatePanel ID="UpdatePanel21" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div id="msgbox" runat="server" style="left: 55px"></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12  ">
                                                                        <div class="col-sm-4   ">
                                                                            ...
                                                                            <div class="col-xs-12 no-padding">
                                                                                <asp:TextBox ID="txtFirstName" runat="server" onkeyup="CopyString('ContentPlaceHolder1_TabContainer1_TabPanel1_',this,'txtDisplay')"
                                                                                    CssClass="form-control-blue validatetext"></asp:TextBox>
                                                                                <div class="text-box-msg">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-4 mgbt-lg-15">
                                                                            ...
                                                                            <div class="">
                                                                                <asp:TextBox ID="txtlastName" runat="server" CssClass="form-control-blue validatetext"></asp:TextBox>
                                                                                <div class="text-box-msg">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-sm-4  ">
                                                                            ...
                                                                            <div class="">
                                                                                <asp:TextBox ID="txtDisplay" runat="server" CssClass="form-control-blue "></asp:TextBox>
                                                                                <div class="text-box-msg">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-sm-12  ">
                                                                        ...
                                                                        <div class="col-md-8" style="padding: 0; margin: 0;">
                                                                            <div class="col-sm-6" runat="server" visible="False" id="divhidemarr">
                                                                                ...
                                                                                <div class="">
                                                                                    <div class="vd_input-wrapper controls ">
                                                                                        <span class="menu-icon"><i class="fa  fa-calendar"></i></span>
                                                                                        <asp:TextBox ID="txtmarranniver" placeholder="yyyy MMM dd" 
                                                                                            runat="server" CssClass="form-control-blue datepicker-normal"></asp:TextBox>
                                                                                        <div class="text-box-msg">
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="col-sm-6 ">
                                                                                ...
                                                                                <div class="">
                                                                                    <asp:TextBox ID="txtmobileno" runat="server" CssClass="form-control-blue  validatetext" MaxLength="10" onBlur="ChecktenDigitMobileNumber(this);"></asp:TextBox>
                                                                                    <div class="text-box-msg">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="">
                                                                            ...
                                                                            <div class="col-sm-6 ">
                                                                                ...
                                                                                <div class="">
                                                                                    <asp:TextBox ID="txtemail" runat="server" CssClass="form-control-blue validatetext"></asp:TextBox>
                                                                                    <div class="text-box-msg">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="">
                                                                            ...
                                                                            <div class="col-sm-6 mgbt-lg-15" style="font-size: 12px;">
                                                                                <label class="control-label">Emergency Contact No.&nbsp;<span class="vd_red">*</span></label>
                                                                                <div class="">
                                                                                    <asp:TextBox ID="txtemergencycontactno" runat="server" CssClass="form-control-blue validatetext" MaxLength="10" onBlur="ChecktenDigitMobileNumber(this);"></asp:TextBox>
                                                                                    <div class="text-box-msg">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-sm-6 ">
                                                                                ...
                                                                                <div class="">
                                                                                    <asp:TextBox ID="txtAadhar" runat="server" placeholder="0000 0000 0000" CssClass="form-control-blue"></asp:TextBox>
                                                                                    <div class="text-box-msg">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-4" style="padding: 0; margin: 0;">
                                                                            <div class="col-sm-12 ">
                                                                                ...
                                                                                <div class="">
                                                                                    <asp:FileUpload ID="avatarUpload" runat="server" CssClass="form-control-blue" onchange="checksFileSizeandFileTypeinupdatePanel(this, 100000, 'jpg|png|jpeg|gif','Avatars',
                                                                                        'ContentPlaceHolder1_ContentPlaceHolderMainBox_hdEmpPhoto');"
                                                                                        type="file" />
                                                                                    <div class="text-box-msg">
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-sm-12 ">
                                                                                <div class="stu-pic-box">
                                                                                    <div class="stu-pic-box-main">
                                                                                        <asp:Image ID="Avatar" runat="server" ImageUrl="../img/user-pic/student-pic.png" Class="Avatars" />
                                                                                        <asp:HiddenField ID="hdEmpPhoto" runat="server" />
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                           ...
                           <br>
                                                                            ...
                                                                            <div class="">
                                                                                <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                                                                                    <ContentTemplate>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtPreseAdd" placeholder="Please don't write State and City name here" runat="server" TextMode="MultiLine" CssClass="form-control-blue validatetext" Rows="1"></asp:TextBox>
                                                                            ...
                                                                            <div class="col-sm-12  ">
                                                                                ...
                                                                                <div class="">
                                                                                    <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                                                                        <ContentTemplate>
                                                                                            <asp:TextBox ID="txtPermAdd" placeholder="Please don't write State and City name here" runat="server" TextMode="MultiLine" Rows="1" CssClass="form-control-blue  validatetext"></asp:TextBox>
                                                                                        </ContentTemplate>
                                                                                    </asp:UpdatePanel>
                                                                                    <div class="text-box-msg">
                                                            ...
                                                            <div class="panel-body form-main-box-border-g">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <div class="">
                                                                            <asp:TextBox ID="txtEmpId" runat="server" CssClass="form-control-blue  validatetext" Enabled="false"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4 mgbt-lg-15">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <div class="controls">
                                                                            <asp:DropDownList ID="drpdes" runat="server" CssClass="form-control-blue validatedrp">
                                                                            </asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4 mgbt-lg-15">
                                                                        ...
                                                                        <div class="controls">
                                                                            <asp:DropDownList ID="drpEmpdes" runat="server" CssClass="form-control-blue validatedrp">
                                                                            </asp:DropDownList>
                                                                        </div>
                                                                    </div>
                                                                     <div class="col-sm-4">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4 mgbt-lg-15" runat="server" id="div1">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="controls">
                                                                            <asp:TextBox ID="txtMachineid" runat="server" CssClass="form-control-blue validatetext"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4 ">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <div class="controls">
                                                                        <asp:UpdatePanel runat="server" ID="upShift">
                                                                            <ContentTemplate>
                                                                                <asp:DropDownList ID="ddlEmpShift" OnSelectedIndexChanged="ddlEmpShift_SelectedIndexChanged" runat="server" AutoPostBack="true" CssClass="form-control-blue ">
                                                                                </asp:DropDownList>
                                                                            </ContentTemplate>
                                                            ...
                                                            <div class="panel-body form-main-box-border-g">
                                                                <div class="row">
                                                                    <div class="col-sm-12 ">
                                                                        ...
                                                                        <asp:UpdatePanel runat="server" ID="dsf">
                                                                            <ContentTemplate>
                                                                                <div class="col-sm-4">
                                                                                    ...
                                                                                    <div class="">
                                                                                        <asp:DropDownList ID="ddlBank" runat="server" CssClass="form-control-blue" OnSelectedIndexChanged="ddlBankBranch_SelectedIndexChanged" AutoPostBack="true">
                                                                                        </asp:DropDownList>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-sm-4 mgbt-lg-15">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            ...
                                                                            <div class="">
                                                                                <asp:DropDownList ID="ddlAccType" runat="server" CssClass="form-control-blue">
                                                                                    <asp:ListItem title="Currant Account" Text="CA" Value="CA"></asp:ListItem>
                                                                        ...
                                                                        <div style="margin-bottom: 267px;">&nbsp;</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                    ...
                                                                                    <div class="controls img-input-ped">
                                                                                        <asp:FileUpload ID="FileUpload4"
                                                                                            ...
                                                                                            onChange="checksFileSizeandFileTypeinupdatePanel_witin_Repeater(this,'500000',
                                                                                                        ...
                                                                                                        GetChecked();" />
                                                                                        <asp:HyperLink runat="server" ID="doc_link" NavigateUrl='<%# Bind("DocPath") %>' Text='<%# Eval("DocPath")==string.Empty?"No-Document":"Download" %>' download="download"></asp:HyperLink>
                                                                                        <div class="text-box-msg">
                                                                                ...
                                                                                <div class="col-sm-4  half-width-50 btn-a-devices-1-p4-p2 ">
                                                                                    <div class="col-sm-4 col-xs-6 mgtp-6">
                                                                                        ...
                                                                                        <asp:CheckBox ID="Chksoft" runat="server" class="vd_checkbox checkbox-success"
                                                                                            TextAlign="Right" Text="Softcopy" Checked='<%# Eval("Softcopy").ToString()=="True" %>' />

                                                                                    </div>
                                                                                    <div class="col-sm-4 col-xs-6 mgtp-6">
                                                                                        <asp:CheckBox ID="Chkhard" runat="server" class="vd_checkbox checkbox-success"
                                                                                            TextAlign="Right" Text="Hardcopy" Checked='<%# Eval("Hardcopy").ToString()=="True" %>' />
                                                                                    </div>
                                                                                    <div class="col-sm-4 col-xs-6 mgtp-6">

                                                                                        <asp:CheckBox ID="chkVerified" runat="server" Text="Verified"
                                                                                            class="vd_checkbox checkbox-success" TextAlign="Right" Checked='<%# Eval("Verified").ToString()=="True" %>' />
                                                                                ...
                                                                                <div class="col-sm-4  half-width-50 mgbt-xs-9">
                                                                                    ...
                                                                                    <div class="vd_input-wrapper ">
                                                                                        ...
                                                                                        <asp:TextBox ID="txtRemark" placeholder="" runat="server" TextMode="MultiLine"
                                                                                            Rows="1" CssClass="form-control-blue" Text='<%# Eval("Remark") %>'></asp:TextBox>
                                                                ...
                                                                <div class="panel widget">
                                                                    ...
                                                                    <div class="panel-body padding-tlbr-15 form-main-box-border">
                                                                        <div id="rpt" class="row">
                                                                            <asp:Label ID="lblStEnRCodes" runat="server" CssClass="hide"></asp:Label>
                                                                            <asp:Label ID="lblstIDs" runat="server" CssClass="hide"></asp:Label>
                                                                            <div class="col-sm-4">
                                ...
                                <div class=" text-left">
                                    <asp:UpdatePanel ID="UpdatePanel88" runat="server">
                                        <ContentTemplate>
                                            <asp:LinkButton runat="server" ID="lnkSubmit" OnClientClick="ValidateDropdown('.validatedrp');ValidateTextBox('.validatetext');return validationReturn();" OnClick="lnkSubmit_Click" CssClass="button">Update</asp:LinkButton>
