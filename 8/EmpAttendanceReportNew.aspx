<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="EmpAttendanceReportNew.aspx.cs" Inherits="_8_EmpAttendanceReportNew" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12">
                                 ...
                                 <div class="col-sm-12  half-width-50  btn-a-devices-1-p4-p2 mgbt-xs-15">
                                    <asp:LinkButton ID="Link_Send" OnClick="Link_Send_Click" runat="server" Visible="false" CssClass="button form-control-blue"> <i class="fa fa-paper-plane"></i> Send SMS </asp:LinkButton>
