<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="HeadMaster.aspx.cs" Inherits="admin_HeadMaster" %>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="col-sm-12  no-padding">
                                                ...
                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                    ...
                                                    <div class="">
                                                        <asp:TextBox ID="txtHeadName" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                                        <div class="text-box-msg">
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" id="divHeadCat" visible="false">
                                                    <label class="control-label">Head Category</label>
                                                    <div class="mgtp-6">
                                                        <asp:RadioButtonList ID="rbHeadCategory" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="radio-success vd_radio">
                                                        </asp:RadioButtonList>
                                                        <div class="text-box-msg">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-2  half-width-50 mgbt-xs-15" runat="server" visible="false">
                                                    ...
                                                    <div class=" table-responsive  table-responsive2">
                                                        <asp:GridView ID="gvHeadMaster" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Head Category" Visible="false">
                                                                    <ItemTemplate>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlHeadType0" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlHeadType0_SelectedIndexChanged" CssClass="form-control-blue">
                                    <asp:ListItem Value="Income">Income</asp:ListItem>
                                    <asp:ListItem Value="Expense">Expense</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblHeadName0" runat="server" CssClass="txt-middle-l txt-bold" Text="Head Name"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtHeadName0" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="hide">
                            <td>
                                <asp:Label ID="HeadCategory0" runat="server" CssClass="txt-middle-l txt-bold" Text="Head Category"></asp:Label>
                            </td>
                            <td>
                                <asp:RadioButtonList ID="rbHeadCategory0" runat="server" RepeatDirection="Vertical" RepeatLayout="Flow" CssClass="vd_radio radio-success">
                                </asp:RadioButtonList>
                            </td>
                        </tr>
                        <tr class="hide">
                            <td>
                                <asp:Label ID="lblRemark0" runat="server" CssClass="txt-middle-l txt-bold" Text="Remark"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr class="hide">
                            ...
                            <td>
                                <asp:RadioButtonList ID="rblIsActive0" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="vd_radio radio-success">
