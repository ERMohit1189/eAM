<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="VendorType.aspx.cs" Inherits="admin_VendorType" %>
                                    ...
                                    <asp:UpdatePanel ID="upMain" runat="server">
                                        <ContentTemplate>
                                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                ...
                                                <div class="">
                                                    <asp:TextBox ID="txtVendorType" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                            ...
                                            <div class="col-sm-4  half-width-50 mgbt-xs-9">
                                                ...
                                                <div class="">
                                                    <asp:TextBox ID="txtRemark" runat="server" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();" TextMode="MultiLine" Rows="1" CssClass="form-control-blue"></asp:TextBox>
                                                    <div class="text-box-msg">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4  half-width-50  btn-a-devices-2-p2 mgbt-xs-15">
                                                <asp:LinkButton ID="btnInsert" runat="server" CssClass="button form-control-blue" OnClick="btnInsert_Click">Submit</asp:LinkButton>
                                            ...
                                            <div class="col-sm-12 ">
                                                <div class=" table-responsive  table-responsive2">
                                                    <asp:GridView ID="gvVendorTypeList" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center ">
                                                       <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Vendor Type">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="VendorType" runat="server" Text='<%# Bind("VendorType") %>'></asp:Label>
                                                                </ItemTemplate>
                ...
                <div style="overflow: auto; width: 1px; height: 1px">
                    <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                        <table class="tab-popup">
                            <tr>
                                <td>
                                    <asp:Label ID="lblVendorType0" runat="server" Text="Vendor Type"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtVendorType0" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td style="display: none;">Is Active<span class="vd_red">*</span> </td>
                                <td style="display: none;">
                                    <asp:RadioButtonList ID="rblIsActive0" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="radio-success vd_radio">
                            ...
                            <tr>
                                <td></td>
                                <td>
                                    <asp:Button ID="Button3" runat="server" CausesValidation="False" OnClientClick="ValidateTextBox('.validatetxt1');return validationReturn();" CssClass="button-y" OnClick="Button3_Click" Text="Update" />
                                    &nbsp;
