<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="InvoiceList.aspx.cs" EnableEventValidation="false" Inherits="admin_InvoiceList" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding" id="tblInsert" runat="server">
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Vendor Name/Vendor Code</label>
                                        <div class="">
                                                                            ...
                                                                            <div class=" table-responsive  table-responsive2">
                                                                                <asp:GridView ID="gvInvoice" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center ">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="InvoiceNo" HeaderText="Subject" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" />
                                                                                        <asp:BoundField DataField="Vendor" HeaderText="Vendor" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" />
                                                                                        ...
                                                                                        <asp:BoundField DataField="discount" HeaderText="Discount" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" ItemStyle-CssClass="text-right" />
                                                                                        <asp:BoundField DataField="GrandTotal" HeaderText="Grand Total" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" ItemStyle-CssClass="text-right" />
                                                                                        <asp:BoundField DataField="Paid" HeaderText="Paid" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" ItemStyle-CssClass="text-right" />
                                                                                        <asp:BoundField DataField="Balance" HeaderText="Balance" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" ItemStyle-CssClass="text-right" />
                                                                                        <asp:BoundField DataField="Status" HeaderText="Payment Status" HeaderStyle-CssClass="vd_bg-blue vd_white text-center" />
