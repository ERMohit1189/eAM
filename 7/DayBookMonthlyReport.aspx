<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="DayBookMonthlyReport.aspx.cs" Inherits="DayBookMonthlyReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMainhead" runat="Server">
    <title>Day Book Monthly Report
    </title>
</asp:Content>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div id="gdv" runat="server" class="text-center" style="width: 100%;">
                                                                                ...
                                                                                <asp:GridView ID="gvDayBook" runat="server" AutoGenerateColumns="false"
                                                                                    CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center"
                                                                                    ShowFooter="true" Width="100%" OnRowDataBound="gvDayBook_RowDataBound">
