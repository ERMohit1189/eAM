<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="OrganizationType.aspx.cs" Inherits="admin_OrganizationType" %>
                                    ...
                                    <asp:UpdatePanel ID="upMain" runat="server">
                                        <ContentTemplate>
                                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                ...
                                                <div class="">
                                                    <asp:TextBox ID="txtOrganizationType" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                            ...
                                            <div class="col-sm-4  half-width-50 mgbt-xs-15" runat="server" visible="false">
                                                ...
                                                <div class="mgtp-6">
                                                    <asp:RadioButtonList ID="rblIsActive" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="vd_radio radio-success">
                                            ...
                                            <div class="col-sm-4  half-width-50  btn-a-devices-2-p2 mgbt-xs-15">
                                                <asp:Button ID="btnInsert" runat="server" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();" CssClass="button form-control-blue" OnClick="btnInsert_Click" Text="Submit" />
                                                <asp:Button ID="btnReset" runat="server" CssClass="button form-control-blue" OnClick="btnReset_Click" Text="Reset" />
                                            ...
                                            <div class="col-sm-12 ">
                                                <div class=" table-responsive  table-responsive2">
                                                    <asp:GridView ID="gvOrganizationTypeList" runat="server" AutoGenerateColumns="false" class="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Organization Type">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="OrganizationType" runat="server" Text='<%# Bind("OrganizationType") %>'></asp:Label>
                                                                </ItemTemplate>
            ...
            <div style="overflow: auto; width: 1px; height: 1px">
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        <tr>
                            <td>
                                <asp:Label ID="lblOrganizationType0" runat="server" Text="Vendor Type"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtOrganizationType0" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
