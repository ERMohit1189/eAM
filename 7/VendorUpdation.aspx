<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="VendorUpdation.aspx.cs" Inherits="VendorUpdation" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        ...
                        <div class="col-sm-12  no-padding">
                            <div class="col-sm-12 " id="pnlSearch" runat="server">
                                <fieldset>
                                    <legend><span class="fieldset-icon"><i class="fa fa-search"></i></span>Search By Vendor ID</legend>
                           ...
                           <div class="col-sm-12  ">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="mgtp-6">
                                            <asp:RadioButtonList ID="rblAccountType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="radio-success vd_radio">
                                                <asp:ListItem title="Current Account" Text="CA" Value="CA" Selected="True"></asp:ListItem>
                                                ...
                                                <asp:ListItem title="Other" Text="Other" Value="Other"></asp:ListItem>
                                            </asp:RadioButtonList>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                            ...
                            <div class="col-sm-12 text-center">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                    <ContentTemplate>
                                        <asp:LinkButton ID="lbtnUpdate" OnClick="lbtnUpdate_Click" OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn();" CssClass="button form-control-blue" runat="server">Update </asp:LinkButton>
