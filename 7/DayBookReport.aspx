<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="DayBookReport.aspx.cs" Inherits="DayBookReport" %>
                                    ...
                                    <ContentTemplate>
                                        <div class="col-lg-12 no-padding" id="tblInsert" runat="server">
                                            <div class="col-lg-12 no-padding">
                                                ...
                                                <div class="col-sm-4 half-width-50 " id="disheadpaymentmode" runat="server">
