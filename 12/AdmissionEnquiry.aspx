<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="AdmissionEnquiry.aspx.cs" Inherits="website_AdmissionEnquiry" %>
                    ...
                    <div class="col-sm-12 mgbt-xs-20">
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                <div class="col-sm-4">
                                       <h3 ><strong>Admission</strong> Enquiry List</h3>
                                </div>
                                 <div class="col-sm-8">
                                        ...
                                        <table class="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="vd_bg-blue-np vd_white-np">E-mail ID</th>
                                                    <th class="vd_bg-blue-np vd_white-np">Contact No.</th>
                                                    <th class="vd_bg-blue-np vd_white-np">Admission</th>
                                                    <th class="vd_bg-blue-np vd_white-np">Message</th>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("Email") %>'></asp:Label></div>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("Phoneno") %>'></asp:Label></div>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("Admissionfor") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("Message") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label7" runat="server" Text='<%# Bind("RecordDate") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:LinkButton ID="lnkDelete" runat="server" CausesValidation="False" title="Delete"  class="btn menu-icon vd_bd-red vd_red" OnClick="LinkButton1_Click"><i class="glyphicon glyphicon-trash"></i>
                                                                    <asp:Label ID="lblid" runat="server" Visible="false" Text='<%# Bind("Id") %>'></asp:Label></asp:LinkButton>
