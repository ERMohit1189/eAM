...
public partial class News : System.Web.UI.Page
{
    ...
    string sql = string.Empty; string stu , gur, staf , Adm, SupAdm = string.Empty;
...
#pragma warning restore 219
    ...
    {
        sql = "Delete from NewsDescription where NewsId='" + lblvalue.Text+"' and SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
