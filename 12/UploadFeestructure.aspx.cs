...
using System.Data;
using System.IO;
public partial class website_UploadFeestructure : System.Web.UI.Page
{
    ...
    protected void bindData()
    {
        ...
        Repeater1.DataBind();
        sql = "Select ROW_NUMBER() OVER (ORDER BY Id ASC) AS SrNo , Id,title,ISNULL(DocNamePath,DocNamePath) as DocName from w_FeeStructure order by Id desc ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.CommandText = "w_spFeeStructure";
