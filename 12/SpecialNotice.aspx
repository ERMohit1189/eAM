<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="SpecialNotice.aspx.cs" Inherits="website_SpecialNotice" %>
                            ...
                            <div class="panel-body">
                                <div class=" no-padding form-group form-group-sm">
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Notice Title&nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                            <asp:TextBox ID="txtHeading1" runat="server" class="form-control validatetxt" TabIndex="1"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Notice Text&nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                            <asp:TextBox ID="txtDescription" TextMode="MultiLine" class="form-control validatetxt" runat="server" TabIndex="2"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15 btn-a-devices-2-p2">
                                        <asp:LinkButton ID="Button1" runat="server" class="button form-control-blue" ValidationGroup="a" OnClick="Button1_Click" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();" TabIndex="3"> <i class="fa fa-paper-plane"></i> &nbsp;Submit</asp:LinkButton>
                                        ...
                                        <table class="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="vd_bg-blue-np vd_white-np">Description</th>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label13" runat="server" Text='<%# Bind("NoticeHeading") %>'></asp:Label></td>
                                ...
                                <div class="col-sm-12 ">
                                    <table class="tab-popup">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group input-group-margin">
                                                    ...
                                                    <asp:TextBox ID="txtHeadingUpdate1" runat="server" class="form-control" TabIndex="1"></asp:TextBox>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>Notice Text</td>
                                            <td>
                                                <asp:TextBox ID="txtDescriptionUPdate" TextMode="MultiLine" Rows="5" TabIndex="2" class="form-control" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
