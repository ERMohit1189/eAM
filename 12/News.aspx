<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="News.aspx.cs"
    Inherits="News" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="txtttle" runat="server" CssClass="form-control-blue"></asp:TextBox>
                                            <div class="text-box-msg">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-9">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="txtdes" runat="server" TextMode="MultiLine" CssClass="form-control-blue" Rows="1"></asp:TextBox>
                                            <div class="text-box-msg">
                                ...
                                <div class="col-sm-12  ">
                                    <div class="table-responsive2 table-responsive">
                                        <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="False" CssClass="table table-striped no-bm table-hover no-head-border table-bordered">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label36" runat="server" Text='<%# Bind("NewsId") %>' Visible="false"></asp:Label>
                                                        <asp:LinkButton ID="LinkButton2" runat="server" title="Edit News" 
                                                ...
                                                <asp:TemplateField HeaderText="Delete">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label37" runat="server" Text='<%# Bind("NewsId") %>' Visible="false"></asp:Label>
                    ...
                    <table class="tab-popup">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtTitlePanel" runat="server" CssClass="form-control-blue"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDescriptionPanel" runat="server" TextMode="MultiLine" CssClass="form-control-blue" Rows="2"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>For <span class="imp">*</span>
                            </td>
                            <td>
                                <asp:CheckBoxList ID="CheckBoxList2" runat="server" OnSelectedIndexChanged="CheckBoxList2_SelectedIndexChanged" RepeatDirection="Horizontal">
