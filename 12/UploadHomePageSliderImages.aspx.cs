...
public partial class website_UploadHomePageSliderImages : System.Web.UI.Page
{
    ...
    protected void bindData()
    {
        ...
        cmd.CommandText = "w_spHomeSlider";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            sql = "select id from HomeSlider where Title='" + txtTitle.Text + "'";
            if (oo.Duplicate(sql))
            {
                // oo.MessageBox("This TitelName alredy in used,choose other...", this.Page);
                Campus camp = new Campus(); camp.msgbox(this.Page, msgbox, "This Slider Title alredy in used,choose other...", "W");
            ...
            else if (txtTitle.Text == "")
            {
                ...
                Campus camp = new Campus(); camp.msgbox(this.Page, msgbox, "Please Enter Slider Title.", "W");
                oo.ClearControls(this.Page);
                oo.MessageBox("", this.Page);
            }
            else if (hfFile.Value=="" || hdfilefileExtention.Value=="")
            {
                Campus camp = new Campus(); camp.msgbox(this.Page, msgbox, "Please Select Slider Photo.", "W");
                oo.ClearControls(this.Page);
                oo.MessageBox("", this.Page);
            }
            else
            {
                ...
                {
                    filePath = @"../Uploads/pics/carousel/";

                    fileName = "Slider-" + DateTime.Today.ToShortDateString().Replace("/", "-").ToString() + fileExtention;
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        lblID.Text = ss;
        //sql = "Select SliderTitle,SliderPath from HomeSlider where SliderId='" + lblId.Text + "'";
        SqlCommand cmd = new SqlCommand();
        cmd.CommandText = "w_spHomeSlider";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Connection = con;
        ...
        if (dt.Rows.Count > 0)
        {
            txtTitlep.Text = dt.Rows[0]["Title"].ToString();
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        try
        {
            sql = "select id from HomeSlider where Title='" + txtTitlep.Text + "'";
            if (oo.Duplicate(sql))
            {
                // oo.MessageBox("This TitelName alredy in used,choose other...", this.Page);
                Campus camp = new Campus(); camp.msgbox(this.Page, msgbox, "This Slider Title alredy in used,choose other...", "W");
            ...
            else
            {
                ...
                cmd.Parameters.AddWithValue("@Title", txtTitlep.Text.Trim().Replace("'", ""));
