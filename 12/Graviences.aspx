<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Graviences.aspx.cs" Inherits="website_GenralEnquiry" %>
                    ...
                    <div class="col-sm-12 mgbt-xs-20">
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                <div class="col-sm-4">
                                       <h3 ><strong>Graviences</strong> List</h3>
                                </div>
                                 <div class="col-sm-8">
                                        ...
                                        <table class="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="vd_bg-blue-np vd_white-np">Graviences</th>
