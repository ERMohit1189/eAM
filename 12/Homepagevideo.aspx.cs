...
public partial class website_HomePageVideo : Page
{
    ...
    protected void bindData()
    {
        try
        {
            ...
            cmd.CommandText = "w_spHomePageVideos";
    ...
    {
        sql = "select Id,YouTubeFrame,Title,CurDate  from w_HomePageVideos  ";
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        lblID.Text = ss;
       // sql = "Select VideoId ,YouTubeFrame,Title, FromDate  from HomePageVideo where VideoId='" + lblId.Text + "'";
        SqlCommand cmd = new SqlCommand();
        cmd.CommandText = "w_spHomePageVideos";
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Connection = con;
