<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="UploadTOPPERS.aspx.cs" Inherits="website_UploadTOPPERS" %>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="gallery-list">
                                                                    <asp:HyperLink runat="server" ID="dd" NavigateUrl='<%# Bind("Path") %>' Target="_blank">Download</asp:HyperLink>
                                                                </div>
                                                            </td>
