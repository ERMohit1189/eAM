<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Founders_Details.aspx.cs" Inherits="_12_Founders_Details" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class=" no-padding form-group form-group-sm">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class=" control-label">Founder Name&nbsp;<span class="vd_red">*</span></label>
                                        <asp:TextBox ID="txtImageName" runat="server" TabIndex="1" class="form-control-blue form-control validatetxt"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Select Image&nbsp;<span class="vd_red">*</span></label>

                                        <asp:FileUpload runat="server" ID="fu1" CssClass="form-control form-control-blue validatetxt" TabIndex="2"
                                    ...
                                    <div class="col-sm-4  btn-a-devices-2-p2 mgbt-xs-15">
                                        <asp:LinkButton ID="Button1" runat="server" class="button form-control-blue" ValidationGroup="a"
                                            ...
                                            TabIndex="3"> <i class="fa fa-paper-plane"></i> &nbsp;Submit</asp:LinkButton>
                                            ...
                                            <table class="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group text-center">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="vd_bg-blue-np vd_white-np">ALBUM TITLE</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="gallery-list">
                                                                        <asp:Image ID="Image1" runat="server" class=" gallery-item" Width="200" Height="120" ImageUrl='<%# Bind("ImagePath") %>' />
                                                                    </div>
                                                                </td>

                                                                <td class="menu-action" style="width: 40px;">
                                                                    <asp:Label ID="lblid" runat="server" Text='<%# Bind("AlbumId")%>' Visible="false"></asp:Label>
                                ...
                                <div class="col-sm-12 ">
                                    <table class="tab-popup">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group input-group-margin ">
                                                    ...
                                                    <asp:TextBox ID="txtEditAlbumName" runat="server" class="form-control"></asp:TextBox>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <center>
                                               <asp:Button ID="btnupdate" CssClass="button-y" runat="server" Text="Update" TabIndex="3" />
                            ...
                            <table class="tab-popup text-center">
                                ...
                                <tr>
                                    <td style="text-align: center">
                                        ...
                                        &nbsp;&nbsp;
                                <asp:Button ID="btnDelete" runat="server" CausesValidation="False" CssClass="button-y" Text="Yes" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
