...
using System.Data;
using System.IO;
public partial class web2_Circular : System.Web.UI.Page
{
    ...
    protected void bindData()
    {
        ...
        Repeater1.DataBind();
        sql = "Select ROW_NUMBER() OVER (ORDER BY Id ASC) AS SrNo , Id,title,ISNULL(DocNamePath,DocNamePath) as DocName from w_Circular order by Id desc ";
