<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Downloads.aspx.cs" Inherits="web2_Downloads" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class=" no-padding form-group form-group-sm">
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Document&nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                           <asp:FileUpload runat="server" ID="fu1" CssClass="form-control validatetxt" TabIndex="2"
                                    ...
                                    <div class="col-sm-6">
                                        <label class=" control-label">Documents Title</label>
                                        <div class="col-md-12">
                                      ...
                                      <div class="col-sm-2 half-width-50 mgbt-xs-15 btn-a-devices-2-p2">
                                ...
                                <div class="col-sm-12" runat="server" id="divList"><br />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="gallery-list">
                                                                    <asp:HyperLink runat="server" ID="dd" NavigateUrl='<%# Bind("DocName") %>' Target="_blank">Download</asp:HyperLink>
                                                                </div>
                                                            </td>
