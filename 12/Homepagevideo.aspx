<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="HomePageVideo.aspx.cs" Inherits="website_HomePageVideo" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class=" no-padding form-group form-group-sm">
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control-blue  datepicker-normal validatetxt"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="txtImageTitle"  runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        ...
                                        <div class=" ">
                                            <asp:TextBox ID="txtYouTubeIFrame" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15 btn-a-devices-3-p6">
                                        <asp:LinkButton ID="Button1" runat="server" CssClass="button form-control-blue" OnClientClick="ValidateTextBox('.validatetxt');return validationReturn();"
                                            TabIndex="4" OnClick="Button1_Click">Submit</asp:LinkButton>
                                ...
                                <div class="col-sm-12 ">
                                    <table class="tab-popup">
                                        ...
                                        <tr>
                                            <td>Video Link</td>
                                            <td>
                                                <asp:TextBox runat="server" ID="videolink" class="form-control" TextMode="MultiLine"></asp:TextBox>
