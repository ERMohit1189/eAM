<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="UploadTC.aspx.cs" Inherits="website_UploadEXAMSCHEDULE" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class=" no-padding form-group form-group-sm">
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Sr.No.&nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                            <asp:TextBox ID="txtImageName" runat="server" TabIndex="1" class="form-control validatetxt"></asp:TextBox>
                                      ...
                                      <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Select Pdf&nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                             <asp:FileUpload runat="server" ID="fu1" CssClass="form-control" TabIndex="2"
                                                    onchange="checksFileSizeandFileTypeinupdatePanel_fordoc(this, 'pdf|PDF',
                                        ...
                                        <table class="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="vd_bg-blue-np vd_white-np">PDF FILE</th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="Repeater1" runat="server">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label12" runat="server" Text='<%# Bind("SRNoo") %>'></asp:Label></td>
                                                            <td>
                                                                <asp:Label ID="Label13" runat="server" Text='<%# Bind("SrNo") %>'></asp:Label></td>

                                                            <td>
                                                                <div class="gallery-list">
                                                                    <asp:Label ID="Image1" runat="server" class=" gallery-item" Text='<%# Bind("RecordDate") %>' />
                                                                </div>
                                                            </td>

                                                              <td>
                                                                <div class="gallery-list">
                                                                    <asp:Label ID="Label1" runat="server" class=" gallery-item" Text='<%# Bind("PdfName") %>' />
                                                                </div>
                                                            </td>
