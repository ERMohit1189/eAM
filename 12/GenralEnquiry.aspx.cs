...
public partial class website_GenralEnquiry : System.Web.UI.Page
{
    ...
    {
      //  sql = "Select Id,Name,PhoneNo,Email,Subject,Message,Convert(nvarchar(20),RecordDate,100) as RecordDate from GenralEnquiry order by id Desc";
        SqlCommand cmd = new SqlCommand();
        cmd.CommandText = "USP_GenralEnquiry";
