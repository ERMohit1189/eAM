<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="UploadDocs.aspx.cs" Inherits="website_AddAlbum" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class=" no-padding form-group form-group-sm">
                                    ...
                                    <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Documents Title&nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                      ...
                                      <div class="col-sm-4 half-width-50 mgbt-xs-15">
                                        <label class="control-label">Upload Document&nbsp;<span class="vd_red">*</span></label>
                                        <div class=" ">
                                             <asp:FileUpload runat="server" ID="fu1" CssClass="form-control" TabIndex="2"
                                                    onchange="checksFileSizeandFileTypeinupdatePanel_fordoc(this, 'jpg|png|jpeg|gif|JPG|PNG|JPEG|GIF|pdf|PDF',
                                        ...
                                        <table class="table table-striped table-hover no-bm no-head-border table-bordered pro-table table-header-group text-center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="vd_bg-blue-np vd_white-np">DOCUMENT</th>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label13" runat="server" Text='<%# Bind("Titel") %>'></asp:Label></td>

                                                            <td>
                                                                <div class="gallery-list">
                                                                    <asp:Label ID="Image1" runat="server" class=" gallery-item" Text='<%# Bind("DocName") %>' />
                                                                </div>
                                                            </td>
