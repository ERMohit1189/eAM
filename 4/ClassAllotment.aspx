<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ClassAllotment.aspx.cs" Inherits="admin_ClassTeacherMaster" %>
                                            ...
                                            <div class="col-sm-12   no-padding" runat="server" id="div1">
                                                ...
                                                <div class="col-sm-12   no-padding ">
                                                    ...
                                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                        ...
                                                        <div class="">
                                                            <asp:DropDownList ID="drpSubjectGroup" runat="server" CssClass="form-control-blue validatedrp">
                                                            </asp:DropDownList>
                                                            <div class="text-box-msg">
                                                            </div>
                                                        </div>
