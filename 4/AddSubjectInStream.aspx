<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="AddSubjectInStream.aspx.cs" Inherits="admin_AddSubjectInStream" %>
        ...
        <ContentTemplate>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12 no-padding ">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpBranch" runat="server" CssClass="form-control-blue validatedrp" AutoPostBack="true" OnSelectedIndexChanged="drpBranch_SelectedIndexChanged">
                                            </asp:DropDownList>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpStream" runat="server" CssClass="form-control-blue" AutoPostBack="True" OnSelectedIndexChanged="drpStream_SelectedIndexChanged">
                                            </asp:DropDownList>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpSubjectGroup" runat="server" CssClass="form-control-blue">
                                            </asp:DropDownList>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" class="table table-striped table-hover no-bm no-head-border table-bordered">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Subject">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSubjectGroup" runat="server" Text='<%# Eval("SubjectGroup") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="lnkEdit" runat="server" OnClick="lnkEdit_Click"
                                                            ...
                                                            OnClientClick="return ValidateDropdown('.validatedrp');"> <i class="fa fa-pencil"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" CssClass="vd_bg-blue vd_white" VerticalAlign="Middle" />
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                </asp:TemplateField>
            ...
            <div style="overflow: auto; width: 1px; height: 1px">
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <div class="tab-popup"></div>
                    <div class="col-sm-12 no-padding mgbt-xs-20">
                        <div class="panel-body-list  table-responsive">
                            <div class="col-sm-6 no-padding">
                                <div class="form-group">
                                    <asp:Label ID="Label5" runat="server" class="col-sm-4 txt-bold" Text="Class *"></asp:Label>
                                    <div class="col-sm-8 mgbt-xs-20 controls">
                            ...
                            <div class="col-sm-6 no-padding">
                                <div class="form-group">
                                    <asp:Label ID="Label6" runat="server" class="col-sm-4 txt-bold" Text="Stream *"></asp:Label>
                                    <div class="col-sm-8 mgbt-xs-20 controls">
                                        <asp:DropDownList ID="drpBranchPanel" runat="server" CssClass="form-control-blue">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 no-padding">
                                <div class="form-group">
                                    <asp:Label ID="Label7" runat="server" class="col-sm-4 txt-bold" Text="Section *"></asp:Label>
                                    <div class="col-sm-8 mgbt-xs-20 controls">
                                        <asp:DropDownList ID="drpSectionPanel" runat="server" CssClass="form-control-blue">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 no-padding">
                                <div class="form-group">
                                    <asp:Label ID="Label8" runat="server" class="col-sm-4 txt-bold" Text="Group *"></asp:Label>
                                    <div class="col-sm-8 mgbt-xs-20 controls">
                                        <asp:DropDownList ID="drpStreamPanel" runat="server" CssClass="form-control-blue">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 no-padding">
                                <div class="form-group">
                                    <asp:Label ID="Label9" runat="server" class="col-sm-4 txt-bold" Text="Subject *"></asp:Label>
                                    <div class="col-sm-8 mgbt-xs-20 controls">
                                        <asp:DropDownList ID="drpSubjectGroupPanel" runat="server" CssClass="form-control-blue">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 no-padding">
                                <div class="form-group">
                                    <asp:Label ID="Label10" runat="server" class="col-sm-4 txt-bold" Text="Remark"></asp:Label>
                                    <div class="col-sm-8 mgbt-xs-20 controls">
                                        <asp:TextBox ID="txtRemarkPanel" CssClass="form-control-blue" Rows="1" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 no-padding text-center">
                            ...
                            <asp:LinkButton ID="lnkUpdate" runat="server" OnClick="lnkUpdate_Click" CssClass="form-control-blue button">Update</asp:LinkButton>
                            &nbsp;
                                                <asp:LinkButton ID="lnkCancel" runat="server" CssClass="form-control-blue button">Cancel</asp:LinkButton>
                    ...
                    <table class="tab-popup text-center">
                        ...
                        <tr>
                            <td style="text-align:center;">
                                ...
                                &nbsp; &nbsp; 
                                <asp:Button ID="btnDelete" CssClass="button-y" runat="server" CausesValidation="False" OnClick="btnDelete_Click" Text="Yes" />
