<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="InternalGrades.aspx.cs" Inherits="Comman_G6_InternalGrades" %>
    ...
    <asp:UpdatePanel ID="tyu" runat="server">
        <ContentTemplate>
                    ...
                    <div class="col-sm-12 mgbt-xs-20">
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                <div id="divinsert" runat="server" class="col-lg-12 no-padding">

                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Entry For</label>
                                        <div class="">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:TextBox ID="txtCaption" runat="server" CssClass="form-control-blue validatetxt"></asp:TextBox>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-3-p6 mgbt-xs-9">
                                ...
                                <div class="col-lg-12 ">
                                    <asp:GridView ID="grd1" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Entry For">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDC" runat="server" Text='<%# Bind("txtfor") %>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Caption">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDA" runat="server" Text='<%# Bind("txt") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkDelete" title="Delete" runat="server" class="btn menu-icon vd_bd-red vd_red" OnClick="lnkDelete_Click"><i class="glyphicon glyphicon-trash"></i></asp:LinkButton>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="vd_bg-blue text-center vd_white" Width="50px" />
                                                <ItemStyle CssClass="text-center menu-action" />
                                            </asp:TemplateField>
            ...
            <div style="overflow: auto; width: 1px; height: 1px">
                                    <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                                        <table class="tab-popup">
                                            <tr>
                                                <td>Entry For</td>
                                                <td>
                                                    <asp:DropDownList ID="drpGradeForPanel" runat="server" CssClass="form-control-blue">
                                                        <asp:ListItem>Internal Grades</asp:ListItem>
                                                        <asp:ListItem>Personality Character Chart</asp:ListItem>
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td>Caption *</td>
                                                <td>
                                                    <asp:TextBox ID="txtCaptionPanel" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td>Remark</td>
                                                <td>
                                                    <asp:TextBox ID="txtRemarkPanel" runat="server" TextMode="MultiLine" Rows="1" CssClass="form-control-blue"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>
                                                    <asp:LinkButton ID="lnkUpdate" runat="server" OnClick="lnkUpdate_Click" OnClientClick="return ValidateTextBox('.validatetxt1');" CssClass="button-y">Update</asp:LinkButton>
                                                    &nbsp; &nbsp;
                                    ...
                                    <ajaxToolkit:ModalPopupExtender ID="Panel1_ModalPopupExtender" runat="server" TargetControlID="LinkButton2" PopupControlID="Panel1"
                                ...
                                <div style="overflow: auto; width: 1px; height: 1px">
                                    ...
                                    <ajaxToolkit:ModalPopupExtender ID="Panel2_ModalPopupExtender" runat="server" Enabled="True" TargetControlID="LinkButton3"
