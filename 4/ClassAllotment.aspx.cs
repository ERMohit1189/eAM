...
#pragma warning restore 169
    ...
    public void loadGroup()
    {
        ...
        sql = sql + " and Medium='" + drpmedium.SelectedItem.ToString() + "' and (BranchId='" + drpBranch.SelectedValue.ToString() + "' or BranchId is null)  and BranchCode=" + Session["BranchCode"].ToString() + " and ClassID='" + drpclass.SelectedValue.ToString() + "'";
        oo.FillDropDown_withValue(sql, drpSubjectGroup , "SubjectName", "Id");
        oo.fillSelectvalue(drpSubjectGroup, "<--Select-->");
    }

    public void loadGroup1()
    {
        sql = "select SubjectName,Id from SubjectGroupMaster where SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
        sql = sql + " and Medium='" + drpmedium1.SelectedItem.ToString() + "' and (BranchId='" + drpBranch1.SelectedValue.ToString() + "' or BranchId is null)  and BranchCode=" + Session["BranchCode"].ToString() + " and ClassID='" + drpclass1.SelectedValue.ToString() + "'";
        oo.FillDropDown_withValue(sql, drpSubjectGroup1, "SubjectName", "Id");
        oo.fillSelectvalue(drpSubjectGroup1, "<--Select-->");
    }
    ...
    public void loadclass1()
    {
        ...
        drpclass1.Items.Insert(0, "<--Select-->");
    }
    ...
    private void loadBranch1()
    {
        ...
        drpBranch1.Items.Insert(0, "<--Select-->");
    }
    ...
    public void loadmedium1()
    {
        ...
        drpmedium1.Items.Insert(0, "<--Select-->");
    }
    
    public void loadsubject1(string groupid, string paperid)
    {
        sql = "Select Id,SubjectName from SubjectMaster Where SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
        sql = sql + " and ClassId='" + drpclass1.SelectedValue.ToString() + "'  and (BranchId='" + drpBranch1.SelectedValue.ToString() + "' or BranchId is null)  and Medium='" + drpmedium1.SelectedItem.ToString() + "'";
        sql = sql + " and GroupId='" + groupid + "' and (PaperId='" + paperid + "' or PaperId is NULL)";
        oo.FillDropDown_withValue(sql, drpSubjectGroup1, "SubjectName", "Id");
    }
    ...
    public void Save()
    {
        ...
        sql = sql + " and Classid='" + drpclass.SelectedValue.ToString() + "' and BranchId='" + drpBranch.SelectedValue.ToString() + "' and SubjectId='" + drpSubjectGroup.SelectedValue.ToString() + "' ";
        ...
        else
        {
            ...
            cmd.Parameters.AddWithValue("@SubjectId", drpSubjectGroup.SelectedValue.ToString());
    ...
    public void DisplayRecord()
    {
        ...
        sql = sql + " inner join ClassMaster cm on cm.Id=sctm.ClassId Left join BranchMaster bm on bm.Classid=cm.id and sctm.Branchid=bm.id and bm.sessionName=cm.sessionNAme inner join TTSubjectMaster sm on sm.Id=sctm.Subjectid";
        ...
        sql = sql + " and sm.SessionName='" + Session["SessionName"].ToString() + "' and eod.BranchCode=" + Session["BranchCode"].ToString() + " and cm.BranchCode=" + Session["BranchCode"].ToString() + " and sctm.BranchCode=" + Session["BranchCode"].ToString() + " ";
    ...
    {
        sql = "Select SectionName from SectionMaster";
        sql = sql + " where ClassNameId='" + drpclass1.SelectedValue.ToString() + "' and SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
    ...
    protected void linkEdit_Click(object sender, EventArgs e)
    {
        ...
        loadGroup1();
        loadsubject1(sgmid, spmid);

        drpSubjectGroup1.SelectedValue = sgmid;
    ...
    protected void lnkUpdate_Click(object sender, EventArgs e)
    {
        ...
        sql = "Select *from SubjectClassteacherMaster where ECode='" + empId.Trim() + "'";
        sql = sql + " and Classid='" + drpclass1.SelectedValue.ToString() + "' and BranchId='" + drpBranch1.SelectedValue.ToString() + "' and SubjectId='" + drpSubjectGroup1.SelectedValue.ToString() + "' ";
        sql = sql + " and Medium='" + drpmedium1.SelectedItem.ToString() + "' and SessionName='" + Session["SessionName"].ToString() + "' and BranchCode=" + Session["BranchCode"].ToString() + "";
        ...
        else
        {
            ...
            cmd.Parameters.AddWithValue("@SubjectId", drpSubjectGroup1.SelectedValue.ToString());
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
