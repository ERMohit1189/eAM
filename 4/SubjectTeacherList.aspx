<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="SubjectTeacherList.aspx.cs" Inherits="SubjectTeacherList" %>
                                                        ...
                                                        <asp:GridView ID="Grd1" runat="server" AutoGenerateColumns="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Subject">
                                                                    ...
                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="vd_bg-blue vd_white" Width="20%" VerticalAlign="Middle" />
                                                                ...
                                                                <asp:TemplateField HeaderText="Emp. Id.">
                                                                    ...
                                                                    <HeaderStyle HorizontalAlign="Center" CssClass="vd_bg-blue vd_white" Width="7%" VerticalAlign="Middle" />
                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                </asp:TemplateField>
