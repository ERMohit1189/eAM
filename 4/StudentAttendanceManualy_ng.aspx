<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="StudentAttendanceManualy_ng.aspx.cs" Inherits="_4_StudentAttendanceManualy_ng" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12 " id="gdv" runat="server">
                                    <div class=" table-responsive  table-responsive2" id="abc" runat="server">
                                        ...
                                        <asp:GridView ID="grdStudentList" runat="server" AutoGenerateColumns="False" ShowFooter="False" class="table p-table p-table-bordered table-hover table-striped table-bordered pro-table table-header-group">
