<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="SetCoscholasticGroupDisplayOrder.aspx.cs" Inherits="admin_temp_AddDisplayOrder" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top ">
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding ">
                                    ...
                                    <asp:LinkButton ID="LinkButton1" CssClass="button form-control-blue" runat="server" OnClick="LinkButton1_Click">Submit</asp:LinkButton>
                                        ...
                                        <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" CssClass="table table-striped table-hover no-bm  no-head-border table-bordered ">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Subject">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("CoscholasticGroup") %>'></asp:Label>
