<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Certificate.ascx.cs" Inherits="admin_Certificate" %>
...
<div class=" text-left col-lg-2 col-md-2 col-xs-2 col-sm-2 no-padding" id="ctrl1" runat="server"  style="margin-right:0px !important; text-align:center;">
    ...
    <div class="mgbt-xs-5 p-mgbt-xs-5">
        <asp:Image ID="Image1" runat="server" class="logo-size"  style="Width: 80px; Height: 80px;" />
    </div>
