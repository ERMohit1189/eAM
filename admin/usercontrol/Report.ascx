<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Report.ascx.cs" Inherits="admin_Report" %>
...
<div class="text-left col-lg-2 col-md-2 col-xs-2 col-sm-2 no-padding" style="padding-left: 0px">
    <div runat="server" id="ctrl13" class="mgbt-xs-5 p-mgbt-xs-5">
        <asp:Image ID="Image2" runat="server" class="logo-size" />
    </div>
...
<div class=" text-left col-lg-2 col-md-2 col-xs-2 col-sm-2 no-padding" id="ctrl1" runat="server" style="margin-right:0px !important; text-align: right;">

    <div class="mgbt-xs-5 p-mgbt-xs-5 text-right">
