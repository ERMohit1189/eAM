<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Result_ng.ascx.cs" Inherits="admin_Examination_ng" %>
...
<div class=" text-center col-lg-8 col-md-8 col-xs-8 col-sm-8 no-padding " id="ctrlmain" runat="server">
    <div class="main-titel-box">
        ...
        <h3 id="ctrl6" runat="server" class="sub-adds ">
            ...
            <asp:Label ID="lblContactnoandemail" runat="server" style="text-transform:lowercase !important;"></asp:Label>
            <i class="append-icon fa fa-envelope-o"></i>
            <asp:Label ID="lblContactnoandemail1" runat="server" style="text-transform:lowercase !important;"></asp:Label>
        </h3>
        <h3 id="ctrl7" runat="server" class="sub-adds ">
            <i class="append-icon fa fa-phone-square"></i> 
            <asp:Label ID="lblPhoneNo" runat="server" style="text-transform:lowercase !important;"></asp:Label>
        </h3>

        <h3 id="ctrl8" runat="server" class="sub-adds ">
            <i class="append-icon fa fa-envelope-o"></i>
            <asp:Label ID="lblEmail" runat="server" style="text-transform:lowercase !important;"></asp:Label>
        </h3>
        ...
        <h3 id="ctrl10" runat="server" class="sub-adds ">
            ...
            <asp:Label ID="lblWebsite" runat="server" style="text-transform:lowercase !important;"></asp:Label>
            <%--    </asp:HyperLink>--%>

        </h3>
        <h3 id="ctrl9" runat="server" class="sub-adds " style="text-transform:lowercase !important;">
            <i class="append-icon fa fa-envelope-o"></i>
            <asp:Label ID="lblWebsiteandEmail" runat="server" style="text-transform:lowercase !important;"></asp:Label>
            <i class="append-icon fa fa-globe"></i>
            <asp:HyperLink ID="hylWebsiteandEmail1" runat="server" Target="_blank" style="text-transform:lowercase !important;">
               <asp:Label ID="lblWebsiteandEmail1" runat="server" Text="" style="text-transform:lowercase !important;"></asp:Label>
            </asp:HyperLink>
        </h3>
        ...
        <h3 class="form-name">
            <span class="span">RESULT SHEET FOR <asp:Label ID="lblSession" runat="server" Text=""></asp:Label> SESSION</span>
        </h3>
