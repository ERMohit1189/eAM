    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Image2.ImageUrl = BAL.objBal.GetImageUrl(ResolveClientUrl("~/img/cbse-logo.png"), Request.Url.AbsoluteUri.Split('/'));
                ...
                {
                    Image1.ImageUrl = dt.Rows[0]["collegeLogo"].ToString();
                    Image3.ImageUrl = dt.Rows[0]["collegeLogo"].ToString();
                }
                ...
                {
                    Image1.ImageUrl = "~/img/cbse-logo.png";
                }
                else
                {
