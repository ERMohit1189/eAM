    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblAddress.Text = dt.Rows[0]["address2"].ToString();
                lblPhoneNumber.Text =  dt.Rows[0]["Phone"].ToString();
                ...
                //lblEmail.Text = dt.Rows[0]["email"].ToString();lblBranchandCity
                ...
                {
                    Images.ImageUrl = "~/uploads/CollegeLogo/DefaultCollegeLogo.png";
                }
                else
                {
                    Images.ImageUrl = BAL.objBal.GetImageUrl(ResolveClientUrl(dt.Rows[0]["collegeLogo"].ToString()), Request.Url.AbsoluteUri.Split('/'));
                }
