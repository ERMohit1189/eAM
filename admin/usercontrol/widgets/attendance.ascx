...
<div class="col-md-4  mgbt-xs-10 dash-b-w">
  <div class="panel widget panel-bd-top  vd_bdt-green vd_todo-widget light-widget">
        <div class="panel-heading no-title ">
            <h3 class="panel-title"><span class="menu-icon"><i class=" fa  fa-child"></i></span>
                <asp:LinkButton ID="lnkStdAtt" runat="server" PostBackUrl="~/11/AttendanceReport.aspx?check=StudenceAttendanceDayWiseReport">Students Attendance</asp:LinkButton>
            </h3>
                     ...
                     <tr class="vd_yellow">
                        ...
                        <td class="tab-b-45 text-right">
                            <asp:LinkButton ID="lblStdTotalLate" ForeColor="#F89C2C" runat="server"
                                PostBackUrl="~/11/AttendanceReport.aspx?Sts=L&check=StudenceAttendanceDayWiseReport"></asp:LinkButton>
                        </td>
                    </tr>
                    <tr class=" vd_red">
