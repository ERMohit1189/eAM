<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Examination.ascx.cs" Inherits="admin_Examination" %>
...
<div class=" text-center col-lg-8 col-md-8 col-xs-8 col-sm-8 no-padding " id="ctrlmain" runat="server">
    <div class="main-titel-box">
        ...
        <h3 id="ctrl6" runat="server" class="sub-adds " style="text-transform:lowercase !important;">
        ...
        <h3 id="ctrl8" runat="server" class="sub-adds " style="text-transform:lowercase !important;">
            <i class="append-icon fa fa-envelope-o"></i>
