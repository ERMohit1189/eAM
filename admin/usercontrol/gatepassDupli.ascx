<%@ Control Language="C#" AutoEventWireup="true" CodeFile="gatepassDupli.ascx.cs" Inherits="gatepassDupli" %>
...
<div class=" text-center col-lg-2 col-md-2 col-xs-2 col-sm-2 no-padding">
    <p style="margin:0">GATE PASS</p>
    <p style="    font-size: 12px;">(Duplicate)</p>
    </div>
