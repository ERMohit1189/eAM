<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="LibraryAuthorWiseReport.aspx.cs"
    Inherits="admin_LibraryTitleWiseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    <table class="table">
        <tr>
            <td align="right">
                Author Category <span class="vd_red">*</span>
            </td>
            <td>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged"
                            ...
                            <asp:ListItem Value="1" Selected="True">Author1</asp:ListItem>
                            <asp:ListItem Value="2">Author2</asp:ListItem>
                            <asp:ListItem Value="3">Author3</asp:ListItem>
                        </asp:RadioButtonList>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" SkinID="Show" CssClass="button">View</asp:LinkButton>
            </td>
        </tr>
    </table>
    ...
    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click" Height="16px" Width="16px">Print</asp:LinkButton>
