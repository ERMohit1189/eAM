...
public partial class admin_MemberShipEntryFacultyLibrary : Page
{
    ...
    {
        sql = "Select EO.EmpId as EmpId,convert(nvarchar,EO.RegistrationDate,106) as RegistrationDate,EO.Designation as Designation, EG.EFirstName+' '+ EG.EMiddleName+' '+ EG.ELastName as Name,EG.EFatherName,EG.EmergencyContactNo,EG.EGender,ED.EPhotoPath";
        ...
        sql = sql + "    where  EO.EmpId='" + txtHeaderEmpId.Text.Trim() + "'";
        sql = sql + " and EO.SessionName='" + Session["SessionName"].ToString() + "' and EO.BranchCode=" + Session["BranchCode"].ToString() + "";
    ...
    protected void LinkButton5_Click(object sender, EventArgs e)
  {
    ...
    protected void LinkButton3_Click(object sender, EventArgs e)
    {
         ...
         sql1 = "Select SrNo from MemberEntryLibrary where SrNo='"+txtHeaderEmpId.Text.Trim()+"'";
        ...
        sql = "Select EO.EmpId as EmpId,EO.Ecode as Ecode,convert(nvarchar,EO.RegistrationDate,106) as RegistrationDate,EO.Designation as Designation, EG.EFirstName+' '+ EG.EMiddleName+' '+ EG.ELastName as Name,EG.EFatherName,EG.EmergencyContactNo,EG.EGender,ED.EPhotoPath";
        sql = sql + "  from EmpployeeOfficialDetails EO";
        sql = sql + " left join EmpGeneralDetail EG on EO.EmpId=EG.EmpId";
        sql = sql + " left join EmpDocuments ED on EO.EmpId=ED.EmpId";
        sql = sql + "    where  EO.EmpId='" + txtHeaderEmpId.Text.Trim() + "'";
        sql = sql + " and EO.SessionName='" + Session["SessionName"].ToString() + "' and EO.BranchCode=" + Session["BranchCode"].ToString() + "";
            ...
            cmd.Parameters.AddWithValue("@MemberClass", oo.ReturnTag(sql, "Designation"));
            ...
            cmd.Parameters.AddWithValue("@SrNo", oo.ReturnTag(sql, "EmpId"));
            cmd.Parameters.AddWithValue("@StEnRCode", oo.ReturnTag(sql, "Ecode"));
            ...
            cmd.Parameters.AddWithValue("@TypeOfPerson", "Faculty");
            cmd.Connection = con;
            try
            {
    ...
    public void DisplayData()
    {
        ...
        sql = sql + "   SrNo ,StEnRCode ,SessionName ,BranchCode ,LoginName,RecordDate from  MemberEntryLibrary where TypeOfPerson='Faculty'";
