...
public partial class admin_TC_Print : Page
{
    ...
    {
        if ((string)Session["TCRecieptNo"] == "" || Session["TCRecieptNo"] == null)
        {
    ...
    public void DisplayStudentCopy()
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (lbl_Class.Text == className)
            {
                ...
                sql = "select convert(varchar(11),RecordDate,106) as RecordDate,Remark,ConductandWork from TCCollection where RecieptNo='" + Session["TCRecieptNo"] + "'";
