<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ArrierStudentReceiptGenerate_duplicate.aspx.cs" Inherits="admin_ArrierStudentReceiptGenerate_duplicate" %>
                                                ...
                                                <asp:TemplateField>
                                                    <FooterTemplate>
                                                        <table width="670" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" align="right" style="text-align: left">&nbsp;&nbsp;<asp:Label ID="lblNexDueAmt" runat="server" Style="font-weight: 700"></asp:Label>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                </td>
                                                                    ...
                                                                    <table width="670" align="center" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            ...
                                                                            <td
                                                                                align="right" width="20%" valign="middle">
                                                                                <asp:Label ID="lblAmt" runat="server" Visible="False"></asp:Label>
                                                                                <asp:Label ID="Label130" runat="server" Text=''
                                                                                    CssClass="address" Font-Names="Arial" Font-Size="12px"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
