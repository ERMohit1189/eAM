...
public partial class admin_ArrierStudentReceiptGenerate_duplicate : System.Web.UI.Page
{
...
#pragma warning restore 649
    ...
    public void LaserPrint()
    {
        ...
        sql = sql + "  fd.LateFeeAmount as LateFeeAmount,Convert(nvarchar(25),fd.RecordDate,100) RecordDate,fd.LoginName,fd.RemainingAmount as RemainingAmount ,sod.Branch,cm.Id as Classid,sod.MODForFeeDeposit,fd.Cocession as Cocession ,fd.RecievedAmount as RecievedAmount,fd.AmountInWords,fd.BusConvience as BusConvience,Case When fd.FeeMonth='Arrier' Then 'Arrear' Else fd.FeeMonth End as FeeMonth,fd.Class as Class,fd.section as section,fd.DiscountName as DiscountName,fd.DiscountAmount as DiscountAmount,bm.BranchName from FeeDeposite Fd ";
        ...
        GridView2.DataBind();
        Label Label250 = (Label)GridView2.Rows[0].FindControl("Label250");
        Label Label120 = (Label)GridView2.Rows[0].FindControl("Label120");
        Label Label130 = (Label)GridView2.Rows[0].FindControl("Label130");
        Label250.Text = "1";
        Label120.Text = "Arrear";
        Label130.Text = oo.ReturnTag(sql, "RecievedAmount").ToString();
