<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="PlannerReport.aspx.cs" Inherits="admin_PlannerReport" %>
                                    ...
                                    <div class="col-sm-12 ">
                                        <div class="table-responsive2  table-responsive" id="mainDiv" runat="server">
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <table class="table p-table p-table-bordered table-hover no-bm table-striped table-bordered table-header-group">
