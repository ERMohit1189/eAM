...
public partial class admin_LibraryTitleWiseReport : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            sql = "Select distinct Publisher from LibraryItemEntry where BranchCode=" + Session["BranchCode"] + "";
            oo.FillDropDownWithOutSelect(sql, DropDownList1, "Publisher");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        sql = sql + "  RecordDate from LibraryItemEntry where  Publisher='" + DropDownList1.SelectedItem.ToString() + "' and BranchCode=" + Session["BranchCode"] + " and DeleteBookYesno is null or DeleteBookYesno='No' order by convert(numeric,AccessionNo) asc";
