<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="SmsEmail_Services.aspx.cs" Inherits="SuperAdmin_Sms_Services" %>
                            ...
                            <div class="panel-body">
                                <div class="col-lg-12 no-padding">
                                        ...
                                        <div class=" table-responsive  table-responsive2">
                                            <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="SMS Template ID">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="SMS" HeaderStyle-HorizontalAlign="Left">
                                                        <ItemTemplate>
                                                     ...
                                                     <asp:TemplateField HeaderText="WhatsApp" HeaderStyle-HorizontalAlign="Left" Visible="false">
                                                         <ItemTemplate>
                                                             <asp:RadioButtonList ID="rblWhatsApp" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow " CssClass="vd_radio radio-success">
                                                                 <asp:ListItem Text="Activate"></asp:ListItem>
                                                                 <asp:ListItem Text="Deactivate"></asp:ListItem>
                                                             </asp:RadioButtonList>
                                                         </ItemTemplate>
                                    ...
                                    <div class="col-lg-12 no-padding text-center">
                                        ...
                                        <asp:LinkButton ID="LinkButton2" runat="server" CssClass="button form-control-blue" OnClick="LinkButton2_Click" Visible="false">Create Default Setting</asp:LinkButton>
