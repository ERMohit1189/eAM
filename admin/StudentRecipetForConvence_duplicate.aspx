<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="StudentRecipetForConvence_duplicate.aspx.cs" Inherits="admin_StudentRecipetForConvence" %>
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl" runat="server" id="Table1">
                ...
                <div class="col-sm-12 ">
                  <%--  <div class="pull-left">--%>
                    ...
                    <%-- <div class="pull-left" style="width: 10%">
                        <div class="bar-code-box">
                            <barcode:barcodelabel id="lblBarCodesch" cssclass="vertical-barcode" runat="server" 
