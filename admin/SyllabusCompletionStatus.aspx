<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="SyllabusCompletionStatus.aspx.cs" Inherits="admin_SyllabusCompletionStatus" %>
                                 ...
                                 <div class="col-sm-12  no-padding">
                                    <div class="col-sm-12  no-padding">
                                      ...
                                      <div class="col-sm-2">
                                        ...
                                        <div class="">
                                           <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control-blue validatedrp" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                        </div>
                                    </div>
                                      <div class="col-sm-3" style="display:none;">
                                       ...
                                       <label class="control-label">Completion Date</label>
                                         <div class="">
                                                    <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DrpSaal_SelectedIndexChanged"
                                                        CssClass="form-control-blue col-xs-4">
                                                    </asp:DropDownList>
                                                    <asp:DropDownList ID="DropDownList3" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="DrpMahina_SelectedIndexChanged"
                                                        CssClass="form-control-blue col-xs-4">
                                                    </asp:DropDownList>
                                                    <asp:DropDownList ID="DropDownList4" runat="server"  AutoPostBack="True" OnSelectedIndexChanged="DrpDin_SelectedIndexChanged"
                                                        CssClass="form-control-blue col-xs-4">
                                                    </asp:DropDownList>
                                            <div class="text-box-msg"></div>
                                        </div>
                                         ...
                                         <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="LessonName" HeaderText="Lesson/Topic Name" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                 ...
                                                 <asp:BoundField DataField="NewDate" HeaderText="Expected Completion Date" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                 <asp:BoundField DataField="Completiondates" HeaderText="Completion Date" HeaderStyle-CssClass="vd_bg-blue vd_white" />
