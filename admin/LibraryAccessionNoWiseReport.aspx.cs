...
public partial class admin_LibraryTitleWiseReport : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //sql = "Select distinct AccessionNo from LibraryItemEntry";
            //oo.FillDropDownWithOutSelect(sql, DropDownList1, "AccessionNo");
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
      ...
      //  int i = 0, co = 1;
        ...
        sql = sql + "  RecordDate from LibraryItemEntry where  AccessionNo='" + TextBox1.Text.ToString() + "' and BranchCode=" + Session["BranchCode"] + "  and DeleteBookYesno is null or DeleteBookYesno='No' order by convert(numeric,AccessionNo) asc";
