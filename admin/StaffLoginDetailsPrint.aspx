<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="StaffLoginDetailsPrint.aspx.cs" Inherits="admin_StaffLoginDetailsPrint" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-4   half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="ddlCourse"  runat="server" CssClass="form-control-blue">
                                            </asp:DropDownList>
                                                        ...
                                                        <td>
                                                            <table class="table no-bm no-head-border pro-table table-header-group">
                                                                <tr>
                                                                   ...
                                                                   <%-- <td>S.R. No.:
                                                                    <asp:Label ID="lblSrno" runat="server" Text='<%# Bind("Ecode") %>'></asp:Label></td>--%>
                                                                    <td>Name:
