<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ArrierStudentReceiptGenerate.aspx.cs" Inherits="StudentReceiptGenerate" %>
                                    ...
                                    <td>
                                       ...
                                       <asp:Label ID="Label6" runat="server" Style="font-family: Arial; font-size: 12px; font-weight: bold;"
                                           Text="FEE RECEIPT"></asp:Label>
                                                            ...
                                                            <td align="right">School&#39;s Copy</td>
                                                        </tr>
                                                    </table>
