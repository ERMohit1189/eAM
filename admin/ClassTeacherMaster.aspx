<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="ClassTeacherMaster.aspx.cs" Inherits="admin_ClassTeacherMaster" %>
                                                        ...
                                                        <asp:GridView ID="Grd1" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Class">
                                                                    ...
                                                                    <HeaderStyle HorizontalAlign="Left" CssClass="vd_bg-blue vd_white" Width="30%" VerticalAlign="Middle" />
