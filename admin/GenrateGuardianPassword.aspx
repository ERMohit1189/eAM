<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="GenrateGuardianPassword.aspx.cs" Inherits="admin_GenrateGuardianPassword" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpClass" runat="server" AutoPostBack="true" CssClass="form-control-blue validatedrp" OnSelectedIndexChanged="drpClass_SelectedIndexChanged"></asp:DropDownList>
                                    ...
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                     ...
                                     <div class="col-sm-3  half-width-50  btn-a-devices-1-p4-p2 mgbt-xs-15">
                                        <asp:LinkButton ID="lnkSubmit" runat="server" OnClick="lnkSubmit_Click"  OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn();" CssClass="button">Submit</asp:LinkButton>
