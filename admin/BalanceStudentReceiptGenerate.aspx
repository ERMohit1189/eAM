<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="BalanceStudentReceiptGenerate.aspx.cs" Inherits="StudentReceiptGenerate" %>
        ...
        <div class="codepart">
            ...
            <div class="contentbox">
                ...
                <table align="center" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td>
                            <table id="Table1" align="center" cellpadding="0" cellspacing="0" runat="server">
                                <tr>
                                    <td>
                                        <div class="hedingbg">
                                    ...
                                    <td>
                                       ...
                                       <asp:Label ID="Label26" runat="server" Style="font-family: Arial; font-size: 12px; font-weight: bold;"
                                           Text="FEE RECEIPT"></asp:Label>
                                            ...
                                            <tr>
                                                <td>
                                                    <table align="center" cellpadding="0" cellspacing="0" runat="server" id="Table2">
                                                        <tr>
