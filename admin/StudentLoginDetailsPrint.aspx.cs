...
public partial class StudentLoginDetailsPrint : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            BLL.BLLInstance.loadCourse(ddlCourse, Session["SessionName"].ToString());
    ...
    public void userPasswordDetails(string classid, string SectionName, string branchid,string courseid)
    {
        ...
        rptLoginDetails.DataSource = DLL.objDll.Sp_SelectRecord_usingExecuteDataset("StudentLoginandPasswordDetails_Proc", param);
    ...
    {
        userPasswordDetails(ddlClass.SelectedValue, ddlSection.SelectedItem.Text, ddlBranch.SelectedValue, ddlCourse.SelectedValue);
