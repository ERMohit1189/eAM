<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="Email_Services.aspx.cs" Inherits="SuperAdmin_Sms_Services" %>
                                    ...
                                    <asp:GridView ID="Grd" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover no-bm no-head-border table-bordered text-center">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Notification" HeaderStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:RadioButtonList ID="rblad1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow " CssClass="vd_radio radio-success">
