                                ...
                                <div class="col-sm-12 no-padding ">
                                    ...
                                    <div class="col-sm-3  half-width-50 ">
                                        ...
                                        <div class="" style="width:80%; float:left;">
                                            <asp:TextBox ID="txtColorbox" runat="server" CssClass="form-control-blue colorpicker-hex" Text="#555555"></asp:TextBox>
                                    ...
                                    <div class="col-sm-4  half-width-50 " runat="server" visible="false">
                                    ...
                                    <div class="col-sm-4  half-width-50  btn-a-devices-3-p6 mgbt-xs-15">
                                         ...
                                         <div class="">
                                            <asp:LinkButton ID="lnkSubmit" runat="server" CssClass="button form-control-blue" 
                                            OnClick="lnkSubmit_Click" OnClientClick="return ValidateTextBox('.validatetxt');">Submit</asp:LinkButton> 
                                                ...
                                                <asp:Repeater ID="rptPlannerType" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lblPlannerType" runat="server" Text='<%# Eval("PlannerType") %>'></asp:Label>                                                                
