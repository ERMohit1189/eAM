<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="StudentReciptGenrate_duplicate.aspx.cs"
    Inherits="admin_StudentReciptGenrate_duplicate" %>

<%@ Register Assembly="Zen.Barcode.Web" Namespace="Zen.Barcode.Web" TagPrefix="barcode" %>
                ...
                <div class="panel widget light-widget panel-bd-top">
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6 no-padding text-right menu-action">
                            ...
                            &nbsp;
                            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="btn-print-box" title="Receipt Print" data-placement="left"><i class="icon-printer"></i></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-12 no-padding print-row marg-bot-30" runat="server" id="abc">
                        ...
                        <tr>
                            ...
                            <td style="width: 25%; vertical-align: top;">
                                <h3 class="main-name-l text-center" style="font-size: 13px; font-weight: 400;">
                                    <asp:Label ID="lblCancel" runat="server" Text="FEE RECEIPT (DUPLICATE)"></asp:Label></h3>
                ...
                <div class="col-sm-12 ">
                                    ...
                                    <HeaderTemplate>
                                        ...
                                        <table style="width: 100%; font-family: Courier New;">
                                           ...
                                           <asp:Label ID="Label34" runat="server" Text="Label" Font-Bold="True" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <table class="table table-striped no-head-border" style="margin-bottom:0px">
                                                        <tr>
                   ...
                   <%-- <div class="pull-left" style="width: 10%">
                        <div class="bar-code-box">
                            <barcode:barcodelabel id="lblBarCode" runat="server" cssclass="vertical-barcode" text="" labelrowstyle-cssclass="barcode-label-style" barcodeencoding="Code39NC" barminwidth="1" barmaxwidth="2" barminheight="30" barmaxheight="40" />
                        </div>
                    </div>--%>
            ...
            <div class="col-sm-12 print-row fee-d-box-nhl" runat="server" id="Table1">
                <div class="col-sm-12 no-padding print-row">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="width: 75%" id="header2" runat="server"></td>
                            <td style="width: 25%; vertical-align: top;">
                                <h3 class="main-name-l text-center" style="font-size: 13px; font-weight: 400;">
                                    <asp:Label ID="lblCancelStudent" runat="server" Text="FEE RECEIPT (DUPLICATE)"></asp:Label></h3>
                ...
                <div class="col-sm-12 ">
                   <%-- <div class="pull-left">--%>
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="100%" ShowFooter="True" BorderStyle="None"
                            GridLines="None" Style="margin-top: 0px" Font-Size="12px">
                            <Columns>
                                <asp:TemplateField>
                   ...
                   <%-- <div class="pull-left" style="width: 10%">
                        <div class="bar-code-box">
                            <barcode:barcodelabel id="lblBarCodesch" cssclass="vertical-barcode" runat="server" labelrowstyle-cssclass="barcode-label-style" text="" barcodeencoding="Code39NC" barminwidth="1" barmaxwidth="2" barminheight="30" barmaxheight="40" />
                        </div>
                    </div>--%>
                </div>
