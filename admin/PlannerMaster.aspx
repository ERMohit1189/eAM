<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="PlannerMaster.aspx.cs"
    Inherits="admin_PlannerMaster" %>
                        ...
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-3 half-width-50" runat="server" Visible="false">
                                        <label class="control-label">Planner For</label>
                                        <div class="mgtp-6 ">
                                            <asp:RadioButtonList ID="rbPlannerFor" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" RepeatLayout="Flow"
                                                CssClass="vd_radio radio-success validaterb" OnSelectedIndexChanged="rbPlannerFor_SelectedIndexChanged">
                                    ...
                                    <div class="col-sm-3   half-width-50" style="display:none;">
                                        <label class="control-label">Description</label>
                                        <div class=" ">
                                            <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control-blue" Rows="1" TextMode="MultiLine"></asp:TextBox>
                                    ...
                                    <div class="col-sm-3   half-width-50 " id="divStudentCount" runat="server">
                                        <label class="control-label">Count Student Attendance</label>
                                        <div class=" ">
                                            <asp:DropDownList ID="drpStudentCount" runat="server" CssClass="form-control-blue">
                                    ...
                                    <div class="col-sm-3   half-width-50 mgbt-xs-15" id="divStaffCount" runat="server">
                                        <label class="control-label">Count Staff Attendance</label>
                                        <div class=" ">
                                            <asp:DropDownList ID="drpStaffCount" runat="server" CssClass="form-control-blue">
                                    ...
                                    <div class="col-sm-3   half-width-50 mgbt-xs-15" id="divfromClass" runat="server" visible="false">
                                        <label class="control-label">From Class</label>
                                        <div class=" ">
                                            <asp:DropDownList ID="drpFromClass" runat="server" CssClass="form-control-blue"></asp:DropDownList>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-sm-3   half-width-50 mgbt-xs-15" id="divtoClass" runat="server" visible="false">
                                    ...
                                    <div class="col-sm-3  half-width-50 mgbt-xs-15">
                                        <label class="control-label">Apply to All Branches</label>
                                        <div class="">
                                    ...
                                    <div id="container" class="col-sm-3  half-width-50  btn-a-devices-6-p6 mgbt-xs-15">
                                        ...
                                        <asp:GridView ID="Grd" runat="server" CssClass="table table-striped table-hover no-bm no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Title">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("PlannerName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="For" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("PlannerFor") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" Width="58px" />
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Type">
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label6" runat="server" Text='<%# Bind("PlannerType") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" CssClass="vd_bg-blue vd_white" />
                                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                                </asp:TemplateField>
