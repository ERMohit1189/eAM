...
public partial class StudentReceiptGenerate : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("YearlyStudentReceiptGenerate.aspx");
        }
...
#pragma warning restore 219
    ...
    public void LaserPrint()
    {
        ...
        try
        {
            ...
            {
                lblArrierStudentCopy.Text = oo.ReturnTag(sql, "ArrierAmt") + ".00";
            }
            else
            {
            ...
            if (oo.ReturnTag(sql, "ArrierAmt") != string.Empty)
            {
                lblArrierSchoolCopy.Text = oo.ReturnTag(sql, "ArrierAmt") + ".00";
            }
            else
            {
