<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="LibraryTitleWiseReport.aspx.cs" Inherits="admin_LibraryTitleWiseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    <table class="table">
        <tr>
            <td align="right">
                Title Name <span class="vd_red">*</span>
            </td>
            <td>
