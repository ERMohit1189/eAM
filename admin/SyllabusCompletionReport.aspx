<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/admin_root-manager.master" CodeFile="SyllabusCompletionReport.aspx.cs" Inherits="admin_SyllabusCompletionReport" %>
                    ...
                    <div class="col-sm-12 mgbt-xs-20">
                        <div class="panel widget light-widget panel-bd-top">
                            <div class="panel-body">
                                ...
                                <asp:RadioButtonList ID="rptType" runat="server" Visible="false" CssClass="vd_radio radio-success" RepeatDirection="Horizontal" RepeatLayout="flow" AutoPostBack="true" OnSelectedIndexChanged="rptType_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem>Batch wise Attendance</asp:ListItem>
                                      ...
                                      <div class="col-sm-2">
                                            <div class="" style="margin-top: 25px;">
                                                <asp:LinkButton ID="LinkButton2" runat="server" OnClientClick="ValidateDropdown('.validatedrp');ValidateTextBox('.validatetxt');return validationReturn();" OnClick="LinkButton1_Click"  CssClass="button form-control-blue">View</asp:LinkButton>
                                         ...
                                         <asp:GridView ID="Grd" runat="server" CssClass="table table-striped no-bm table-hover no-head-border table-bordered" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="NumberofDays" HeaderText="Days" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                 <asp:BoundField DataField="DisplayofSequence" HeaderText="Display Order" Visible="false" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                 <asp:BoundField DataField="NewDate" HeaderText="Scheduled Completion Date" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                 <asp:BoundField DataField="Completiondates" HeaderText="Actual Completion Date" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                                                  <asp:BoundField DataField="DelayInDays" HeaderText="Delay in Days" HeaderStyle-CssClass="vd_bg-blue vd_white" />
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup">
                        <tr>
                            <td>
                                <asp:Label ID="lblIDEdit" runat="server" Visible="false"></asp:Label>
                                  <asp:Label ID="lblEditlessonID" runat="server" Visible="false"></asp:Label>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>
                                <asp:Label ID="Label8" runat="server" Text="Expected Completion Date"></asp:Label>
                            </td>
                            <td>
                                 <div class="">
                                                    <asp:DropDownList ID="DropDownList5" runat="server"  Enabled="false" AutoPostBack="True" OnSelectedIndexChanged="DropDownList5_SelectedIndexChanged"
                                                        CssClass="form-control-blue col-xs-4">
                                                    </asp:DropDownList>
                                                    <asp:DropDownList ID="DropDownList6" runat="server"  Enabled="false"  AutoPostBack="True" OnSelectedIndexChanged="DropDownList6_SelectedIndexChanged"
                                                        CssClass="form-control-blue col-xs-4">
                                                    </asp:DropDownList>
                                                    <asp:DropDownList ID="DropDownList7" runat="server"  Enabled="false"  AutoPostBack="True" OnSelectedIndexChanged="DropDownList7_SelectedIndexChanged"
                                                        CssClass="form-control-blue col-xs-4">
                                                    </asp:DropDownList>
