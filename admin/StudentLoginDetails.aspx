<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="StudentLoginDetails.aspx.cs" Inherits="SuperAdmin_StaffLoginDetails" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    <div class="col-sm-3   half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="DrpClass" OnSelectedIndexChanged="DrpClass_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control-blue validatedrp">
                                            </asp:DropDownList>
                                    ...
                                    <div class="col-sm-3  half-width-50 btn-a-devices-1-p4-p2 mgbt-xs-15">
                                        <asp:LinkButton ID="lnkSend" runat="server" CssClass="button" Visible="false"  OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn();" OnClick="lnkSend_Click">Send SMS</asp:LinkButton>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="lnkEdit" runat="server" title="Edit Events" 
                                                ...
                                                <asp:TemplateField HeaderText="Status">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblBlocked" runat="server" Text='<%# Eval("IsBlocked").ToString()=="NO"?"Active":"Inactive" %>'></asp:Label>
                                                    </ItemTemplate>
