<%@ Page Title="" Language="C#" MasterPageFile="~/Master/admin_root-manager.master" AutoEventWireup="true" CodeFile="LibraryAccessionNoWiseReport.aspx.cs"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMainBox" runat="Server">
    ...
    <tr>
        <td>
            Accession No <span class="vd_red">*</span>
        </td>
        <td>
    ...
    <td>
        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CssClass="button">View</asp:LinkButton></td>
    </tr>
    </table>
