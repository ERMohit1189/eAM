...
public partial class admin_SyllabusCompletionReport : System.Web.UI.Page
{
    string _sql = "";
    ...
    protected void LoadReport()
    {
            ...
            List<SqlParameter> param = new List<SqlParameter>
        {
            ...
            DataSet ds = new DLL().Sp_SelectRecord_usingExecuteDataset("SyllabusCompletionReportProc", param);
