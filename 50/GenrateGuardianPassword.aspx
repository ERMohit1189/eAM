<%@ Page Title="" Language="C#" MasterPageFile="~/50/sadminRootManager.master" AutoEventWireup="true" CodeFile="GenrateGuardianPassword.aspx.cs" Inherits="admin_GenrateGuardianPassword" %>
                            ...
                            <div class="panel-body ">
                                <div class="col-sm-12  no-padding">
                                    ...
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            <asp:DropDownList ID="drpClass" runat="server" AutoPostBack="true" CssClass="form-control-blue" OnSelectedIndexChanged="drpClass_SelectedIndexChanged"></asp:DropDownList>
