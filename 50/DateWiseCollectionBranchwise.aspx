<%@ Page Title="" Language="C#" MasterPageFile="~/50/sadminRootManager.master" AutoEventWireup="true" CodeFile="DateWiseCollectionBranchwise.aspx.cs"
    Inherits="DateWiseCollectionBranchwise" %>
                                ...
                                <div class="col-sm-12  no-padding ">
                                    <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                        ...
                                        <div class="">
                                            ...
                                            <asp:DropDownList ID="DDDate" runat="server" CssClass="form-control-blue col-xs-4"></asp:DropDownList>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                        <ContentTemplate>
                                            <div style="float: right; font-size: 19px;" id="Panel2" runat="server">
                                                ...
                                                <asp:LinkButton ID="ImageButton3" runat="server" OnClick="ImageButton3_Click" Visible="false" CssClass="icon-pdf-color"
                                            ...
                                            <ContentTemplate>
                                                <div id="gdv1" runat="server">
                                                    <table align="center" id="abc" runat="server" width="100%" class="table no-p-b-table"  visible="false">
                                                        <tr>
                                                            <td>
                                                                <div id="header" runat="server" class="col-md-12 no-padding text-center">
