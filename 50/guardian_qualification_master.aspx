<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/50/sadminRootManager.master" 
    CodeFile="guardian_qualification_master.aspx.cs"
    Inherits="_1.AdminGuardianDesignationMasterNew"
  %>
            ...
            <div style="overflow: auto; width: 1px; height: 1px">
                <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                    <table class="tab-popup ">
                        <tr>
                            <td>Qualification <span class="vd_red">*</span>
                            </td>
                            <td>
