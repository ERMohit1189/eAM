...
public partial class admin_ChangePassword : System.Web.UI.Page
{
    ...
    protected void txtOldPanel_TextChanged(object sender, EventArgs e)
    {
        ...
        string qry = "select Pass from LoginTab where  Pass='" + txtOldPanel.Text + "' and LoginName='" + Session["LoginName"] + "' and LoginTypeId=1";
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        {
            string qry = "update LoginTab set Pass='" + txtNewPanel.Text + "'   where  Pass='" + Session["OldPass"] + "' and LoginName='" + Session["LoginName"] + "'  and  logintypeid=1 ";
            ...
            try
            {
                ...
                con.Close();
                sql = "update NewSuperAdminInformation set Password='" + txtNewPanel.Text + "'   where userid='" + Session["LoginName"] + "'";
                cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = sql;
                cmd.Connection = con;
