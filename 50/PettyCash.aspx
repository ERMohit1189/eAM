<%@ Page Title="" Language="C#" MasterPageFile="~/50/sadminRootManager.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="PettyCash.aspx.cs"
    Inherits="PettyCash" %>
                            ...
                            <div class="panel-body">
                                <div class="col-lg-12 col-md-12 col-sm-12   no-padding">
                                    ...
                                    <div class="col-sm-12   ">
                                        <fieldset>
                                            <legend>
                                                <span class="font-s-17">Institute Details</span>
                                            </legend>
                                            ...
                                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                ...
                                                <div class=" ">
                                                    ...
                                                    <asp:DropDownList ID="ddluserType" runat="server" AutoPostBack="True" CssClass="form-control-blue validatedrp" OnSelectedIndexChanged="ddluserType_SelectedIndexChanged">
                                            ...
                                            <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                <label class="control-label">Users&nbsp;<span class="vd_red">*</span></label>
                                                <div class=" ">
                                                    <asp:DropDownList ID="ddlUser" runat="server" CssClass="form-control-blue validatedrp" OnSelectedIndexChanged="ddlUser_SelectedIndexChanged" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <div class="text-box-msg">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-sm-12   ">
                                        <fieldset>
                                            <legend>
                                                <span class="font-s-17">Payment Details</span>
                                            </legend>
                                            <div class="col-sm-4   mgbt-xs-15">
                                                <label class="control-label">Date &nbsp;<span class="vd_red">*</span></label>
                                                <div class="">
                                                    <asp:DropDownList ID="DDYears" runat="server" CssClass="form-control-blue col-sm-4" OnSelectedIndexChanged="DDYear_SelectedIndexChanged" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <asp:DropDownList ID="DDMonths" runat="server" CssClass="form-control-blue col-sm-4" OnSelectedIndexChanged="DDMonth_SelectedIndexChanged" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <asp:DropDownList ID="DDDates" runat="server" CssClass="form-control-blue col-sm-4" OnSelectedIndexChanged="DDDay_SelectedIndexChanged" AutoPostBack="true">
                                                    </asp:DropDownList>
                                                    <div class="text-box-msg">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-4   mgbt-xs-15">
                                                ...
                                                <div class="">
                                                    <asp:DropDownList ID="ddlMode" runat="server" CssClass="form-control-blue validatedrp" AutoPostBack="true" OnSelectedIndexChanged="ddlMode_SelectedIndexChanged" onchange="MODChenge();">
                                                        <asp:ListItem Value=""><--Select--></asp:ListItem>
                                            ...
                                            <div class="col-sm-12  no-padding" id="divOtherTools" runat="server" visible="false">
                                                <div class="col-sm-4  half-width-50 mgbt-xs-15" id="div8" runat="server">
                                                    ...
                                                    <div class="">
                                                        <asp:DropDownList ID="DDChequeYears" runat="server" CssClass="form-control-blue col-sm-4" OnSelectedIndexChanged="DDChequeYears_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                        <asp:DropDownList ID="DDChequeMonths" runat="server" CssClass="form-control-blue col-sm-4" OnSelectedIndexChanged="DDChequeMonths_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                        <asp:DropDownList ID="DDChequeDates" runat="server" CssClass="form-control-blue col-sm-4"></asp:DropDownList>
                                                        <div class="text-box-msg">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4  half-width-50 mgbt-xs-15">
                                                    ...
                                                    <div class="">
                                                        <asp:TextBox ID="txtChqNo" runat="server" CssClass="form-control-blue"></asp:TextBox>
                                                        <div class="text-box-msg">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4 mgbt-xs-15" runat="server" visible="false">
                                            ...
                                            <div class="col-sm-8   mgbt-xs-9">
                                                <label class="control-label">Remark&nbsp;<span class="vd_red"></span></label>
                                                <div class="">
                                                    <asp:TextBox ID="txtARemark" runat="server" TextMode="MultiLine" CssClass="form-control-blue" Rows="1"></asp:TextBox>
                                                    <div class="text-box-msg">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4  btn-a-devices-2-p2  mgbt-xs-20">
                                                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"
                                                    OnClientClick="ValidateTextBox('.validatetxt');ValidateDropdown('.validatedrp');return validationReturn();" CssClass="button form-control-blue">Submit</asp:LinkButton>
    ...
    <script>
        function MODChenge() {
            ...
            if ($("[id*=DropDownMOD]").val() == "Cash") {
                $("[id*=txtChqNo]").removeClass("validateText");
                $("[id*=txtBankName]").removeClass("validateText");
                $("[id*=txtBankName]").val("");
            }
            else {
                $("[id*=txtChqNo]").addClass("validateText");
                $("[id*=txtBankName]").addClass("validateText");
                $("[id*=txtBankName]").val("NA");
            }
