...
namespace _1
{
    public partial class AdminGuardianDesignationMaster : System.Web.UI.Page
    {
        ...
        protected void load()
        {
            ...
            {
                Label occupation = (Label)Grd.Rows[i].FindControl("Label2");
                ...
                _sql = "select FatherOccupation from StudentFamilyDetails where FatherOccupation='" + occupation.Text.Trim() + "'";
                if (_oo.Duplicate(_sql))
                {
                    LinkButton LinkButton2 = (LinkButton)Grd.Rows[i].FindControl("LinkButton2");
                    LinkButton LinkButton3 = (LinkButton)Grd.Rows[i].FindControl("LinkButton3");
