<%@ Page Title="" Language="C#" MasterPageFile="~/50/sadminRootManager.master" AutoEventWireup="true" CodeFile="StaffMenuAccessability.aspx.cs" Inherits="SuperAdmin_menu_accessability" %>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12 no-padding">
                                    ...
                                    <div class="col-sm-4 half-width-50  mgbt-xs-15">
                                        ...
                                        <div class=" ">
                                            <label class="control-label">Selected User is : </label>
                                            <span class="vd_red">
                                                <asp:Label ID="lblUser" runat="server" Font-Bold="true" Text=""></asp:Label></span>
                                            <div class="text-box-msg">
                                            </div>
                                        </div>
                                    </div>
