<%@ Page Title="" Language="C#" MasterPageFile="~/50/sadminRootManager.master" AutoEventWireup="true" CodeFile="country_master.aspx.cs" Inherits="admin_country_master" %>
                                        ...
                                        <div class=" ">
                                            ...
                                            <div class="text-box-msg">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
                                                    ErrorMessage="Please enter country name." Style="color: #CC0000" SetFocusOnError="True" Display="None"
                                ...
                                <div style="overflow: auto; width: 1px; height: 1px">
                                    <asp:Panel ID="Panel1" runat="server" CssClass="popup animated2 fadeInDown">
                                        <table class="tab-popup">
                                            <tr>
                                                <td>Country&nbsp;<span class="vd_red">*</span></td>
                                                <td class="controls">
                                                    <asp:TextBox ID="txtCountryPanel" runat="server" CssClass="form-control-blue validatetxt1"></asp:TextBox>
                                                    <asp:Button ID="Button5" runat="server" Style="display: none" /></td>
                                            </tr>
                                            <tr>
                                                <td>Remark </td>
                                                <td class="controls">
                                                    <asp:TextBox ID="txtRemarkPanel" runat="server" TextMode="MultiLine" Rows="2" CssClass="form-control-blue"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>
                                    ...
                                    <asp:ModalPopupExtender ID="Panel1_ModalPopupExtender" runat="server"
                                        TargetControlID="Button5" PopupControlID="Panel1" CancelControlID="Button4" BackgroundCssClass="popup_bg" BehaviorID="Panel1_ModalPopupExtender_Close">
                                        ...
                                        <table class="tab-popup text-center">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    &nbsp; &nbsp;
                                                        <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" Text="Yes" OnClientClick="javascript:scroll(0,0);" CssClass="button-y" CausesValidation="False" />
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
