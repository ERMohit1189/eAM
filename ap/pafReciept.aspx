<%@ Page Title="" Language="C#" MasterPageFile="~/ap/main-ap.master" AutoEventWireup="true" CodeFile="pafReciept.aspx.cs"
                                                    ...
                                                    <td style="width: 25%; vertical-align: top;">
                                                        <div class="print-side-titel-box text-center">
                                                            <h3 class="main-name-l text-center">
                                                                <asp:Label ID="Label26" runat="server" Text="FEE RECEIPT"></asp:Label>
                                                            </h3>
                                                            ...
                                                            <h3 class="sub-adds-l text-center">
                                                                <asp:Label ID="LabelDupliactes" runat="server"></asp:Label></h3>
                                                            <h3 class="sub-adds-l text-center">
                                                                <asp:Label ID="lblCancel" runat="server"></asp:Label>STUDENT'S COPY<br />(ORIGINAL)</h3>
                                        ...
                                        <div class="col-sm-12 ">
                                            <table style="width: 100%; margin: 0; font-family: Courier New !important;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right" style="width: 60%;">-<asp:Label ID="lblConcession" runat="server" Font-Names="Courier New" Font-Size="12px"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left" style="width: 40%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 25%; vertical-align: top;">
                                                        ...
                                                        <div class="print-side-titel-box text-center">
                                                            ...
                                                            <h3 class="sub-adds-l text-center">
                                                                <asp:Label ID="LabelDupliactes1" runat="server"></asp:Label></h3>
                                                            <h3 class="sub-adds-l text-center">
                                                                <asp:Label ID="Label6" runat="server"></asp:Label>School's Copy <br />(ORIGINAL)</h3>
                                                        </div>
                                                    </td>
                                                </tr>
